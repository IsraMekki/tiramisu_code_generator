...
int main(int argc, char **argv){
    tiramisu::init("function70802_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70802/function70802_schedule_1/function70802_schedule_1.o");
