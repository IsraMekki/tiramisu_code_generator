...
int main(int argc, char **argv){
    tiramisu::init("function64893_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i2) * input02(i0) + input03(i0) * input04(i1, i2) - input05(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function64893/function64893_no_schedule/function64893_no_schedule.o");
