...
int main(int argc, char **argv){
    tiramisu::init("function72156_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72156/function72156_schedule_2/function72156_schedule_2.o");
