...
int main(int argc, char **argv){
    tiramisu::init("function70458_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1, i2) - input02(i0, i2) + input03(i2) * input04(i0, i2) - input05(i2) * input06(i0, i1) - input07(i1) + input08(i0) + input09(i0, i1));
    ...
    buffer buf04("buf04", {64, 256}, p_int32, a_input);
    ...
    buffer buf09("buf09", {64, 2048}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70458/function70458_no_schedule/function70458_no_schedule.o");
