...
int main(int argc, char **argv){
    tiramisu::init("function66866_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66866/function66866_no_schedule/function66866_no_schedule.o");
