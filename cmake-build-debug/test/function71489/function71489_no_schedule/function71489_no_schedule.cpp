...
int main(int argc, char **argv){
    tiramisu::init("function71489_no_schedule");
    ...
    input input02("input02", {i2, i3, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) + input01(i2) - input02(i2, i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71489/function71489_no_schedule/function71489_no_schedule.o");
