...
int main(int argc, char **argv){
    tiramisu::init("function71803_no_schedule");
    ...
    buffer buf00("buf00", {256, 4096, 64}, p_int32, a_input);
    buffer buf0("buf0", {256, 4096, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function71803/function71803_no_schedule/function71803_no_schedule.o");
