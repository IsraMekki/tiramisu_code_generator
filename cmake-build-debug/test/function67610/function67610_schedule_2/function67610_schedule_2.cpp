...
int main(int argc, char **argv){
    tiramisu::init("function67610_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67610/function67610_schedule_2/function67610_schedule_2.o");
