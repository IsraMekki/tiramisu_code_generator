...
int main(int argc, char **argv){
    tiramisu::init("function69658_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69658/function69658_no_schedule/function69658_no_schedule.o");
