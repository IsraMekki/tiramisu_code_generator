...
int main(int argc, char **argv){
    tiramisu::init("function69254_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69254/function69254_no_schedule/function69254_no_schedule.o");
