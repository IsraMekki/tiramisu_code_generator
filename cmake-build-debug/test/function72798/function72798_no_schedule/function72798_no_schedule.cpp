...
int main(int argc, char **argv){
    tiramisu::init("function72798_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) + input01(i1, i2) * input02(i0, i1) * input03(i1, i3) + input04(i1, i3) - input05(i0, i2, i3) + input06(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function72798/function72798_no_schedule/function72798_no_schedule.o");
