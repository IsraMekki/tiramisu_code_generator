...
int main(int argc, char **argv){
    tiramisu::init("function65789_no_schedule");
    ...
    input input02("input02", {i2, i1, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i0, i1, i3) * input02(i2, i1, i0) - input03(i0, i3) + input04(i0, i1, i3) * input05(i0, i2) + input06(i3) + input07(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65789/function65789_no_schedule/function65789_no_schedule.o");
