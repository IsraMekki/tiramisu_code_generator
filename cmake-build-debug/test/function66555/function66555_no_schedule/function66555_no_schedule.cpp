...
int main(int argc, char **argv){
    tiramisu::init("function66555_no_schedule");

    constant c0("c0", 64), c1("c1", 128), c2("c2", 4096);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) - input01(i1, i2) + input02(i0, i2) * input03(i1, i2) - input04(i0) - input05(i1) + input06(i0) * input07(i0, i1) - input08(i0) + input09(i0, i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64, 128}, p_int32, a_input);
    buffer buf01("buf01", {128, 4096}, p_int32, a_input);
    buffer buf02("buf02", {64, 4096}, p_int32, a_input);
    buffer buf03("buf03", {128, 4096}, p_int32, a_input);
    ...
    buffer buf09("buf09", {64, 4096}, p_int32, a_input);
    buffer buf0("buf0", {64, 128, 4096}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function66555/function66555_no_schedule/function66555_no_schedule.o");
