...
int main(int argc, char **argv){
    tiramisu::init("function67172_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67172/function67172_no_schedule/function67172_no_schedule.o");
