...
int main(int argc, char **argv){
    tiramisu::init("function66508_no_schedule");
    ...
    input input02("input02", {i1, i0, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) * input01(i0) + input02(i1, i0, i2) - input03(i1, i2) - input04(i0, i1, i2) + input05(i1, i2, i3) * input06(i0, i2) * input07(i0, i2) * input08(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function66508/function66508_no_schedule/function66508_no_schedule.o");
