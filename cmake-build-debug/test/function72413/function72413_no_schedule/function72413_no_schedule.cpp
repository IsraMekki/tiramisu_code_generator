...
int main(int argc, char **argv){
    tiramisu::init("function72413_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) * input01(i1, i3) - input02(i1, i2, i3) * input03(i1, i3) + input04(i0) * input05(i1, i2) + input06(i1, i3) + input07(i1, i2) + input08(i3) - input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function72413/function72413_no_schedule/function72413_no_schedule.o");
