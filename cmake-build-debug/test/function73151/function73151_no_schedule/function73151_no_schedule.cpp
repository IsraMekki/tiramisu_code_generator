...
int main(int argc, char **argv){
    tiramisu::init("function73151_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i0) * input02(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73151/function73151_no_schedule/function73151_no_schedule.o");
