...
int main(int argc, char **argv){
    tiramisu::init("function72428_no_schedule");
    ...
    input input01("input01", {i2, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i2, i1) + input02(i0) + input03(i1) * input04(i2) + input05(i1, i2) + input06(i0, i1) * input07(i0, i1) - input08(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function72428/function72428_no_schedule/function72428_no_schedule.o");
