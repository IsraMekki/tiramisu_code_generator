...
int main(int argc, char **argv){
    tiramisu::init("function72153_no_schedule");
    ...
    input input05("input05", {i1, i0, i2}, p_int32);

    input input06("input06", {i1, i2, i3}, p_int32);

    input input07("input07", {i0, i2, i3}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) * input01(i0, i1, i3) * input02(i2) + input03(i0, i2) - input04(i3) * input05(i1, i0, i2) - input06(i1, i2, i3) * input07(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function72153/function72153_no_schedule/function72153_no_schedule.o");
