...
int main(int argc, char **argv){
    tiramisu::init("function73637_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73637/function73637_schedule_0/function73637_schedule_0.o");
