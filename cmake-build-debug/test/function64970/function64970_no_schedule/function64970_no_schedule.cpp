...
int main(int argc, char **argv){
    tiramisu::init("function64970_no_schedule");
    ...
    buffer buf00("buf00", {8192, 128, 64}, p_int32, a_input);
    buffer buf0("buf0", {8192, 128, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function64970/function64970_no_schedule/function64970_no_schedule.o");
