...
int main(int argc, char **argv){
    tiramisu::init("function70257_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i0, i1) * input02(i1, i2) + input03(i2) + input04(i2) * input05(i0, i1) * input06(i0) + input07(i0, i1) - input08(i0, i2) - input09(i0, i2));
    ...
    buffer buf07("buf07", {1024, 256}, p_int32, a_input);
    buffer buf08("buf08", {1024, 128}, p_int32, a_input);
    buffer buf09("buf09", {1024, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70257/function70257_no_schedule/function70257_no_schedule.o");
