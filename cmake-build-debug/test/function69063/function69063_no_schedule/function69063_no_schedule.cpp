...
int main(int argc, char **argv){
    tiramisu::init("function69063_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i2) * input02(i0) + input03(i2) + input04(i0) * input05(i2) * input06(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function69063/function69063_no_schedule/function69063_no_schedule.o");
