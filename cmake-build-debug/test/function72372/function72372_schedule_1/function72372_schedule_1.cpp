...
int main(int argc, char **argv){
    tiramisu::init("function72372_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72372/function72372_schedule_1/function72372_schedule_1.o");
