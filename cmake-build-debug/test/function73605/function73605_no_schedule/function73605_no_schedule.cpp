...
int main(int argc, char **argv){
    tiramisu::init("function73605_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i2) + input02(i0) * input03(i0, i1) + input04(i1) - input05(i1, i2) * input06(i2) - input07(i1, i2) + input08(i0, i2) - input09(i0, i2));
    ...
    buffer buf03("buf03", {8192, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73605/function73605_no_schedule/function73605_no_schedule.o");
