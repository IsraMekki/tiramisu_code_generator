...
int main(int argc, char **argv){
    tiramisu::init("function72265_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72265/function72265_schedule_1/function72265_schedule_1.o");
