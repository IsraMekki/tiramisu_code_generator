...
int main(int argc, char **argv){
    tiramisu::init("function74495_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74495/function74495_no_schedule/function74495_no_schedule.o");
