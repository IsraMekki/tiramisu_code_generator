...
int main(int argc, char **argv){
    tiramisu::init("function74141_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74141/function74141_no_schedule/function74141_no_schedule.o");
