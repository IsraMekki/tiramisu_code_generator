...
int main(int argc, char **argv){
    tiramisu::init("function67997_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i1) + input01(i1, i3) - input02(i1, i2) - input03(i1, i2) - input04(i0, i2, i3) - input05(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function67997/function67997_no_schedule/function67997_no_schedule.o");
