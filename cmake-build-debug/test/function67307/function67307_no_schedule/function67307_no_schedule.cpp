...
int main(int argc, char **argv){
    tiramisu::init("function67307_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67307/function67307_no_schedule/function67307_no_schedule.o");
