...
int main(int argc, char **argv){
    tiramisu::init("function74529_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74529/function74529_no_schedule/function74529_no_schedule.o");
