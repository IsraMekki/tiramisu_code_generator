...
int main(int argc, char **argv){
    tiramisu::init("function69371_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69371/function69371_schedule_2/function69371_schedule_2.o");
