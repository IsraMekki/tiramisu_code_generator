...
int main(int argc, char **argv){
    tiramisu::init("function68781_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) + input01(i0) + input02(i0, i1, i2) + input03(i3) + input04(i2, i3) + input05(i2, i3) + input06(i0, i1, i2) + input07(i3) - input08(i0, i1, i3) - input09(i0, i2, i3));
    ...
    buffer buf05("buf05", {128, 128}, p_int32, a_input);
    ...
    buffer buf09("buf09", {64, 128, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function68781/function68781_no_schedule/function68781_no_schedule.o");
