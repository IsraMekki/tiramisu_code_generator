...
int main(int argc, char **argv){
    tiramisu::init("function70394_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) + input01(i1) * input02(i1, i0) + input03(i0, i2) * input04(i0, i1) - input05(i3) + input06(i0) - input07(i3) * input08(i2) - input09(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70394/function70394_no_schedule/function70394_no_schedule.o");
