...
int main(int argc, char **argv){
    tiramisu::init("function73468_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) + input01(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73468/function73468_no_schedule/function73468_no_schedule.o");
