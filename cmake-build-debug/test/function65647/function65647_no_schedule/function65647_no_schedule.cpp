...
int main(int argc, char **argv){
    tiramisu::init("function65647_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65647/function65647_no_schedule/function65647_no_schedule.o");
