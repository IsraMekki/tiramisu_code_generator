...
int main(int argc, char **argv){
    tiramisu::init("function68591_no_schedule");
    ...
    input input06("input06", {i0, i3, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) + input01(i0) * input02(i3) * input03(i0, i1, i2) - input04(i0, i3) * input05(i0, i2, i3) - input06(i0, i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function68591/function68591_no_schedule/function68591_no_schedule.o");
