...
int main(int argc, char **argv){
    tiramisu::init("function66150_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66150/function66150_no_schedule/function66150_no_schedule.o");
