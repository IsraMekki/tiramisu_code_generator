...
int main(int argc, char **argv){
    tiramisu::init("function65422_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65422/function65422_no_schedule/function65422_no_schedule.o");
