...
int main(int argc, char **argv){
    tiramisu::init("function67650_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67650/function67650_schedule_2/function67650_schedule_2.o");
