...
int main(int argc, char **argv){
    tiramisu::init("function67650_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67650/function67650_no_schedule/function67650_no_schedule.o");
