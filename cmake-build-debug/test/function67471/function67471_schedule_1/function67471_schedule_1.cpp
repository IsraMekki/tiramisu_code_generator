...
int main(int argc, char **argv){
    tiramisu::init("function67471_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67471/function67471_schedule_1/function67471_schedule_1.o");
