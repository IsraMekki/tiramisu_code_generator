...
int main(int argc, char **argv){
    tiramisu::init("function64897_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i2) - input02(i0, i1) + input03(i0) + input04(i0, i2) - input05(i1, i2) + input06(i0, i2) + input07(i0) + input08(i0, i1) + input09(i0, i2));
    ...
    buffer buf04("buf04", {1024, 1024}, p_int32, a_input);
    buffer buf05("buf05", {64, 1024}, p_int32, a_input);
    buffer buf06("buf06", {1024, 1024}, p_int32, a_input);
    buffer buf07("buf07", {1024}, p_int32, a_input);
    buffer buf08("buf08", {1024, 64}, p_int32, a_input);
    buffer buf09("buf09", {1024, 1024}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function64897/function64897_no_schedule/function64897_no_schedule.o");
