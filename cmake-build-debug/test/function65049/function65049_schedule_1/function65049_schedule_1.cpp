...
int main(int argc, char **argv){
    tiramisu::init("function65049_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65049/function65049_schedule_1/function65049_schedule_1.o");
