...
int main(int argc, char **argv){
    tiramisu::init("function66011_no_schedule");
    ...
    buffer buf00("buf00", {64, 64, 16384}, p_int32, a_input);
    buffer buf0("buf0", {64, 64, 16384}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function66011/function66011_no_schedule/function66011_no_schedule.o");
