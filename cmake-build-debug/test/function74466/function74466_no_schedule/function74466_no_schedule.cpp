...
int main(int argc, char **argv){
    tiramisu::init("function74466_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74466/function74466_no_schedule/function74466_no_schedule.o");
