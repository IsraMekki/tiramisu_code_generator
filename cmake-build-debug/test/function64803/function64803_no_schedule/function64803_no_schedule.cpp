...
int main(int argc, char **argv){
    tiramisu::init("function64803_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64803/function64803_no_schedule/function64803_no_schedule.o");
