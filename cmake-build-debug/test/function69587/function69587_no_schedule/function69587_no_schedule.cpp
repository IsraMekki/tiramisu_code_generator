...
int main(int argc, char **argv){
    tiramisu::init("function69587_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69587/function69587_no_schedule/function69587_no_schedule.o");
