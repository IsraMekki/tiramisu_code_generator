...
int main(int argc, char **argv){
    tiramisu::init("function71642_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71642/function71642_no_schedule/function71642_no_schedule.o");
