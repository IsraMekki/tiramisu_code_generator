...
int main(int argc, char **argv){
    tiramisu::init("function70726_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70726/function70726_schedule_0/function70726_schedule_0.o");
