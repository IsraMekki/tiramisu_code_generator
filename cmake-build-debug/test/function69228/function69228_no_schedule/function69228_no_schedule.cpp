...
int main(int argc, char **argv){
    tiramisu::init("function69228_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i1) - input02(i1, i2) + input03(i0) * input04(i0, i2) + input05(i0, i2) - input06(i0, i2) + input07(i1) - input08(i2) + input09(i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {256, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69228/function69228_no_schedule/function69228_no_schedule.o");
