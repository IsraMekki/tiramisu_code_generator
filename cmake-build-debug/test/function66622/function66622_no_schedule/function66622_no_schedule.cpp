...
int main(int argc, char **argv){
    tiramisu::init("function66622_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66622/function66622_no_schedule/function66622_no_schedule.o");
