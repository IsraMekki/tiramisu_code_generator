...
int main(int argc, char **argv){
    tiramisu::init("function66622_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66622/function66622_schedule_2/function66622_schedule_2.o");
