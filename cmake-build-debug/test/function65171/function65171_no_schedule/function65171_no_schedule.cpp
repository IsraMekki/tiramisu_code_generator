...
int main(int argc, char **argv){
    tiramisu::init("function65171_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i0, i2) * input02(i2) - input03(i0, i2) + input04(i0, i1) * input05(i0, i2) + input06(i0, i2) - input07(i0, i2));
    ...
    buffer buf0("buf0", {1024, 128, 256}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65171/function65171_no_schedule/function65171_no_schedule.o");
