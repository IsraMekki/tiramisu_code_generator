...
int main(int argc, char **argv){
    tiramisu::init("function74074_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74074/function74074_schedule_2/function74074_schedule_2.o");
