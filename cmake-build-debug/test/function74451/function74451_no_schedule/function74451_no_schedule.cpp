...
int main(int argc, char **argv){
    tiramisu::init("function74451_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2) - input02(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74451/function74451_no_schedule/function74451_no_schedule.o");
