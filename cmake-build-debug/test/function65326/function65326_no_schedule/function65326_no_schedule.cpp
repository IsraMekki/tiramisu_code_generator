...
int main(int argc, char **argv){
    tiramisu::init("function65326_no_schedule");

    constant c0("c0", 8192), c1("c1", 16384);
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) - input01(i0) * input02(i1) + input03(i1) * input04(i1) + input05(i0) * input06(i0) + input07(i0) - input08(i0));
    ...
    buffer buf0("buf0", {8192, 16384}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65326/function65326_no_schedule/function65326_no_schedule.o");
