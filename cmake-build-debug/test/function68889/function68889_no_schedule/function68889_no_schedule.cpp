...
int main(int argc, char **argv){
    tiramisu::init("function68889_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68889/function68889_no_schedule/function68889_no_schedule.o");
