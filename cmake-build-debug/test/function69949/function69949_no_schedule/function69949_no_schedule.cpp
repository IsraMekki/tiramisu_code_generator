...
int main(int argc, char **argv){
    tiramisu::init("function69949_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) + input01(i1) * input02(i0, i1, i3) + input03(i0, i2) * input04(i0, i1, i2) + input05(i1) + input06(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function69949/function69949_no_schedule/function69949_no_schedule.o");
