...
int main(int argc, char **argv){
    tiramisu::init("function67049_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67049/function67049_no_schedule/function67049_no_schedule.o");
