...
int main(int argc, char **argv){
    tiramisu::init("function68998_no_schedule");
    ...
    buffer buf00("buf00", {128, 256, 2048}, p_int32, a_input);
    buffer buf0("buf0", {128, 256, 2048}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function68998/function68998_no_schedule/function68998_no_schedule.o");
