...
int main(int argc, char **argv){
    tiramisu::init("function70805_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70805/function70805_no_schedule/function70805_no_schedule.o");
