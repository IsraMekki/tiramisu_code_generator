...
int main(int argc, char **argv){
    tiramisu::init("function68625_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68625/function68625_no_schedule/function68625_no_schedule.o");
