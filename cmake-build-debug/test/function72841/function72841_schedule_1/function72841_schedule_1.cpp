...
int main(int argc, char **argv){
    tiramisu::init("function72841_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72841/function72841_schedule_1/function72841_schedule_1.o");
