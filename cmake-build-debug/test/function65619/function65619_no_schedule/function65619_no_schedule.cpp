...
int main(int argc, char **argv){
    tiramisu::init("function65619_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) + input01(i3) + input02(i1) - input03(i0, i1, i3) - input04(i0, i2, i3) * input05(i2) * input06(i2) - input07(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65619/function65619_no_schedule/function65619_no_schedule.o");
