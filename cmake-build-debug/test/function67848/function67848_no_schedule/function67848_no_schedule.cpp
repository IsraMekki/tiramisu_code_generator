...
int main(int argc, char **argv){
    tiramisu::init("function67848_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67848/function67848_no_schedule/function67848_no_schedule.o");
