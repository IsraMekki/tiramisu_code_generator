...
int main(int argc, char **argv){
    tiramisu::init("function68509_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68509/function68509_no_schedule/function68509_no_schedule.o");
