...
int main(int argc, char **argv){
    tiramisu::init("function66812_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66812/function66812_no_schedule/function66812_no_schedule.o");
