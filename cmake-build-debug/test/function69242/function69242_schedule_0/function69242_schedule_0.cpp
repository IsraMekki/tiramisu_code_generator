...
int main(int argc, char **argv){
    tiramisu::init("function69242_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69242/function69242_schedule_0/function69242_schedule_0.o");
