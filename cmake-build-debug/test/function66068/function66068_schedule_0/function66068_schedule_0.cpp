...
int main(int argc, char **argv){
    tiramisu::init("function66068_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66068/function66068_schedule_0/function66068_schedule_0.o");
