...
int main(int argc, char **argv){
    tiramisu::init("function72181_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i0, i2) + input02(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72181/function72181_no_schedule/function72181_no_schedule.o");
