...
int main(int argc, char **argv){
    tiramisu::init("function74304_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74304/function74304_no_schedule/function74304_no_schedule.o");
