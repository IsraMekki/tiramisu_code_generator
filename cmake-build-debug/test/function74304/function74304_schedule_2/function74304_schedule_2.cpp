...
int main(int argc, char **argv){
    tiramisu::init("function74304_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74304/function74304_schedule_2/function74304_schedule_2.o");
