...
int main(int argc, char **argv){
    tiramisu::init("function72210_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) + input01(i2, i3) * input02(i2, i1, i0) * input03(i2) - input04(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72210/function72210_no_schedule/function72210_no_schedule.o");
