...
int main(int argc, char **argv){
    tiramisu::init("function71972_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71972/function71972_schedule_1/function71972_schedule_1.o");
