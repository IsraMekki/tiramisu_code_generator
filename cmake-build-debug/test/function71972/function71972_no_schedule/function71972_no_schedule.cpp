...
int main(int argc, char **argv){
    tiramisu::init("function71972_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71972/function71972_no_schedule/function71972_no_schedule.o");
