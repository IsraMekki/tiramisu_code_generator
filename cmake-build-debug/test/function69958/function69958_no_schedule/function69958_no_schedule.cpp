...
int main(int argc, char **argv){
    tiramisu::init("function69958_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69958/function69958_no_schedule/function69958_no_schedule.o");
