...
int main(int argc, char **argv){
    tiramisu::init("function74757_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74757/function74757_no_schedule/function74757_no_schedule.o");
