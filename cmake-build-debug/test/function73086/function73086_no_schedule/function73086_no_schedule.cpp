...
int main(int argc, char **argv){
    tiramisu::init("function73086_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73086/function73086_no_schedule/function73086_no_schedule.o");
