...
int main(int argc, char **argv){
    tiramisu::init("function64974_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64974/function64974_schedule_2/function64974_schedule_2.o");
