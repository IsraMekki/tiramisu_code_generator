...
int main(int argc, char **argv){
    tiramisu::init("function73095_no_schedule");
    ...
    input input07("input07", {i2, i1, i0}, p_int32);

    input input08("input08", {i0, i1}, p_int32);

    input input09("input09", {i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i3) * input02(i2) * input03(i2) - input04(i0, i1, i3) + input05(i2) + input06(i1, i2) - input07(i2, i1, i0) * input08(i0, i1) * input09(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73095/function73095_no_schedule/function73095_no_schedule.o");
