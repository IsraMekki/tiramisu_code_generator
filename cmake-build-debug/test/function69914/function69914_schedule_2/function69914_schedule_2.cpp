...
int main(int argc, char **argv){
    tiramisu::init("function69914_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69914/function69914_schedule_2/function69914_schedule_2.o");
