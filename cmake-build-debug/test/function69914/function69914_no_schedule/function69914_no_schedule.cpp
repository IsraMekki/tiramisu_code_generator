...
int main(int argc, char **argv){
    tiramisu::init("function69914_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69914/function69914_no_schedule/function69914_no_schedule.o");
