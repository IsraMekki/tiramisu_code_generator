...
int main(int argc, char **argv){
    tiramisu::init("function72908_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72908/function72908_no_schedule/function72908_no_schedule.o");
