...
int main(int argc, char **argv){
    tiramisu::init("function71641_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71641/function71641_no_schedule/function71641_no_schedule.o");
