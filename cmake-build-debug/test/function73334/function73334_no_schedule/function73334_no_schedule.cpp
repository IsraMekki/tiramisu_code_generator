...
int main(int argc, char **argv){
    tiramisu::init("function73334_no_schedule");
    ...
    buffer buf00("buf00", {1024, 256, 256}, p_int32, a_input);
    buffer buf0("buf0", {1024, 256, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function73334/function73334_no_schedule/function73334_no_schedule.o");
