...
int main(int argc, char **argv){
    tiramisu::init("function66229_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66229/function66229_schedule_1/function66229_schedule_1.o");
