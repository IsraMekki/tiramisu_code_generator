...
int main(int argc, char **argv){
    tiramisu::init("function73545_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2) - input01(i1, i3) + input02(i3) + input03(i1, i2) + input04(i1) * input05(i1) - input06(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function73545/function73545_no_schedule/function73545_no_schedule.o");
