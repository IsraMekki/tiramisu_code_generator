...
int main(int argc, char **argv){
    tiramisu::init("function66733_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66733/function66733_no_schedule/function66733_no_schedule.o");
