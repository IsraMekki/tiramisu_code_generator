...
int main(int argc, char **argv){
    tiramisu::init("function73486_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73486/function73486_no_schedule/function73486_no_schedule.o");
