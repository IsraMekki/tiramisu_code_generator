...
int main(int argc, char **argv){
    tiramisu::init("function74430_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74430/function74430_no_schedule/function74430_no_schedule.o");
