...
int main(int argc, char **argv){
    tiramisu::init("function70341_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70341/function70341_no_schedule/function70341_no_schedule.o");
