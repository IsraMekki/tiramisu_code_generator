...
int main(int argc, char **argv){
    tiramisu::init("function65344_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65344/function65344_schedule_1/function65344_schedule_1.o");
