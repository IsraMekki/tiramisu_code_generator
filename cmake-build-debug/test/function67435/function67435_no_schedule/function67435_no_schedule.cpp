...
int main(int argc, char **argv){
    tiramisu::init("function67435_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) * input01(i1) + input02(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67435/function67435_no_schedule/function67435_no_schedule.o");
