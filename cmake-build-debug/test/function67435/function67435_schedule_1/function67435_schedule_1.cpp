...
int main(int argc, char **argv){
    tiramisu::init("function67435_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67435/function67435_schedule_1/function67435_schedule_1.o");
