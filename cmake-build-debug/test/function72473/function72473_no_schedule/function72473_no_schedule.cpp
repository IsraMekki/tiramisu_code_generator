...
int main(int argc, char **argv){
    tiramisu::init("function72473_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72473/function72473_no_schedule/function72473_no_schedule.o");
