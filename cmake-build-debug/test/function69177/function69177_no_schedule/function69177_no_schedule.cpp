...
int main(int argc, char **argv){
    tiramisu::init("function69177_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69177/function69177_no_schedule/function69177_no_schedule.o");
