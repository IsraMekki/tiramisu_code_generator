...
int main(int argc, char **argv){
    tiramisu::init("function69177_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69177/function69177_schedule_0/function69177_schedule_0.o");
