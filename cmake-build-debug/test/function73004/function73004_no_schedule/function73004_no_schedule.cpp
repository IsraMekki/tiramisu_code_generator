...
int main(int argc, char **argv){
    tiramisu::init("function73004_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73004/function73004_no_schedule/function73004_no_schedule.o");
