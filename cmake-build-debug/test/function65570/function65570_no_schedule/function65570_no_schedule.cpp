...
int main(int argc, char **argv){
    tiramisu::init("function65570_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65570/function65570_no_schedule/function65570_no_schedule.o");
