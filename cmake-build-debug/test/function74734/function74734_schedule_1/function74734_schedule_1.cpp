...
int main(int argc, char **argv){
    tiramisu::init("function74734_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74734/function74734_schedule_1/function74734_schedule_1.o");
