...
int main(int argc, char **argv){
    tiramisu::init("function67919_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67919/function67919_schedule_1/function67919_schedule_1.o");
