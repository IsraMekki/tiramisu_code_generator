...
int main(int argc, char **argv){
    tiramisu::init("function68424_no_schedule");
    ...
    input input08("input08", {i3, i2, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) - input01(i0) + input02(i1) - input03(i0, i1) - input04(i3) - input05(i0, i3) - input06(i3) * input07(i0) - input08(i3, i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function68424/function68424_no_schedule/function68424_no_schedule.o");
