...
int main(int argc, char **argv){
    tiramisu::init("function66346_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66346/function66346_schedule_1/function66346_schedule_1.o");
