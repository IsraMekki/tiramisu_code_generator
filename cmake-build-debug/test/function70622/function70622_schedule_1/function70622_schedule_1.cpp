...
int main(int argc, char **argv){
    tiramisu::init("function70622_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70622/function70622_schedule_1/function70622_schedule_1.o");
