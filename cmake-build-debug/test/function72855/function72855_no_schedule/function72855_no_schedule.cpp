...
int main(int argc, char **argv){
    tiramisu::init("function72855_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72855/function72855_no_schedule/function72855_no_schedule.o");
