...
int main(int argc, char **argv){
    tiramisu::init("function71495_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71495/function71495_no_schedule/function71495_no_schedule.o");
