...
int main(int argc, char **argv){
    tiramisu::init("function65136_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65136/function65136_schedule_2/function65136_schedule_2.o");
