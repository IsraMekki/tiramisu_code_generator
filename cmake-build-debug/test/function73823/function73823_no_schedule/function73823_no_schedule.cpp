...
int main(int argc, char **argv){
    tiramisu::init("function73823_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73823/function73823_no_schedule/function73823_no_schedule.o");
