...
int main(int argc, char **argv){
    tiramisu::init("function70448_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) - input01(i0) - input02(i1) * input03(i1) * input04(i0) - input05(i1) * input06(i0) + input07(i1) * input08(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function70448/function70448_no_schedule/function70448_no_schedule.o");
