...
int main(int argc, char **argv){
    tiramisu::init("function68927_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i0) - input02(i0, i1) * input03(i0) + input04(i0, i2) - input05(i1, i2) * input06(i1) - input07(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function68927/function68927_no_schedule/function68927_no_schedule.o");
