...
int main(int argc, char **argv){
    tiramisu::init("function67422_no_schedule");

    constant c0("c0", 2048), c1("c1", 65536);
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) + input01(i1) * input02(i0) * input03(i1) * input04(i0) - input05(i1) * input06(i0) * input07(i0) - input08(i0) * input09(i1));
    ...
    buffer buf09("buf09", {65536}, p_int32, a_input);
    buffer buf0("buf0", {2048, 65536}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67422/function67422_no_schedule/function67422_no_schedule.o");
