...
int main(int argc, char **argv){
    tiramisu::init("function65175_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65175/function65175_schedule_1/function65175_schedule_1.o");
