...
int main(int argc, char **argv){
    tiramisu::init("function66585_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66585/function66585_no_schedule/function66585_no_schedule.o");
