...
int main(int argc, char **argv){
    tiramisu::init("function66570_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66570/function66570_no_schedule/function66570_no_schedule.o");
