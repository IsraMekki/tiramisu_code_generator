...
int main(int argc, char **argv){
    tiramisu::init("function66789_no_schedule");
    ...
    input input01("input01", {i3, i2, i1}, p_int32);

    input input02("input02", {i0, i3}, p_int32);

    input input03("input03", {i0, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i3, i2, i1) - input02(i0, i3) - input03(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66789/function66789_no_schedule/function66789_no_schedule.o");
