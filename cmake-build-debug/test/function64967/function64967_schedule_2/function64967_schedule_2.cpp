...
int main(int argc, char **argv){
    tiramisu::init("function64967_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64967/function64967_schedule_2/function64967_schedule_2.o");
