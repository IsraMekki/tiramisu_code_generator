...
int main(int argc, char **argv){
    tiramisu::init("function69263_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69263/function69263_no_schedule/function69263_no_schedule.o");
