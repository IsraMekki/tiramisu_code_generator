...
int main(int argc, char **argv){
    tiramisu::init("function72844_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72844/function72844_no_schedule/function72844_no_schedule.o");
