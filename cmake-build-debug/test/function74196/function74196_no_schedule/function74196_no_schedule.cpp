...
int main(int argc, char **argv){
    tiramisu::init("function74196_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) - input01(i0, i1, i2) - input02(i0, i3, i2) - input03(i0) + input04(i2) + input05(i1, i2, i3) + input06(i0, i2) + input07(i0) + input08(i0, i1, i2) + input09(i0, i1));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64, 128}, p_int32, a_input);
    buffer buf01("buf01", {64, 64, 128}, p_int32, a_input);
    buffer buf02("buf02", {64, 128, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function74196/function74196_no_schedule/function74196_no_schedule.o");
