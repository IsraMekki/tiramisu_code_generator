...
int main(int argc, char **argv){
    tiramisu::init("function71256_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71256/function71256_schedule_1/function71256_schedule_1.o");
