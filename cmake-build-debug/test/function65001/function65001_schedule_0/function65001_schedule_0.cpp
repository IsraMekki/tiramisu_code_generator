...
int main(int argc, char **argv){
    tiramisu::init("function65001_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65001/function65001_schedule_0/function65001_schedule_0.o");
