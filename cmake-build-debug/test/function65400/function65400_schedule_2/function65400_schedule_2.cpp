...
int main(int argc, char **argv){
    tiramisu::init("function65400_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65400/function65400_schedule_2/function65400_schedule_2.o");
