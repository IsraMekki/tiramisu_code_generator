...
int main(int argc, char **argv){
    tiramisu::init("function72418_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72418/function72418_no_schedule/function72418_no_schedule.o");
