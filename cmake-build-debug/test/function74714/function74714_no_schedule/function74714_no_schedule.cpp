...
int main(int argc, char **argv){
    tiramisu::init("function74714_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74714/function74714_no_schedule/function74714_no_schedule.o");
