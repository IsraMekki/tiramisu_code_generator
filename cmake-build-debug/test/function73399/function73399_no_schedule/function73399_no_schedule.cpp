...
int main(int argc, char **argv){
    tiramisu::init("function73399_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73399/function73399_no_schedule/function73399_no_schedule.o");
