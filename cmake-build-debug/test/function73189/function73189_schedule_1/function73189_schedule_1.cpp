...
int main(int argc, char **argv){
    tiramisu::init("function73189_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73189/function73189_schedule_1/function73189_schedule_1.o");
