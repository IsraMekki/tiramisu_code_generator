...
int main(int argc, char **argv){
    tiramisu::init("function69759_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69759/function69759_schedule_2/function69759_schedule_2.o");
