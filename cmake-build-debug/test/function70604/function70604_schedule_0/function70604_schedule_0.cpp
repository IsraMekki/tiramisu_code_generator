...
int main(int argc, char **argv){
    tiramisu::init("function70604_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70604/function70604_schedule_0/function70604_schedule_0.o");
