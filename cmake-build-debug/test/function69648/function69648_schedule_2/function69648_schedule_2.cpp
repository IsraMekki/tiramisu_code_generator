...
int main(int argc, char **argv){
    tiramisu::init("function69648_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69648/function69648_schedule_2/function69648_schedule_2.o");
