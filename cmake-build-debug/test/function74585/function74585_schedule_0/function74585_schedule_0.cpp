...
int main(int argc, char **argv){
    tiramisu::init("function74585_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74585/function74585_schedule_0/function74585_schedule_0.o");
