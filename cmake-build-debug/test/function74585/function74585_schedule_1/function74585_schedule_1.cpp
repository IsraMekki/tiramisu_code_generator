...
int main(int argc, char **argv){
    tiramisu::init("function74585_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74585/function74585_schedule_1/function74585_schedule_1.o");
