...
int main(int argc, char **argv){
    tiramisu::init("function67753_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67753/function67753_no_schedule/function67753_no_schedule.o");
