...
int main(int argc, char **argv){
    tiramisu::init("function71517_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71517/function71517_no_schedule/function71517_no_schedule.o");
