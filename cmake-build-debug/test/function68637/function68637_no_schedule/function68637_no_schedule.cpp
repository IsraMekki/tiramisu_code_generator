...
int main(int argc, char **argv){
    tiramisu::init("function68637_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68637/function68637_no_schedule/function68637_no_schedule.o");
