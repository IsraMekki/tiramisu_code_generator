...
int main(int argc, char **argv){
    tiramisu::init("function74532_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74532/function74532_no_schedule/function74532_no_schedule.o");
