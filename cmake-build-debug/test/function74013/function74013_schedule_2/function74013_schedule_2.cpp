...
int main(int argc, char **argv){
    tiramisu::init("function74013_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74013/function74013_schedule_2/function74013_schedule_2.o");
