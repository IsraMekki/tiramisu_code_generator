...
int main(int argc, char **argv){
    tiramisu::init("function69776_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69776/function69776_schedule_1/function69776_schedule_1.o");
