...
int main(int argc, char **argv){
    tiramisu::init("function66115_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66115/function66115_no_schedule/function66115_no_schedule.o");
