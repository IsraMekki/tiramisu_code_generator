...
int main(int argc, char **argv){
    tiramisu::init("function74788_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74788/function74788_no_schedule/function74788_no_schedule.o");
