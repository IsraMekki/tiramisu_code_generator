...
int main(int argc, char **argv){
    tiramisu::init("function65320_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65320/function65320_schedule_1/function65320_schedule_1.o");
