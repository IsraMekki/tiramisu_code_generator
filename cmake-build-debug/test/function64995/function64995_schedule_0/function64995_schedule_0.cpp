...
int main(int argc, char **argv){
    tiramisu::init("function64995_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64995/function64995_schedule_0/function64995_schedule_0.o");
