...
int main(int argc, char **argv){
    tiramisu::init("function65278_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i0, i2, i3) * input02(i2, i0) * input03(i3) - input04(i1, i2) + input05(i0, i2, i3) + input06(i2) - input07(i2) + input08(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65278/function65278_no_schedule/function65278_no_schedule.o");
