...
int main(int argc, char **argv){
    tiramisu::init("function66994_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66994/function66994_schedule_2/function66994_schedule_2.o");
