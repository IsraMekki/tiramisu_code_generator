...
int main(int argc, char **argv){
    tiramisu::init("function67996_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67996/function67996_no_schedule/function67996_no_schedule.o");
