...
int main(int argc, char **argv){
    tiramisu::init("function67987_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) - input01(i1, i2, i3) - input02(i0, i2) + input03(i1) - input04(i1, i3) + input05(i2) * input06(i1) * input07(i0, i1) * input08(i0, i3) + input09(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67987/function67987_no_schedule/function67987_no_schedule.o");
