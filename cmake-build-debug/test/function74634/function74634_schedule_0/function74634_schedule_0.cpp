...
int main(int argc, char **argv){
    tiramisu::init("function74634_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74634/function74634_schedule_0/function74634_schedule_0.o");
