...
int main(int argc, char **argv){
    tiramisu::init("function69344_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69344/function69344_no_schedule/function69344_no_schedule.o");
