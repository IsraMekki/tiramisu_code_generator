...
int main(int argc, char **argv){
    tiramisu::init("function66993_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3, i0) - input01(i0, i3) - input02(i0) - input03(i0) - input04(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66993/function66993_no_schedule/function66993_no_schedule.o");
