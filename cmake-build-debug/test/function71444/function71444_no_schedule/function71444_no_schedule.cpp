...
int main(int argc, char **argv){
    tiramisu::init("function71444_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71444/function71444_no_schedule/function71444_no_schedule.o");
