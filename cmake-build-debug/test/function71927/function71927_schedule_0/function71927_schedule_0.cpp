...
int main(int argc, char **argv){
    tiramisu::init("function71927_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71927/function71927_schedule_0/function71927_schedule_0.o");
