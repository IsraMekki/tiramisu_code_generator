...
int main(int argc, char **argv){
    tiramisu::init("function71927_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71927/function71927_no_schedule/function71927_no_schedule.o");
