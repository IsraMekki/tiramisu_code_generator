...
int main(int argc, char **argv){
    tiramisu::init("function65077_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65077/function65077_no_schedule/function65077_no_schedule.o");
