...
int main(int argc, char **argv){
    tiramisu::init("function70886_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70886/function70886_no_schedule/function70886_no_schedule.o");
