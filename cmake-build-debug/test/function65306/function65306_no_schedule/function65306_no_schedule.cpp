...
int main(int argc, char **argv){
    tiramisu::init("function65306_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i0) * input02(i1) * input03(i0, i2) - input04(i2) * input05(i0, i2) * input06(i1) + input07(i2) + input08(i0, i2) * input09(i0, i1));
    ...
    buffer buf03("buf03", {4096, 64}, p_int32, a_input);
    ...
    buffer buf09("buf09", {4096, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function65306/function65306_no_schedule/function65306_no_schedule.o");
