...
int main(int argc, char **argv){
    tiramisu::init("function67246_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) + input01(i1) * input02(i1) - input03(i1) * input04(i0, i2) - input05(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function67246/function67246_no_schedule/function67246_no_schedule.o");
