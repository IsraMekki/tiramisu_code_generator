...
int main(int argc, char **argv){
    tiramisu::init("function70625_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) + input01(i1, i2) * input02(i3, i1) + input03(i1, i2, i3) * input04(i2, i3) - input05(i0, i1) + input06(i0) - input07(i0) - input08(i0) - input09(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70625/function70625_no_schedule/function70625_no_schedule.o");
