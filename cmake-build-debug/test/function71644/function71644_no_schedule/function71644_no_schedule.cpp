...
int main(int argc, char **argv){
    tiramisu::init("function71644_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) * input01(i1) * input02(i1) - input03(i2, i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71644/function71644_no_schedule/function71644_no_schedule.o");
