...
int main(int argc, char **argv){
    tiramisu::init("function66566_no_schedule");

    constant c0("c0", 128), c1("c1", 1024), c2("c2", 1024);
    ...
    buffer buf00("buf00", {128, 1024, 1024}, p_int32, a_input);
    buffer buf0("buf0", {128, 1024, 1024}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function66566/function66566_no_schedule/function66566_no_schedule.o");
