...
int main(int argc, char **argv){
    tiramisu::init("function68909_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68909/function68909_no_schedule/function68909_no_schedule.o");
