...
int main(int argc, char **argv){
    tiramisu::init("function69927_no_schedule");
    ...
    input input05("input05", {i2, i1, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) * input01(i0, i1, i2) * input02(i2, i3) - input03(i1) * input04(i0, i2, i3) * input05(i2, i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function69927/function69927_no_schedule/function69927_no_schedule.o");
