...
int main(int argc, char **argv){
    tiramisu::init("function66055_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66055/function66055_schedule_2/function66055_schedule_2.o");
