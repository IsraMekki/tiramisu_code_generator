...
int main(int argc, char **argv){
    tiramisu::init("function74731_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74731/function74731_no_schedule/function74731_no_schedule.o");
