...
int main(int argc, char **argv){
    tiramisu::init("function74731_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74731/function74731_schedule_1/function74731_schedule_1.o");
