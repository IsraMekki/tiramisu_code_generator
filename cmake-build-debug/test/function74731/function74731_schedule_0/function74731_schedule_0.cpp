...
int main(int argc, char **argv){
    tiramisu::init("function74731_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74731/function74731_schedule_0/function74731_schedule_0.o");
