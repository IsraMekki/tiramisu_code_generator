...
int main(int argc, char **argv){
    tiramisu::init("function70479_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70479/function70479_schedule_0/function70479_schedule_0.o");
