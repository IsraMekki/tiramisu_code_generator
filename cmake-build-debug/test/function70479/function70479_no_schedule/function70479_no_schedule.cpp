...
int main(int argc, char **argv){
    tiramisu::init("function70479_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70479/function70479_no_schedule/function70479_no_schedule.o");
