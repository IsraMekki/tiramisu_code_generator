...
int main(int argc, char **argv){
    tiramisu::init("function72396_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72396/function72396_no_schedule/function72396_no_schedule.o");
