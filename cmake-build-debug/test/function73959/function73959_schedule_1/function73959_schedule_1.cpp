...
int main(int argc, char **argv){
    tiramisu::init("function73959_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73959/function73959_schedule_1/function73959_schedule_1.o");
