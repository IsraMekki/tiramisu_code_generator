...
int main(int argc, char **argv){
    tiramisu::init("function67918_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) * input01(i0, i2, i3) - input02(i1, i0) - input03(i1, i2, i3) + input04(i0, i3) * input05(i0, i1) * input06(i2, i3) * input07(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function67918/function67918_no_schedule/function67918_no_schedule.o");
