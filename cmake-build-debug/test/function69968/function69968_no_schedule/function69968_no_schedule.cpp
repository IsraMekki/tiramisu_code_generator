...
int main(int argc, char **argv){
    tiramisu::init("function69968_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69968/function69968_no_schedule/function69968_no_schedule.o");
