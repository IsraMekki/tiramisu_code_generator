...
int main(int argc, char **argv){
    tiramisu::init("function69372_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69372/function69372_no_schedule/function69372_no_schedule.o");
