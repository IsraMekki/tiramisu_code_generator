...
int main(int argc, char **argv){
    tiramisu::init("function71152_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71152/function71152_no_schedule/function71152_no_schedule.o");
