...
int main(int argc, char **argv){
    tiramisu::init("function68375_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68375/function68375_no_schedule/function68375_no_schedule.o");
