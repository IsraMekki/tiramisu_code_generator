...
int main(int argc, char **argv){
    tiramisu::init("function67417_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67417/function67417_schedule_1/function67417_schedule_1.o");
