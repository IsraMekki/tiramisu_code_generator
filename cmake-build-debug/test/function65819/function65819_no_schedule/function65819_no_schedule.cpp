...
int main(int argc, char **argv){
    tiramisu::init("function65819_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65819/function65819_no_schedule/function65819_no_schedule.o");
