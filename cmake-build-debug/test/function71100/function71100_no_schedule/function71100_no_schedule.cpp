...
int main(int argc, char **argv){
    tiramisu::init("function71100_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) * input01(i0, i1, i3) * input02(i2, i3) - input03(i0, i1) * input04(i2, i3) - input05(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function71100/function71100_no_schedule/function71100_no_schedule.o");
