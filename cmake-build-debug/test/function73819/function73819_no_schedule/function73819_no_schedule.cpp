...
int main(int argc, char **argv){
    tiramisu::init("function73819_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73819/function73819_no_schedule/function73819_no_schedule.o");
