...
int main(int argc, char **argv){
    tiramisu::init("function67857_no_schedule");
    ...
    input input07("input07", {i2, i1, i3}, p_int32);

    input input08("input08", {i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) + input01(i1, i2, i3) + input02(i1, i2, i3) - input03(i1, i3) * input04(i0, i1, i3) - input05(i0, i3) * input06(i1, i2, i3) - input07(i2, i1, i3) * input08(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function67857/function67857_no_schedule/function67857_no_schedule.o");
