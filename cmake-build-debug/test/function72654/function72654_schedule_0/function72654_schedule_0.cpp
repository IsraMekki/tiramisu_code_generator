...
int main(int argc, char **argv){
    tiramisu::init("function72654_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72654/function72654_schedule_0/function72654_schedule_0.o");
