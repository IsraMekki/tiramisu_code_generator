...
int main(int argc, char **argv){
    tiramisu::init("function69108_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) + input01(i1) * input02(i1) * input03(i0) + input04(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69108/function69108_no_schedule/function69108_no_schedule.o");
