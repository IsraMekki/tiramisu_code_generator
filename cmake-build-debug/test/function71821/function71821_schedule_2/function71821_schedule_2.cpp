...
int main(int argc, char **argv){
    tiramisu::init("function71821_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71821/function71821_schedule_2/function71821_schedule_2.o");
