...
int main(int argc, char **argv){
    tiramisu::init("function71821_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71821/function71821_no_schedule/function71821_no_schedule.o");
