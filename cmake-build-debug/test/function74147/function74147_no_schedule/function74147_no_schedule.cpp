...
int main(int argc, char **argv){
    tiramisu::init("function74147_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) + input01(i3) + input02(i3) * input03(i3) - input04(i0, i1, i2) + input05(i1) * input06(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function74147/function74147_no_schedule/function74147_no_schedule.o");
