...
int main(int argc, char **argv){
    tiramisu::init("function65975_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65975/function65975_no_schedule/function65975_no_schedule.o");
