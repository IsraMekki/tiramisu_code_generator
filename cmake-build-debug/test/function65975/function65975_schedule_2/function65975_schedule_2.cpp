...
int main(int argc, char **argv){
    tiramisu::init("function65975_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65975/function65975_schedule_2/function65975_schedule_2.o");
