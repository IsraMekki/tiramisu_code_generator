...
int main(int argc, char **argv){
    tiramisu::init("function67739_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67739/function67739_no_schedule/function67739_no_schedule.o");
