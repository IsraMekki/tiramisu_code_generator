...
int main(int argc, char **argv){
    tiramisu::init("function73510_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i0, i1) * input02(i0, i1) + input03(i0) + input04(i0, i2) + input05(i1) * input06(i0) + input07(i1, i2) + input08(i0, i2) + input09(i0, i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64}, p_int32, a_input);
    buffer buf01("buf01", {8192, 128}, p_int32, a_input);
    buffer buf02("buf02", {8192, 128}, p_int32, a_input);
    ...
    buffer buf08("buf08", {8192, 64}, p_int32, a_input);
    buffer buf09("buf09", {8192, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73510/function73510_no_schedule/function73510_no_schedule.o");
