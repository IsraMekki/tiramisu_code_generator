...
int main(int argc, char **argv){
    tiramisu::init("function73425_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73425/function73425_schedule_1/function73425_schedule_1.o");
