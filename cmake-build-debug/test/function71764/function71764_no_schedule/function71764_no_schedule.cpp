...
int main(int argc, char **argv){
    tiramisu::init("function71764_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71764/function71764_no_schedule/function71764_no_schedule.o");
