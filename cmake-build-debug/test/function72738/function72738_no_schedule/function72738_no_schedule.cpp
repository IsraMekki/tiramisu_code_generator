...
int main(int argc, char **argv){
    tiramisu::init("function72738_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2) - input02(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72738/function72738_no_schedule/function72738_no_schedule.o");
