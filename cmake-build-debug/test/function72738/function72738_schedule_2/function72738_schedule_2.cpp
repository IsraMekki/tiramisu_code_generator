...
int main(int argc, char **argv){
    tiramisu::init("function72738_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72738/function72738_schedule_2/function72738_schedule_2.o");
