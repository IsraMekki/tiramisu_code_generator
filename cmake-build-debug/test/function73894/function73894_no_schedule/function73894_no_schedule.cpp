...
int main(int argc, char **argv){
    tiramisu::init("function73894_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73894/function73894_no_schedule/function73894_no_schedule.o");
