...
int main(int argc, char **argv){
    tiramisu::init("function73964_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73964/function73964_schedule_1/function73964_schedule_1.o");
