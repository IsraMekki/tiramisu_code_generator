...
int main(int argc, char **argv){
    tiramisu::init("function74279_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74279/function74279_no_schedule/function74279_no_schedule.o");
