...
int main(int argc, char **argv){
    tiramisu::init("function72377_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) - input01(i0, i1) * input02(i0, i2, i3) * input03(i1) - input04(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72377/function72377_no_schedule/function72377_no_schedule.o");
