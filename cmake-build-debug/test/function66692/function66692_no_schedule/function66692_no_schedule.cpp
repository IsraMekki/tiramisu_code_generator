...
int main(int argc, char **argv){
    tiramisu::init("function66692_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66692/function66692_no_schedule/function66692_no_schedule.o");
