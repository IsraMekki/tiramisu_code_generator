...
int main(int argc, char **argv){
    tiramisu::init("function67169_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67169/function67169_no_schedule/function67169_no_schedule.o");
