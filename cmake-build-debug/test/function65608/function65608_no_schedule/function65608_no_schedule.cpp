...
int main(int argc, char **argv){
    tiramisu::init("function65608_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i1, i2, i3) + input02(i2) - input03(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65608/function65608_no_schedule/function65608_no_schedule.o");
