...
int main(int argc, char **argv){
    tiramisu::init("function70150_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i1, i2) + input02(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70150/function70150_no_schedule/function70150_no_schedule.o");
