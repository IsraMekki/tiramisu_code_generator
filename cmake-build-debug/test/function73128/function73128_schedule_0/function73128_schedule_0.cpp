...
int main(int argc, char **argv){
    tiramisu::init("function73128_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73128/function73128_schedule_0/function73128_schedule_0.o");
