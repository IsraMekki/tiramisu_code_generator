...
int main(int argc, char **argv){
    tiramisu::init("function73199_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73199/function73199_schedule_0/function73199_schedule_0.o");
