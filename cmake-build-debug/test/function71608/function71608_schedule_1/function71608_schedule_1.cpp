...
int main(int argc, char **argv){
    tiramisu::init("function71608_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71608/function71608_schedule_1/function71608_schedule_1.o");
