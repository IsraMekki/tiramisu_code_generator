...
int main(int argc, char **argv){
    tiramisu::init("function71608_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71608/function71608_no_schedule/function71608_no_schedule.o");
