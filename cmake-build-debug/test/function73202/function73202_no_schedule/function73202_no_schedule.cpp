...
int main(int argc, char **argv){
    tiramisu::init("function73202_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73202/function73202_no_schedule/function73202_no_schedule.o");
