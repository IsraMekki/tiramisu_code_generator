...
int main(int argc, char **argv){
    tiramisu::init("function68670_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i1, i2) - input02(i0) - input03(i1) - input04(i0, i1) + input05(i0, i2) * input06(i0) + input07(i0, i2) + input08(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function68670/function68670_no_schedule/function68670_no_schedule.o");
