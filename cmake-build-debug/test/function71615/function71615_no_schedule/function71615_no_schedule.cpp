...
int main(int argc, char **argv){
    tiramisu::init("function71615_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71615/function71615_no_schedule/function71615_no_schedule.o");
