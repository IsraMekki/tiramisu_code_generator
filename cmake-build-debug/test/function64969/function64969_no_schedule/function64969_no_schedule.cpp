...
int main(int argc, char **argv){
    tiramisu::init("function64969_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64969/function64969_no_schedule/function64969_no_schedule.o");
