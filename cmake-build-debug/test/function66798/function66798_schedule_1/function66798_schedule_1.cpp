...
int main(int argc, char **argv){
    tiramisu::init("function66798_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66798/function66798_schedule_1/function66798_schedule_1.o");
