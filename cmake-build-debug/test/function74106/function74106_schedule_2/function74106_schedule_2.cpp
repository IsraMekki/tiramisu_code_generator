...
int main(int argc, char **argv){
    tiramisu::init("function74106_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74106/function74106_schedule_2/function74106_schedule_2.o");
