...
int main(int argc, char **argv){
    tiramisu::init("function70628_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2) - input01(i0, i2, i3) - input02(i0, i2) * input03(i1) * input04(i2) - input05(i3, i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function70628/function70628_no_schedule/function70628_no_schedule.o");
