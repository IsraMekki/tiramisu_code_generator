...
int main(int argc, char **argv){
    tiramisu::init("function70700_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70700/function70700_schedule_1/function70700_schedule_1.o");
