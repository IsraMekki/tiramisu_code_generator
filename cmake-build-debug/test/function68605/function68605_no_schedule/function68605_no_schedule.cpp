...
int main(int argc, char **argv){
    tiramisu::init("function68605_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68605/function68605_no_schedule/function68605_no_schedule.o");
