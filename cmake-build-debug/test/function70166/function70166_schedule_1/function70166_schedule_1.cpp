...
int main(int argc, char **argv){
    tiramisu::init("function70166_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70166/function70166_schedule_1/function70166_schedule_1.o");
