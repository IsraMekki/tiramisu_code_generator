...
int main(int argc, char **argv){
    tiramisu::init("function73676_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73676/function73676_no_schedule/function73676_no_schedule.o");
