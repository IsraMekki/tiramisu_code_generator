...
int main(int argc, char **argv){
    tiramisu::init("function70597_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i0) * input02(i2) - input03(i1) - input04(i0) + input05(i2, i3) - input06(i2) * input07(i1, i2, i3) + input08(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function70597/function70597_no_schedule/function70597_no_schedule.o");
