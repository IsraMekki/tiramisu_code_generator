...
int main(int argc, char **argv){
    tiramisu::init("function70090_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) - input01(i0) - input02(i0) + input03(i0) - input04(i1) + input05(i1) * input06(i0) - input07(i1) * input08(i0) * input09(i0));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {256}, p_int32, a_input);
    buffer buf01("buf01", {262144}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70090/function70090_no_schedule/function70090_no_schedule.o");
