...
int main(int argc, char **argv){
    tiramisu::init("function69141_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69141/function69141_schedule_2/function69141_schedule_2.o");
