...
int main(int argc, char **argv){
    tiramisu::init("function64884_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64884/function64884_schedule_2/function64884_schedule_2.o");
