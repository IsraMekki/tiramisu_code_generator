...
int main(int argc, char **argv){
    tiramisu::init("function69595_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69595/function69595_schedule_2/function69595_schedule_2.o");
