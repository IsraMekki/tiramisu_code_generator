...
int main(int argc, char **argv){
    tiramisu::init("function65123_no_schedule");
    ...
    input input03("input03", {i3, i1, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) + input01(i0, i2, i3) - input02(i0, i1, i2) - input03(i3, i1, i0) - input04(i1) - input05(i0) + input06(i1, i2) + input07(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65123/function65123_no_schedule/function65123_no_schedule.o");
