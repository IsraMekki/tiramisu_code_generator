...
int main(int argc, char **argv){
    tiramisu::init("function74498_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74498/function74498_schedule_0/function74498_schedule_0.o");
