...
int main(int argc, char **argv){
    tiramisu::init("function64838_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64838/function64838_schedule_2/function64838_schedule_2.o");
