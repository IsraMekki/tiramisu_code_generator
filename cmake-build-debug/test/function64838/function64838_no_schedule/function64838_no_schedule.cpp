...
int main(int argc, char **argv){
    tiramisu::init("function64838_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64838/function64838_no_schedule/function64838_no_schedule.o");
