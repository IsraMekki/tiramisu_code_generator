...
int main(int argc, char **argv){
    tiramisu::init("function67569_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) * input01(i1) * input02(i0, i2, i3) + input03(i0, i2, i3) + input04(i1, i2) * input05(i0, i2, i3) * input06(i2) * input07(i0, i2, i3) * input08(i1, i2, i3) * input09(i1, i2, i3));
    ...
    buffer buf07("buf07", {64, 64, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67569/function67569_no_schedule/function67569_no_schedule.o");
