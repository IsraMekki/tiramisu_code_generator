...
int main(int argc, char **argv){
    tiramisu::init("function66811_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66811/function66811_schedule_1/function66811_schedule_1.o");
