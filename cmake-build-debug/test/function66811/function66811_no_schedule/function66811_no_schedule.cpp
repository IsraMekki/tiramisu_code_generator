...
int main(int argc, char **argv){
    tiramisu::init("function66811_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66811/function66811_no_schedule/function66811_no_schedule.o");
