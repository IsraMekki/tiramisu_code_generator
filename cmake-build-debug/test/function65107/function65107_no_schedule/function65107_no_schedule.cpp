...
int main(int argc, char **argv){
    tiramisu::init("function65107_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65107/function65107_no_schedule/function65107_no_schedule.o");
