...
int main(int argc, char **argv){
    tiramisu::init("function64879_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64879/function64879_schedule_0/function64879_schedule_0.o");
