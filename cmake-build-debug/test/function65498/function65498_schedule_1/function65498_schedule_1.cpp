...
int main(int argc, char **argv){
    tiramisu::init("function65498_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65498/function65498_schedule_1/function65498_schedule_1.o");
