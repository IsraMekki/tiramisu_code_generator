...
int main(int argc, char **argv){
    tiramisu::init("function65498_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65498/function65498_no_schedule/function65498_no_schedule.o");
