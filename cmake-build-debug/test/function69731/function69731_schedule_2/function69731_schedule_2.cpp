...
int main(int argc, char **argv){
    tiramisu::init("function69731_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69731/function69731_schedule_2/function69731_schedule_2.o");
