...
int main(int argc, char **argv){
    tiramisu::init("function68086_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68086/function68086_schedule_2/function68086_schedule_2.o");
