...
int main(int argc, char **argv){
    tiramisu::init("function68086_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68086/function68086_no_schedule/function68086_no_schedule.o");
