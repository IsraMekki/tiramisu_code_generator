...
int main(int argc, char **argv){
    tiramisu::init("function70057_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70057/function70057_schedule_0/function70057_schedule_0.o");
