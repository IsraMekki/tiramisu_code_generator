...
int main(int argc, char **argv){
    tiramisu::init("function70057_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70057/function70057_no_schedule/function70057_no_schedule.o");
