...
int main(int argc, char **argv){
    tiramisu::init("function65299_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65299/function65299_schedule_2/function65299_schedule_2.o");
