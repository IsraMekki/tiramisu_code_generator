...
int main(int argc, char **argv){
    tiramisu::init("function65299_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65299/function65299_schedule_1/function65299_schedule_1.o");
