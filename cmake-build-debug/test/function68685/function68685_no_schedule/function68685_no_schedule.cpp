...
int main(int argc, char **argv){
    tiramisu::init("function68685_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68685/function68685_no_schedule/function68685_no_schedule.o");
