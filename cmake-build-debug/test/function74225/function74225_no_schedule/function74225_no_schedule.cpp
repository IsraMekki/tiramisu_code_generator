...
int main(int argc, char **argv){
    tiramisu::init("function74225_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74225/function74225_no_schedule/function74225_no_schedule.o");
