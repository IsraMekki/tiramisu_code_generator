...
int main(int argc, char **argv){
    tiramisu::init("function73950_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73950/function73950_no_schedule/function73950_no_schedule.o");
