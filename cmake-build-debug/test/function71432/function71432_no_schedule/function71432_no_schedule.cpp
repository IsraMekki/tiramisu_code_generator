...
int main(int argc, char **argv){
    tiramisu::init("function71432_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71432/function71432_no_schedule/function71432_no_schedule.o");
