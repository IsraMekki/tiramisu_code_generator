...
int main(int argc, char **argv){
    tiramisu::init("function74302_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) - input01(i0) * input02(i0) * input03(i1) * input04(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74302/function74302_no_schedule/function74302_no_schedule.o");
