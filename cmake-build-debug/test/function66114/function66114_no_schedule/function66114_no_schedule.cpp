...
int main(int argc, char **argv){
    tiramisu::init("function66114_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66114/function66114_no_schedule/function66114_no_schedule.o");
