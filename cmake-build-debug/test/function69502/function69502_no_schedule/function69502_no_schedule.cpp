...
int main(int argc, char **argv){
    tiramisu::init("function69502_no_schedule");
    ...
    input input03("input03", {i2, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) - input01(i1, i2) - input02(i1, i2) + input03(i2, i1) - input04(i0) - input05(i0, i2) * input06(i1, i2) - input07(i1) + input08(i1) * input09(i0, i1));
    ...
    buffer buf09("buf09", {512, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69502/function69502_no_schedule/function69502_no_schedule.o");
