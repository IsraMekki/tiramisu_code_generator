...
int main(int argc, char **argv){
    tiramisu::init("function67163_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67163/function67163_no_schedule/function67163_no_schedule.o");
