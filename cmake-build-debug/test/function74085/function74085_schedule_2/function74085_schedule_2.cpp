...
int main(int argc, char **argv){
    tiramisu::init("function74085_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74085/function74085_schedule_2/function74085_schedule_2.o");
