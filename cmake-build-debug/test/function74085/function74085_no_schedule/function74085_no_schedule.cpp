...
int main(int argc, char **argv){
    tiramisu::init("function74085_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74085/function74085_no_schedule/function74085_no_schedule.o");
