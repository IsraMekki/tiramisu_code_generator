...
int main(int argc, char **argv){
    tiramisu::init("function65544_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65544/function65544_schedule_1/function65544_schedule_1.o");
