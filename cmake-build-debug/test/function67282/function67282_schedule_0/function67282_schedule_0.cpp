...
int main(int argc, char **argv){
    tiramisu::init("function67282_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67282/function67282_schedule_0/function67282_schedule_0.o");
