...
int main(int argc, char **argv){
    tiramisu::init("function67947_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) * input01(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67947/function67947_no_schedule/function67947_no_schedule.o");
