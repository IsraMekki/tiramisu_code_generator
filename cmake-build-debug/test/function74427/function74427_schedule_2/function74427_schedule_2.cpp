...
int main(int argc, char **argv){
    tiramisu::init("function74427_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74427/function74427_schedule_2/function74427_schedule_2.o");
