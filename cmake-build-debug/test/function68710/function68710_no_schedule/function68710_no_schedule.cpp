...
int main(int argc, char **argv){
    tiramisu::init("function68710_no_schedule");
    ...
    input input03("input03", {i2, i1, i0}, p_int32);

    input input04("input04", {i3}, p_int32);

    input input05("input05", {i0, i3}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) + input01(i2) * input02(i0) - input03(i2, i1, i0) * input04(i3) + input05(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function68710/function68710_no_schedule/function68710_no_schedule.o");
