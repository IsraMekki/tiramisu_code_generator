...
int main(int argc, char **argv){
    tiramisu::init("function71426_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71426/function71426_no_schedule/function71426_no_schedule.o");
