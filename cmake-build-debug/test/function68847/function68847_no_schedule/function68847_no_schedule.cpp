...
int main(int argc, char **argv){
    tiramisu::init("function68847_no_schedule");

    constant c0("c0", 1024), c1("c1", 131072);
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) - input01(i1) + input02(i0) + input03(i0) * input04(i0) - input05(i1) * input06(i1) - input07(i0) + input08(i1) + input09(i1));
    ...
    buffer buf09("buf09", {131072}, p_int32, a_input);
    buffer buf0("buf0", {1024, 131072}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function68847/function68847_no_schedule/function68847_no_schedule.o");
