...
int main(int argc, char **argv){
    tiramisu::init("function69340_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1) + input02(i1) + input03(i0, i1) + input04(i0, i1) * input05(i1, i2) + input06(i1, i2) - input07(i0, i2) * input08(i1) + input09(i0, i1));
    ...
    buffer buf04("buf04", {256, 256}, p_int32, a_input);
    buffer buf05("buf05", {256, 512}, p_int32, a_input);
    buffer buf06("buf06", {256, 512}, p_int32, a_input);
    buffer buf07("buf07", {256, 512}, p_int32, a_input);
    buffer buf08("buf08", {256}, p_int32, a_input);
    buffer buf09("buf09", {256, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69340/function69340_no_schedule/function69340_no_schedule.o");
