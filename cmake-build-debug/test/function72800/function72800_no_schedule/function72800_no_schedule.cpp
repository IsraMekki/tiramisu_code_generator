...
int main(int argc, char **argv){
    tiramisu::init("function72800_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72800/function72800_no_schedule/function72800_no_schedule.o");
