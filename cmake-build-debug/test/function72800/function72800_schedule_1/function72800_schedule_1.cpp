...
int main(int argc, char **argv){
    tiramisu::init("function72800_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72800/function72800_schedule_1/function72800_schedule_1.o");
