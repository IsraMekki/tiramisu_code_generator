...
int main(int argc, char **argv){
    tiramisu::init("function68817_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68817/function68817_schedule_2/function68817_schedule_2.o");
