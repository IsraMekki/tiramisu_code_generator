...
int main(int argc, char **argv){
    tiramisu::init("function74036_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74036/function74036_schedule_0/function74036_schedule_0.o");
