...
int main(int argc, char **argv){
    tiramisu::init("function68096_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68096/function68096_no_schedule/function68096_no_schedule.o");
