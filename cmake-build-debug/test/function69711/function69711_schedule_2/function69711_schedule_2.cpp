...
int main(int argc, char **argv){
    tiramisu::init("function69711_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69711/function69711_schedule_2/function69711_schedule_2.o");
