...
int main(int argc, char **argv){
    tiramisu::init("function69711_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69711/function69711_no_schedule/function69711_no_schedule.o");
