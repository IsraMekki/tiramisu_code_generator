...
int main(int argc, char **argv){
    tiramisu::init("function74301_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74301/function74301_schedule_0/function74301_schedule_0.o");
