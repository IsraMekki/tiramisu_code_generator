...
int main(int argc, char **argv){
    tiramisu::init("function68972_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) * input01(i0, i1, i3) * input02(i2) + input03(i1, i2, i3) * input04(i0, i1, i2) * input05(i1) - input06(i2, i3) + input07(i1, i2, i3) * input08(i0, i2, i3) + input09(i1, i2, i3));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {256, 64, 64}, p_int32, a_input);
    buffer buf01("buf01", {256, 64, 64}, p_int32, a_input);
    buffer buf02("buf02", {64}, p_int32, a_input);
    buffer buf03("buf03", {64, 64, 64}, p_int32, a_input);
    buffer buf04("buf04", {256, 64, 64}, p_int32, a_input);
    buffer buf05("buf05", {64}, p_int32, a_input);
    buffer buf06("buf06", {64, 64}, p_int32, a_input);
    buffer buf07("buf07", {64, 64, 64}, p_int32, a_input);
    buffer buf08("buf08", {256, 64, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function68972/function68972_no_schedule/function68972_no_schedule.o");
