...
int main(int argc, char **argv){
    tiramisu::init("function71024_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i2) * input02(i0, i3) * input03(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71024/function71024_no_schedule/function71024_no_schedule.o");
