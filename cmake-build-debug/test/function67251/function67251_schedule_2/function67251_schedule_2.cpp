...
int main(int argc, char **argv){
    tiramisu::init("function67251_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67251/function67251_schedule_2/function67251_schedule_2.o");
