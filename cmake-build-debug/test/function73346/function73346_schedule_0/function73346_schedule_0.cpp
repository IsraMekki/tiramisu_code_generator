...
int main(int argc, char **argv){
    tiramisu::init("function73346_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73346/function73346_schedule_0/function73346_schedule_0.o");
