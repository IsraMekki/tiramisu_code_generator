...
int main(int argc, char **argv){
    tiramisu::init("function66481_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66481/function66481_no_schedule/function66481_no_schedule.o");
