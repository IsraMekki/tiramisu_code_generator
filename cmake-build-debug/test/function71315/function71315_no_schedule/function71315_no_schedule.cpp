...
int main(int argc, char **argv){
    tiramisu::init("function71315_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71315/function71315_no_schedule/function71315_no_schedule.o");
