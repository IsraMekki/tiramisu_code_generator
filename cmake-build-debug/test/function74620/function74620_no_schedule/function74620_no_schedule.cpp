...
int main(int argc, char **argv){
    tiramisu::init("function74620_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) - input01(i0, i2) * input02(i0) - input03(i0, i2) + input04(i0, i1) - input05(i0, i1) + input06(i0) * input07(i0, i1) - input08(i1) + input09(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function74620/function74620_no_schedule/function74620_no_schedule.o");
