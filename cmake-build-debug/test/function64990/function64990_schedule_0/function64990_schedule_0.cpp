...
int main(int argc, char **argv){
    tiramisu::init("function64990_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function64990/function64990_schedule_0/function64990_schedule_0.o");
