...
int main(int argc, char **argv){
    tiramisu::init("function67157_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i0, i2) + input02(i0, i2) + input03(i2) * input04(i2) - input05(i0, i2) - input06(i2) * input07(i1, i2) + input08(i2) * input09(i0, i1));
    ...
    buffer buf05("buf05", {1024, 512}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67157/function67157_no_schedule/function67157_no_schedule.o");
