...
int main(int argc, char **argv){
    tiramisu::init("function68386_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68386/function68386_schedule_0/function68386_schedule_0.o");
