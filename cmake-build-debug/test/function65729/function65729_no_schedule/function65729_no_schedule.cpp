...
int main(int argc, char **argv){
    tiramisu::init("function65729_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65729/function65729_no_schedule/function65729_no_schedule.o");
