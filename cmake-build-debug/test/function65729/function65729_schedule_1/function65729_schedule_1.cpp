...
int main(int argc, char **argv){
    tiramisu::init("function65729_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65729/function65729_schedule_1/function65729_schedule_1.o");
