...
int main(int argc, char **argv){
    tiramisu::init("function71744_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71744/function71744_no_schedule/function71744_no_schedule.o");
