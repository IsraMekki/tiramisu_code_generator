...
int main(int argc, char **argv){
    tiramisu::init("function71744_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71744/function71744_schedule_0/function71744_schedule_0.o");
