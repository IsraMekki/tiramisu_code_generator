...
int main(int argc, char **argv){
    tiramisu::init("function67368_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67368/function67368_schedule_1/function67368_schedule_1.o");
