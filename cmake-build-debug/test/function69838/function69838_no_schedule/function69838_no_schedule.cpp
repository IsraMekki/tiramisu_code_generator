...
int main(int argc, char **argv){
    tiramisu::init("function69838_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69838/function69838_no_schedule/function69838_no_schedule.o");
