...
int main(int argc, char **argv){
    tiramisu::init("function64913_no_schedule");
    ...
    input input05("input05", {i2, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) + input01(i0, i1) - input02(i0, i1) - input03(i2) - input04(i0) + input05(i2, i1) - input06(i0) + input07(i1) - input08(i1) - input09(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function64913/function64913_no_schedule/function64913_no_schedule.o");
