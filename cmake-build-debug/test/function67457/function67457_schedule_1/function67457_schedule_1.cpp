...
int main(int argc, char **argv){
    tiramisu::init("function67457_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67457/function67457_schedule_1/function67457_schedule_1.o");
