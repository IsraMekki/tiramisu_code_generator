...
int main(int argc, char **argv){
    tiramisu::init("function65892_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65892/function65892_no_schedule/function65892_no_schedule.o");
