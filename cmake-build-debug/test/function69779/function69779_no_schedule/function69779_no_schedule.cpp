...
int main(int argc, char **argv){
    tiramisu::init("function69779_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69779/function69779_no_schedule/function69779_no_schedule.o");
