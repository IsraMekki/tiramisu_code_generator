...
int main(int argc, char **argv){
    tiramisu::init("function67662_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67662/function67662_schedule_2/function67662_schedule_2.o");
