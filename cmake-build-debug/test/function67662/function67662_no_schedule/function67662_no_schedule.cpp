...
int main(int argc, char **argv){
    tiramisu::init("function67662_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67662/function67662_no_schedule/function67662_no_schedule.o");
