...
int main(int argc, char **argv){
    tiramisu::init("function66870_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66870/function66870_no_schedule/function66870_no_schedule.o");
