...
int main(int argc, char **argv){
    tiramisu::init("function67062_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67062/function67062_schedule_2/function67062_schedule_2.o");
