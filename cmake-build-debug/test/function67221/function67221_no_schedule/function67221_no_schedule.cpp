...
int main(int argc, char **argv){
    tiramisu::init("function67221_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67221/function67221_no_schedule/function67221_no_schedule.o");
