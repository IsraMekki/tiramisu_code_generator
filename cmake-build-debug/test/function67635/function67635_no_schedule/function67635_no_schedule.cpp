...
int main(int argc, char **argv){
    tiramisu::init("function67635_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67635/function67635_no_schedule/function67635_no_schedule.o");
