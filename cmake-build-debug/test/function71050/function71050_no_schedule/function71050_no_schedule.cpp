...
int main(int argc, char **argv){
    tiramisu::init("function71050_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71050/function71050_no_schedule/function71050_no_schedule.o");
