...
int main(int argc, char **argv){
    tiramisu::init("function67340_no_schedule");
    ...
    input input03("input03", {i3, i2, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) - input01(i1, i2, i3) * input02(i1) - input03(i3, i2, i1) + input04(i0) + input05(i0, i1, i2) * input06(i0, i1, i2) + input07(i2) + input08(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function67340/function67340_no_schedule/function67340_no_schedule.o");
