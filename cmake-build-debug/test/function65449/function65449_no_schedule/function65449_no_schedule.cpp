...
int main(int argc, char **argv){
    tiramisu::init("function65449_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65449/function65449_no_schedule/function65449_no_schedule.o");
