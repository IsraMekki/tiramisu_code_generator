...
int main(int argc, char **argv){
    tiramisu::init("function69374_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i3) + input02(i0, i1) - input03(i0, i1, i2) + input04(i3));
    ...
    buffer buf03("buf03", {256, 64, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69374/function69374_no_schedule/function69374_no_schedule.o");
