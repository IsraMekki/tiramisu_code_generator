...
int main(int argc, char **argv){
    tiramisu::init("function69168_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69168/function69168_no_schedule/function69168_no_schedule.o");
