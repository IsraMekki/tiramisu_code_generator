...
int main(int argc, char **argv){
    tiramisu::init("function67042_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67042/function67042_no_schedule/function67042_no_schedule.o");
