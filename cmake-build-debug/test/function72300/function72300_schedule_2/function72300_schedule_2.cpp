...
int main(int argc, char **argv){
    tiramisu::init("function72300_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72300/function72300_schedule_2/function72300_schedule_2.o");
