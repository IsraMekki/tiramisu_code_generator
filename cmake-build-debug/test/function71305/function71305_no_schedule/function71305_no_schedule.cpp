...
int main(int argc, char **argv){
    tiramisu::init("function71305_no_schedule");
    ...
    input input03("input03", {i0, i3, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) * input01(i1, i2, i3) * input02(i0, i2, i3) + input03(i0, i3, i1) + input04(i0) + input05(i2) * input06(i2, i3) + input07(i0, i2) + input08(i0) - input09(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function71305/function71305_no_schedule/function71305_no_schedule.o");
