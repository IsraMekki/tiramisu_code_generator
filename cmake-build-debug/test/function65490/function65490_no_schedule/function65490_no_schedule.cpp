...
int main(int argc, char **argv){
    tiramisu::init("function65490_no_schedule");
    ...
    input input03("input03", {i2, i0, i3}, p_int32);

    input input04("input04", {i2, i1, i3}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i2) - input02(i0) * input03(i2, i0, i3) + input04(i2, i1, i3) + input05(i0) + input06(i0, i1, i2) + input07(i1) + input08(i2, i3) - input09(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function65490/function65490_no_schedule/function65490_no_schedule.o");
