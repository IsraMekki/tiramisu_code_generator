...
int main(int argc, char **argv){
    tiramisu::init("function69444_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69444/function69444_no_schedule/function69444_no_schedule.o");
