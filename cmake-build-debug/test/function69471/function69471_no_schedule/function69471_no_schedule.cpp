...
int main(int argc, char **argv){
    tiramisu::init("function69471_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69471/function69471_no_schedule/function69471_no_schedule.o");
