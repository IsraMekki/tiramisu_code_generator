...
int main(int argc, char **argv){
    tiramisu::init("function74153_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74153/function74153_schedule_1/function74153_schedule_1.o");
