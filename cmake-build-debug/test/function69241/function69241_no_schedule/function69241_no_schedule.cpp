...
int main(int argc, char **argv){
    tiramisu::init("function69241_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69241/function69241_no_schedule/function69241_no_schedule.o");
