...
int main(int argc, char **argv){
    tiramisu::init("function65698_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65698/function65698_no_schedule/function65698_no_schedule.o");
