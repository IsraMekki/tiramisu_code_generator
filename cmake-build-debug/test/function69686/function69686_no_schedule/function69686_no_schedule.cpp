...
int main(int argc, char **argv){
    tiramisu::init("function69686_no_schedule");

    constant c0("c0", 1048576), c1("c1", 128);
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) + input01(i0) - input02(i0) * input03(i1) - input04(i1) * input05(i1) + input06(i1));
    ...
    buffer buf0("buf0", {1048576, 128}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function69686/function69686_no_schedule/function69686_no_schedule.o");
