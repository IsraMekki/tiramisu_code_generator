...
int main(int argc, char **argv){
    tiramisu::init("function66436_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66436/function66436_schedule_1/function66436_schedule_1.o");
