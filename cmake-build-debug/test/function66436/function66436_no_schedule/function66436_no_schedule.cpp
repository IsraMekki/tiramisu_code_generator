...
int main(int argc, char **argv){
    tiramisu::init("function66436_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i0) - input02(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66436/function66436_no_schedule/function66436_no_schedule.o");
