...
int main(int argc, char **argv){
    tiramisu::init("function69096_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69096/function69096_no_schedule/function69096_no_schedule.o");
