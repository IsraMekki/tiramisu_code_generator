...
int main(int argc, char **argv){
    tiramisu::init("function68682_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68682/function68682_no_schedule/function68682_no_schedule.o");
