...
int main(int argc, char **argv){
    tiramisu::init("function64850_no_schedule");
    ...
    input input05("input05", {i3, i1, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) * input01(i0) * input02(i0) - input03(i1, i2, i3) * input04(i0) + input05(i3, i1, i0) * input06(i1, i2, i3) - input07(i0, i3) + input08(i1) * input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function64850/function64850_no_schedule/function64850_no_schedule.o");
