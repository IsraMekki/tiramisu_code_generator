...
int main(int argc, char **argv){
    tiramisu::init("function67821_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67821/function67821_no_schedule/function67821_no_schedule.o");
