...
int main(int argc, char **argv){
    tiramisu::init("function74657_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74657/function74657_no_schedule/function74657_no_schedule.o");
