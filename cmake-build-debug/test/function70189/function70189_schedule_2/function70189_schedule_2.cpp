...
int main(int argc, char **argv){
    tiramisu::init("function70189_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70189/function70189_schedule_2/function70189_schedule_2.o");
