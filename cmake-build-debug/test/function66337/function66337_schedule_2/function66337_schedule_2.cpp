...
int main(int argc, char **argv){
    tiramisu::init("function66337_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66337/function66337_schedule_2/function66337_schedule_2.o");
