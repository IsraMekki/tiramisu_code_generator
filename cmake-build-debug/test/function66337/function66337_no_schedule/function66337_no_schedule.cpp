...
int main(int argc, char **argv){
    tiramisu::init("function66337_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i0) * input02(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66337/function66337_no_schedule/function66337_no_schedule.o");
