...
int main(int argc, char **argv){
    tiramisu::init("function65531_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65531/function65531_no_schedule/function65531_no_schedule.o");
