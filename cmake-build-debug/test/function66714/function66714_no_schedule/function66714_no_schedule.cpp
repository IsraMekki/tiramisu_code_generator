...
int main(int argc, char **argv){
    tiramisu::init("function66714_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66714/function66714_no_schedule/function66714_no_schedule.o");
