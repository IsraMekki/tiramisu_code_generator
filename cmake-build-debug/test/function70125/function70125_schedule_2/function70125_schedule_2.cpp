...
int main(int argc, char **argv){
    tiramisu::init("function70125_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70125/function70125_schedule_2/function70125_schedule_2.o");
