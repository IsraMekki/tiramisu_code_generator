...
int main(int argc, char **argv){
    tiramisu::init("function70526_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70526/function70526_schedule_2/function70526_schedule_2.o");
