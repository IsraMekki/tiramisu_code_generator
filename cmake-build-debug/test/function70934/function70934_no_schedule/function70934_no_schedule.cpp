...
int main(int argc, char **argv){
    tiramisu::init("function70934_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70934/function70934_no_schedule/function70934_no_schedule.o");
