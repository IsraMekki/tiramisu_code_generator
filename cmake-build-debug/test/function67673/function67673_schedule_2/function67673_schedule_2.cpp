...
int main(int argc, char **argv){
    tiramisu::init("function67673_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67673/function67673_schedule_2/function67673_schedule_2.o");
