...
int main(int argc, char **argv){
    tiramisu::init("function74755_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74755/function74755_no_schedule/function74755_no_schedule.o");
