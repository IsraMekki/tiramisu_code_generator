...
int main(int argc, char **argv){
    tiramisu::init("function66662_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66662/function66662_no_schedule/function66662_no_schedule.o");
