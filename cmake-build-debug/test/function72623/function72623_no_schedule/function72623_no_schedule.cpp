...
int main(int argc, char **argv){
    tiramisu::init("function72623_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72623/function72623_no_schedule/function72623_no_schedule.o");
