...
int main(int argc, char **argv){
    tiramisu::init("function73788_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73788/function73788_no_schedule/function73788_no_schedule.o");
