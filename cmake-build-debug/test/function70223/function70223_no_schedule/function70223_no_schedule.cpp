...
int main(int argc, char **argv){
    tiramisu::init("function70223_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70223/function70223_no_schedule/function70223_no_schedule.o");
