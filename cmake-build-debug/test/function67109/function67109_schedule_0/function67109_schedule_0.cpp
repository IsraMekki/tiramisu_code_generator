...
int main(int argc, char **argv){
    tiramisu::init("function67109_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67109/function67109_schedule_0/function67109_schedule_0.o");
