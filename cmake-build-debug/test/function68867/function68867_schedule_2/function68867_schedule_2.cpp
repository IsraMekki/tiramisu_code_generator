...
int main(int argc, char **argv){
    tiramisu::init("function68867_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68867/function68867_schedule_2/function68867_schedule_2.o");
