...
int main(int argc, char **argv){
    tiramisu::init("function73374_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73374/function73374_no_schedule/function73374_no_schedule.o");
