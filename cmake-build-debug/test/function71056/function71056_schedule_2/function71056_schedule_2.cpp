...
int main(int argc, char **argv){
    tiramisu::init("function71056_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71056/function71056_schedule_2/function71056_schedule_2.o");
