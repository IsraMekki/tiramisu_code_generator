...
int main(int argc, char **argv){
    tiramisu::init("function67506_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67506/function67506_no_schedule/function67506_no_schedule.o");
