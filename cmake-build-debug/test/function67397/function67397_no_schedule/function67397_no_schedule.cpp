...
int main(int argc, char **argv){
    tiramisu::init("function67397_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67397/function67397_no_schedule/function67397_no_schedule.o");
