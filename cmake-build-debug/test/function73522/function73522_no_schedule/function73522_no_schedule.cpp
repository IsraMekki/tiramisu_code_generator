...
int main(int argc, char **argv){
    tiramisu::init("function73522_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73522/function73522_no_schedule/function73522_no_schedule.o");
