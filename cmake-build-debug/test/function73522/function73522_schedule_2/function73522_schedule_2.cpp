...
int main(int argc, char **argv){
    tiramisu::init("function73522_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73522/function73522_schedule_2/function73522_schedule_2.o");
