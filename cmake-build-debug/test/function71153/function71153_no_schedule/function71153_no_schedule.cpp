...
int main(int argc, char **argv){
    tiramisu::init("function71153_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71153/function71153_no_schedule/function71153_no_schedule.o");
