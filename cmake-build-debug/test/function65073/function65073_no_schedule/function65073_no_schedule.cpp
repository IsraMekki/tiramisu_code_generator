...
int main(int argc, char **argv){
    tiramisu::init("function65073_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65073/function65073_no_schedule/function65073_no_schedule.o");
