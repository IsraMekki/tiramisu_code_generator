...
int main(int argc, char **argv){
    tiramisu::init("function68807_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68807/function68807_schedule_1/function68807_schedule_1.o");
