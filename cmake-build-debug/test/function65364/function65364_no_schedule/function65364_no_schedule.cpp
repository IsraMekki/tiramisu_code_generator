...
int main(int argc, char **argv){
    tiramisu::init("function65364_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i1, i3) + input02(i0, i1) * input03(i0, i1, i2) - input04(i3, i1, i2) - input05(i1, i3) - input06(i1, i2, i3) * input07(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65364/function65364_no_schedule/function65364_no_schedule.o");
