...
int main(int argc, char **argv){
    tiramisu::init("function65550_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) + input01(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65550/function65550_no_schedule/function65550_no_schedule.o");
