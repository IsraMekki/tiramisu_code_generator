...
int main(int argc, char **argv){
    tiramisu::init("function74660_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74660/function74660_schedule_2/function74660_schedule_2.o");
