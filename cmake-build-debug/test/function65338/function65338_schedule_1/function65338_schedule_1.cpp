...
int main(int argc, char **argv){
    tiramisu::init("function65338_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65338/function65338_schedule_1/function65338_schedule_1.o");
