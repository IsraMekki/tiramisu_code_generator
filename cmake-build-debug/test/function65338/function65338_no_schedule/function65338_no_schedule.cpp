...
int main(int argc, char **argv){
    tiramisu::init("function65338_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65338/function65338_no_schedule/function65338_no_schedule.o");
