...
int main(int argc, char **argv){
    tiramisu::init("function67796_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) - input01(i0) + input02(i1, i2) - input03(i1, i2) + input04(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67796/function67796_no_schedule/function67796_no_schedule.o");
