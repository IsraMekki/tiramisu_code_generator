...
int main(int argc, char **argv){
    tiramisu::init("function67215_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67215/function67215_no_schedule/function67215_no_schedule.o");
