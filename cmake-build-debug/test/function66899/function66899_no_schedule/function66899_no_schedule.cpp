...
int main(int argc, char **argv){
    tiramisu::init("function66899_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66899/function66899_no_schedule/function66899_no_schedule.o");
