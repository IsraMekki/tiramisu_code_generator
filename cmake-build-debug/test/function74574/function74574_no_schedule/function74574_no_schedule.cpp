...
int main(int argc, char **argv){
    tiramisu::init("function74574_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i0, i3) - input02(i1, i2, i3) + input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74574/function74574_no_schedule/function74574_no_schedule.o");
