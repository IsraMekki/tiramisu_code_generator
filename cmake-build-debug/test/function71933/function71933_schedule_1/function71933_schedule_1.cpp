...
int main(int argc, char **argv){
    tiramisu::init("function71933_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71933/function71933_schedule_1/function71933_schedule_1.o");
