...
int main(int argc, char **argv){
    tiramisu::init("function72313_no_schedule");
    ...
    input input07("input07", {i0, i3, i2}, p_int32);

    input input08("input08", {i0, i1, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i2) * input02(i2, i3) + input03(i2) * input04(i0, i1, i2) * input05(i0, i2, i3) * input06(i0, i1, i2) * input07(i0, i3, i2) - input08(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function72313/function72313_no_schedule/function72313_no_schedule.o");
