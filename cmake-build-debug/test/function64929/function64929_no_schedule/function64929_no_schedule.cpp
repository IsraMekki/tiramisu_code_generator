...
int main(int argc, char **argv){
    tiramisu::init("function64929_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64929/function64929_no_schedule/function64929_no_schedule.o");
