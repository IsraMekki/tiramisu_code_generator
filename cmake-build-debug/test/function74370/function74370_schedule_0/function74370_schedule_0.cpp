...
int main(int argc, char **argv){
    tiramisu::init("function74370_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74370/function74370_schedule_0/function74370_schedule_0.o");
