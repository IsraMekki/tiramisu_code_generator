...
int main(int argc, char **argv){
    tiramisu::init("function72454_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72454/function72454_no_schedule/function72454_no_schedule.o");
