...
int main(int argc, char **argv){
    tiramisu::init("function71846_no_schedule");
    ...
    buffer buf00("buf00", {4096, 128, 64}, p_int32, a_input);
    buffer buf0("buf0", {4096, 128, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function71846/function71846_no_schedule/function71846_no_schedule.o");
