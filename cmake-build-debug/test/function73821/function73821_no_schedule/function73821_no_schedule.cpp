...
int main(int argc, char **argv){
    tiramisu::init("function73821_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73821/function73821_no_schedule/function73821_no_schedule.o");
