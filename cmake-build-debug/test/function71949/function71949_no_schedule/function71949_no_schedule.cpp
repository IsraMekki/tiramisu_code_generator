...
int main(int argc, char **argv){
    tiramisu::init("function71949_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71949/function71949_no_schedule/function71949_no_schedule.o");
