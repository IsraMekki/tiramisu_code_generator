...
int main(int argc, char **argv){
    tiramisu::init("function72400_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72400/function72400_no_schedule/function72400_no_schedule.o");
