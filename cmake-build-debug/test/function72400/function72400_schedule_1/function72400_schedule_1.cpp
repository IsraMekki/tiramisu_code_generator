...
int main(int argc, char **argv){
    tiramisu::init("function72400_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72400/function72400_schedule_1/function72400_schedule_1.o");
