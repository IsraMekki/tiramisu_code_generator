...
int main(int argc, char **argv){
    tiramisu::init("function70362_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70362/function70362_schedule_0/function70362_schedule_0.o");
