...
int main(int argc, char **argv){
    tiramisu::init("function70362_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70362/function70362_schedule_2/function70362_schedule_2.o");
