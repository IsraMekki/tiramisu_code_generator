...
int main(int argc, char **argv){
    tiramisu::init("function74688_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i1, i2) * input02(i2) - input03(i0, i2) * input04(i0, i1) + input05(i0, i1) * input06(i2) - input07(i1) * input08(i2) * input09(i1, i2));
    ...
    buffer buf04("buf04", {128, 8192}, p_int32, a_input);
    buffer buf05("buf05", {128, 8192}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function74688/function74688_no_schedule/function74688_no_schedule.o");
