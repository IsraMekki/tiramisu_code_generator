...
int main(int argc, char **argv){
    tiramisu::init("function72003_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72003/function72003_no_schedule/function72003_no_schedule.o");
