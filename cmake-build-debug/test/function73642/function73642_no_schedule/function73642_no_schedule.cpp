...
int main(int argc, char **argv){
    tiramisu::init("function73642_no_schedule");
    ...
    buffer buf00("buf00", {2048, 512, 64}, p_int32, a_input);
    buffer buf0("buf0", {2048, 512, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function73642/function73642_no_schedule/function73642_no_schedule.o");
