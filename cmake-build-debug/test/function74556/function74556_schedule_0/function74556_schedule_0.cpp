...
int main(int argc, char **argv){
    tiramisu::init("function74556_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74556/function74556_schedule_0/function74556_schedule_0.o");
