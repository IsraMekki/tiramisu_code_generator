...
int main(int argc, char **argv){
    tiramisu::init("function69307_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69307/function69307_schedule_1/function69307_schedule_1.o");
