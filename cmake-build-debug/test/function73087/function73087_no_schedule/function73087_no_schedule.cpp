...
int main(int argc, char **argv){
    tiramisu::init("function73087_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73087/function73087_no_schedule/function73087_no_schedule.o");
