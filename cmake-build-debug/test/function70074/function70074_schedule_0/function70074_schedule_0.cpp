...
int main(int argc, char **argv){
    tiramisu::init("function70074_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70074/function70074_schedule_0/function70074_schedule_0.o");
