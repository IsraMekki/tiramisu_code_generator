...
int main(int argc, char **argv){
    tiramisu::init("function72475_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72475/function72475_schedule_2/function72475_schedule_2.o");
