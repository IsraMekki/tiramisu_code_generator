...
int main(int argc, char **argv){
    tiramisu::init("function69419_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69419/function69419_no_schedule/function69419_no_schedule.o");
