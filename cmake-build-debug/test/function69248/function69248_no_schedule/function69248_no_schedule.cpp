...
int main(int argc, char **argv){
    tiramisu::init("function69248_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69248/function69248_no_schedule/function69248_no_schedule.o");
