...
int main(int argc, char **argv){
    tiramisu::init("function65070_no_schedule");
    ...
    input input09("input09", {i0, i3, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i0, i2, i3) * input02(i0, i3) + input03(i1, i2, i3) + input04(i1, i2, i3) * input05(i1, i3) + input06(i0, i2, i3) - input07(i0) - input08(i0) - input09(i0, i3, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function65070/function65070_no_schedule/function65070_no_schedule.o");
