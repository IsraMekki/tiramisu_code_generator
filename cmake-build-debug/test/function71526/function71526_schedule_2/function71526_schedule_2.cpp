...
int main(int argc, char **argv){
    tiramisu::init("function71526_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71526/function71526_schedule_2/function71526_schedule_2.o");
