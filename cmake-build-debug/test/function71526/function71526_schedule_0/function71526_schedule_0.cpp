...
int main(int argc, char **argv){
    tiramisu::init("function71526_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71526/function71526_schedule_0/function71526_schedule_0.o");
