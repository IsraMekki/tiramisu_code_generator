...
int main(int argc, char **argv){
    tiramisu::init("function68976_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68976/function68976_schedule_1/function68976_schedule_1.o");
