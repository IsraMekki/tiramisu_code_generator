...
int main(int argc, char **argv){
    tiramisu::init("function65817_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65817/function65817_no_schedule/function65817_no_schedule.o");
