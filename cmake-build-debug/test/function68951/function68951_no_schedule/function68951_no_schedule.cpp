...
int main(int argc, char **argv){
    tiramisu::init("function68951_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68951/function68951_no_schedule/function68951_no_schedule.o");
