...
int main(int argc, char **argv){
    tiramisu::init("function69139_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69139/function69139_no_schedule/function69139_no_schedule.o");
