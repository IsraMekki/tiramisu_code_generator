...
int main(int argc, char **argv){
    tiramisu::init("function69929_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69929/function69929_schedule_2/function69929_schedule_2.o");
