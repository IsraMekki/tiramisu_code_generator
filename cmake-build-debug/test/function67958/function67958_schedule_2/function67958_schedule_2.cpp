...
int main(int argc, char **argv){
    tiramisu::init("function67958_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67958/function67958_schedule_2/function67958_schedule_2.o");
