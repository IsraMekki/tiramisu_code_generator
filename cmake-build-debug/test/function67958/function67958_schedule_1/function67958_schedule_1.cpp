...
int main(int argc, char **argv){
    tiramisu::init("function67958_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67958/function67958_schedule_1/function67958_schedule_1.o");
