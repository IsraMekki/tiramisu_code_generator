...
int main(int argc, char **argv){
    tiramisu::init("function70380_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70380/function70380_no_schedule/function70380_no_schedule.o");
