...
int main(int argc, char **argv){
    tiramisu::init("function74081_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74081/function74081_schedule_0/function74081_schedule_0.o");
