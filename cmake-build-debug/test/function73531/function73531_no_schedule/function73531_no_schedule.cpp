...
int main(int argc, char **argv){
    tiramisu::init("function73531_no_schedule");
    ...
    input input05("input05", {i0, i3, i1}, p_int32);

    input input06("input06", {i0, i2, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i3, i0) + input02(i0) + input03(i2, i3) * input04(i0) - input05(i0, i3, i1) * input06(i0, i2, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function73531/function73531_no_schedule/function73531_no_schedule.o");
