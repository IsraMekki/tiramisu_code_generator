...
int main(int argc, char **argv){
    tiramisu::init("function65864_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65864/function65864_schedule_0/function65864_schedule_0.o");
