...
int main(int argc, char **argv){
    tiramisu::init("function65715_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i0, i2) + input02(i1, i2) + input03(i0, i1) + input04(i2) - input05(i0, i2) - input06(i2) - input07(i1, i2) * input08(i0, i2));
    ...
    buffer buf03("buf03", {512, 2048}, p_int32, a_input);
    buffer buf04("buf04", {64}, p_int32, a_input);
    buffer buf05("buf05", {512, 64}, p_int32, a_input);
    buffer buf06("buf06", {64}, p_int32, a_input);
    buffer buf07("buf07", {2048, 64}, p_int32, a_input);
    buffer buf08("buf08", {512, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65715/function65715_no_schedule/function65715_no_schedule.o");
