...
int main(int argc, char **argv){
    tiramisu::init("function68215_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68215/function68215_no_schedule/function68215_no_schedule.o");
