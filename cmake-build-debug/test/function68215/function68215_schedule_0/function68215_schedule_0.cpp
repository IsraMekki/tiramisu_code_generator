...
int main(int argc, char **argv){
    tiramisu::init("function68215_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68215/function68215_schedule_0/function68215_schedule_0.o");
