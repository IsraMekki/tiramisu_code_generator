...
int main(int argc, char **argv){
    tiramisu::init("function71531_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71531/function71531_no_schedule/function71531_no_schedule.o");
