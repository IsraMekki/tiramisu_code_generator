...
int main(int argc, char **argv){
    tiramisu::init("function74163_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74163/function74163_schedule_1/function74163_schedule_1.o");
