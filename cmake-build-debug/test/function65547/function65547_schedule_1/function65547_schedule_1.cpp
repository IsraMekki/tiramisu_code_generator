...
int main(int argc, char **argv){
    tiramisu::init("function65547_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65547/function65547_schedule_1/function65547_schedule_1.o");
