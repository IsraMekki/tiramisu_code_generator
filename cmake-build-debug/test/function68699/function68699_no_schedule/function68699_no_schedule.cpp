...
int main(int argc, char **argv){
    tiramisu::init("function68699_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68699/function68699_no_schedule/function68699_no_schedule.o");
