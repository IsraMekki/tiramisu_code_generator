...
int main(int argc, char **argv){
    tiramisu::init("function67556_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67556/function67556_no_schedule/function67556_no_schedule.o");
