...
int main(int argc, char **argv){
    tiramisu::init("function65151_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65151/function65151_schedule_1/function65151_schedule_1.o");
