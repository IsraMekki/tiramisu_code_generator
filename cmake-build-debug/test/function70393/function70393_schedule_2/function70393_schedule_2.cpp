...
int main(int argc, char **argv){
    tiramisu::init("function70393_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70393/function70393_schedule_2/function70393_schedule_2.o");
