...
int main(int argc, char **argv){
    tiramisu::init("function74058_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74058/function74058_schedule_1/function74058_schedule_1.o");
