...
int main(int argc, char **argv){
    tiramisu::init("function68574_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68574/function68574_schedule_2/function68574_schedule_2.o");
