...
int main(int argc, char **argv){
    tiramisu::init("function69475_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69475/function69475_no_schedule/function69475_no_schedule.o");
