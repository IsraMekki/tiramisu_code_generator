...
int main(int argc, char **argv){
    tiramisu::init("function73588_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73588/function73588_schedule_2/function73588_schedule_2.o");
