...
int main(int argc, char **argv){
    tiramisu::init("function73588_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73588/function73588_no_schedule/function73588_no_schedule.o");
