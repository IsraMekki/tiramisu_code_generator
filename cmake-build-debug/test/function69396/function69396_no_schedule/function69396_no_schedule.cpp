...
int main(int argc, char **argv){
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i1, i0) - input01(i2) * input02(i0) * input03(i0) * input04(i2) + input05(i0, i1, i3) - input06(i1, i2, i3) + input07(i2, i3) * input08(i0) * input09(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69396/function69396_no_schedule/function69396_no_schedule.o");
