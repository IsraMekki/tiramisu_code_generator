...
int main(int argc, char **argv){
    tiramisu::init("function69651_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69651/function69651_schedule_1/function69651_schedule_1.o");
