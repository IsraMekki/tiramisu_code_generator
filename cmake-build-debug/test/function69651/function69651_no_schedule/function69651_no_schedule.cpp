...
int main(int argc, char **argv){
    tiramisu::init("function69651_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69651/function69651_no_schedule/function69651_no_schedule.o");
