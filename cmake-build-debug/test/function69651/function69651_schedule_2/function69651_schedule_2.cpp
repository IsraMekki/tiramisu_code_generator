...
int main(int argc, char **argv){
    tiramisu::init("function69651_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69651/function69651_schedule_2/function69651_schedule_2.o");
