...
int main(int argc, char **argv){
    tiramisu::init("function70245_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70245/function70245_schedule_1/function70245_schedule_1.o");
