...
int main(int argc, char **argv){
    tiramisu::init("function70245_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70245/function70245_no_schedule/function70245_no_schedule.o");
