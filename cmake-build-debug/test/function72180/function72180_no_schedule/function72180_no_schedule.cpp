...
int main(int argc, char **argv){
    tiramisu::init("function72180_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72180/function72180_no_schedule/function72180_no_schedule.o");
