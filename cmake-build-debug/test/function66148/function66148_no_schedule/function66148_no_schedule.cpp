...
int main(int argc, char **argv){
    tiramisu::init("function66148_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66148/function66148_no_schedule/function66148_no_schedule.o");
