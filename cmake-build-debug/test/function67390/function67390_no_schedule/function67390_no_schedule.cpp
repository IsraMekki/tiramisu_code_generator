...
int main(int argc, char **argv){
    tiramisu::init("function67390_no_schedule");
    ...
    input input04("input04", {i3, i2, i0}, p_int32);
    ...
    input input09("input09", {i3, i2, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) + input01(i0, i2, i3) + input02(i0, i2, i3) - input03(i2) - input04(i3, i2, i0) - input05(i1) + input06(i0, i2, i3) * input07(i3) - input08(i1, i2, i3) + input09(i3, i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67390/function67390_no_schedule/function67390_no_schedule.o");
