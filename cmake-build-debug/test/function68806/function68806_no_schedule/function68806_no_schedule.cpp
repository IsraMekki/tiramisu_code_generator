...
int main(int argc, char **argv){
    tiramisu::init("function68806_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68806/function68806_no_schedule/function68806_no_schedule.o");
