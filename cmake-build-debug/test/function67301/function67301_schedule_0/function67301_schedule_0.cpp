...
int main(int argc, char **argv){
    tiramisu::init("function67301_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67301/function67301_schedule_0/function67301_schedule_0.o");
