...
int main(int argc, char **argv){
    tiramisu::init("function72302_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72302/function72302_no_schedule/function72302_no_schedule.o");
