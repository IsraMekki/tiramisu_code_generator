...
int main(int argc, char **argv){
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3, i0) * input01(i2) - input02(i1, i0) * input03(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69567/function69567_no_schedule/function69567_no_schedule.o");
