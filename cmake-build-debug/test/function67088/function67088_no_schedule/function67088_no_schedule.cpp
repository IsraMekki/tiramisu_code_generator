...
int main(int argc, char **argv){
    tiramisu::init("function67088_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67088/function67088_no_schedule/function67088_no_schedule.o");
