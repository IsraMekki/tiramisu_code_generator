...
int main(int argc, char **argv){
    tiramisu::init("function74068_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74068/function74068_no_schedule/function74068_no_schedule.o");
