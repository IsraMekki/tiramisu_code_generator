...
int main(int argc, char **argv){
    tiramisu::init("function72565_no_schedule");
    ...
    input input02("input02", {i2, i3, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) - input01(i0, i3) + input02(i2, i3, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72565/function72565_no_schedule/function72565_no_schedule.o");
