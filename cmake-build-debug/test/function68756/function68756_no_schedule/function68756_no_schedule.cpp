...
int main(int argc, char **argv){
    tiramisu::init("function68756_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) + input01(i0) + input02(i0) - input03(i1) - input04(i0) + input05(i0) * input06(i1) * input07(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function68756/function68756_no_schedule/function68756_no_schedule.o");
