...
int main(int argc, char **argv){
    tiramisu::init("function69174_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69174/function69174_schedule_0/function69174_schedule_0.o");
