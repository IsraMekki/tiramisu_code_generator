...
int main(int argc, char **argv){
    tiramisu::init("function69738_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69738/function69738_no_schedule/function69738_no_schedule.o");
