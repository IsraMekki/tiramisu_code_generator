...
int main(int argc, char **argv){
    tiramisu::init("function68149_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68149/function68149_no_schedule/function68149_no_schedule.o");
