...
int main(int argc, char **argv){
    tiramisu::init("function71378_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71378/function71378_schedule_2/function71378_schedule_2.o");
