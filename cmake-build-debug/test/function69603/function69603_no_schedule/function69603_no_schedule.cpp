...
int main(int argc, char **argv){
    tiramisu::init("function69603_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) + input01(i1, i2) - input02(i1) + input03(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69603/function69603_no_schedule/function69603_no_schedule.o");
