...
int main(int argc, char **argv){
    tiramisu::init("function68530_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68530/function68530_no_schedule/function68530_no_schedule.o");
