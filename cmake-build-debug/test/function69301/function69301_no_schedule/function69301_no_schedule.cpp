...
int main(int argc, char **argv){
    tiramisu::init("function69301_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69301/function69301_no_schedule/function69301_no_schedule.o");
