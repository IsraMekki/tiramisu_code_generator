...
int main(int argc, char **argv){
    tiramisu::init("function66989_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i1, i2) + input02(i3) * input03(i2, i3) * input04(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66989/function66989_no_schedule/function66989_no_schedule.o");
