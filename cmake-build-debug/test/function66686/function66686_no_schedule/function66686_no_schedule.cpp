...
int main(int argc, char **argv){
    ...
    input input09("input09", {i2, i3, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3, i2) - input01(i0) * input02(i0) - input03(i2) * input04(i0, i2, i3) - input05(i0) * input06(i3) * input07(i0, i3) * input08(i0) - input09(i2, i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function66686/function66686_no_schedule/function66686_no_schedule.o");
