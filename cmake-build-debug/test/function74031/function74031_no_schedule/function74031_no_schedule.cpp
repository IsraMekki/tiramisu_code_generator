...
int main(int argc, char **argv){
    tiramisu::init("function74031_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74031/function74031_no_schedule/function74031_no_schedule.o");
