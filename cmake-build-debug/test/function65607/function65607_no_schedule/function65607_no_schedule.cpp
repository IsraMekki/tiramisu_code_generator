...
int main(int argc, char **argv){
    tiramisu::init("function65607_no_schedule");
    ...
    input input02("input02", {i3, i0, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) - input01(i0, i1, i2) + input02(i3, i0, i2) + input03(i3) * input04(i1, i2, i3) * input05(i1, i2) * input06(i0, i2) - input07(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function65607/function65607_no_schedule/function65607_no_schedule.o");
