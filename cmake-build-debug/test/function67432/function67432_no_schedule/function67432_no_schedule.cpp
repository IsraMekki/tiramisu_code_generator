...
int main(int argc, char **argv){
    tiramisu::init("function67432_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67432/function67432_no_schedule/function67432_no_schedule.o");
