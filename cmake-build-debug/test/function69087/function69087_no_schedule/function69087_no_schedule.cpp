...
int main(int argc, char **argv){
    tiramisu::init("function69087_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69087/function69087_no_schedule/function69087_no_schedule.o");
