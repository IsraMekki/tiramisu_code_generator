...
int main(int argc, char **argv){
    tiramisu::init("function68330_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i0) * input01(i1, i0) * input02(i1, i2) * input03(i2) + input04(i0, i1) * input05(i1) * input06(i2) + input07(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function68330/function68330_no_schedule/function68330_no_schedule.o");
