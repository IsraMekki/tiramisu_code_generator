...
int main(int argc, char **argv){
    tiramisu::init("function73351_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73351/function73351_no_schedule/function73351_no_schedule.o");
