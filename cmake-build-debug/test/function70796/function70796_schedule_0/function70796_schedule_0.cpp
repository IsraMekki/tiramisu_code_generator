...
int main(int argc, char **argv){
    tiramisu::init("function70796_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70796/function70796_schedule_0/function70796_schedule_0.o");
