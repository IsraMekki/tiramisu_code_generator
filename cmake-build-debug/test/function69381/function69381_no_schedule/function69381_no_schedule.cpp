...
int main(int argc, char **argv){
    tiramisu::init("function69381_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69381/function69381_no_schedule/function69381_no_schedule.o");
