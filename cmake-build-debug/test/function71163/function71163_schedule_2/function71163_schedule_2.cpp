...
int main(int argc, char **argv){
    tiramisu::init("function71163_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71163/function71163_schedule_2/function71163_schedule_2.o");
