...
int main(int argc, char **argv){
    tiramisu::init("function69297_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69297/function69297_no_schedule/function69297_no_schedule.o");
