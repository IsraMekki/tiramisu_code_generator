...
int main(int argc, char **argv){
    tiramisu::init("function67438_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i0, i1) - input02(i0, i2) * input03(i0) * input04(i1, i2) + input05(i0, i2) - input06(i0, i1) - input07(i1, i2) - input08(i1) - input09(i0));
    ...
    buffer buf06("buf06", {512, 1024}, p_int32, a_input);
    buffer buf07("buf07", {1024, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67438/function67438_no_schedule/function67438_no_schedule.o");
