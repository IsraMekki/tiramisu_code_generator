...
int main(int argc, char **argv){
    tiramisu::init("function74559_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74559/function74559_no_schedule/function74559_no_schedule.o");
