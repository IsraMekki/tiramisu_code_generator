...
int main(int argc, char **argv){
    tiramisu::init("function74559_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74559/function74559_schedule_2/function74559_schedule_2.o");
