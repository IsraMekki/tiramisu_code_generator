...
int main(int argc, char **argv){
    tiramisu::init("function72131_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i1) * input02(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72131/function72131_no_schedule/function72131_no_schedule.o");
