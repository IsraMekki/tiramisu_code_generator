...
int main(int argc, char **argv){
    tiramisu::init("function74794_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74794/function74794_no_schedule/function74794_no_schedule.o");
