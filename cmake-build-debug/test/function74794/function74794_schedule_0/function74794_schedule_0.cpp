...
int main(int argc, char **argv){
    tiramisu::init("function74794_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74794/function74794_schedule_0/function74794_schedule_0.o");
