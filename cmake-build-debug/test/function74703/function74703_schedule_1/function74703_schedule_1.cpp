...
int main(int argc, char **argv){
    tiramisu::init("function74703_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74703/function74703_schedule_1/function74703_schedule_1.o");
