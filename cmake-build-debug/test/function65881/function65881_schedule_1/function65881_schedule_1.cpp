...
int main(int argc, char **argv){
    tiramisu::init("function65881_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65881/function65881_schedule_1/function65881_schedule_1.o");
