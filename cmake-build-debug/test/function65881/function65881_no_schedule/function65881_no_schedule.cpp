...
int main(int argc, char **argv){
    tiramisu::init("function65881_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) - input01(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65881/function65881_no_schedule/function65881_no_schedule.o");
