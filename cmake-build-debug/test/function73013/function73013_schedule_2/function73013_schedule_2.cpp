...
int main(int argc, char **argv){
    tiramisu::init("function73013_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73013/function73013_schedule_2/function73013_schedule_2.o");
