...
int main(int argc, char **argv){
    tiramisu::init("function70038_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70038/function70038_no_schedule/function70038_no_schedule.o");
