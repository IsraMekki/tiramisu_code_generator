...
int main(int argc, char **argv){
    tiramisu::init("function74711_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74711/function74711_no_schedule/function74711_no_schedule.o");
