...
int main(int argc, char **argv){
    tiramisu::init("function66554_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i0, i2) + input02(i1, i2) * input03(i0, i2) - input04(i1) + input05(i0) * input06(i1, i2) - input07(i2) + input08(i1) * input09(i1, i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64, 8192}, p_int32, a_input);
    buffer buf01("buf01", {64, 8192}, p_int32, a_input);
    buffer buf02("buf02", {64, 8192}, p_int32, a_input);
    buffer buf03("buf03", {64, 8192}, p_int32, a_input);
    buffer buf04("buf04", {64}, p_int32, a_input);
    buffer buf05("buf05", {64}, p_int32, a_input);
    buffer buf06("buf06", {64, 8192}, p_int32, a_input);
    buffer buf07("buf07", {8192}, p_int32, a_input);
    buffer buf08("buf08", {64}, p_int32, a_input);
    buffer buf09("buf09", {64, 8192}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function66554/function66554_no_schedule/function66554_no_schedule.o");
