...
int main(int argc, char **argv){
    tiramisu::init("function69482_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69482/function69482_schedule_0/function69482_schedule_0.o");
