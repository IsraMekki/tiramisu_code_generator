...
int main(int argc, char **argv){
    tiramisu::init("function67358_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67358/function67358_schedule_2/function67358_schedule_2.o");
