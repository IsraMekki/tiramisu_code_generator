...
int main(int argc, char **argv){
    tiramisu::init("function64817_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64817/function64817_schedule_1/function64817_schedule_1.o");
