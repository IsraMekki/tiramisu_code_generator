...
int main(int argc, char **argv){
    tiramisu::init("function68317_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68317/function68317_no_schedule/function68317_no_schedule.o");
