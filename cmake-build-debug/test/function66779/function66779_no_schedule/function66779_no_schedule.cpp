...
int main(int argc, char **argv){
    tiramisu::init("function66779_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) + input01(i2, i3) + input02(i3) - input03(i0) + input04(i2) - input05(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function66779/function66779_no_schedule/function66779_no_schedule.o");
