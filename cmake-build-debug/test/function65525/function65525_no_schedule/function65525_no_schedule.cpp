...
int main(int argc, char **argv){
    tiramisu::init("function65525_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65525/function65525_no_schedule/function65525_no_schedule.o");
