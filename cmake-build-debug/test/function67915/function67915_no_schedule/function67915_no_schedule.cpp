...
int main(int argc, char **argv){
    tiramisu::init("function67915_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67915/function67915_no_schedule/function67915_no_schedule.o");
