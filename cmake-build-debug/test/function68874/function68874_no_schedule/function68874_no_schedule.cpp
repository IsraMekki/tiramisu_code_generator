...
int main(int argc, char **argv){
    tiramisu::init("function68874_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68874/function68874_no_schedule/function68874_no_schedule.o");
