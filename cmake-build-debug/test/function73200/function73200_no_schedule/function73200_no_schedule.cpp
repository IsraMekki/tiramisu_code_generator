...
int main(int argc, char **argv){
    tiramisu::init("function73200_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) - input01(i0, i2, i3) - input02(i1, i3) * input03(i3) * input04(i3, i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73200/function73200_no_schedule/function73200_no_schedule.o");
