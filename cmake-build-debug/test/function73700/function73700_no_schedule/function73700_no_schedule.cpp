...
int main(int argc, char **argv){
    tiramisu::init("function73700_no_schedule");
    ...
    input input09("input09", {i3, i1, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i3) + input02(i0, i1, i2) - input03(i1) + input04(i0, i2) - input05(i1) + input06(i1, i3) - input07(i0, i2, i3) * input08(i0) + input09(i3, i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73700/function73700_no_schedule/function73700_no_schedule.o");
