...
int main(int argc, char **argv){
    tiramisu::init("function64973_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64973/function64973_no_schedule/function64973_no_schedule.o");
