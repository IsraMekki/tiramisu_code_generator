...
int main(int argc, char **argv){
    tiramisu::init("function73277_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73277/function73277_no_schedule/function73277_no_schedule.o");
