...
int main(int argc, char **argv){
    tiramisu::init("function71754_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71754/function71754_schedule_0/function71754_schedule_0.o");
