...
int main(int argc, char **argv){
    tiramisu::init("function70082_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70082/function70082_schedule_2/function70082_schedule_2.o");
