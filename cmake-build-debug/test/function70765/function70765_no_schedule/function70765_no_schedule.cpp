...
int main(int argc, char **argv){
    tiramisu::init("function70765_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70765/function70765_no_schedule/function70765_no_schedule.o");
