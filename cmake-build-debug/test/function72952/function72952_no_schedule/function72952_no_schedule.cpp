...
int main(int argc, char **argv){
    tiramisu::init("function72952_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72952/function72952_no_schedule/function72952_no_schedule.o");
