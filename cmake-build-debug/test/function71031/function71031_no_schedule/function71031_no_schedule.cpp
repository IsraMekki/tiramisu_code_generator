...
int main(int argc, char **argv){
    tiramisu::init("function71031_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71031/function71031_no_schedule/function71031_no_schedule.o");
