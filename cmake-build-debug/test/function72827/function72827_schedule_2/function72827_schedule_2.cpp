...
int main(int argc, char **argv){
    tiramisu::init("function72827_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72827/function72827_schedule_2/function72827_schedule_2.o");
