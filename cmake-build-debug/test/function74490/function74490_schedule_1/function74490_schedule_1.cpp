...
int main(int argc, char **argv){
    tiramisu::init("function74490_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74490/function74490_schedule_1/function74490_schedule_1.o");
