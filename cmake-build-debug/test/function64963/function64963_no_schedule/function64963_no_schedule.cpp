...
int main(int argc, char **argv){
    tiramisu::init("function64963_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function64963/function64963_no_schedule/function64963_no_schedule.o");
