...
int main(int argc, char **argv){
    tiramisu::init("function74580_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74580/function74580_no_schedule/function74580_no_schedule.o");
