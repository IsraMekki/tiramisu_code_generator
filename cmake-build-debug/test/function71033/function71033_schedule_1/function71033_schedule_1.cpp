...
int main(int argc, char **argv){
    tiramisu::init("function71033_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71033/function71033_schedule_1/function71033_schedule_1.o");
