...
int main(int argc, char **argv){
    tiramisu::init("function71013_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71013/function71013_no_schedule/function71013_no_schedule.o");
