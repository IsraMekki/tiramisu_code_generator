...
int main(int argc, char **argv){
    tiramisu::init("function69480_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69480/function69480_schedule_2/function69480_schedule_2.o");
