...
int main(int argc, char **argv){
    tiramisu::init("function72333_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72333/function72333_schedule_0/function72333_schedule_0.o");
