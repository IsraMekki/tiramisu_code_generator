...
int main(int argc, char **argv){
    tiramisu::init("function66241_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) - input01(i1, i2) - input02(i1, i2) * input03(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66241/function66241_no_schedule/function66241_no_schedule.o");
