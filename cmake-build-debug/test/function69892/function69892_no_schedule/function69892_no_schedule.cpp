...
int main(int argc, char **argv){
    tiramisu::init("function69892_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69892/function69892_no_schedule/function69892_no_schedule.o");
