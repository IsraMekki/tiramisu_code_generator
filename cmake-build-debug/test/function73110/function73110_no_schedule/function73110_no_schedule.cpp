...
int main(int argc, char **argv){
    tiramisu::init("function73110_no_schedule");
    ...
    input input08("input08", {i3, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) + input01(i1, i2) - input02(i0) * input03(i0, i2, i3) * input04(i2, i3) * input05(i1, i2) * input06(i1, i2, i3) * input07(i0, i1, i3) - input08(i3, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function73110/function73110_no_schedule/function73110_no_schedule.o");
