...
int main(int argc, char **argv){
    tiramisu::init("function68660_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68660/function68660_schedule_2/function68660_schedule_2.o");
