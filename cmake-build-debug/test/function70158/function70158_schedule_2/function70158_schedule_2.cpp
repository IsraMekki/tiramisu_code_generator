...
int main(int argc, char **argv){
    tiramisu::init("function70158_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70158/function70158_schedule_2/function70158_schedule_2.o");
