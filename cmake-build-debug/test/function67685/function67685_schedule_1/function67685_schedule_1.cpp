...
int main(int argc, char **argv){
    tiramisu::init("function67685_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67685/function67685_schedule_1/function67685_schedule_1.o");
