...
int main(int argc, char **argv){
    tiramisu::init("function69442_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) + input01(i0) - input02(i1) - input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69442/function69442_no_schedule/function69442_no_schedule.o");
