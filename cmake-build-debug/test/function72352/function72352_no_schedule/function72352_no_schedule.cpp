...
int main(int argc, char **argv){
    tiramisu::init("function72352_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72352/function72352_no_schedule/function72352_no_schedule.o");
