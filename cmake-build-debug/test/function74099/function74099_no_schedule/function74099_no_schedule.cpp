...
int main(int argc, char **argv){
    tiramisu::init("function74099_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74099/function74099_no_schedule/function74099_no_schedule.o");
