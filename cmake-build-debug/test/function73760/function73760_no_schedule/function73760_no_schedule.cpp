...
int main(int argc, char **argv){
    tiramisu::init("function73760_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73760/function73760_no_schedule/function73760_no_schedule.o");
