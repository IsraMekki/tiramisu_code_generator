...
int main(int argc, char **argv){
    tiramisu::init("function66557_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66557/function66557_no_schedule/function66557_no_schedule.o");
