...
int main(int argc, char **argv){
    tiramisu::init("function67842_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67842/function67842_schedule_0/function67842_schedule_0.o");
