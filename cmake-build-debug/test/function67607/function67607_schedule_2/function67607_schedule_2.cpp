...
int main(int argc, char **argv){
    tiramisu::init("function67607_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67607/function67607_schedule_2/function67607_schedule_2.o");
