...
int main(int argc, char **argv){
    tiramisu::init("function64827_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64827/function64827_schedule_0/function64827_schedule_0.o");
