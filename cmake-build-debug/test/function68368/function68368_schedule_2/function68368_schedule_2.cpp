...
int main(int argc, char **argv){
    tiramisu::init("function68368_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68368/function68368_schedule_2/function68368_schedule_2.o");
