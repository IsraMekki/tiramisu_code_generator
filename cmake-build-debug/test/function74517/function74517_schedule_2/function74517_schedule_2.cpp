...
int main(int argc, char **argv){
    tiramisu::init("function74517_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74517/function74517_schedule_2/function74517_schedule_2.o");
