...
int main(int argc, char **argv){
    tiramisu::init("function68821_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2, i3) - input02(i2) - input03(i0) - input04(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68821/function68821_no_schedule/function68821_no_schedule.o");
