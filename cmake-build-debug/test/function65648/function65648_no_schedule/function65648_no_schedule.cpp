...
int main(int argc, char **argv){
    tiramisu::init("function65648_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) + input01(i0, i1, i2) * input02(i0, i3) - input03(i0) + input04(i1, i3) - input05(i0, i2, i3) - input06(i1, i2, i3) * input07(i0, i3) * input08(i3));
    ...
    buffer buf05("buf05", {64, 256, 64}, p_int32, a_input);
    buffer buf06("buf06", {64, 256, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65648/function65648_no_schedule/function65648_no_schedule.o");
