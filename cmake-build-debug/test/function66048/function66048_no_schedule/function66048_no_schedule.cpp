...
int main(int argc, char **argv){
    tiramisu::init("function66048_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66048/function66048_no_schedule/function66048_no_schedule.o");
