...
int main(int argc, char **argv){
    tiramisu::init("function65688_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3, i0) * input01(i0, i2, i3) + input02(i0) + input03(i2) + input04(i2) + input05(i2, i3) * input06(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function65688/function65688_no_schedule/function65688_no_schedule.o");
