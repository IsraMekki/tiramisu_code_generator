...
int main(int argc, char **argv){
    tiramisu::init("function66324_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66324/function66324_no_schedule/function66324_no_schedule.o");
