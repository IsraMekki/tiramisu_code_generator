...
int main(int argc, char **argv){
    tiramisu::init("function71133_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71133/function71133_no_schedule/function71133_no_schedule.o");
