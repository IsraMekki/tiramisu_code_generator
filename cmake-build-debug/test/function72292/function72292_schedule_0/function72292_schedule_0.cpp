...
int main(int argc, char **argv){
    tiramisu::init("function72292_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72292/function72292_schedule_0/function72292_schedule_0.o");
