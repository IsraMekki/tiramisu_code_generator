...
int main(int argc, char **argv){
    tiramisu::init("function72292_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72292/function72292_no_schedule/function72292_no_schedule.o");
