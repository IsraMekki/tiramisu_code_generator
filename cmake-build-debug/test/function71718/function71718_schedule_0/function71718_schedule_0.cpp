...
int main(int argc, char **argv){
    tiramisu::init("function71718_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71718/function71718_schedule_0/function71718_schedule_0.o");
