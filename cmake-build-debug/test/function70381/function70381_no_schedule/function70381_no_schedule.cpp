...
int main(int argc, char **argv){
    tiramisu::init("function70381_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70381/function70381_no_schedule/function70381_no_schedule.o");
