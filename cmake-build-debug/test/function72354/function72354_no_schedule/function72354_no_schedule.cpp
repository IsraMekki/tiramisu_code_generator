...
int main(int argc, char **argv){
    tiramisu::init("function72354_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) + input01(i0, i1, i2) * input02(i3, i2, i1) * input03(i1, i2) + input04(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72354/function72354_no_schedule/function72354_no_schedule.o");
