...
int main(int argc, char **argv){
    tiramisu::init("function70666_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70666/function70666_schedule_2/function70666_schedule_2.o");
