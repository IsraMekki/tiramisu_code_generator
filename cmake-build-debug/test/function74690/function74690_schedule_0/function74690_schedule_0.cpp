...
int main(int argc, char **argv){
    tiramisu::init("function74690_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74690/function74690_schedule_0/function74690_schedule_0.o");
