...
int main(int argc, char **argv){
    tiramisu::init("function69072_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69072/function69072_no_schedule/function69072_no_schedule.o");
