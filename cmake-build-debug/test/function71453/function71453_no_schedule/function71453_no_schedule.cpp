...
int main(int argc, char **argv){
    tiramisu::init("function71453_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71453/function71453_no_schedule/function71453_no_schedule.o");
