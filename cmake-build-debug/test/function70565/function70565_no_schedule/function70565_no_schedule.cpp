...
int main(int argc, char **argv){
    tiramisu::init("function70565_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70565/function70565_no_schedule/function70565_no_schedule.o");
