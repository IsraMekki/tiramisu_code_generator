...
int main(int argc, char **argv){
    tiramisu::init("function67979_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67979/function67979_schedule_2/function67979_schedule_2.o");
