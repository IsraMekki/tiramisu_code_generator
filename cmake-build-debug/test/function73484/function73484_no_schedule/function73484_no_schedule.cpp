...
int main(int argc, char **argv){
    tiramisu::init("function73484_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i1) - input02(i0, i2) - input03(i0, i2) + input04(i0) * input05(i2) + input06(i0, i1) * input07(i1, i2, i3) - input08(i0) * input09(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73484/function73484_no_schedule/function73484_no_schedule.o");
