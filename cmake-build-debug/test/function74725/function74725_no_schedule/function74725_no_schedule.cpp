...
int main(int argc, char **argv){
    tiramisu::init("function74725_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1, i2) - input02(i2) * input03(i1) + input04(i0, i2) * input05(i1, i2) * input06(i2) * input07(i2));
    ...
    buffer buf05("buf05", {4096, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function74725/function74725_no_schedule/function74725_no_schedule.o");
