...
int main(int argc, char **argv){
    tiramisu::init("function74339_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74339/function74339_schedule_1/function74339_schedule_1.o");
