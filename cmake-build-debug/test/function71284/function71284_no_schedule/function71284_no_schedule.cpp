...
int main(int argc, char **argv){
    tiramisu::init("function71284_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71284/function71284_no_schedule/function71284_no_schedule.o");
