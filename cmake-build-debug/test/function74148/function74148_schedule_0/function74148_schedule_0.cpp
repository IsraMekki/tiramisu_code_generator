...
int main(int argc, char **argv){
    tiramisu::init("function74148_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74148/function74148_schedule_0/function74148_schedule_0.o");
