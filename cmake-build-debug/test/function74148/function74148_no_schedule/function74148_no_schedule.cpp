...
int main(int argc, char **argv){
    tiramisu::init("function74148_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74148/function74148_no_schedule/function74148_no_schedule.o");
