...
int main(int argc, char **argv){
    tiramisu::init("function69549_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69549/function69549_no_schedule/function69549_no_schedule.o");
