...
int main(int argc, char **argv){
    tiramisu::init("function70627_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70627/function70627_no_schedule/function70627_no_schedule.o");
