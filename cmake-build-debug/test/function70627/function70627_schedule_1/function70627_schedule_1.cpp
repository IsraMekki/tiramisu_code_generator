...
int main(int argc, char **argv){
    tiramisu::init("function70627_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70627/function70627_schedule_1/function70627_schedule_1.o");
