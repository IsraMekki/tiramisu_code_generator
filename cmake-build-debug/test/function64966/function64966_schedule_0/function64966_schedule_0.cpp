...
int main(int argc, char **argv){
    tiramisu::init("function64966_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64966/function64966_schedule_0/function64966_schedule_0.o");
