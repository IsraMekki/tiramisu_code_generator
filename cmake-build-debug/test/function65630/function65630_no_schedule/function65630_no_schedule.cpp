...
int main(int argc, char **argv){
    tiramisu::init("function65630_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65630/function65630_no_schedule/function65630_no_schedule.o");
