...
int main(int argc, char **argv){
    tiramisu::init("function65630_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65630/function65630_schedule_1/function65630_schedule_1.o");
