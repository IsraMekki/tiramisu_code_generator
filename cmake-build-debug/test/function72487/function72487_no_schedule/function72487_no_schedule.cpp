...
int main(int argc, char **argv){
    tiramisu::init("function72487_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72487/function72487_no_schedule/function72487_no_schedule.o");
