...
int main(int argc, char **argv){
    tiramisu::init("function65751_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65751/function65751_no_schedule/function65751_no_schedule.o");
