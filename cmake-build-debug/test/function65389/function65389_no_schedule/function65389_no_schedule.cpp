...
int main(int argc, char **argv){
    tiramisu::init("function65389_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) + input01(i2) * input02(i3, i0) - input03(i0, i2, i3) * input04(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65389/function65389_no_schedule/function65389_no_schedule.o");
