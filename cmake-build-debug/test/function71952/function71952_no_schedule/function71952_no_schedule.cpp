...
int main(int argc, char **argv){
    tiramisu::init("function71952_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71952/function71952_no_schedule/function71952_no_schedule.o");
