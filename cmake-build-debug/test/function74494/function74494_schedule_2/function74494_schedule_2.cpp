...
int main(int argc, char **argv){
    tiramisu::init("function74494_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74494/function74494_schedule_2/function74494_schedule_2.o");
