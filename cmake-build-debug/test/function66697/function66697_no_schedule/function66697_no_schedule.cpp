...
int main(int argc, char **argv){
    tiramisu::init("function66697_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66697/function66697_no_schedule/function66697_no_schedule.o");
