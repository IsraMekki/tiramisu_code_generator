...
int main(int argc, char **argv){
    tiramisu::init("function73502_no_schedule");
    ...
    input input05("input05", {i3, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i0) + input02(i1, i2, i3) - input03(i2, i3) + input04(i1, i3) - input05(i3, i2) + input06(i0, i1, i3) * input07(i1) * input08(i1, i2, i3) + input09(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73502/function73502_no_schedule/function73502_no_schedule.o");
