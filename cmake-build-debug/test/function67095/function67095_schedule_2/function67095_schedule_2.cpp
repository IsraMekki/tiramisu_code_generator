...
int main(int argc, char **argv){
    tiramisu::init("function67095_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67095/function67095_schedule_2/function67095_schedule_2.o");
