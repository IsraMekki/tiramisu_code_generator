...
int main(int argc, char **argv){
    tiramisu::init("function67095_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67095/function67095_no_schedule/function67095_no_schedule.o");
