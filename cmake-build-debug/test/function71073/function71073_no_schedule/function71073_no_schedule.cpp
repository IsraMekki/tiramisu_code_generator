...
int main(int argc, char **argv){
    tiramisu::init("function71073_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71073/function71073_no_schedule/function71073_no_schedule.o");
