...
int main(int argc, char **argv){
    tiramisu::init("function74164_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i0) * input02(i2) - input03(i2) + input04(i0, i1) + input05(i0) - input06(i1, i2) * input07(i2) + input08(i0) + input09(i0, i1));
    ...
    buffer buf06("buf06", {512, 2048}, p_int32, a_input);
    buffer buf07("buf07", {2048}, p_int32, a_input);
    buffer buf08("buf08", {64}, p_int32, a_input);
    buffer buf09("buf09", {64, 512}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function74164/function74164_no_schedule/function74164_no_schedule.o");
