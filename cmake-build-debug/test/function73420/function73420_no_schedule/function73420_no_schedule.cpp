...
int main(int argc, char **argv){
    tiramisu::init("function73420_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73420/function73420_no_schedule/function73420_no_schedule.o");
