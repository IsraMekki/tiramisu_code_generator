...
int main(int argc, char **argv){
    tiramisu::init("function67479_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67479/function67479_schedule_0/function67479_schedule_0.o");
