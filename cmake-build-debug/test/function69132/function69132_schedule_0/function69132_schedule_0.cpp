...
int main(int argc, char **argv){
    tiramisu::init("function69132_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69132/function69132_schedule_0/function69132_schedule_0.o");
