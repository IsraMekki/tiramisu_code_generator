...
int main(int argc, char **argv){
    tiramisu::init("function70986_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70986/function70986_no_schedule/function70986_no_schedule.o");
