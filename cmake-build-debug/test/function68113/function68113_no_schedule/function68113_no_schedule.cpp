...
int main(int argc, char **argv){
    tiramisu::init("function68113_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68113/function68113_no_schedule/function68113_no_schedule.o");
