...
int main(int argc, char **argv){
    tiramisu::init("function68273_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68273/function68273_schedule_2/function68273_schedule_2.o");
