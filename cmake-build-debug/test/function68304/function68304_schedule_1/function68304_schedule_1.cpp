...
int main(int argc, char **argv){
    tiramisu::init("function68304_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68304/function68304_schedule_1/function68304_schedule_1.o");
