...
int main(int argc, char **argv){
    tiramisu::init("function68119_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68119/function68119_no_schedule/function68119_no_schedule.o");
