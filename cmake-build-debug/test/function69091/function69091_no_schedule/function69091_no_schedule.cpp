...
int main(int argc, char **argv){
    tiramisu::init("function69091_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69091/function69091_no_schedule/function69091_no_schedule.o");
