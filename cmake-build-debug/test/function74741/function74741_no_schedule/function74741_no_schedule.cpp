...
int main(int argc, char **argv){
    tiramisu::init("function74741_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74741/function74741_no_schedule/function74741_no_schedule.o");
