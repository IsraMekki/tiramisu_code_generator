...
int main(int argc, char **argv){
    tiramisu::init("function64900_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) - input01(i0) * input02(i0) * input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64900/function64900_no_schedule/function64900_no_schedule.o");
