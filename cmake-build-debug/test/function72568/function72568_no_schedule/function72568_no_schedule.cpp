...
int main(int argc, char **argv){
    tiramisu::init("function72568_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72568/function72568_no_schedule/function72568_no_schedule.o");
