...
int main(int argc, char **argv){
    tiramisu::init("function72117_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i0, i2) * input02(i0, i2) + input03(i0) - input04(i0) - input05(i0, i2) - input06(i0, i2) + input07(i0, i2) * input08(i0) + input09(i0, i1));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {128, 2048}, p_int32, a_input);
    ...
    buffer buf06("buf06", {128, 2048}, p_int32, a_input);
    buffer buf07("buf07", {128, 2048}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function72117/function72117_no_schedule/function72117_no_schedule.o");
