...
int main(int argc, char **argv){
    tiramisu::init("function67440_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67440/function67440_schedule_0/function67440_schedule_0.o");
