...
int main(int argc, char **argv){
    tiramisu::init("function66948_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66948/function66948_no_schedule/function66948_no_schedule.o");
