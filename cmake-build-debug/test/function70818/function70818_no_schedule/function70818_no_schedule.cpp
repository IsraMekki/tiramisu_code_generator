...
int main(int argc, char **argv){
    tiramisu::init("function70818_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i3) * input02(i1, i2, i3) - input03(i1, i2, i3) - input04(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function70818/function70818_no_schedule/function70818_no_schedule.o");
