...
int main(int argc, char **argv){
    tiramisu::init("function69544_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69544/function69544_no_schedule/function69544_no_schedule.o");
