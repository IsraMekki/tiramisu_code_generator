...
int main(int argc, char **argv){
    tiramisu::init("function67073_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67073/function67073_no_schedule/function67073_no_schedule.o");
