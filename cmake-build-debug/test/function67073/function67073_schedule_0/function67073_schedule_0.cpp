...
int main(int argc, char **argv){
    tiramisu::init("function67073_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67073/function67073_schedule_0/function67073_schedule_0.o");
