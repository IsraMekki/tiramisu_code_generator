...
int main(int argc, char **argv){
    tiramisu::init("function66175_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66175/function66175_no_schedule/function66175_no_schedule.o");
