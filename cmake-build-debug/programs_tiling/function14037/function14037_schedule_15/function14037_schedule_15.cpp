...
int main(int argc, char **argv){
    tiramisu::init("function14037_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) - input01(i0, i1, i2) * input02(i0) * input03(i0) - input04(i0) * input05(i0, i2, i3) + input06(i3) * input07(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14037/function14037_schedule_15/function14037_schedule_15.o");
