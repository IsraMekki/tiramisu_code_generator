...
int main(int argc, char **argv){
    tiramisu::init("function13845_schedule_38");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13845/function13845_schedule_38/function13845_schedule_38.o");
