...
int main(int argc, char **argv){
    tiramisu::init("function13893_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13893/function13893_schedule_10/function13893_schedule_10.o");
