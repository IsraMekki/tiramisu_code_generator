...
int main(int argc, char **argv){
    tiramisu::init("function13761_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13761/function13761_schedule_10/function13761_schedule_10.o");
