...
int main(int argc, char **argv){
    tiramisu::init("function13761_schedule_17");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13761/function13761_schedule_17/function13761_schedule_17.o");
