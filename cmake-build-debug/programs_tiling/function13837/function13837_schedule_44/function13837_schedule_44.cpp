...
int main(int argc, char **argv){
    tiramisu::init("function13837_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) + input01(i0, i1, i2) * input02(i0, i3) + input03(i3) + input04(i3) + input05(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function13837/function13837_schedule_44/function13837_schedule_44.o");
