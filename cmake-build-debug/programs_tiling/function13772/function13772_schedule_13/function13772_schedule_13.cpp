...
int main(int argc, char **argv){
    tiramisu::init("function13772_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i2, i3) * input02(i0, i2, i3) + input03(i2) * input04(i2) + input05(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function13772/function13772_schedule_13/function13772_schedule_13.o");
