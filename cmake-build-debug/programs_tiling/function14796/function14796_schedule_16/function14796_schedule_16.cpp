...
int main(int argc, char **argv){
    tiramisu::init("function14796_schedule_16");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14796/function14796_schedule_16/function14796_schedule_16.o");
