...
int main(int argc, char **argv){
    tiramisu::init("function14318_schedule_14");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14318/function14318_schedule_14/function14318_schedule_14.o");
