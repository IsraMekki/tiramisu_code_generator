...
int main(int argc, char **argv){
    tiramisu::init("function14540_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i1, i2) * input02(i1) - input03(i0) * input04(i0) - input05(i0) - input06(i0, i2) * input07(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14540/function14540_schedule_44/function14540_schedule_44.o");
