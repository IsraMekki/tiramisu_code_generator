...
int main(int argc, char **argv){
    tiramisu::init("function14747_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14747/function14747_no_schedule/function14747_no_schedule.o");
