...
int main(int argc, char **argv){
    tiramisu::init("function14747_schedule_24");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14747/function14747_schedule_24/function14747_schedule_24.o");
