...
int main(int argc, char **argv){
    tiramisu::init("function14730_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) + input01(i0) + input02(i2) + input03(i2) - input04(i1) + input05(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14730/function14730_schedule_26/function14730_schedule_26.o");
