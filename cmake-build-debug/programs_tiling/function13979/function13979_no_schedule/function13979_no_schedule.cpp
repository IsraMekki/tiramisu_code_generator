...
int main(int argc, char **argv){
    tiramisu::init("function13979_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13979/function13979_no_schedule/function13979_no_schedule.o");
