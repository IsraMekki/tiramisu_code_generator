...
int main(int argc, char **argv){
    tiramisu::init("function14440_schedule_14");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14440/function14440_schedule_14/function14440_schedule_14.o");
