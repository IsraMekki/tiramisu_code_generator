...
int main(int argc, char **argv){
    tiramisu::init("function13971_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13971/function13971_schedule_2/function13971_schedule_2.o");
