...
int main(int argc, char **argv){
    tiramisu::init("function13918_schedule_26");

    constant c0("c0", 64), c1("c1", 256), c2("c2", 4096);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i1) * input02(i1, i2) + input03(i1) * input04(i1, i2) - input05(i1) - input06(i0, i1) + input07(i1, i2) + input08(i2) - input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function13918/function13918_schedule_26/function13918_schedule_26.o");
