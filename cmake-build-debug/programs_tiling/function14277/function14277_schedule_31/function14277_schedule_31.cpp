...
int main(int argc, char **argv){
    tiramisu::init("function14277_schedule_31");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14277/function14277_schedule_31/function14277_schedule_31.o");
