...
int main(int argc, char **argv){
    tiramisu::init("function13989_schedule_7");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13989/function13989_schedule_7/function13989_schedule_7.o");
