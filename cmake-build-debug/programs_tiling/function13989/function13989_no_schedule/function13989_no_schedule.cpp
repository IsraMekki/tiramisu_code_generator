...
int main(int argc, char **argv){
    tiramisu::init("function13989_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13989/function13989_no_schedule/function13989_no_schedule.o");
