...
int main(int argc, char **argv){
    tiramisu::init("function13989_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13989/function13989_schedule_6/function13989_schedule_6.o");
