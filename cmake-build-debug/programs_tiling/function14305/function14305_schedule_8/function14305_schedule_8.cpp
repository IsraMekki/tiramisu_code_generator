...
int main(int argc, char **argv){
    tiramisu::init("function14305_schedule_8");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14305/function14305_schedule_8/function14305_schedule_8.o");
