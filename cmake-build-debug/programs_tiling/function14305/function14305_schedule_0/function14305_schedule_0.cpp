...
int main(int argc, char **argv){
    tiramisu::init("function14305_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14305/function14305_schedule_0/function14305_schedule_0.o");
