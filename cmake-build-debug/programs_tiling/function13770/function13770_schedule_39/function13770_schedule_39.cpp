...
int main(int argc, char **argv){
    tiramisu::init("function13770_schedule_39");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13770/function13770_schedule_39/function13770_schedule_39.o");
