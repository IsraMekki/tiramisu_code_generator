...
int main(int argc, char **argv){
    tiramisu::init("function13770_schedule_15");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13770/function13770_schedule_15/function13770_schedule_15.o");
