...
int main(int argc, char **argv){
    tiramisu::init("function14672_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) + input01(i0) - input02(i2) + input03(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14672/function14672_schedule_44/function14672_schedule_44.o");
