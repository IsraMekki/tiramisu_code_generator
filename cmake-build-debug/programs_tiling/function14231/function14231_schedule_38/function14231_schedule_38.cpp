...
int main(int argc, char **argv){
    tiramisu::init("function14231_schedule_38");
    ...
    input input09("input09", {i3, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i0, i1) + input02(i2, i3) + input03(i0, i2, i3) - input04(i3) - input05(i3) - input06(i2, i3) * input07(i1) + input08(i1, i3) * input09(i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14231/function14231_schedule_38/function14231_schedule_38.o");
