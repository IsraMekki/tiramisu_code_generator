...
int main(int argc, char **argv){
    tiramisu::init("function14775_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i0, i2) - input02(i1) * input03(i0, i1) + input04(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14775/function14775_schedule_26/function14775_schedule_26.o");
