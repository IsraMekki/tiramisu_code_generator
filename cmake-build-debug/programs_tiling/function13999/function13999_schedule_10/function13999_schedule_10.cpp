...
int main(int argc, char **argv){
    tiramisu::init("function13999_schedule_10");
    ...
    comp0.tile(i101, i102, i103, 32, 32, 64, i01, i02, i03, i04, i05, i06);
    comp0.parallelize(i100);
    
    buffer buf00("buf00", {64, 64, 128, 128}, p_int32, a_input);
    buffer buf0("buf0", {64, 64, 128, 128}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13999/function13999_schedule_10/function13999_schedule_10.o");
