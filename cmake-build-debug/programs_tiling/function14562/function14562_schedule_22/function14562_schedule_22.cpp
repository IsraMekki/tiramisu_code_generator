...
int main(int argc, char **argv){
    tiramisu::init("function14562_schedule_22");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14562/function14562_schedule_22/function14562_schedule_22.o");
