...
int main(int argc, char **argv){
    tiramisu::init("function13928_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13928/function13928_no_schedule/function13928_no_schedule.o");
