...
int main(int argc, char **argv){
    tiramisu::init("function13928_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13928/function13928_schedule_20/function13928_schedule_20.o");
