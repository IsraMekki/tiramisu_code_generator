...
int main(int argc, char **argv){
    tiramisu::init("function14558_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14558/function14558_schedule_6/function14558_schedule_6.o");
