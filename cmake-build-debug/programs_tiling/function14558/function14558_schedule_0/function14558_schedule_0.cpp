...
int main(int argc, char **argv){
    tiramisu::init("function14558_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14558/function14558_schedule_0/function14558_schedule_0.o");
