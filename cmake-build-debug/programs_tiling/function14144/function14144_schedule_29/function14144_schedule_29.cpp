...
int main(int argc, char **argv){
    tiramisu::init("function14144_schedule_29");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14144/function14144_schedule_29/function14144_schedule_29.o");
