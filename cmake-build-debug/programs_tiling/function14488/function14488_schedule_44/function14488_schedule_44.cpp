...
int main(int argc, char **argv){
    tiramisu::init("function14488_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i0) + input02(i1) - input03(i1) * input04(i1, i2) + input05(i0, i2) + input06(i1, i2) - input07(i0, i1) * input08(i2) - input09(i1, i2));
    ...
    buffer buf05("buf05", {128, 256}, p_int32, a_input);
    buffer buf06("buf06", {1024, 256}, p_int32, a_input);
    buffer buf07("buf07", {128, 1024}, p_int32, a_input);
    buffer buf08("buf08", {256}, p_int32, a_input);
    buffer buf09("buf09", {1024, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14488/function14488_schedule_44/function14488_schedule_44.o");
