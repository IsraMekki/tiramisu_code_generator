...
int main(int argc, char **argv){
    tiramisu::init("function14553_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14553/function14553_schedule_10/function14553_schedule_10.o");
