...
int main(int argc, char **argv){
    tiramisu::init("function14726_schedule_39");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i3) * input02(i0, i1, i3) * input03(i3, i2) * input04(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14726/function14726_schedule_39/function14726_schedule_39.o");
