...
int main(int argc, char **argv){
    tiramisu::init("function14328_schedule_21");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14328/function14328_schedule_21/function14328_schedule_21.o");
