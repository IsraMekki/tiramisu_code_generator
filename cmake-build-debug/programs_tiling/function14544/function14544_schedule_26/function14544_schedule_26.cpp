...
int main(int argc, char **argv){
    tiramisu::init("function14544_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) * input01(i0, i2) * input02(i1, i2) * input03(i1, i2) - input04(i1, i2) * input05(i0, i1) + input06(i2) + input07(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14544/function14544_schedule_26/function14544_schedule_26.o");
