...
int main(int argc, char **argv){
    tiramisu::init("function14287_schedule_47");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) * input01(i0, i2, i3) * input02(i0, i1, i3) - input03(i3) * input04(i0, i1) + input05(i0, i1) * input06(i0, i1, i3) + input07(i1, i2, i3));
    
    comp0.tile(i1, i2, i3, 128, 64, 128, i01, i02, i03, i04, i05, i06);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14287/function14287_schedule_47/function14287_schedule_47.o");
