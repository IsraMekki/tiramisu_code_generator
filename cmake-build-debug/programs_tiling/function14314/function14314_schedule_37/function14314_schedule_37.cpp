...
int main(int argc, char **argv){
    tiramisu::init("function14314_schedule_37");
    ...
    input input00("input00", {i2, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i0) - input01(i0, i2) * input02(i2) * input03(i0, i1, i3) + input04(i1) * input05(i0, i2) * input06(i0, i1) + input07(i1) - input08(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14314/function14314_schedule_37/function14314_schedule_37.o");
