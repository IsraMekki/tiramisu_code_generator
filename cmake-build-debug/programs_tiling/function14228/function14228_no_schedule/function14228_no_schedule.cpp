...
int main(int argc, char **argv){
    tiramisu::init("function14228_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14228/function14228_no_schedule/function14228_no_schedule.o");
