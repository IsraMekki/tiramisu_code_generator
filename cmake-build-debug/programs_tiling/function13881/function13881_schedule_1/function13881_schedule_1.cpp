...
int main(int argc, char **argv){
    tiramisu::init("function13881_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13881/function13881_schedule_1/function13881_schedule_1.o");
