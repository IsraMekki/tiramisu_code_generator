...
int main(int argc, char **argv){
    tiramisu::init("function14393_schedule_35");
    ...
    input input06("input06", {i3, i1, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i2, i3) * input02(i2) + input03(i3) * input04(i0, i2) - input05(i2) + input06(i3, i1, i0) - input07(i0, i3) - input08(i1) + input09(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14393/function14393_schedule_35/function14393_schedule_35.o");
