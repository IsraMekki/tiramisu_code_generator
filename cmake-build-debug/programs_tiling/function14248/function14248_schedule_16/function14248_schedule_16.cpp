...
int main(int argc, char **argv){
    tiramisu::init("function14248_schedule_16");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14248/function14248_schedule_16/function14248_schedule_16.o");
