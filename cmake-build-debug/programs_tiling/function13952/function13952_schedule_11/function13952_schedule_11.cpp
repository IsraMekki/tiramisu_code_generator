...
int main(int argc, char **argv){
    tiramisu::init("function13952_schedule_11");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13952/function13952_schedule_11/function13952_schedule_11.o");
