...
int main(int argc, char **argv){
    tiramisu::init("function13952_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13952/function13952_no_schedule/function13952_no_schedule.o");
