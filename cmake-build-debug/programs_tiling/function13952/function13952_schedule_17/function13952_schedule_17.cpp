...
int main(int argc, char **argv){
    tiramisu::init("function13952_schedule_17");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1, i2) * input02(i0, i2) + input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13952/function13952_schedule_17/function13952_schedule_17.o");
