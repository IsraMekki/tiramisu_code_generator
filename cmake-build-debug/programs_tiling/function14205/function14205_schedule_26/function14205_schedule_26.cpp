...
int main(int argc, char **argv){
    tiramisu::init("function14205_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i2) * input02(i1) * input03(i2) * input04(i0) + input05(i1, i2) + input06(i1) * input07(i1, i2) + input08(i1, i2) * input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14205/function14205_schedule_26/function14205_schedule_26.o");
