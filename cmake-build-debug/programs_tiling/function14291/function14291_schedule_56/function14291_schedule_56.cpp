...
int main(int argc, char **argv){
    tiramisu::init("function14291_schedule_56");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) - input01(i1) * input02(i1, i2, i3) - input03(i0) + input04(i0) * input05(i0, i1) + input06(i0, i1, i2) + input07(i3) - input08(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14291/function14291_schedule_56/function14291_schedule_56.o");
