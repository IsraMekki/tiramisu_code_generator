...
int main(int argc, char **argv){
    tiramisu::init("function14185_schedule_32");
    ...
    buffer buf00("buf00", {128, 256, 1024}, p_int32, a_input);
    buffer buf0("buf0", {128, 256, 1024}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14185/function14185_schedule_32/function14185_schedule_32.o");
