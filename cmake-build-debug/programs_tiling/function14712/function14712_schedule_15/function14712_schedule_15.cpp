...
int main(int argc, char **argv){
    tiramisu::init("function14712_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) + input01(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14712/function14712_schedule_15/function14712_schedule_15.o");
