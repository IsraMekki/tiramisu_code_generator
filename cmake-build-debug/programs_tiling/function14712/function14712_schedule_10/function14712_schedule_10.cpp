...
int main(int argc, char **argv){
    tiramisu::init("function14712_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14712/function14712_schedule_10/function14712_schedule_10.o");
