...
int main(int argc, char **argv){
    tiramisu::init("function14522_schedule_15");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14522/function14522_schedule_15/function14522_schedule_15.o");
