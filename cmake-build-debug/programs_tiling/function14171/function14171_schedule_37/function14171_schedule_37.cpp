...
int main(int argc, char **argv){
    tiramisu::init("function14171_schedule_37");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i3) * input02(i2) - input03(i0, i1, i2) * input04(i1, i3) - input05(i3) + input06(i1, i3) * input07(i1, i2, i3) * input08(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14171/function14171_schedule_37/function14171_schedule_37.o");
