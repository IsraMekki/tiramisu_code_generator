...
int main(int argc, char **argv){
    tiramisu::init("function14504_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14504/function14504_schedule_2/function14504_schedule_2.o");
