...
int main(int argc, char **argv){
    tiramisu::init("function14182_schedule_18");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14182/function14182_schedule_18/function14182_schedule_18.o");
