...
int main(int argc, char **argv){
    tiramisu::init("function14767_schedule_32");
    ...
    buffer buf00("buf00", {128, 512, 512}, p_int32, a_input);
    buffer buf0("buf0", {128, 512, 512}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14767/function14767_schedule_32/function14767_schedule_32.o");
