...
int main(int argc, char **argv){
    tiramisu::init("function14011_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) * input01(i1, i2, i3) - input02(i0, i2, i3) + input03(i2, i3) - input04(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14011/function14011_schedule_26/function14011_schedule_26.o");
