...
int main(int argc, char **argv){
    tiramisu::init("function14011_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14011/function14011_schedule_20/function14011_schedule_20.o");
