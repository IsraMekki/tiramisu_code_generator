...
int main(int argc, char **argv){
    tiramisu::init("function14545_schedule_28");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14545/function14545_schedule_28/function14545_schedule_28.o");
