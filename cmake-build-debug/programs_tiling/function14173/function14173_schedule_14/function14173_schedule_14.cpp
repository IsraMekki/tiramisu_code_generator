...
int main(int argc, char **argv){
    tiramisu::init("function14173_schedule_14");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14173/function14173_schedule_14/function14173_schedule_14.o");
