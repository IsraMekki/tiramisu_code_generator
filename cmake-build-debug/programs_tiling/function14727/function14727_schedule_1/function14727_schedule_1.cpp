...
int main(int argc, char **argv){
    tiramisu::init("function14727_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14727/function14727_schedule_1/function14727_schedule_1.o");
