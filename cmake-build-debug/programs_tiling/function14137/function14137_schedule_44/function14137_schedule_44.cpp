...
int main(int argc, char **argv){
    tiramisu::init("function14137_schedule_44");
    ...
    input input03("input03", {i2, i1, i3}, p_int32);

    input input04("input04", {i1}, p_int32);

    input input05("input05", {i3}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i0) + input02(i1) * input03(i2, i1, i3) - input04(i1) - input05(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14137/function14137_schedule_44/function14137_schedule_44.o");
