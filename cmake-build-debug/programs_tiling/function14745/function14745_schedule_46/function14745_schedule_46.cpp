...
int main(int argc, char **argv){
    tiramisu::init("function14745_schedule_46");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) - input01(i3) + input02(i1, i2, i3) * input03(i1) + input04(i0, i2, i3) - input05(i2) * input06(i2) * input07(i1) + input08(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14745/function14745_schedule_46/function14745_schedule_46.o");
