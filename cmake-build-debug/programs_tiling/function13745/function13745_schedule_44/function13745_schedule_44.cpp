...
int main(int argc, char **argv){
    tiramisu::init("function13745_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i0, i1) - input02(i1) * input03(i0, i1) - input04(i0, i1) * input05(i0) - input06(i1) - input07(i1) - input08(i0) - input09(i0, i1));
    ...
    buffer buf03("buf03", {256, 1024}, p_int32, a_input);
    ...
    buffer buf09("buf09", {256, 1024}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function13745/function13745_schedule_44/function13745_schedule_44.o");
