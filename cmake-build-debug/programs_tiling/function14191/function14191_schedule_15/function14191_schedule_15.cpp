...
int main(int argc, char **argv){
    tiramisu::init("function14191_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) - input01(i2, i1, i3) * input02(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14191/function14191_schedule_15/function14191_schedule_15.o");
