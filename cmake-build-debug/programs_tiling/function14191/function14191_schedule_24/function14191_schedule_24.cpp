...
int main(int argc, char **argv){
    tiramisu::init("function14191_schedule_24");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14191/function14191_schedule_24/function14191_schedule_24.o");
