...
int main(int argc, char **argv){
    tiramisu::init("function13820_schedule_3");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13820/function13820_schedule_3/function13820_schedule_3.o");
