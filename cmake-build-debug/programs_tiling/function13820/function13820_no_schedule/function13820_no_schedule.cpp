...
int main(int argc, char **argv){
    tiramisu::init("function13820_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13820/function13820_no_schedule/function13820_no_schedule.o");
