...
int main(int argc, char **argv){
    tiramisu::init("function13820_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13820/function13820_schedule_2/function13820_schedule_2.o");
