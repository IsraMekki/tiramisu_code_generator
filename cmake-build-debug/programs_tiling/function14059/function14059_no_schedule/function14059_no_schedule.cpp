...
int main(int argc, char **argv){
    tiramisu::init("function14059_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14059/function14059_no_schedule/function14059_no_schedule.o");
