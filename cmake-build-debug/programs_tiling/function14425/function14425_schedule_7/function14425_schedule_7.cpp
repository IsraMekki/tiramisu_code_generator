...
int main(int argc, char **argv){
    tiramisu::init("function14425_schedule_7");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14425/function14425_schedule_7/function14425_schedule_7.o");
