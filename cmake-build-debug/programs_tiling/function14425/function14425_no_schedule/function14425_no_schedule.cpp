...
int main(int argc, char **argv){
    tiramisu::init("function14425_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14425/function14425_no_schedule/function14425_no_schedule.o");
