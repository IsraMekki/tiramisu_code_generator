...
int main(int argc, char **argv){
    tiramisu::init("function13765_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13765/function13765_no_schedule/function13765_no_schedule.o");
