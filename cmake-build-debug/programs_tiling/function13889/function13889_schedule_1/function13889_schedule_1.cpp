...
int main(int argc, char **argv){
    tiramisu::init("function13889_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13889/function13889_schedule_1/function13889_schedule_1.o");
