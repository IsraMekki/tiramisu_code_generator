...
int main(int argc, char **argv){
    tiramisu::init("function14439_schedule_31");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14439/function14439_schedule_31/function14439_schedule_31.o");
