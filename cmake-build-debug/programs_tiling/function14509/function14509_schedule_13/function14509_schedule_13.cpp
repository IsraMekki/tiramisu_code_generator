...
int main(int argc, char **argv){
    tiramisu::init("function14509_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) + input01(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14509/function14509_schedule_13/function14509_schedule_13.o");
