...
int main(int argc, char **argv){
    tiramisu::init("function14509_schedule_27");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14509/function14509_schedule_27/function14509_schedule_27.o");
