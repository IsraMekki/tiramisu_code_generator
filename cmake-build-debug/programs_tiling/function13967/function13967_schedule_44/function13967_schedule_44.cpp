...
int main(int argc, char **argv){
    tiramisu::init("function13967_schedule_44");
    ...
    input input03("input03", {i3, i0, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) - input01(i0, i1, i2) * input02(i0) - input03(i3, i0, i1) - input04(i0, i1) - input05(i1, i2) * input06(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function13967/function13967_schedule_44/function13967_schedule_44.o");
