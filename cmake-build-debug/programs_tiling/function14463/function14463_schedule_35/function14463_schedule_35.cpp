...
int main(int argc, char **argv){
    tiramisu::init("function14463_schedule_35");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14463/function14463_schedule_35/function14463_schedule_35.o");
