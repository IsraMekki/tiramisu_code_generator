...
int main(int argc, char **argv){
    tiramisu::init("function14379_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i1) - input02(i2) + input03(i0, i2, i3) + input04(i1, i2) + input05(i0, i3) + input06(i1) + input07(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14379/function14379_schedule_44/function14379_schedule_44.o");
