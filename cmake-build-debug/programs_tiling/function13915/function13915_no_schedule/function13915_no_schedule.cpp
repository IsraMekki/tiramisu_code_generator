...
int main(int argc, char **argv){
    tiramisu::init("function13915_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13915/function13915_no_schedule/function13915_no_schedule.o");
