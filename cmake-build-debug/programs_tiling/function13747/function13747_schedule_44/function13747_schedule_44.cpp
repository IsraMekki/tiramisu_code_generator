...
int main(int argc, char **argv){
    tiramisu::init("function13747_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i0, i2) * input02(i0, i1) - input03(i0, i2) + input04(i0, i2) + input05(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function13747/function13747_schedule_44/function13747_schedule_44.o");
