...
int main(int argc, char **argv){
    tiramisu::init("function14151_schedule_13");
    ...
    buffer buf00("buf00", {512, 64, 1024}, p_int32, a_input);
    buffer buf0("buf0", {512, 64, 1024}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14151/function14151_schedule_13/function14151_schedule_13.o");
