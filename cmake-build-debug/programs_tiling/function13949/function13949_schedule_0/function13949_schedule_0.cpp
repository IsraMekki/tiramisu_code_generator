...
int main(int argc, char **argv){
    tiramisu::init("function13949_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13949/function13949_schedule_0/function13949_schedule_0.o");
