...
int main(int argc, char **argv){
    tiramisu::init("function13949_schedule_4");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13949/function13949_schedule_4/function13949_schedule_4.o");
