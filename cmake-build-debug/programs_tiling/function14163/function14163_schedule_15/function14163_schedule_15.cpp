...
int main(int argc, char **argv){
    tiramisu::init("function14163_schedule_15");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14163/function14163_schedule_15/function14163_schedule_15.o");
