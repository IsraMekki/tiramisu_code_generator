...
int main(int argc, char **argv){
    tiramisu::init("function13867_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13867/function13867_schedule_20/function13867_schedule_20.o");
