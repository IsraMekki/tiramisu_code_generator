...
int main(int argc, char **argv){
    tiramisu::init("function13867_schedule_32");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13867/function13867_schedule_32/function13867_schedule_32.o");
