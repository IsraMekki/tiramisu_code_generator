...
int main(int argc, char **argv){
    tiramisu::init("function13867_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13867/function13867_no_schedule/function13867_no_schedule.o");
