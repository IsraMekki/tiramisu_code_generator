...
int main(int argc, char **argv){
    tiramisu::init("function13854_schedule_33");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13854/function13854_schedule_33/function13854_schedule_33.o");
