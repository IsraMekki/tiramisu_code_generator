...
int main(int argc, char **argv){
    tiramisu::init("function13854_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13854/function13854_no_schedule/function13854_no_schedule.o");
