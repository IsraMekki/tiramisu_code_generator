...
int main(int argc, char **argv){
    tiramisu::init("function13854_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13854/function13854_schedule_6/function13854_schedule_6.o");
