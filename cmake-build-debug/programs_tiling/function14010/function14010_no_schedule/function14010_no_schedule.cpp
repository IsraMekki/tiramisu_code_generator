...
int main(int argc, char **argv){
    tiramisu::init("function14010_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14010/function14010_no_schedule/function14010_no_schedule.o");
