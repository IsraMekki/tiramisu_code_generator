...
int main(int argc, char **argv){
    tiramisu::init("function14253_schedule_12");
    ...
    buffer buf00("buf00", {1024, 64, 512}, p_int32, a_input);
    buffer buf0("buf0", {1024, 64, 512}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14253/function14253_schedule_12/function14253_schedule_12.o");
