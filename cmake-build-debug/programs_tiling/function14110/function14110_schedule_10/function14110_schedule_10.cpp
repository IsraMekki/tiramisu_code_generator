...
int main(int argc, char **argv){
    tiramisu::init("function14110_schedule_10");
    ...
    buffer buf00("buf00", {64, 128, 128, 64}, p_int32, a_input);
    buffer buf0("buf0", {64, 128, 128, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14110/function14110_schedule_10/function14110_schedule_10.o");
