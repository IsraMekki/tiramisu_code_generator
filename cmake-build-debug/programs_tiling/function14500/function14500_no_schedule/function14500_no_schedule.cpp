...
int main(int argc, char **argv){
    tiramisu::init("function14500_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) + input01(i1) - input02(i2) - input03(i1) + input04(i0, i2) - input05(i1, i2) + input06(i1, i2) - input07(i0, i2) + input08(i1) * input09(i0, i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64, 16384}, p_int32, a_input);
    ...
    buffer buf06("buf06", {16384, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14500/function14500_no_schedule/function14500_no_schedule.o");
