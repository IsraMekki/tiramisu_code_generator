...
int main(int argc, char **argv){
    tiramisu::init("function14106_schedule_25");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i1, i3) - input02(i0) * input03(i0, i3) + input04(i0, i1) + input05(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14106/function14106_schedule_25/function14106_schedule_25.o");
