...
int main(int argc, char **argv){
    tiramisu::init("function14358_schedule_18");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) * input01(i2) + input02(i1, i2, i3) * input03(i1, i2, i3) * input04(i3) + input05(i2) + input06(i1, i2, i3) - input07(i3) + input08(i0) + input09(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14358/function14358_schedule_18/function14358_schedule_18.o");
