...
int main(int argc, char **argv){
    tiramisu::init("function14225_schedule_16");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14225/function14225_schedule_16/function14225_schedule_16.o");
