...
int main(int argc, char **argv){
    tiramisu::init("function14028_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14028/function14028_schedule_1/function14028_schedule_1.o");
