...
int main(int argc, char **argv){
    tiramisu::init("function14368_schedule_11");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i0, i1) - input02(i0) - input03(i0) + input04(i0) + input05(i1, i2));
    
    comp0.tile(i1, i2, 128, 64, i01, i02, i03, i04);
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64}, p_int32, a_input);
    buffer buf01("buf01", {64, 16384}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14368/function14368_schedule_11/function14368_schedule_11.o");
