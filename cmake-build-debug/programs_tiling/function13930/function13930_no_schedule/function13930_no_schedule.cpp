...
int main(int argc, char **argv){
    tiramisu::init("function13930_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13930/function13930_no_schedule/function13930_no_schedule.o");
