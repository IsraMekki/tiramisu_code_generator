...
int main(int argc, char **argv){
    tiramisu::init("function13778_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13778/function13778_no_schedule/function13778_no_schedule.o");
