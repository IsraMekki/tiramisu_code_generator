...
int main(int argc, char **argv){
    tiramisu::init("function14692_schedule_29");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) + input01(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14692/function14692_schedule_29/function14692_schedule_29.o");
