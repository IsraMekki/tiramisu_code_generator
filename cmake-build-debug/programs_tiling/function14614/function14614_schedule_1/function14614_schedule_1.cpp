...
int main(int argc, char **argv){
    tiramisu::init("function14614_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14614/function14614_schedule_1/function14614_schedule_1.o");
