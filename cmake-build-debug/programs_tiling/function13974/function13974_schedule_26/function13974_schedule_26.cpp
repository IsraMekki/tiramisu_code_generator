...
int main(int argc, char **argv){
    tiramisu::init("function13974_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i0, i1) - input02(i0, i1) - input03(i0) - input04(i2) - input05(i1, i2) + input06(i0, i2) - input07(i0, i1) * input08(i0));
    
    comp0.tile(i0, i1, i2, 128, 32, 128, i01, i02, i03, i04, i05, i06);
    comp0.parallelize(i01);
    
    buffer buf00("buf00", {4096, 64}, p_int32, a_input);
    buffer buf01("buf01", {4096, 64}, p_int32, a_input);
    buffer buf02("buf02", {4096, 64}, p_int32, a_input);
    buffer buf03("buf03", {4096}, p_int32, a_input);
    buffer buf04("buf04", {256}, p_int32, a_input);
    buffer buf05("buf05", {64, 256}, p_int32, a_input);
    buffer buf06("buf06", {4096, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function13974/function13974_schedule_26/function13974_schedule_26.o");
