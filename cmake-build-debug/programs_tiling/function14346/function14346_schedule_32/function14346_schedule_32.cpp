...
int main(int argc, char **argv){
    tiramisu::init("function14346_schedule_32");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) + input01(i0, i2, i3) - input02(i3, i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14346/function14346_schedule_32/function14346_schedule_32.o");
