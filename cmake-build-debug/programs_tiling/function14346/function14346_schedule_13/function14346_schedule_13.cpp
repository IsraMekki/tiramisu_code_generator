...
int main(int argc, char **argv){
    tiramisu::init("function14346_schedule_13");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14346/function14346_schedule_13/function14346_schedule_13.o");
