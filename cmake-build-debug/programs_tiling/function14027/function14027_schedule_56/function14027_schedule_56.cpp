...
int main(int argc, char **argv){
    tiramisu::init("function14027_schedule_56");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) - input01(i0, i1) + input02(i3) + input03(i1, i2) * input04(i0, i1, i2) - input05(i0) + input06(i1, i2, i3) - input07(i3, i2, i1) - input08(i0, i1, i2));
    ...
    buffer buf08("buf08", {64, 128, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14027/function14027_schedule_56/function14027_schedule_56.o");
