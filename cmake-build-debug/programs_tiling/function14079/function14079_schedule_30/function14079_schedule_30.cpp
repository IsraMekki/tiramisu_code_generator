...
int main(int argc, char **argv){
    tiramisu::init("function14079_schedule_30");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14079/function14079_schedule_30/function14079_schedule_30.o");
