...
int main(int argc, char **argv){
    tiramisu::init("function14079_schedule_41");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14079/function14079_schedule_41/function14079_schedule_41.o");
