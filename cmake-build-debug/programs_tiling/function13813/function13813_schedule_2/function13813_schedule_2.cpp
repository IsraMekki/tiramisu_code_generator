...
int main(int argc, char **argv){
    tiramisu::init("function13813_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13813/function13813_schedule_2/function13813_schedule_2.o");
