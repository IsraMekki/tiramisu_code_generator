...
int main(int argc, char **argv){
    tiramisu::init("function14272_schedule_4");
    ...
    buffer buf00("buf00", {262144, 256}, p_int32, a_input);
    buffer buf0("buf0", {262144, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14272/function14272_schedule_4/function14272_schedule_4.o");
