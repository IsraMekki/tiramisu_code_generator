...
int main(int argc, char **argv){
    tiramisu::init("function14629_schedule_39");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2) + input02(i1, i2, i3) + input03(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14629/function14629_schedule_39/function14629_schedule_39.o");
