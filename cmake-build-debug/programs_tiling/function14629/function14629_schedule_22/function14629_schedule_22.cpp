...
int main(int argc, char **argv){
    tiramisu::init("function14629_schedule_22");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14629/function14629_schedule_22/function14629_schedule_22.o");
