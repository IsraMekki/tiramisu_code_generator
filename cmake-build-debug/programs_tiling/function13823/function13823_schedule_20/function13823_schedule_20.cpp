...
int main(int argc, char **argv){
    tiramisu::init("function13823_schedule_20");
    ...
    buffer buf00("buf00", {512, 2048, 64}, p_int32, a_input);
    buffer buf0("buf0", {512, 2048, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13823/function13823_schedule_20/function13823_schedule_20.o");
