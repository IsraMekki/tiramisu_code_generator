...
int main(int argc, char **argv){
    tiramisu::init("function14464_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2) - input01(i0, i1, i3) * input02(i2, i3) + input03(i2, i3) * input04(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14464/function14464_schedule_15/function14464_schedule_15.o");
