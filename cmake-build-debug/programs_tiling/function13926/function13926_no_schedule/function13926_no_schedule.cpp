...
int main(int argc, char **argv){
    tiramisu::init("function13926_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13926/function13926_no_schedule/function13926_no_schedule.o");
