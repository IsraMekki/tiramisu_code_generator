...
int main(int argc, char **argv){
    tiramisu::init("function13926_schedule_30");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13926/function13926_schedule_30/function13926_schedule_30.o");
