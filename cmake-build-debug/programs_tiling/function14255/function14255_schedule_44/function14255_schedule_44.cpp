...
int main(int argc, char **argv){
    tiramisu::init("function14255_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i1) + input02(i1) - input03(i1, i2) - input04(i1, i2) - input05(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14255/function14255_schedule_44/function14255_schedule_44.o");
