...
int main(int argc, char **argv){
    tiramisu::init("function14569_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i1, i3) * input02(i2, i1, i0) + input03(i3) + input04(i3) + input05(i1, i3) - input06(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14569/function14569_schedule_36/function14569_schedule_36.o");
