...
int main(int argc, char **argv){
    tiramisu::init("function13784_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) + input01(i2, i0) * input02(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13784/function13784_schedule_44/function13784_schedule_44.o");
