...
int main(int argc, char **argv){
    tiramisu::init("function13784_schedule_43");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13784/function13784_schedule_43/function13784_schedule_43.o");
