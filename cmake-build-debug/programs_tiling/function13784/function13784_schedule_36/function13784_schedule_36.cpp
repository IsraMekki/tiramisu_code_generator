...
int main(int argc, char **argv){
    tiramisu::init("function13784_schedule_36");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13784/function13784_schedule_36/function13784_schedule_36.o");
