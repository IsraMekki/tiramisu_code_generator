...
int main(int argc, char **argv){
    tiramisu::init("function13784_schedule_17");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13784/function13784_schedule_17/function13784_schedule_17.o");
