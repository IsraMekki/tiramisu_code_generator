...
int main(int argc, char **argv){
    tiramisu::init("function14301_schedule_37");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i0, i2, i3) + input02(i1, i2, i3) - input03(i0, i1) * input04(i1, i3) + input05(i0, i1, i2) - input06(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14301/function14301_schedule_37/function14301_schedule_37.o");
