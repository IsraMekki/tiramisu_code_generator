...
int main(int argc, char **argv){
    tiramisu::init("function14332_schedule_13");
    ...
    input input03("input03", {i1, i0, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) + input01(i1, i2, i3) + input02(i0, i1, i2) - input03(i1, i0, i2) - input04(i1, i2, i3) - input05(i1, i2, i3) + input06(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14332/function14332_schedule_13/function14332_schedule_13.o");
