...
int main(int argc, char **argv){
    tiramisu::init("function13896_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) - input01(i1) + input02(i0, i2) - input03(i1, i2) + input04(i1, i2) * input05(i0, i2) - input06(i1, i2));
    ...
    buffer buf05("buf05", {8192, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function13896/function13896_schedule_26/function13896_schedule_26.o");
