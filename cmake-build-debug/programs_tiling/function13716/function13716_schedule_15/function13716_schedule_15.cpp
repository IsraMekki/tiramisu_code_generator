...
int main(int argc, char **argv){
    tiramisu::init("function13716_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) * input01(i0, i2, i3) - input02(i0, i1, i2) - input03(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13716/function13716_schedule_15/function13716_schedule_15.o");
