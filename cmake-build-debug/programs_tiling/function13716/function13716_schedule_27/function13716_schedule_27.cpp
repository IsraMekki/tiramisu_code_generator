...
int main(int argc, char **argv){
    tiramisu::init("function13716_schedule_27");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13716/function13716_schedule_27/function13716_schedule_27.o");
