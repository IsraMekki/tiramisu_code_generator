...
int main(int argc, char **argv){
    tiramisu::init("function14031_schedule_20");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) - input01(i1, i2) * input02(i1, i2) - input03(i2) + input04(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14031/function14031_schedule_20/function14031_schedule_20.o");
