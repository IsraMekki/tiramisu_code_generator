...
int main(int argc, char **argv){
    tiramisu::init("function14143_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14143/function14143_no_schedule/function14143_no_schedule.o");
