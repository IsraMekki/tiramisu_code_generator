...
int main(int argc, char **argv){
    tiramisu::init("function14143_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14143/function14143_schedule_2/function14143_schedule_2.o");
