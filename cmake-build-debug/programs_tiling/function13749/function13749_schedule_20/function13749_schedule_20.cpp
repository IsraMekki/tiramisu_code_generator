...
int main(int argc, char **argv){
    tiramisu::init("function13749_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13749/function13749_schedule_20/function13749_schedule_20.o");
