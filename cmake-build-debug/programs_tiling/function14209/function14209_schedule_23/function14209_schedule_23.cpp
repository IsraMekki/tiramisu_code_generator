...
int main(int argc, char **argv){
    tiramisu::init("function14209_schedule_23");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14209/function14209_schedule_23/function14209_schedule_23.o");
