...
int main(int argc, char **argv){
    tiramisu::init("function14209_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i0, i1, i3) * input02(i0, i2, i3) * input03(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14209/function14209_schedule_13/function14209_schedule_13.o");
