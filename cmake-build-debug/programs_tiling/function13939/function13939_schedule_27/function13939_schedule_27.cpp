...
int main(int argc, char **argv){
    tiramisu::init("function13939_schedule_27");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13939/function13939_schedule_27/function13939_schedule_27.o");
