...
int main(int argc, char **argv){
    tiramisu::init("function13939_schedule_26");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13939/function13939_schedule_26/function13939_schedule_26.o");
