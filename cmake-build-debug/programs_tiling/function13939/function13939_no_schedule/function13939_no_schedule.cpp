...
int main(int argc, char **argv){
    tiramisu::init("function13939_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13939/function13939_no_schedule/function13939_no_schedule.o");
