...
int main(int argc, char **argv){
    tiramisu::init("function14038_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14038/function14038_schedule_20/function14038_schedule_20.o");
