...
int main(int argc, char **argv){
    tiramisu::init("function14038_schedule_17");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14038/function14038_schedule_17/function14038_schedule_17.o");
