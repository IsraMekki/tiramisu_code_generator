...
int main(int argc, char **argv){
    tiramisu::init("function13750_schedule_8");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13750/function13750_schedule_8/function13750_schedule_8.o");
