...
int main(int argc, char **argv){
    tiramisu::init("function13873_schedule_56");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13873/function13873_schedule_56/function13873_schedule_56.o");
