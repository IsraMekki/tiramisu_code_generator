...
int main(int argc, char **argv){
    tiramisu::init("function13873_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13873/function13873_schedule_25/function13873_schedule_25.o");
