...
int main(int argc, char **argv){
    tiramisu::init("function13873_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13873/function13873_no_schedule/function13873_no_schedule.o");
