...
int main(int argc, char **argv){
    tiramisu::init("function14696_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14696/function14696_no_schedule/function14696_no_schedule.o");
