...
int main(int argc, char **argv){
    tiramisu::init("function14024_schedule_25");
    ...
    input input04("input04", {i3, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) * input01(i0, i2, i3) * input02(i0, i1) + input03(i3) * input04(i3, i0) * input05(i2, i3) - input06(i0, i1, i2) * input07(i2) * input08(i1, i2, i3) + input09(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14024/function14024_schedule_25/function14024_schedule_25.o");
