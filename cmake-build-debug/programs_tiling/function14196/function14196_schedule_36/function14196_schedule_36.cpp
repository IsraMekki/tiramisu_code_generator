...
int main(int argc, char **argv){
    tiramisu::init("function14196_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i3) * input02(i1) * input03(i0, i1, i3) - input04(i0) + input05(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14196/function14196_schedule_36/function14196_schedule_36.o");
