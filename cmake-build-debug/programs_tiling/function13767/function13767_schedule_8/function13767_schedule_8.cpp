...
int main(int argc, char **argv){
    tiramisu::init("function13767_schedule_8");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13767/function13767_schedule_8/function13767_schedule_8.o");
