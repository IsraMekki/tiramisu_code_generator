...
int main(int argc, char **argv){
    tiramisu::init("function13767_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13767/function13767_schedule_6/function13767_schedule_6.o");
