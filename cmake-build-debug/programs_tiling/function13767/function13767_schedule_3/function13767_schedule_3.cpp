...
int main(int argc, char **argv){
    tiramisu::init("function13767_schedule_3");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13767/function13767_schedule_3/function13767_schedule_3.o");
