...
int main(int argc, char **argv){
    tiramisu::init("function13767_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13767/function13767_no_schedule/function13767_no_schedule.o");
