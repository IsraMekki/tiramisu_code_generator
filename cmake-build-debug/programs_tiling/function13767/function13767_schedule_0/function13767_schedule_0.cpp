...
int main(int argc, char **argv){
    tiramisu::init("function13767_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13767/function13767_schedule_0/function13767_schedule_0.o");
