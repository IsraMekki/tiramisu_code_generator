...
int main(int argc, char **argv){
    tiramisu::init("function14146_schedule_19");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14146/function14146_schedule_19/function14146_schedule_19.o");
