...
int main(int argc, char **argv){
    tiramisu::init("function13852_schedule_18");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13852/function13852_schedule_18/function13852_schedule_18.o");
