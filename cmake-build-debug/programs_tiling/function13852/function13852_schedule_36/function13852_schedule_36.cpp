...
int main(int argc, char **argv){
    tiramisu::init("function13852_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) + input01(i0) - input02(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13852/function13852_schedule_36/function13852_schedule_36.o");
