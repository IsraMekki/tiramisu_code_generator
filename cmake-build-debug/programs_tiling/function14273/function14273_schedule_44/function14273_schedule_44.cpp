...
int main(int argc, char **argv){
    tiramisu::init("function14273_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i0) - input02(i0) * input03(i0, i1, i3) * input04(i2) * input05(i1) + input06(i2, i3) - input07(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14273/function14273_schedule_44/function14273_schedule_44.o");
