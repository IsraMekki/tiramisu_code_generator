...
int main(int argc, char **argv){
    tiramisu::init("function14085_schedule_20");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14085/function14085_schedule_20/function14085_schedule_20.o");
