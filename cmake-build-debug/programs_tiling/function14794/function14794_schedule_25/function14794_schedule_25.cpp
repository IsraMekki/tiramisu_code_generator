...
int main(int argc, char **argv){
    tiramisu::init("function14794_schedule_25");
    ...
    buffer buf00("buf00", {512, 128, 512}, p_int32, a_input);
    buffer buf0("buf0", {512, 128, 512}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14794/function14794_schedule_25/function14794_schedule_25.o");
