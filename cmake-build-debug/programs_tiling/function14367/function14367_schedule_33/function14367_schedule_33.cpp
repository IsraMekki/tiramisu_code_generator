...
int main(int argc, char **argv){
    tiramisu::init("function14367_schedule_33");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14367/function14367_schedule_33/function14367_schedule_33.o");
