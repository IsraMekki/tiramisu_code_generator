...
int main(int argc, char **argv){
    tiramisu::init("function14605_schedule_12");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14605/function14605_schedule_12/function14605_schedule_12.o");
