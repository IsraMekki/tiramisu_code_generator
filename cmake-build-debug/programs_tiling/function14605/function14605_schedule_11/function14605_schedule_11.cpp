...
int main(int argc, char **argv){
    tiramisu::init("function14605_schedule_11");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i0, i2) + input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14605/function14605_schedule_11/function14605_schedule_11.o");
