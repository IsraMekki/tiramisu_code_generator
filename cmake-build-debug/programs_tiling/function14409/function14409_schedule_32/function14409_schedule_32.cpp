...
int main(int argc, char **argv){
    tiramisu::init("function14409_schedule_32");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i1) * input01(i0, i1, i3) + input02(i0, i3) * input03(i1, i2, i3) + input04(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14409/function14409_schedule_32/function14409_schedule_32.o");
