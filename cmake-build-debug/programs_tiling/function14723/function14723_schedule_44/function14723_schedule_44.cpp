...
int main(int argc, char **argv){
    tiramisu::init("function14723_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) + input01(i0, i1, i3) + input02(i0, i1, i3) - input03(i2) * input04(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14723/function14723_schedule_44/function14723_schedule_44.o");
