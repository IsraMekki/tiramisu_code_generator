...
int main(int argc, char **argv){
    tiramisu::init("function14633_schedule_17");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) + input01(i1, i2) - input02(i0, i1) - input03(i1) - input04(i0, i1) * input05(i0, i2) + input06(i0) * input07(i0) + input08(i0, i1) + input09(i2));
    ...
    buffer buf02("buf02", {4096, 256}, p_int32, a_input);
    buffer buf03("buf03", {256}, p_int32, a_input);
    buffer buf04("buf04", {4096, 256}, p_int32, a_input);
    buffer buf05("buf05", {4096, 64}, p_int32, a_input);
    buffer buf06("buf06", {4096}, p_int32, a_input);
    buffer buf07("buf07", {4096}, p_int32, a_input);
    buffer buf08("buf08", {4096, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14633/function14633_schedule_17/function14633_schedule_17.o");
