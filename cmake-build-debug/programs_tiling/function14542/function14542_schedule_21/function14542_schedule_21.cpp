...
int main(int argc, char **argv){
    tiramisu::init("function14542_schedule_21");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14542/function14542_schedule_21/function14542_schedule_21.o");
