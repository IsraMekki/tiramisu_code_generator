...
int main(int argc, char **argv){
    tiramisu::init("function14402_schedule_17");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14402/function14402_schedule_17/function14402_schedule_17.o");
