...
int main(int argc, char **argv){
    tiramisu::init("function14402_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i2) + input02(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14402/function14402_schedule_15/function14402_schedule_15.o");
