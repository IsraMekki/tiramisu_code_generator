...
int main(int argc, char **argv){
    tiramisu::init("function14724_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14724/function14724_no_schedule/function14724_no_schedule.o");
