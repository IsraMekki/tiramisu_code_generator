...
int main(int argc, char **argv){
    tiramisu::init("function13800_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13800/function13800_no_schedule/function13800_no_schedule.o");
