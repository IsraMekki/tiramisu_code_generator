...
int main(int argc, char **argv){
    tiramisu::init("function14226_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14226/function14226_schedule_1/function14226_schedule_1.o");
