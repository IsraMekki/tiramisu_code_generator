...
int main(int argc, char **argv){
    tiramisu::init("function14706_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) + input01(i2) * input02(i3) * input03(i0, i2, i3) + input04(i1, i2, i3) * input05(i2) * input06(i0, i2, i3) + input07(i0, i1, i3) * input08(i1) + input09(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14706/function14706_schedule_36/function14706_schedule_36.o");
