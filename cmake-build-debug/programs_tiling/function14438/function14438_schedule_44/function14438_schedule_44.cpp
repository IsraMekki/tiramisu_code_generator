...
int main(int argc, char **argv){
    tiramisu::init("function14438_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0, i1) * input02(i0, i2) * input03(i0) + input04(i1, i2) + input05(i1) + input06(i1, i2) * input07(i0, i1) * input08(i0, i2));
    ...
    buffer buf07("buf07", {256, 128}, p_int32, a_input);
    buffer buf08("buf08", {256, 1024}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14438/function14438_schedule_44/function14438_schedule_44.o");
