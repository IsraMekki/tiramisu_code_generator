...
int main(int argc, char **argv){
    tiramisu::init("function13866_schedule_30");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13866/function13866_schedule_30/function13866_schedule_30.o");
