...
int main(int argc, char **argv){
    tiramisu::init("function14133_schedule_40");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14133/function14133_schedule_40/function14133_schedule_40.o");
