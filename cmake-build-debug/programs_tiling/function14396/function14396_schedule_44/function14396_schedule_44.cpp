...
int main(int argc, char **argv){
    tiramisu::init("function14396_schedule_44");
    ...
    comp0.tile(i100, i101, i102, 128, 128, 128, i01, i02, i03, i04, i05, i06);
    comp0.parallelize(i01);
    
    buffer buf00("buf00", {256, 256, 512}, p_int32, a_input);
    buffer buf0("buf0", {256, 256, 512}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14396/function14396_schedule_44/function14396_schedule_44.o");
