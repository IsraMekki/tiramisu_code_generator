...
int main(int argc, char **argv){
    tiramisu::init("function14026_schedule_42");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14026/function14026_schedule_42/function14026_schedule_42.o");
