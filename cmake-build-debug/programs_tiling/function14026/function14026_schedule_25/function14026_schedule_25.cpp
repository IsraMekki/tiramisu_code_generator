...
int main(int argc, char **argv){
    tiramisu::init("function14026_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14026/function14026_schedule_25/function14026_schedule_25.o");
