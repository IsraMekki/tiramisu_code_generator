...
int main(int argc, char **argv){
    tiramisu::init("function13709_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2, i1) + input01(i0) * input02(i1) - input03(i1, i2) + input04(i2) + input05(i0, i2) + input06(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function13709/function13709_schedule_44/function13709_schedule_44.o");
