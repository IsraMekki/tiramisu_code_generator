...
int main(int argc, char **argv){
    tiramisu::init("function14411_schedule_26");
    ...
    input input06("input06", {i1, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1, i2) * input02(i1, i2) + input03(i2) - input04(i0, i2) - input05(i0, i1) * input06(i1, i0) + input07(i1) + input08(i2) * input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14411/function14411_schedule_26/function14411_schedule_26.o");
