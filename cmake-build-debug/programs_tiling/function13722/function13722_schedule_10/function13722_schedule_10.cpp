...
int main(int argc, char **argv){
    tiramisu::init("function13722_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13722/function13722_schedule_10/function13722_schedule_10.o");
