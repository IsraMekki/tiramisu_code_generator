...
int main(int argc, char **argv){
    tiramisu::init("function13722_schedule_11");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13722/function13722_schedule_11/function13722_schedule_11.o");
