...
int main(int argc, char **argv){
    tiramisu::init("function13722_schedule_15");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13722/function13722_schedule_15/function13722_schedule_15.o");
