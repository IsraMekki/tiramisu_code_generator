...
int main(int argc, char **argv){
    tiramisu::init("function13722_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13722/function13722_no_schedule/function13722_no_schedule.o");
