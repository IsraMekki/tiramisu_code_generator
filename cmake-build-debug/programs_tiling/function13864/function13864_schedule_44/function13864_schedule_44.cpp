...
int main(int argc, char **argv){
    tiramisu::init("function13864_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i1, i2) + input02(i2) * input03(i1, i2) * input04(i1, i2) * input05(i1, i2) * input06(i0) - input07(i0, i1) + input08(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function13864/function13864_schedule_44/function13864_schedule_44.o");
