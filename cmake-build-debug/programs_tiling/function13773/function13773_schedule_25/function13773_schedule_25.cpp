...
int main(int argc, char **argv){
    tiramisu::init("function13773_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13773/function13773_schedule_25/function13773_schedule_25.o");
