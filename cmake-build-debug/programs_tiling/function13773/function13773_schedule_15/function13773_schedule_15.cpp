...
int main(int argc, char **argv){
    tiramisu::init("function13773_schedule_15");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) - input01(i0) * input02(i2, i3) + input03(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13773/function13773_schedule_15/function13773_schedule_15.o");
