...
int main(int argc, char **argv){
    tiramisu::init("function13882_schedule_24");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13882/function13882_schedule_24/function13882_schedule_24.o");
