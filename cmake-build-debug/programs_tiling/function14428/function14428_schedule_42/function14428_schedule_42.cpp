...
int main(int argc, char **argv){
    tiramisu::init("function14428_schedule_42");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) + input01(i2, i3) - input02(i1) * input03(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14428/function14428_schedule_42/function14428_schedule_42.o");
