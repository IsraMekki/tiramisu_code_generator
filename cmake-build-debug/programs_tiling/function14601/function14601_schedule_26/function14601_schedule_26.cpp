...
int main(int argc, char **argv){
    tiramisu::init("function14601_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1, i2) + input02(i0) + input03(i2) + input04(i1, i2) * input05(i0, i2) * input06(i0, i1) + input07(i0, i2) - input08(i1) * input09(i0, i1));
    ...
    buffer buf05("buf05", {1024, 1024}, p_int32, a_input);
    ...
    buffer buf09("buf09", {1024, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14601/function14601_schedule_26/function14601_schedule_26.o");
