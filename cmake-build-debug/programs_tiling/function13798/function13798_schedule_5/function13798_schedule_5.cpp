...
int main(int argc, char **argv){
    tiramisu::init("function13798_schedule_5");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13798/function13798_schedule_5/function13798_schedule_5.o");
