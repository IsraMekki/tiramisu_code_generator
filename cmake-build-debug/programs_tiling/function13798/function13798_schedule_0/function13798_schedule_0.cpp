...
int main(int argc, char **argv){
    tiramisu::init("function13798_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13798/function13798_schedule_0/function13798_schedule_0.o");
