...
int main(int argc, char **argv){
    tiramisu::init("function14252_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) - input01(i0) * input02(i0, i1) + input03(i1) - input04(i0, i1, i2) - input05(i3, i2) * input06(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14252/function14252_schedule_36/function14252_schedule_36.o");
