...
int main(int argc, char **argv){
    tiramisu::init("function13946_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13946/function13946_schedule_1/function13946_schedule_1.o");
