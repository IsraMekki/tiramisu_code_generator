...
int main(int argc, char **argv){
    tiramisu::init("function13891_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) * input01(i2, i3) * input02(i1) * input03(i2) + input04(i2) - input05(i3) - input06(i0, i1, i2) - input07(i0, i2, i3) * input08(i0, i2, i3) * input09(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function13891/function13891_schedule_36/function13891_schedule_36.o");
