...
int main(int argc, char **argv){
    tiramisu::init("function14292_schedule_38");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) - input01(i0, i1, i3) * input02(i0, i3) - input03(i0, i1, i3) - input04(i1, i2, i3) * input05(i1) * input06(i2) * input07(i2) * input08(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14292/function14292_schedule_38/function14292_schedule_38.o");
