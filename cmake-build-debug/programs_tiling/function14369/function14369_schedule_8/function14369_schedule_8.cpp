...
int main(int argc, char **argv){
    tiramisu::init("function14369_schedule_8");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14369/function14369_schedule_8/function14369_schedule_8.o");
