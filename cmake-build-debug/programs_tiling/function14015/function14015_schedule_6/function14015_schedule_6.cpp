...
int main(int argc, char **argv){
    tiramisu::init("function14015_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14015/function14015_schedule_6/function14015_schedule_6.o");
