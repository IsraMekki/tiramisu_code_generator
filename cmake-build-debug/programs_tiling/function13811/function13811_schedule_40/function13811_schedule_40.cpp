...
int main(int argc, char **argv){
    tiramisu::init("function13811_schedule_40");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13811/function13811_schedule_40/function13811_schedule_40.o");
