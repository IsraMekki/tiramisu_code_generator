...
int main(int argc, char **argv){
    tiramisu::init("function13811_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13811/function13811_no_schedule/function13811_no_schedule.o");
