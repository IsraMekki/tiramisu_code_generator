...
int main(int argc, char **argv){
    tiramisu::init("function13811_schedule_39");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13811/function13811_schedule_39/function13811_schedule_39.o");
