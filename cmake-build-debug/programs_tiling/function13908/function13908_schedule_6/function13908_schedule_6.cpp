...
int main(int argc, char **argv){
    tiramisu::init("function13908_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13908/function13908_schedule_6/function13908_schedule_6.o");
