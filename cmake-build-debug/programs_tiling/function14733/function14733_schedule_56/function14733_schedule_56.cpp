...
int main(int argc, char **argv){
    tiramisu::init("function14733_schedule_56");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i2) - input02(i0) * input03(i1) + input04(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14733/function14733_schedule_56/function14733_schedule_56.o");
