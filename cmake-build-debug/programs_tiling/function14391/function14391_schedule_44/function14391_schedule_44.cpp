...
int main(int argc, char **argv){
    tiramisu::init("function14391_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0, i2) + input02(i0) + input03(i0, i1) + input04(i0, i2) - input05(i0, i1) + input06(i0) + input07(i0) + input08(i2) * input09(i0, i2));
    ...
    buffer buf04("buf04", {128, 2048}, p_int32, a_input);
    ...
    buffer buf09("buf09", {128, 2048}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14391/function14391_schedule_44/function14391_schedule_44.o");
