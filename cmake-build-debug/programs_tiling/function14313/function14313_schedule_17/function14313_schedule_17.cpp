...
int main(int argc, char **argv){
    tiramisu::init("function14313_schedule_17");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0) + input02(i1, i2) + input03(i0) + input04(i2) + input05(i0, i2) * input06(i0) + input07(i1, i2) - input08(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14313/function14313_schedule_17/function14313_schedule_17.o");
