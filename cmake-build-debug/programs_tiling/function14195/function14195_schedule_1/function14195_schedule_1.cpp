...
int main(int argc, char **argv){
    tiramisu::init("function14195_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14195/function14195_schedule_1/function14195_schedule_1.o");
