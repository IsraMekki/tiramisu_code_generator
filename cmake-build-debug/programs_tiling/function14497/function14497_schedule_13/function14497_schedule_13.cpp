...
int main(int argc, char **argv){
    tiramisu::init("function14497_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) + input01(i0, i1, i3) * input02(i2, i3) - input03(i1, i2, i3) * input04(i0, i2, i3) * input05(i2) - input06(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14497/function14497_schedule_13/function14497_schedule_13.o");
