...
int main(int argc, char **argv){
    tiramisu::init("function14636_schedule_20");
    ...
    buffer buf00("buf00", {2048, 256, 64}, p_int32, a_input);
    buffer buf0("buf0", {2048, 256, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14636/function14636_schedule_20/function14636_schedule_20.o");
