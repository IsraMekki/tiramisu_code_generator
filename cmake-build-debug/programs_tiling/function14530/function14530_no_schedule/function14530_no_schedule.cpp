...
int main(int argc, char **argv){
    tiramisu::init("function14530_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14530/function14530_no_schedule/function14530_no_schedule.o");
