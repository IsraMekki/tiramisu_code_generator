...
int main(int argc, char **argv){
    tiramisu::init("function13996_schedule_13");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13996/function13996_schedule_13/function13996_schedule_13.o");
