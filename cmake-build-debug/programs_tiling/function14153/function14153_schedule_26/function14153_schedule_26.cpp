...
int main(int argc, char **argv){
    tiramisu::init("function14153_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i0, i2) * input02(i1) + input03(i0, i1) - input04(i0, i2) + input05(i2) * input06(i1) - input07(i0) * input08(i0, i1));
    
    comp0.tile(i0, i1, i2, 128, 32, 128, i01, i02, i03, i04, i05, i06);
    comp0.parallelize(i01);
    
    buffer buf00("buf00", {64, 512}, p_int32, a_input);
    buffer buf01("buf01", {1024, 512}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14153/function14153_schedule_26/function14153_schedule_26.o");
