...
int main(int argc, char **argv){
    tiramisu::init("function14072_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14072/function14072_no_schedule/function14072_no_schedule.o");
