...
int main(int argc, char **argv){
    tiramisu::init("function14200_schedule_23");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14200/function14200_schedule_23/function14200_schedule_23.o");
