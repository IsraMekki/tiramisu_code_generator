...
int main(int argc, char **argv){
    tiramisu::init("function14204_schedule_11");
    ...
    buffer buf00("buf00", {128, 64, 128, 64}, p_int32, a_input);
    buffer buf0("buf0", {128, 64, 128, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14204/function14204_schedule_11/function14204_schedule_11.o");
