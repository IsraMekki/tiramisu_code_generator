...
int main(int argc, char **argv){
    tiramisu::init("function14052_schedule_12");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14052/function14052_schedule_12/function14052_schedule_12.o");
