...
int main(int argc, char **argv){
    tiramisu::init("function13976_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13976/function13976_no_schedule/function13976_no_schedule.o");
