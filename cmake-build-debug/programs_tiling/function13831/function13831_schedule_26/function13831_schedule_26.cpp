...
int main(int argc, char **argv){
    tiramisu::init("function13831_schedule_26");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13831/function13831_schedule_26/function13831_schedule_26.o");
