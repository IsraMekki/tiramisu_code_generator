...
int main(int argc, char **argv){
    tiramisu::init("function13831_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13831/function13831_no_schedule/function13831_no_schedule.o");
