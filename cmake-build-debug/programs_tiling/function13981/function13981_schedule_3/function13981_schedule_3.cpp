...
int main(int argc, char **argv){
    tiramisu::init("function13981_schedule_3");
    ...
    buffer buf00("buf00", {64, 64, 64, 64}, p_int32, a_input);
    buffer buf0("buf0", {64, 64, 64, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13981/function13981_schedule_3/function13981_schedule_3.o");
