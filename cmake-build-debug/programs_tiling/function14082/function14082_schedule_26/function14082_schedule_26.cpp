...
int main(int argc, char **argv){
    tiramisu::init("function14082_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1, i2) + input02(i1, i2) * input03(i2) * input04(i1) * input05(i0) + input06(i0, i2));
    ...
    buffer buf06("buf06", {128, 8192}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14082/function14082_schedule_26/function14082_schedule_26.o");
