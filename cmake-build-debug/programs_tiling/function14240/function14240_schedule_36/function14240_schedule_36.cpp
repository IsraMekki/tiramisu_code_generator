...
int main(int argc, char **argv){
    tiramisu::init("function14240_schedule_36");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14240/function14240_schedule_36/function14240_schedule_36.o");
