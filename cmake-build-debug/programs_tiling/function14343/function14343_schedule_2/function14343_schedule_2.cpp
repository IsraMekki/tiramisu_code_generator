...
int main(int argc, char **argv){
    tiramisu::init("function14343_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14343/function14343_schedule_2/function14343_schedule_2.o");
