...
int main(int argc, char **argv){
    tiramisu::init("function14372_schedule_33");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i0, i2) * input02(i2, i3) + input03(i0) + input04(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14372/function14372_schedule_33/function14372_schedule_33.o");
