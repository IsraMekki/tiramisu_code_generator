...
int main(int argc, char **argv){
    tiramisu::init("function13708_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13708/function13708_schedule_1/function13708_schedule_1.o");
