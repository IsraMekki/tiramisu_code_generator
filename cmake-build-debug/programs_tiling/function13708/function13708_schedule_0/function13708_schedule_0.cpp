...
int main(int argc, char **argv){
    tiramisu::init("function13708_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13708/function13708_schedule_0/function13708_schedule_0.o");
