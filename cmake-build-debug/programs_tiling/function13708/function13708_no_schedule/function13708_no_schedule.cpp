...
int main(int argc, char **argv){
    tiramisu::init("function13708_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13708/function13708_no_schedule/function13708_no_schedule.o");
