...
int main(int argc, char **argv){
    tiramisu::init("function14619_schedule_28");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) + input01(i2) + input02(i1, i2) - input03(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14619/function14619_schedule_28/function14619_schedule_28.o");
