...
int main(int argc, char **argv){
    tiramisu::init("function13850_schedule_28");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13850/function13850_schedule_28/function13850_schedule_28.o");
