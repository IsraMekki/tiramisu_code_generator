...
int main(int argc, char **argv){
    tiramisu::init("function13850_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13850/function13850_schedule_13/function13850_schedule_13.o");
