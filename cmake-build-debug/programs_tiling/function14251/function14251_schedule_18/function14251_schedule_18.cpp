...
int main(int argc, char **argv){
    tiramisu::init("function14251_schedule_18");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i0, i1, i2) * input02(i1, i2, i3) + input03(i2, i3) - input04(i2) * input05(i2, i3) - input06(i1) - input07(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14251/function14251_schedule_18/function14251_schedule_18.o");
