...
int main(int argc, char **argv){
    tiramisu::init("function14186_schedule_47");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14186/function14186_schedule_47/function14186_schedule_47.o");
