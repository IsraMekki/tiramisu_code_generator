...
int main(int argc, char **argv){
    tiramisu::init("function13753_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13753/function13753_no_schedule/function13753_no_schedule.o");
