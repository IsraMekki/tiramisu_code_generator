...
int main(int argc, char **argv){
    tiramisu::init("function14784_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14784/function14784_no_schedule/function14784_no_schedule.o");
