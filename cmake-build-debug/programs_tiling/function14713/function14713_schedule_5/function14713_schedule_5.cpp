...
int main(int argc, char **argv){
    tiramisu::init("function14713_schedule_5");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14713/function14713_schedule_5/function14713_schedule_5.o");
