...
int main(int argc, char **argv){
    tiramisu::init("function14197_schedule_19");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14197/function14197_schedule_19/function14197_schedule_19.o");
