...
int main(int argc, char **argv){
    tiramisu::init("function14591_schedule_38");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) + input01(i0, i3) - input02(i3) - input03(i2) + input04(i3) + input05(i2, i3) * input06(i3) - input07(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14591/function14591_schedule_38/function14591_schedule_38.o");
