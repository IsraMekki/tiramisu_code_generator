...
int main(int argc, char **argv){
    tiramisu::init("function13825_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13825/function13825_no_schedule/function13825_no_schedule.o");
