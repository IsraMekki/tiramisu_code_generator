...
int main(int argc, char **argv){
    tiramisu::init("function14187_schedule_33");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) * input01(i0, i1) * input02(i0, i3) - input03(i1) * input04(i2) * input05(i0) - input06(i0, i2) + input07(i0, i1, i3) * input08(i1) - input09(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function14187/function14187_schedule_33/function14187_schedule_33.o");
