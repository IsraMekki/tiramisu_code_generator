...
int main(int argc, char **argv){
    tiramisu::init("function13855_schedule_12");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13855/function13855_schedule_12/function13855_schedule_12.o");
