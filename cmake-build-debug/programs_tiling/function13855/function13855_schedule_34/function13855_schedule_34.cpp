...
int main(int argc, char **argv){
    tiramisu::init("function13855_schedule_34");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13855/function13855_schedule_34/function13855_schedule_34.o");
