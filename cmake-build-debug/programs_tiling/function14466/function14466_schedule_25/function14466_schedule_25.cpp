...
int main(int argc, char **argv){
    tiramisu::init("function14466_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14466/function14466_schedule_25/function14466_schedule_25.o");
