...
int main(int argc, char **argv){
    tiramisu::init("function14466_schedule_34");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14466/function14466_schedule_34/function14466_schedule_34.o");
