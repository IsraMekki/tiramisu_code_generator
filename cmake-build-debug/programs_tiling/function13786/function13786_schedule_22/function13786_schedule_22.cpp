...
int main(int argc, char **argv){
    tiramisu::init("function13786_schedule_22");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13786/function13786_schedule_22/function13786_schedule_22.o");
