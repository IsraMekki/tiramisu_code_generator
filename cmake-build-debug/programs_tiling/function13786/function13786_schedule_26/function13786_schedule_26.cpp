...
int main(int argc, char **argv){
    tiramisu::init("function13786_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) + input01(i2) * input02(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13786/function13786_schedule_26/function13786_schedule_26.o");
