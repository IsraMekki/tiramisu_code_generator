...
int main(int argc, char **argv){
    tiramisu::init("function14342_schedule_32");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) * input01(i0, i3) * input02(i1) + input03(i1, i2, i3) + input04(i1) + input05(i0, i3) + input06(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14342/function14342_schedule_32/function14342_schedule_32.o");
