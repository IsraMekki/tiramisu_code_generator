...
int main(int argc, char **argv){
    tiramisu::init("function13766_schedule_38");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) - input01(i0, i3) - input02(i1, i3) + input03(i0, i2, i3) * input04(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13766/function13766_schedule_38/function13766_schedule_38.o");
