...
int main(int argc, char **argv){
    tiramisu::init("function14383_schedule_46");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14383/function14383_schedule_46/function14383_schedule_46.o");
