...
int main(int argc, char **argv){
    tiramisu::init("function14383_schedule_32");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14383/function14383_schedule_32/function14383_schedule_32.o");
