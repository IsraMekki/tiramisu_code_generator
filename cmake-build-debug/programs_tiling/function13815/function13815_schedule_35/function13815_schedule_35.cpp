...
int main(int argc, char **argv){
    tiramisu::init("function13815_schedule_35");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13815/function13815_schedule_35/function13815_schedule_35.o");
