...
int main(int argc, char **argv){
    tiramisu::init("function13815_schedule_22");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13815/function13815_schedule_22/function13815_schedule_22.o");
