...
int main(int argc, char **argv){
    tiramisu::init("function13871_schedule_7");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13871/function13871_schedule_7/function13871_schedule_7.o");
