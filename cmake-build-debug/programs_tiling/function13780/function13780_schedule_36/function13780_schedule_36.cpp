...
int main(int argc, char **argv){
    tiramisu::init("function13780_schedule_36");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13780/function13780_schedule_36/function13780_schedule_36.o");
