...
int main(int argc, char **argv){
    tiramisu::init("function13907_schedule_44");
    ...
    buffer buf00("buf00", {512, 512, 256}, p_int32, a_input);
    buffer buf0("buf0", {512, 512, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13907/function13907_schedule_44/function13907_schedule_44.o");
