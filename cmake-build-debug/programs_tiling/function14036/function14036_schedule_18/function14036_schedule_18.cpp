...
int main(int argc, char **argv){
    tiramisu::init("function14036_schedule_18");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14036/function14036_schedule_18/function14036_schedule_18.o");
