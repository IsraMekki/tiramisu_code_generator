...
int main(int argc, char **argv){
    tiramisu::init("function13719_schedule_36");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2) * input01(i0, i1, i3) - input02(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13719/function13719_schedule_36/function13719_schedule_36.o");
