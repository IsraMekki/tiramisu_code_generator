...
int main(int argc, char **argv){
    tiramisu::init("function13719_schedule_18");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13719/function13719_schedule_18/function13719_schedule_18.o");
