...
int main(int argc, char **argv){
    tiramisu::init("function14684_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i1) + input02(i0, i1, i2) * input03(i1) + input04(i3) + input05(i0, i2, i3) + input06(i2, i3) - input07(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14684/function14684_schedule_13/function14684_schedule_13.o");
