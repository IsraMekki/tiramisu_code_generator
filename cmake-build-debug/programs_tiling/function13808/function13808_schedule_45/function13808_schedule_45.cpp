...
int main(int argc, char **argv){
    tiramisu::init("function13808_schedule_45");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13808/function13808_schedule_45/function13808_schedule_45.o");
