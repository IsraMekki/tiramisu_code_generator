...
int main(int argc, char **argv){
    tiramisu::init("function14385_schedule_37");
    ...
    input input03("input03", {i3, i0, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i1) - input01(i0, i1, i3) * input02(i0, i2, i3) + input03(i3, i0, i2) * input04(i2) - input05(i0) + input06(i2, i3) + input07(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14385/function14385_schedule_37/function14385_schedule_37.o");
