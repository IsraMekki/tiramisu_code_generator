...
int main(int argc, char **argv){
    tiramisu::init("function13730_schedule_13");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) * input01(i1) - input02(i2, i1) - input03(i0, i1, i2) + input04(i0, i1, i3) - input05(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function13730/function13730_schedule_13/function13730_schedule_13.o");
