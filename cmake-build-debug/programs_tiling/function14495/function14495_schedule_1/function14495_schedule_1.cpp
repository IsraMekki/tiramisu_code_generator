...
int main(int argc, char **argv){
    tiramisu::init("function14495_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14495/function14495_schedule_1/function14495_schedule_1.o");
