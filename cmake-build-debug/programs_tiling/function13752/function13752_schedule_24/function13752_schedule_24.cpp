...
int main(int argc, char **argv){
    tiramisu::init("function13752_schedule_24");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i1, i2) * input02(i1, i2) * input03(i1, i2) * input04(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13752/function13752_schedule_24/function13752_schedule_24.o");
