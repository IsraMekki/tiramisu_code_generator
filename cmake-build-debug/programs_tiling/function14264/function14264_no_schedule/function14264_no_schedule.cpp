...
int main(int argc, char **argv){
    tiramisu::init("function14264_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14264/function14264_no_schedule/function14264_no_schedule.o");
