...
int main(int argc, char **argv){
    tiramisu::init("function13879_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) - input01(i1) + input02(i1) - input03(i0) - input04(i0) + input05(i1) + input06(i0) - input07(i1) + input08(i0) - input09(i0));
    ...
    buffer buf08("buf08", {32768}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function13879/function13879_no_schedule/function13879_no_schedule.o");
