...
int main(int argc, char **argv){
    tiramisu::init("function14304_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14304/function14304_schedule_25/function14304_schedule_25.o");
