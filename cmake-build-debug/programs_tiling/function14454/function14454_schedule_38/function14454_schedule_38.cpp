...
int main(int argc, char **argv){
    tiramisu::init("function14454_schedule_38");
    ...
    input input01("input01", {i1, i3, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) - input01(i1, i3, i0) + input02(i0, i1, i2) * input03(i2) + input04(i2) + input05(i0, i2) - input06(i1, i2, i3) + input07(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function14454/function14454_schedule_38/function14454_schedule_38.o");
