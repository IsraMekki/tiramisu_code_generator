...
int main(int argc, char **argv){
    tiramisu::init("function14549_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) + input01(i0) - input02(i0, i1) * input03(i0) + input04(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14549/function14549_schedule_26/function14549_schedule_26.o");
