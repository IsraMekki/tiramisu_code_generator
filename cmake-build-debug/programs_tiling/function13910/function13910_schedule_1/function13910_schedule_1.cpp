...
int main(int argc, char **argv){
    tiramisu::init("function13910_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13910/function13910_schedule_1/function13910_schedule_1.o");
