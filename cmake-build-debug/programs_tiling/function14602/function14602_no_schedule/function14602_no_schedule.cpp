...
int main(int argc, char **argv){
    tiramisu::init("function14602_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14602/function14602_no_schedule/function14602_no_schedule.o");
