...
int main(int argc, char **argv){
    tiramisu::init("function14602_schedule_11");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14602/function14602_schedule_11/function14602_schedule_11.o");
