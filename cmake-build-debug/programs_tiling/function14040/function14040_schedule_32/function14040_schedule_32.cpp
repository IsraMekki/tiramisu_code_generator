...
int main(int argc, char **argv){
    tiramisu::init("function14040_schedule_32");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i0, i2, i3) + input02(i2) * input03(i0, i3) + input04(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14040/function14040_schedule_32/function14040_schedule_32.o");
