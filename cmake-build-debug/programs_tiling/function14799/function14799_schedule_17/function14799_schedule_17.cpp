...
int main(int argc, char **argv){
    tiramisu::init("function14799_schedule_17");
    ...
    buffer buf00("buf00", {64, 512, 1024}, p_int32, a_input);
    buffer buf0("buf0", {64, 512, 1024}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14799/function14799_schedule_17/function14799_schedule_17.o");
