...
int main(int argc, char **argv){
    tiramisu::init("function14331_schedule_31");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14331/function14331_schedule_31/function14331_schedule_31.o");
