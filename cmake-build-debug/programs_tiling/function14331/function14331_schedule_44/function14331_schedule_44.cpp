...
int main(int argc, char **argv){
    tiramisu::init("function14331_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14331/function14331_schedule_44/function14331_schedule_44.o");
