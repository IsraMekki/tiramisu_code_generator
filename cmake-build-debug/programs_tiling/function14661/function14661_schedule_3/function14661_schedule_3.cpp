...
int main(int argc, char **argv){
    tiramisu::init("function14661_schedule_3");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14661/function14661_schedule_3/function14661_schedule_3.o");
