...
int main(int argc, char **argv){
    tiramisu::init("function14661_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14661/function14661_no_schedule/function14661_no_schedule.o");
