...
int main(int argc, char **argv){
    tiramisu::init("function14612_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) + input01(i1) - input02(i1, i2, i3) - input03(i1, i2, i3) + input04(i1, i2) - input05(i0) - input06(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14612/function14612_schedule_44/function14612_schedule_44.o");
