...
int main(int argc, char **argv){
    tiramisu::init("function13759_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13759/function13759_no_schedule/function13759_no_schedule.o");
