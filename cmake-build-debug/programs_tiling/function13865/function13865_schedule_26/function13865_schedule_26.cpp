...
int main(int argc, char **argv){
    tiramisu::init("function13865_schedule_26");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i0, i1) + input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13865/function13865_schedule_26/function13865_schedule_26.o");
