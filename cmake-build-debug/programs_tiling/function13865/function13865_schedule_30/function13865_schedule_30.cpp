...
int main(int argc, char **argv){
    tiramisu::init("function13865_schedule_30");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function13865/function13865_schedule_30/function13865_schedule_30.o");
