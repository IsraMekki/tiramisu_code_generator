...
int main(int argc, char **argv){
    tiramisu::init("function14543_schedule_23");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14543/function14543_schedule_23/function14543_schedule_23.o");
