...
int main(int argc, char **argv){
    tiramisu::init("function14049_schedule_8");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14049/function14049_schedule_8/function14049_schedule_8.o");
