...
int main(int argc, char **argv){
    tiramisu::init("function14049_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14049/function14049_schedule_6/function14049_schedule_6.o");
