...
int main(int argc, char **argv){
    tiramisu::init("function13728_schedule_32");
    ...
    buffer buf00("buf00", {256, 2048, 128}, p_int32, a_input);
    buffer buf0("buf0", {256, 2048, 128}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13728/function13728_schedule_32/function13728_schedule_32.o");
