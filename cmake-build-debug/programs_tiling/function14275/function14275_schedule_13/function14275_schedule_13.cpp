...
int main(int argc, char **argv){
    tiramisu::init("function14275_schedule_13");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14275/function14275_schedule_13/function14275_schedule_13.o");
