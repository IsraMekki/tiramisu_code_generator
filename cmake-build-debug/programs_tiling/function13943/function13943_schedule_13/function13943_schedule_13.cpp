...
int main(int argc, char **argv){
    tiramisu::init("function13943_schedule_13");
    ...
    buffer buf00("buf00", {2048, 64, 256}, p_int32, a_input);
    buffer buf0("buf0", {2048, 64, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function13943/function13943_schedule_13/function13943_schedule_13.o");
