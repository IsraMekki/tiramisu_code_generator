...
int main(int argc, char **argv){
    tiramisu::init("function14610_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14610/function14610_no_schedule/function14610_no_schedule.o");
