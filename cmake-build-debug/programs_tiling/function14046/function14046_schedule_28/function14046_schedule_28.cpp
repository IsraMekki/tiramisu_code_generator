...
int main(int argc, char **argv){
    tiramisu::init("function14046_schedule_28");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2) - input02(i0, i1, i2) * input03(i1, i3) - input04(i0, i1) - input05(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14046/function14046_schedule_28/function14046_schedule_28.o");
