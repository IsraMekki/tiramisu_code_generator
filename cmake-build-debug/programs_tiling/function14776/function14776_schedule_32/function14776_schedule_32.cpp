...
int main(int argc, char **argv){
    tiramisu::init("function14776_schedule_32");
    ...
    comp0.tile(i100, i101, i102, 64, 128, 128, i01, i02, i03, i04, i05, i06);
    comp0.parallelize(i01);
    
    buffer buf00("buf00", {128, 1024, 512}, p_int32, a_input);
    buffer buf0("buf0", {128, 1024, 512}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14776/function14776_schedule_32/function14776_schedule_32.o");
