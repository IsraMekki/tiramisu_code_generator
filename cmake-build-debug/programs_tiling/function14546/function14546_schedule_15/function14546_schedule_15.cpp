...
int main(int argc, char **argv){
    tiramisu::init("function14546_schedule_15");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14546/function14546_schedule_15/function14546_schedule_15.o");
