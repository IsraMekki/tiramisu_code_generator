...
int main(int argc, char **argv){
    tiramisu::init("function14126_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) + input01(i1) - input02(i1, i2) + input03(i0) * input04(i0) - input05(i1, i2) * input06(i0) * input07(i0, i1) - input08(i2));
    ...
    buffer buf02("buf02", {256, 1024}, p_int32, a_input);
    buffer buf03("buf03", {256}, p_int32, a_input);
    buffer buf04("buf04", {256}, p_int32, a_input);
    buffer buf05("buf05", {256, 1024}, p_int32, a_input);
    buffer buf06("buf06", {256}, p_int32, a_input);
    buffer buf07("buf07", {256, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14126/function14126_schedule_44/function14126_schedule_44.o");
