...
int main(int argc, char **argv){
    tiramisu::init("function14645_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14645/function14645_no_schedule/function14645_no_schedule.o");
