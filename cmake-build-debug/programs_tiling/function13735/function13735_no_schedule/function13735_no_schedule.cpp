...
int main(int argc, char **argv){
    tiramisu::init("function13735_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13735/function13735_no_schedule/function13735_no_schedule.o");
