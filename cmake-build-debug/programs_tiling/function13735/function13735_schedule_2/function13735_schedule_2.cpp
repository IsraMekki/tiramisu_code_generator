...
int main(int argc, char **argv){
    tiramisu::init("function13735_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13735/function13735_schedule_2/function13735_schedule_2.o");
