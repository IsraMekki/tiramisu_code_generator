...
int main(int argc, char **argv){
    tiramisu::init("function13735_schedule_3");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13735/function13735_schedule_3/function13735_schedule_3.o");
