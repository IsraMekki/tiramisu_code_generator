...
int main(int argc, char **argv){
    tiramisu::init("function13735_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function13735/function13735_schedule_0/function13735_schedule_0.o");
