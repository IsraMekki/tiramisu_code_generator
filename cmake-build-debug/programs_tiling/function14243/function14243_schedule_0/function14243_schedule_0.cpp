...
int main(int argc, char **argv){
    tiramisu::init("function14243_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14243/function14243_schedule_0/function14243_schedule_0.o");
