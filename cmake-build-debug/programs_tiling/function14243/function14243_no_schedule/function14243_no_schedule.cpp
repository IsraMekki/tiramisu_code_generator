...
int main(int argc, char **argv){
    tiramisu::init("function14243_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14243/function14243_no_schedule/function14243_no_schedule.o");
