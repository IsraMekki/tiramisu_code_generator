...
int main(int argc, char **argv){
    tiramisu::init("function14657_schedule_38");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14657/function14657_schedule_38/function14657_schedule_38.o");
