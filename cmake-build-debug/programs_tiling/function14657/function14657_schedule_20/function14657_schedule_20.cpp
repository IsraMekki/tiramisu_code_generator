...
int main(int argc, char **argv){
    tiramisu::init("function14657_schedule_20");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i0) + input02(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14657/function14657_schedule_20/function14657_schedule_20.o");
