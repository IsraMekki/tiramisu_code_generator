...
int main(int argc, char **argv){
    tiramisu::init("function14567_schedule_32");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14567/function14567_schedule_32/function14567_schedule_32.o");
