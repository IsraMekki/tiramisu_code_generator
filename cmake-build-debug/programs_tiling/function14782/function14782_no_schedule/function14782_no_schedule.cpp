...
int main(int argc, char **argv){
    tiramisu::init("function14782_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14782/function14782_no_schedule/function14782_no_schedule.o");
