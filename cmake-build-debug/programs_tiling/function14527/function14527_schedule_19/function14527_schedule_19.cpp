...
int main(int argc, char **argv){
    tiramisu::init("function14527_schedule_19");
    ...
    buffer buf00("buf00", {2048, 128, 128}, p_int32, a_input);
    buffer buf0("buf0", {2048, 128, 128}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function14527/function14527_schedule_19/function14527_schedule_19.o");
