...
int main(int argc, char **argv){
    tiramisu::init("function14766_schedule_23");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14766/function14766_schedule_23/function14766_schedule_23.o");
