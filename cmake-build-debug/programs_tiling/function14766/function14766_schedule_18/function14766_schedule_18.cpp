...
int main(int argc, char **argv){
    tiramisu::init("function14766_schedule_18");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) - input01(i2, i3) * input02(i0, i1, i2) - input03(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14766/function14766_schedule_18/function14766_schedule_18.o");
