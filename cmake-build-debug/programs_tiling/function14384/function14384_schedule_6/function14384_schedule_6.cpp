...
int main(int argc, char **argv){
    tiramisu::init("function14384_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14384/function14384_schedule_6/function14384_schedule_6.o");
