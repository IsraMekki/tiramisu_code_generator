...
int main(int argc, char **argv){
    tiramisu::init("function14121_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14121/function14121_schedule_25/function14121_schedule_25.o");
