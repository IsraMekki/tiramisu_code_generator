...
int main(int argc, char **argv){
    tiramisu::init("function14754_schedule_34");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14754/function14754_schedule_34/function14754_schedule_34.o");
