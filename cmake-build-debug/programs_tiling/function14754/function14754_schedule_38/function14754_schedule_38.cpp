...
int main(int argc, char **argv){
    tiramisu::init("function14754_schedule_38");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) - input01(i3) - input02(i1, i2, i3) * input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14754/function14754_schedule_38/function14754_schedule_38.o");
