...
int main(int argc, char **argv){
    tiramisu::init("function14626_schedule_33");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i0, i1) - input02(i0) * input03(i0) * input04(i0, i1, i2) * input05(i1) * input06(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function14626/function14626_schedule_33/function14626_schedule_33.o");
