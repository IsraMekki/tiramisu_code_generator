...
int main(int argc, char **argv){
    tiramisu::init("function14237_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function14237/function14237_no_schedule/function14237_no_schedule.o");
