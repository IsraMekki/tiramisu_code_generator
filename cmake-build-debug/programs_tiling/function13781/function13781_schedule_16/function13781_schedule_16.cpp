...
int main(int argc, char **argv){
    tiramisu::init("function13781_schedule_16");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13781/function13781_schedule_16/function13781_schedule_16.o");
