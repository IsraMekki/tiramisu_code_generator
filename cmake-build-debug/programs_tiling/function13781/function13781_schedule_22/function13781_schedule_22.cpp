...
int main(int argc, char **argv){
    tiramisu::init("function13781_schedule_22");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13781/function13781_schedule_22/function13781_schedule_22.o");
