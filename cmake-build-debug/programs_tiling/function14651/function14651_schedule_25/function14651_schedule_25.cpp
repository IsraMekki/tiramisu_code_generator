...
int main(int argc, char **argv){
    tiramisu::init("function14651_schedule_25");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14651/function14651_schedule_25/function14651_schedule_25.o");
