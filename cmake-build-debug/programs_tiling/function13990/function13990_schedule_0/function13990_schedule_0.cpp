...
int main(int argc, char **argv){
    tiramisu::init("function13990_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13990/function13990_schedule_0/function13990_schedule_0.o");
