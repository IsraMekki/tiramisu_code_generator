...
int main(int argc, char **argv){
    tiramisu::init("function13990_schedule_6");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function13990/function13990_schedule_6/function13990_schedule_6.o");
