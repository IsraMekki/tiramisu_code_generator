...
int main(int argc, char **argv){
    tiramisu::init("function13700_schedule_35");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i1) + input02(i0) + input03(i0, i2) + input04(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13700/function13700_schedule_35/function13700_schedule_35.o");
