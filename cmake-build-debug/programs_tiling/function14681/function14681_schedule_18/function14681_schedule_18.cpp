...
int main(int argc, char **argv){
    tiramisu::init("function14681_schedule_18");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14681/function14681_schedule_18/function14681_schedule_18.o");
