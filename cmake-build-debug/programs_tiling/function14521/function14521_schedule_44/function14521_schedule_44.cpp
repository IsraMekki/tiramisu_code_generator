...
int main(int argc, char **argv){
    tiramisu::init("function14521_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i1) - input02(i1) - input03(i2) - input04(i0) - input05(i0, i1) - input06(i0, i2) - input07(i2) * input08(i0, i1));
    ...
    buffer buf06("buf06", {1024, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14521/function14521_schedule_44/function14521_schedule_44.o");
