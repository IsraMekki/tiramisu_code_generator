...
int main(int argc, char **argv){
    tiramisu::init("function14069_schedule_28");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14069/function14069_schedule_28/function14069_schedule_28.o");
