...
int main(int argc, char **argv){
    tiramisu::init("function14069_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) * input01(i0, i2) * input02(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function14069/function14069_schedule_44/function14069_schedule_44.o");
