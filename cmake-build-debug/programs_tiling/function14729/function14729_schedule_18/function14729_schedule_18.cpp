...
int main(int argc, char **argv){
    tiramisu::init("function14729_schedule_18");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) * input01(i2) + input02(i0, i2, i3) * input03(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14729/function14729_schedule_18/function14729_schedule_18.o");
