...
int main(int argc, char **argv){
    tiramisu::init("function14729_schedule_10");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14729/function14729_schedule_10/function14729_schedule_10.o");
