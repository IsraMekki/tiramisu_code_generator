...
int main(int argc, char **argv){
    tiramisu::init("function14461_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14461/function14461_schedule_2/function14461_schedule_2.o");
