...
int main(int argc, char **argv){
    tiramisu::init("function14030_schedule_36");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14030/function14030_schedule_36/function14030_schedule_36.o");
