...
int main(int argc, char **argv){
    tiramisu::init("function14030_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function14030/function14030_no_schedule/function14030_no_schedule.o");
