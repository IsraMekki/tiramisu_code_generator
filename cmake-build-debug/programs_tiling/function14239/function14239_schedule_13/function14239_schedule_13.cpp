...
int main(int argc, char **argv){
    tiramisu::init("function14239_schedule_13");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function14239/function14239_schedule_13/function14239_schedule_13.o");
