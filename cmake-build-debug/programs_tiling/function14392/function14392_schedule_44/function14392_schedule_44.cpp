...
int main(int argc, char **argv){
    tiramisu::init("function14392_schedule_44");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i2) + input02(i0, i1) + input03(i0, i1) + input04(i0, i2) + input05(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function14392/function14392_schedule_44/function14392_schedule_44.o");
