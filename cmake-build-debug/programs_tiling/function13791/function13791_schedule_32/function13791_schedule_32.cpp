...
int main(int argc, char **argv){
    tiramisu::init("function13791_schedule_32");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) + input01(i2) + input02(i0, i1, i2) + input03(i0, i1, i3) * input04(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function13791/function13791_schedule_32/function13791_schedule_32.o");
