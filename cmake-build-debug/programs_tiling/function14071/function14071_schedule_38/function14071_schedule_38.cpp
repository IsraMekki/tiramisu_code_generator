...
int main(int argc, char **argv){
    tiramisu::init("function14071_schedule_38");
    ...
    input input04("input04", {i1, i2, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i1, i2, i3) * input02(i2) - input03(i1) + input04(i1, i2, i0) * input05(i1, i3) - input06(i0, i1, i3) * input07(i0, i1, i3) * input08(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function14071/function14071_schedule_38/function14071_schedule_38.o");
