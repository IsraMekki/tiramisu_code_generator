...
int main(int argc, char **argv){
    tiramisu::init("function66517_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66517/function66517_no_schedule/function66517_no_schedule.o");
