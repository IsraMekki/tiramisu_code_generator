...
int main(int argc, char **argv){
    tiramisu::init("function66861_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66861/function66861_no_schedule/function66861_no_schedule.o");
