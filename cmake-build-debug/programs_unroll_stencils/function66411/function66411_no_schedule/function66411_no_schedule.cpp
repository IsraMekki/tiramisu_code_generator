...
int main(int argc, char **argv){
    tiramisu::init("function66411_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) + input01(i2) - input02(i3, i0) + input03(i1) - input04(i2) * input05(i1, i3, i2) - input06(i1, i3) * input07(i0, i1, i3) - input08(i0, i2) - input09(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function66411/function66411_no_schedule/function66411_no_schedule.o");
