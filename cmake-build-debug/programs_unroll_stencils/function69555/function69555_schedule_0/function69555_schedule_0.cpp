...
int main(int argc, char **argv){
    tiramisu::init("function69555_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69555/function69555_schedule_0/function69555_schedule_0.o");
