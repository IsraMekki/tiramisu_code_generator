...
int main(int argc, char **argv){
    tiramisu::init("function71067_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71067/function71067_no_schedule/function71067_no_schedule.o");
