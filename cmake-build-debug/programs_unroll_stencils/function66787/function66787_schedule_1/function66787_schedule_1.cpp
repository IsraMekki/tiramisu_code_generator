...
int main(int argc, char **argv){
    tiramisu::init("function66787_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66787/function66787_schedule_1/function66787_schedule_1.o");
