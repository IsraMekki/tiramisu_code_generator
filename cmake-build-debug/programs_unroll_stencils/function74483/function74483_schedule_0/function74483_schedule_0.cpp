...
int main(int argc, char **argv){
    tiramisu::init("function74483_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74483/function74483_schedule_0/function74483_schedule_0.o");
