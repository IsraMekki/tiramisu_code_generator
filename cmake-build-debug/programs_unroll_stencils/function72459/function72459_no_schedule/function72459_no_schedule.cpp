...
int main(int argc, char **argv){
    tiramisu::init("function72459_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72459/function72459_no_schedule/function72459_no_schedule.o");
