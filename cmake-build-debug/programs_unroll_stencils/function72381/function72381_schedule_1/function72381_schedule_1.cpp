...
int main(int argc, char **argv){
    tiramisu::init("function72381_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72381/function72381_schedule_1/function72381_schedule_1.o");
