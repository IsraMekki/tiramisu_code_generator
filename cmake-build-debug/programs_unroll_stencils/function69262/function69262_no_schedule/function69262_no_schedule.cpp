...
int main(int argc, char **argv){
    tiramisu::init("function69262_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69262/function69262_no_schedule/function69262_no_schedule.o");
