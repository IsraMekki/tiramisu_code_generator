...
int main(int argc, char **argv){
    tiramisu::init("function71022_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71022/function71022_no_schedule/function71022_no_schedule.o");
