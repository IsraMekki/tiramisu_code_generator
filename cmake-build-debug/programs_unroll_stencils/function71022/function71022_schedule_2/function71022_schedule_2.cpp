...
int main(int argc, char **argv){
    tiramisu::init("function71022_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71022/function71022_schedule_2/function71022_schedule_2.o");
