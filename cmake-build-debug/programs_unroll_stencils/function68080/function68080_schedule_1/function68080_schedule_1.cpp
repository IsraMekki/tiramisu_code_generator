...
int main(int argc, char **argv){
    tiramisu::init("function68080_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68080/function68080_schedule_1/function68080_schedule_1.o");
