...
int main(int argc, char **argv){
    tiramisu::init("function74074_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0) * input01(i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74074/function74074_no_schedule/function74074_no_schedule.o");
