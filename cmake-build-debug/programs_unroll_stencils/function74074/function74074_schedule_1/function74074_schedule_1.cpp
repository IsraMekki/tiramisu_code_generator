...
int main(int argc, char **argv){
    tiramisu::init("function74074_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74074/function74074_schedule_1/function74074_schedule_1.o");
