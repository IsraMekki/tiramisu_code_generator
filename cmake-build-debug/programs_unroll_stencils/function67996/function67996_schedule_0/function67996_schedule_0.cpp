...
int main(int argc, char **argv){
    tiramisu::init("function67996_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67996/function67996_schedule_0/function67996_schedule_0.o");
