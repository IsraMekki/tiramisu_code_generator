...
int main(int argc, char **argv){
    tiramisu::init("function71922_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71922/function71922_schedule_0/function71922_schedule_0.o");
