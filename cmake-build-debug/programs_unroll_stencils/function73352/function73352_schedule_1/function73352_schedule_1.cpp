...
int main(int argc, char **argv){
    tiramisu::init("function73352_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73352/function73352_schedule_1/function73352_schedule_1.o");
