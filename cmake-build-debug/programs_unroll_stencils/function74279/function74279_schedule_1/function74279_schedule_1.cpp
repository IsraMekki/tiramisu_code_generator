...
int main(int argc, char **argv){
    tiramisu::init("function74279_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74279/function74279_schedule_1/function74279_schedule_1.o");
