...
int main(int argc, char **argv){
    tiramisu::init("function66897_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66897/function66897_no_schedule/function66897_no_schedule.o");
