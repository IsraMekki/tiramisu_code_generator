...
int main(int argc, char **argv){
    tiramisu::init("function69371_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69371/function69371_no_schedule/function69371_no_schedule.o");
