...
int main(int argc, char **argv){
    tiramisu::init("function69371_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69371/function69371_schedule_0/function69371_schedule_0.o");
