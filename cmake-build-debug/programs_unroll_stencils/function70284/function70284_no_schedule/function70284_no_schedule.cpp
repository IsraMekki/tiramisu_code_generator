...
int main(int argc, char **argv){
    tiramisu::init("function70284_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70284/function70284_no_schedule/function70284_no_schedule.o");
