...
int main(int argc, char **argv){
    tiramisu::init("function71960_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) - input01(i0, i1) * input02(i1) - input03(i0, i2, i3) * input04(i0, i1, i2) * input05(i1) * input06(i2, i3) * input07(i0, i2, i3) * input08(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function71960/function71960_no_schedule/function71960_no_schedule.o");
