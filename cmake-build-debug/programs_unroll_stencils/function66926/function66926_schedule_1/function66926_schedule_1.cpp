...
int main(int argc, char **argv){
    tiramisu::init("function66926_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66926/function66926_schedule_1/function66926_schedule_1.o");
