...
int main(int argc, char **argv){
    tiramisu::init("function70189_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70189/function70189_no_schedule/function70189_no_schedule.o");
