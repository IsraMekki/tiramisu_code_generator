...
int main(int argc, char **argv){
    tiramisu::init("function64971_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64971/function64971_no_schedule/function64971_no_schedule.o");
