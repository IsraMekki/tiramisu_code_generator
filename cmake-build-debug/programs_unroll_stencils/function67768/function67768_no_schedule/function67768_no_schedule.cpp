...
int main(int argc, char **argv){
    tiramisu::init("function67768_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67768/function67768_no_schedule/function67768_no_schedule.o");
