...
int main(int argc, char **argv){
    tiramisu::init("function73788_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73788/function73788_schedule_1/function73788_schedule_1.o");
