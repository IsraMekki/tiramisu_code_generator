...
int main(int argc, char **argv){
    tiramisu::init("function73930_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i0, i1, i2) - input02(i0, i2, i3) + input03(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73930/function73930_no_schedule/function73930_no_schedule.o");
