...
int main(int argc, char **argv){
    tiramisu::init("function64935_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64935/function64935_schedule_0/function64935_schedule_0.o");
