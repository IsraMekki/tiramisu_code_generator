...
int main(int argc, char **argv){
    tiramisu::init("function69812_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69812/function69812_no_schedule/function69812_no_schedule.o");
