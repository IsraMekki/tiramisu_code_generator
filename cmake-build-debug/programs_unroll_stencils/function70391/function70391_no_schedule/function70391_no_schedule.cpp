...
int main(int argc, char **argv){
    tiramisu::init("function70391_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70391/function70391_no_schedule/function70391_no_schedule.o");
