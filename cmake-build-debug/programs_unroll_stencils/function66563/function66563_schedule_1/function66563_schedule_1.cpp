...
int main(int argc, char **argv){
    tiramisu::init("function66563_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66563/function66563_schedule_1/function66563_schedule_1.o");
