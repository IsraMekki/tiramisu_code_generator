...
int main(int argc, char **argv){
    tiramisu::init("function66037_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66037/function66037_no_schedule/function66037_no_schedule.o");
