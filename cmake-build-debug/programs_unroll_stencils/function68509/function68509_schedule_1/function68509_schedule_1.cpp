...
int main(int argc, char **argv){
    tiramisu::init("function68509_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68509/function68509_schedule_1/function68509_schedule_1.o");
