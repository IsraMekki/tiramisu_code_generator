...
int main(int argc, char **argv){
    tiramisu::init("function66923_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66923/function66923_no_schedule/function66923_no_schedule.o");
