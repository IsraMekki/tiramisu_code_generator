...
int main(int argc, char **argv){
    tiramisu::init("function65056_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65056/function65056_schedule_0/function65056_schedule_0.o");
