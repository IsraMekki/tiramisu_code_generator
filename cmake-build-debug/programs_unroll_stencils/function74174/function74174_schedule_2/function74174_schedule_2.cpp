...
int main(int argc, char **argv){
    tiramisu::init("function74174_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74174/function74174_schedule_2/function74174_schedule_2.o");
