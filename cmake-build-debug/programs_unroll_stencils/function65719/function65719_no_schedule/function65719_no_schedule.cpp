...
int main(int argc, char **argv){
    tiramisu::init("function65719_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65719/function65719_no_schedule/function65719_no_schedule.o");
