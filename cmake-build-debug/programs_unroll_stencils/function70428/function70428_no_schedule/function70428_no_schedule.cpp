...
int main(int argc, char **argv){
    tiramisu::init("function70428_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1) * input02(i1, i2) + input03(i0, i2) * input04(i1) * input05(i1, i2) + input06(i2) * input07(i1, i2) * input08(i1, i2) - input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70428/function70428_no_schedule/function70428_no_schedule.o");
