...
int main(int argc, char **argv){
    tiramisu::init("function67694_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67694/function67694_schedule_0/function67694_schedule_0.o");
