...
int main(int argc, char **argv){
    tiramisu::init("function67903_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67903/function67903_schedule_1/function67903_schedule_1.o");
