...
int main(int argc, char **argv){
    tiramisu::init("function73975_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73975/function73975_schedule_2/function73975_schedule_2.o");
