...
int main(int argc, char **argv){
    tiramisu::init("function67306_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67306/function67306_schedule_0/function67306_schedule_0.o");
