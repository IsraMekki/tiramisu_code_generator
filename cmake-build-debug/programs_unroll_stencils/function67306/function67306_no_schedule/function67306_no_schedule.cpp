...
int main(int argc, char **argv){
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3, i1, i0) - input01(i0, i1, i3) * input02(i0, i2, i3) - input03(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67306/function67306_no_schedule/function67306_no_schedule.o");
