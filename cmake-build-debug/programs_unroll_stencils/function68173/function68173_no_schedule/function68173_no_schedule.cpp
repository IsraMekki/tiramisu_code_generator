...
int main(int argc, char **argv){
    tiramisu::init("function68173_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i2) + input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68173/function68173_no_schedule/function68173_no_schedule.o");
