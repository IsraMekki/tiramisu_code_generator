...
int main(int argc, char **argv){
    tiramisu::init("function68173_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68173/function68173_schedule_0/function68173_schedule_0.o");
