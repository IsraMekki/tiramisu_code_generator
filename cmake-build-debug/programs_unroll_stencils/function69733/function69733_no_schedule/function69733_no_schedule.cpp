...
int main(int argc, char **argv){
    tiramisu::init("function69733_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69733/function69733_no_schedule/function69733_no_schedule.o");
