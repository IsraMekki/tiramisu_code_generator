...
int main(int argc, char **argv){
    tiramisu::init("function69165_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) * input01(i3) - input02(i3) - input03(i0, i3) * input04(i3) + input05(i0, i1, i2) * input06(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function69165/function69165_no_schedule/function69165_no_schedule.o");
