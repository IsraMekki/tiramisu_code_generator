...
int main(int argc, char **argv){
    tiramisu::init("function66232_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66232/function66232_schedule_1/function66232_schedule_1.o");
