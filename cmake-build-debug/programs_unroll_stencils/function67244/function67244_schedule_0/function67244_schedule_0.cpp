...
int main(int argc, char **argv){
    tiramisu::init("function67244_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67244/function67244_schedule_0/function67244_schedule_0.o");
