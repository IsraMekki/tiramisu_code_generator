...
int main(int argc, char **argv){
    tiramisu::init("function67748_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67748/function67748_no_schedule/function67748_no_schedule.o");
