...
int main(int argc, char **argv){
    tiramisu::init("function70571_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70571/function70571_schedule_1/function70571_schedule_1.o");
