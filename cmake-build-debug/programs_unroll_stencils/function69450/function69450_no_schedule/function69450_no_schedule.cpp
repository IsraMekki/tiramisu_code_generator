...
int main(int argc, char **argv){
    tiramisu::init("function69450_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69450/function69450_no_schedule/function69450_no_schedule.o");
