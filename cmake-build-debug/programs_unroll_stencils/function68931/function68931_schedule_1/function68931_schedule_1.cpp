...
int main(int argc, char **argv){
    tiramisu::init("function68931_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68931/function68931_schedule_1/function68931_schedule_1.o");
