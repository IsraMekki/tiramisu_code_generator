...
int main(int argc, char **argv){
    tiramisu::init("function70177_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70177/function70177_schedule_1/function70177_schedule_1.o");
