...
int main(int argc, char **argv){
    tiramisu::init("function70177_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70177/function70177_no_schedule/function70177_no_schedule.o");
