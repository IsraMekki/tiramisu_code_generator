...
int main(int argc, char **argv){
    tiramisu::init("function69297_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69297/function69297_schedule_0/function69297_schedule_0.o");
