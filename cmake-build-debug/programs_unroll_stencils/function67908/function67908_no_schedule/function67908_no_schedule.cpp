...
int main(int argc, char **argv){
    tiramisu::init("function67908_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67908/function67908_no_schedule/function67908_no_schedule.o");
