...
int main(int argc, char **argv){
    tiramisu::init("function74203_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74203/function74203_schedule_0/function74203_schedule_0.o");
