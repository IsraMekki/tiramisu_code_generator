...
int main(int argc, char **argv){
    tiramisu::init("function70034_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70034/function70034_no_schedule/function70034_no_schedule.o");
