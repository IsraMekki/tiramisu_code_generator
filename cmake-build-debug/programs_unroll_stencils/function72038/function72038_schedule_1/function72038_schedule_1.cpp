...
int main(int argc, char **argv){
    tiramisu::init("function72038_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72038/function72038_schedule_1/function72038_schedule_1.o");
