...
int main(int argc, char **argv){
    tiramisu::init("function73263_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73263/function73263_schedule_0/function73263_schedule_0.o");
