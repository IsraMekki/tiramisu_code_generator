...
int main(int argc, char **argv){
    tiramisu::init("function67743_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67743/function67743_schedule_2/function67743_schedule_2.o");
