...
int main(int argc, char **argv){
    tiramisu::init("function71827_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71827/function71827_schedule_1/function71827_schedule_1.o");
