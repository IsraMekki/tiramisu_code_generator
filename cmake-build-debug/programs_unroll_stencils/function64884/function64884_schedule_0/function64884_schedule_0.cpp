...
int main(int argc, char **argv){
    tiramisu::init("function64884_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64884/function64884_schedule_0/function64884_schedule_0.o");
