...
int main(int argc, char **argv){
    tiramisu::init("function72693_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72693/function72693_no_schedule/function72693_no_schedule.o");
