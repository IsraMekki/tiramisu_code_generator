...
int main(int argc, char **argv){
    tiramisu::init("function64833_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64833/function64833_schedule_1/function64833_schedule_1.o");
