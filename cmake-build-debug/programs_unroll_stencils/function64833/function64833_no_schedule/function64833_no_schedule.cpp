...
int main(int argc, char **argv){
    tiramisu::init("function64833_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i0, i1, i3) - input02(i1, i2, i3) - input03(i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64833/function64833_no_schedule/function64833_no_schedule.o");
