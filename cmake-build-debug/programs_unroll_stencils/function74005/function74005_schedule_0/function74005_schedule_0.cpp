...
int main(int argc, char **argv){
    tiramisu::init("function74005_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74005/function74005_schedule_0/function74005_schedule_0.o");
