...
int main(int argc, char **argv){
    tiramisu::init("function74517_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74517/function74517_no_schedule/function74517_no_schedule.o");
