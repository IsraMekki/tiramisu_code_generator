...
int main(int argc, char **argv){
    tiramisu::init("function65813_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65813/function65813_no_schedule/function65813_no_schedule.o");
