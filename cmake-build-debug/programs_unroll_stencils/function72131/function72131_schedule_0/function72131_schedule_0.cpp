...
int main(int argc, char **argv){
    tiramisu::init("function72131_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72131/function72131_schedule_0/function72131_schedule_0.o");
