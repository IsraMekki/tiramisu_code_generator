...
int main(int argc, char **argv){
    tiramisu::init("function67301_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67301/function67301_schedule_2/function67301_schedule_2.o");
