...
int main(int argc, char **argv){
    tiramisu::init("function68417_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68417/function68417_schedule_1/function68417_schedule_1.o");
