...
int main(int argc, char **argv){
    tiramisu::init("function68417_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68417/function68417_no_schedule/function68417_no_schedule.o");
