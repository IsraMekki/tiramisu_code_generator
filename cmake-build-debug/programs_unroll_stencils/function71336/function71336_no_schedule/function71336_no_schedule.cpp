...
int main(int argc, char **argv){
    tiramisu::init("function71336_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71336/function71336_no_schedule/function71336_no_schedule.o");
