...
int main(int argc, char **argv){
    tiramisu::init("function69134_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69134/function69134_no_schedule/function69134_no_schedule.o");
