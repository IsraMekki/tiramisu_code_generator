...
int main(int argc, char **argv){
    tiramisu::init("function68718_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68718/function68718_schedule_2/function68718_schedule_2.o");
