...
int main(int argc, char **argv){
    tiramisu::init("function67950_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67950/function67950_no_schedule/function67950_no_schedule.o");
