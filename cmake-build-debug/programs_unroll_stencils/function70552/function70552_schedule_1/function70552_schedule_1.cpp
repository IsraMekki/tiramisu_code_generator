...
int main(int argc, char **argv){
    tiramisu::init("function70552_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70552/function70552_schedule_1/function70552_schedule_1.o");
