...
int main(int argc, char **argv){
    tiramisu::init("function66832_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66832/function66832_no_schedule/function66832_no_schedule.o");
