...
int main(int argc, char **argv){
    tiramisu::init("function71996_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71996/function71996_schedule_1/function71996_schedule_1.o");
