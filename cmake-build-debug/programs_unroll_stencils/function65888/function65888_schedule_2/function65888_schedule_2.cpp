...
int main(int argc, char **argv){
    tiramisu::init("function65888_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65888/function65888_schedule_2/function65888_schedule_2.o");
