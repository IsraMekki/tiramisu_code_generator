...
int main(int argc, char **argv){
    tiramisu::init("function68660_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68660/function68660_no_schedule/function68660_no_schedule.o");
