...
int main(int argc, char **argv){
    tiramisu::init("function68693_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68693/function68693_no_schedule/function68693_no_schedule.o");
