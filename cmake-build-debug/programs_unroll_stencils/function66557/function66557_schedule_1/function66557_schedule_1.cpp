...
int main(int argc, char **argv){
    tiramisu::init("function66557_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66557/function66557_schedule_1/function66557_schedule_1.o");
