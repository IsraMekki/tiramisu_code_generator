...
int main(int argc, char **argv){
    tiramisu::init("function66001_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66001/function66001_no_schedule/function66001_no_schedule.o");
