...
int main(int argc, char **argv){
    tiramisu::init("function66944_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66944/function66944_schedule_1/function66944_schedule_1.o");
