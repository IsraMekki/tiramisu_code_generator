...
int main(int argc, char **argv){
    tiramisu::init("function73264_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73264/function73264_schedule_1/function73264_schedule_1.o");
