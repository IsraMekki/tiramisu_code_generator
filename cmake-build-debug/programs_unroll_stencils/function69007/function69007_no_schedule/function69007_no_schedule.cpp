...
int main(int argc, char **argv){
    tiramisu::init("function69007_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i0, i1) * input02(i0, i2) - input03(i0, i1) * input04(i0) * input05(i0) + input06(i0, i2) - input07(i2) * input08(i0) * input09(i0));
    ...
    buffer buf03("buf03", {256, 2048}, p_int32, a_input);
    buffer buf04("buf04", {256}, p_int32, a_input);
    buffer buf05("buf05", {256}, p_int32, a_input);
    buffer buf06("buf06", {256, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69007/function69007_no_schedule/function69007_no_schedule.o");
