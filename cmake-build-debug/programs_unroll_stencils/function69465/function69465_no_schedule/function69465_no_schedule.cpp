...
int main(int argc, char **argv){
    tiramisu::init("function69465_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69465/function69465_no_schedule/function69465_no_schedule.o");
