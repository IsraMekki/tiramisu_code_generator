...
int main(int argc, char **argv){
    tiramisu::init("function69792_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69792/function69792_no_schedule/function69792_no_schedule.o");
