...
int main(int argc, char **argv){
    tiramisu::init("function74402_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74402/function74402_schedule_0/function74402_schedule_0.o");
