...
int main(int argc, char **argv){
    tiramisu::init("function66819_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i0, i1) + input02(i0) + input03(i0, i1) + input04(i1, i2) + input05(i2) - input06(i0, i1) * input07(i0, i1) * input08(i1, i2));
    ...
    buffer buf08("buf08", {256, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function66819/function66819_no_schedule/function66819_no_schedule.o");
