...
int main(int argc, char **argv){
    tiramisu::init("function66706_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66706/function66706_no_schedule/function66706_no_schedule.o");
