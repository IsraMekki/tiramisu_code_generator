...
int main(int argc, char **argv){
    tiramisu::init("function66706_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66706/function66706_schedule_2/function66706_schedule_2.o");
