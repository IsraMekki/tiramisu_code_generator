...
int main(int argc, char **argv){
    tiramisu::init("function69648_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69648/function69648_schedule_1/function69648_schedule_1.o");
