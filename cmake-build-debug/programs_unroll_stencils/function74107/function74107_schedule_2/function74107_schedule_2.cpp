...
int main(int argc, char **argv){
    tiramisu::init("function74107_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74107/function74107_schedule_2/function74107_schedule_2.o");
