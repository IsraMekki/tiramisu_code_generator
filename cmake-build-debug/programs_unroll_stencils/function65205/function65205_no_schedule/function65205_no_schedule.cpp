...
int main(int argc, char **argv){
    tiramisu::init("function65205_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) * input01(i0, i1, i3) * input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65205/function65205_no_schedule/function65205_no_schedule.o");
