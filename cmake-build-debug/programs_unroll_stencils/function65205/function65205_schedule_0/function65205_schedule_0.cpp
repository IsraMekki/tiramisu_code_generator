...
int main(int argc, char **argv){
    tiramisu::init("function65205_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65205/function65205_schedule_0/function65205_schedule_0.o");
