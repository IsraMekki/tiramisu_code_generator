...
int main(int argc, char **argv){
    tiramisu::init("function74160_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74160/function74160_schedule_0/function74160_schedule_0.o");
