...
int main(int argc, char **argv){
    tiramisu::init("function72698_no_schedule");
    ...
    input input02("input02", {i1, i2, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) + input01(i3) + input02(i1, i2, i0) + input03(i0) + input04(i0, i1) + input05(i0, i3) - input06(i1, i3) - input07(i0, i1, i2) - input08(i2) - input09(i0, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function72698/function72698_no_schedule/function72698_no_schedule.o");
