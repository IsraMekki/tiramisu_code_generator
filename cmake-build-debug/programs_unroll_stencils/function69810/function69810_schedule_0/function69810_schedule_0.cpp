...
int main(int argc, char **argv){
    tiramisu::init("function69810_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69810/function69810_schedule_0/function69810_schedule_0.o");
