...
int main(int argc, char **argv){
    tiramisu::init("function66145_no_schedule");
    ...
    input input04("input04", {i2, i3, i1}, p_int32);

    input input05("input05", {i0, i1, i2}, p_int32);

    input input06("input06", {i0, i1}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) + input01(i1, i3) + input02(i1, i2) - input03(i3, i1) - input04(i2, i3, i1) * input05(i0, i1, i2) * input06(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function66145/function66145_no_schedule/function66145_no_schedule.o");
