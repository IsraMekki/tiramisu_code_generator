...
int main(int argc, char **argv){
    tiramisu::init("function69166_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69166/function69166_schedule_2/function69166_schedule_2.o");
