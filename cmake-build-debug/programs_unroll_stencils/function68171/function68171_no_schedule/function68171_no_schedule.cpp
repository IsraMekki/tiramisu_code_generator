...
int main(int argc, char **argv){
    tiramisu::init("function68171_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68171/function68171_no_schedule/function68171_no_schedule.o");
