...
int main(int argc, char **argv){
    tiramisu::init("function68413_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68413/function68413_schedule_1/function68413_schedule_1.o");
