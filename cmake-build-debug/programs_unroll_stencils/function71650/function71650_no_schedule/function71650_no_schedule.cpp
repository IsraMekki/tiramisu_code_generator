...
int main(int argc, char **argv){
    tiramisu::init("function71650_no_schedule");
    ...
    input input01("input01", {i3, i2}, p_int32);

    input input02("input02", {i1}, p_int32);

    input input03("input03", {i3, i2}, p_int32);
    ...
    input input09("input09", {i1, i0, i3}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) - input01(i3, i2) + input02(i1) + input03(i3, i2) - input04(i0, i1, i2) - input05(i1, i3) + input06(i0) - input07(i2) + input08(i1, i2) * input09(i1, i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function71650/function71650_no_schedule/function71650_no_schedule.o");
