...
int main(int argc, char **argv){
    tiramisu::init("function69798_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i1, i2, i3) - input02(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69798/function69798_no_schedule/function69798_no_schedule.o");
