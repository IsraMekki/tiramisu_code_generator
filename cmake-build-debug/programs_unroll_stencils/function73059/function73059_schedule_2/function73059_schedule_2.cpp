...
int main(int argc, char **argv){
    tiramisu::init("function73059_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73059/function73059_schedule_2/function73059_schedule_2.o");
