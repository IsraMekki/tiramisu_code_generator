...
int main(int argc, char **argv){
    tiramisu::init("function70599_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70599/function70599_schedule_1/function70599_schedule_1.o");
