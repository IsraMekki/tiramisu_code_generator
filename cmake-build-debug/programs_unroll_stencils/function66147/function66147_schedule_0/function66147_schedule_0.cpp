...
int main(int argc, char **argv){
    tiramisu::init("function66147_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66147/function66147_schedule_0/function66147_schedule_0.o");
