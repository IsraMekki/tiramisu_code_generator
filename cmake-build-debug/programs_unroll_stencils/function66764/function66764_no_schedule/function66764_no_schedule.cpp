...
int main(int argc, char **argv){
    tiramisu::init("function66764_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66764/function66764_no_schedule/function66764_no_schedule.o");
