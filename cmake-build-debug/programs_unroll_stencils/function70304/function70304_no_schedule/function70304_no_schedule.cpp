...
int main(int argc, char **argv){
    tiramisu::init("function70304_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70304/function70304_no_schedule/function70304_no_schedule.o");
