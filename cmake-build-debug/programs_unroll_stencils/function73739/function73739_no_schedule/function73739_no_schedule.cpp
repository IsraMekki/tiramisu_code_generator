...
int main(int argc, char **argv){
    tiramisu::init("function73739_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73739/function73739_no_schedule/function73739_no_schedule.o");
