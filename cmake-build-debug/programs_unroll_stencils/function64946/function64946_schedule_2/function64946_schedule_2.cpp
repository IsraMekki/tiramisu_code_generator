...
int main(int argc, char **argv){
    tiramisu::init("function64946_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64946/function64946_schedule_2/function64946_schedule_2.o");
