...
int main(int argc, char **argv){
    tiramisu::init("function74521_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74521/function74521_no_schedule/function74521_no_schedule.o");
