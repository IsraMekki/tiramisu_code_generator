...
int main(int argc, char **argv){
    tiramisu::init("function74521_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74521/function74521_schedule_0/function74521_schedule_0.o");
