...
int main(int argc, char **argv){
    tiramisu::init("function66562_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66562/function66562_schedule_0/function66562_schedule_0.o");
