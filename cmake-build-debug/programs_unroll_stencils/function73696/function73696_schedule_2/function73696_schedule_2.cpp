...
int main(int argc, char **argv){
    tiramisu::init("function73696_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73696/function73696_schedule_2/function73696_schedule_2.o");
