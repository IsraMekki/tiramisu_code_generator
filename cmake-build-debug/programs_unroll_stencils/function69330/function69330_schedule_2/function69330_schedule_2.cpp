...
int main(int argc, char **argv){
    tiramisu::init("function69330_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69330/function69330_schedule_2/function69330_schedule_2.o");
