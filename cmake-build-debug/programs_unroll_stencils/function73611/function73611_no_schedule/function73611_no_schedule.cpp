...
int main(int argc, char **argv){
    tiramisu::init("function73611_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73611/function73611_no_schedule/function73611_no_schedule.o");
