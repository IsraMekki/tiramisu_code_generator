...
int main(int argc, char **argv){
    tiramisu::init("function67979_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67979/function67979_schedule_1/function67979_schedule_1.o");
