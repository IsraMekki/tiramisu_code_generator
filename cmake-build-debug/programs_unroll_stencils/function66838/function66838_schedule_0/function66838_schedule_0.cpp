...
int main(int argc, char **argv){
    tiramisu::init("function66838_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66838/function66838_schedule_0/function66838_schedule_0.o");
