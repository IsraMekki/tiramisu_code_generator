...
int main(int argc, char **argv){
    tiramisu::init("function71021_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71021/function71021_no_schedule/function71021_no_schedule.o");
