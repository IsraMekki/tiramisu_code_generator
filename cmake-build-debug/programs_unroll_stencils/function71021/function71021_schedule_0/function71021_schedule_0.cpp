...
int main(int argc, char **argv){
    tiramisu::init("function71021_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71021/function71021_schedule_0/function71021_schedule_0.o");
