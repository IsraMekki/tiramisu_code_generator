...
int main(int argc, char **argv){
    tiramisu::init("function73964_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73964/function73964_no_schedule/function73964_no_schedule.o");
