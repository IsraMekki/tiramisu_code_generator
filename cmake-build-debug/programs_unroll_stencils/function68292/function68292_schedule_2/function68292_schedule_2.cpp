...
int main(int argc, char **argv){
    tiramisu::init("function68292_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68292/function68292_schedule_2/function68292_schedule_2.o");
