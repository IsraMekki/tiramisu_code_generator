...
int main(int argc, char **argv){
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3, i1, i2) + input01(i2, i3) + input02(i1) + input03(i0, i2) + input04(i0, i1, i3) * input05(i1) * input06(i0) - input07(i1, i3) + input08(i1) + input09(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function71681/function71681_no_schedule/function71681_no_schedule.o");
