...
int main(int argc, char **argv){
    tiramisu::init("function70255_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70255/function70255_no_schedule/function70255_no_schedule.o");
