...
int main(int argc, char **argv){
    tiramisu::init("function70618_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70618/function70618_schedule_0/function70618_schedule_0.o");
