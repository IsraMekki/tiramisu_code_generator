...
int main(int argc, char **argv){
    tiramisu::init("function70618_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0) * input02(i0) - input03(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70618/function70618_no_schedule/function70618_no_schedule.o");
