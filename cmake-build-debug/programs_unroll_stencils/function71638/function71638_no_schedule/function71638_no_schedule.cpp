...
int main(int argc, char **argv){
    tiramisu::init("function71638_no_schedule");
    ...
    input input05("input05", {i3, i2, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) - input01(i2, i3, i0) + input02(i2, i3) - input03(i3) * input04(i1, i2, i3) + input05(i3, i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function71638/function71638_no_schedule/function71638_no_schedule.o");
