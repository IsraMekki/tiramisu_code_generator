...
int main(int argc, char **argv){
    tiramisu::init("function72535_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72535/function72535_no_schedule/function72535_no_schedule.o");
