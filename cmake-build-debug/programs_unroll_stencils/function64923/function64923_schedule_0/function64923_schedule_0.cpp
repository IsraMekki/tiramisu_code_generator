...
int main(int argc, char **argv){
    tiramisu::init("function64923_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64923/function64923_schedule_0/function64923_schedule_0.o");
