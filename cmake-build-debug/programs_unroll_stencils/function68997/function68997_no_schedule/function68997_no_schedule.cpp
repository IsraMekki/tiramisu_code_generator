...
int main(int argc, char **argv){
    tiramisu::init("function68997_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68997/function68997_no_schedule/function68997_no_schedule.o");
