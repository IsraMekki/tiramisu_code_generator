...
int main(int argc, char **argv){
    tiramisu::init("function70885_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70885/function70885_no_schedule/function70885_no_schedule.o");
