...
int main(int argc, char **argv){
    tiramisu::init("function71690_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71690/function71690_schedule_0/function71690_schedule_0.o");
