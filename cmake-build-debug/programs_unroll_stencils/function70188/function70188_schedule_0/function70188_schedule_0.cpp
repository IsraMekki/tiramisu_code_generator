...
int main(int argc, char **argv){
    tiramisu::init("function70188_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70188/function70188_schedule_0/function70188_schedule_0.o");
