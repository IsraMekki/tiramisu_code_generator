...
int main(int argc, char **argv){
    tiramisu::init("function68521_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68521/function68521_schedule_1/function68521_schedule_1.o");
