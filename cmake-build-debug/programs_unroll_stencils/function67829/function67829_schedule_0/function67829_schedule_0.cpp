...
int main(int argc, char **argv){
    tiramisu::init("function67829_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67829/function67829_schedule_0/function67829_schedule_0.o");
