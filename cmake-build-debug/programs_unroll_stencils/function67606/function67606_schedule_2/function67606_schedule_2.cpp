...
int main(int argc, char **argv){
    tiramisu::init("function67606_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67606/function67606_schedule_2/function67606_schedule_2.o");
