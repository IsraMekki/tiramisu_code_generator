...
int main(int argc, char **argv){
    tiramisu::init("function71205_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71205/function71205_schedule_2/function71205_schedule_2.o");
