...
int main(int argc, char **argv){
    tiramisu::init("function72464_schedule_2");
    ...
    buffer buf00("buf00", {256, 64, 64, 64}, p_int32, a_input);
    buffer buf0("buf0", {256, 64, 64, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function72464/function72464_schedule_2/function72464_schedule_2.o");
