...
int main(int argc, char **argv){
    tiramisu::init("function72611_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72611/function72611_no_schedule/function72611_no_schedule.o");
