...
int main(int argc, char **argv){
    tiramisu::init("function72161_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72161/function72161_schedule_0/function72161_schedule_0.o");
