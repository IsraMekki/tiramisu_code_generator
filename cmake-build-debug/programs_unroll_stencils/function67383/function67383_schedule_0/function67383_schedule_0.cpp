...
int main(int argc, char **argv){
    tiramisu::init("function67383_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67383/function67383_schedule_0/function67383_schedule_0.o");
