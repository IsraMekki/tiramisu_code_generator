...
int main(int argc, char **argv){
    tiramisu::init("function68821_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68821/function68821_schedule_0/function68821_schedule_0.o");
