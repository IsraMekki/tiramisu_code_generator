...
int main(int argc, char **argv){
    tiramisu::init("function67437_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67437/function67437_no_schedule/function67437_no_schedule.o");
