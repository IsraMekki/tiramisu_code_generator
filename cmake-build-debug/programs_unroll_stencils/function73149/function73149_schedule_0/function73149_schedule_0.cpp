...
int main(int argc, char **argv){
    tiramisu::init("function73149_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73149/function73149_schedule_0/function73149_schedule_0.o");
