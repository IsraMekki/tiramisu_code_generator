...
int main(int argc, char **argv){
    tiramisu::init("function73069_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73069/function73069_no_schedule/function73069_no_schedule.o");
