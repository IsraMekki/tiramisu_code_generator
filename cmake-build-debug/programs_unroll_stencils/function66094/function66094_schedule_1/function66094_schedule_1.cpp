...
int main(int argc, char **argv){
    tiramisu::init("function66094_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66094/function66094_schedule_1/function66094_schedule_1.o");
