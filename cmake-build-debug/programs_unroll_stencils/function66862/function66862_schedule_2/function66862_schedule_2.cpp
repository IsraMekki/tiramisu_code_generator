...
int main(int argc, char **argv){
    tiramisu::init("function66862_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66862/function66862_schedule_2/function66862_schedule_2.o");
