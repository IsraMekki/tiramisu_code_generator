...
int main(int argc, char **argv){
    tiramisu::init("function69220_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69220/function69220_schedule_2/function69220_schedule_2.o");
