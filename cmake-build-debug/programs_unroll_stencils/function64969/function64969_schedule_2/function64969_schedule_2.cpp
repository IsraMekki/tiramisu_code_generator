...
int main(int argc, char **argv){
    tiramisu::init("function64969_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64969/function64969_schedule_2/function64969_schedule_2.o");
