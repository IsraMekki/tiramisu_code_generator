...
int main(int argc, char **argv){
    tiramisu::init("function72658_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72658/function72658_no_schedule/function72658_no_schedule.o");
