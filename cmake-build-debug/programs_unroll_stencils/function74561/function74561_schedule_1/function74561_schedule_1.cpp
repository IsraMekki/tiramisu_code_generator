...
int main(int argc, char **argv){
    tiramisu::init("function74561_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74561/function74561_schedule_1/function74561_schedule_1.o");
