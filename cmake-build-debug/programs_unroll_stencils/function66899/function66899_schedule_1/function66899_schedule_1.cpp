...
int main(int argc, char **argv){
    tiramisu::init("function66899_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66899/function66899_schedule_1/function66899_schedule_1.o");
