...
int main(int argc, char **argv){
    tiramisu::init("function66899_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66899/function66899_schedule_0/function66899_schedule_0.o");
