...
int main(int argc, char **argv){
    tiramisu::init("function67947_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67947/function67947_schedule_0/function67947_schedule_0.o");
