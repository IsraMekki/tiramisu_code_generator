...
int main(int argc, char **argv){
    tiramisu::init("function66956_no_schedule");

    constant c0("c0", 16384), c1("c1", 8192);
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) - input01(i0) * input02(i1) - input03(i0) + input04(i1) - input05(i1));
    ...
    buffer buf0("buf0", {16384, 8192}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function66956/function66956_no_schedule/function66956_no_schedule.o");
