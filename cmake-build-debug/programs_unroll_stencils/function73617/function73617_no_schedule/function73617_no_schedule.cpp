...
int main(int argc, char **argv){
    tiramisu::init("function73617_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73617/function73617_no_schedule/function73617_no_schedule.o");
