...
int main(int argc, char **argv){
    tiramisu::init("function71958_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71958/function71958_schedule_0/function71958_schedule_0.o");
