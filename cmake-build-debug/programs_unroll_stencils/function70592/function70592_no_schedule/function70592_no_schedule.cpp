...
int main(int argc, char **argv){
    tiramisu::init("function70592_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70592/function70592_no_schedule/function70592_no_schedule.o");
