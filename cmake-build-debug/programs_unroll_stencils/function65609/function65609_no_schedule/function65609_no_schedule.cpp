...
int main(int argc, char **argv){
    tiramisu::init("function65609_no_schedule");

    constant c0("c0", 131072), c1("c1", 1024);
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) - input01(i0) + input02(i1) - input03(i0) + input04(i1) + input05(i1) - input06(i1) + input07(i0) * input08(i1) - input09(i0));
    ...
    buffer buf0("buf0", {131072, 1024}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function65609/function65609_no_schedule/function65609_no_schedule.o");
