...
int main(int argc, char **argv){
    tiramisu::init("function66161_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66161/function66161_schedule_1/function66161_schedule_1.o");
