...
int main(int argc, char **argv){
    tiramisu::init("function70909_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70909/function70909_schedule_0/function70909_schedule_0.o");
