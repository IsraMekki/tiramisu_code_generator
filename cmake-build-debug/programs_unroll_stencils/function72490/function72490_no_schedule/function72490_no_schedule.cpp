...
int main(int argc, char **argv){
    tiramisu::init("function72490_no_schedule");
    ...
    input input02("input02", {i3, i2}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i2) - input02(i3, i2) - input03(i0) - input04(i1, i2, i3) + input05(i1, i2, i3) - input06(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function72490/function72490_no_schedule/function72490_no_schedule.o");
