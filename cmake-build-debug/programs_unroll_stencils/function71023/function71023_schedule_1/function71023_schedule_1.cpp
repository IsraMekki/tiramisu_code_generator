...
int main(int argc, char **argv){
    tiramisu::init("function71023_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71023/function71023_schedule_1/function71023_schedule_1.o");
