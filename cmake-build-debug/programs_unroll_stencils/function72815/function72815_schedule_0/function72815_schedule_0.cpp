...
int main(int argc, char **argv){
    tiramisu::init("function72815_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72815/function72815_schedule_0/function72815_schedule_0.o");
