...
int main(int argc, char **argv){
    tiramisu::init("function73096_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73096/function73096_schedule_2/function73096_schedule_2.o");
