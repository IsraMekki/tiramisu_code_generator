...
int main(int argc, char **argv){
    tiramisu::init("function68423_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68423/function68423_schedule_0/function68423_schedule_0.o");
