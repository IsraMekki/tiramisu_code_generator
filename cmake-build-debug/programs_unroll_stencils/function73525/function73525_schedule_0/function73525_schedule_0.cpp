...
int main(int argc, char **argv){
    tiramisu::init("function73525_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73525/function73525_schedule_0/function73525_schedule_0.o");
