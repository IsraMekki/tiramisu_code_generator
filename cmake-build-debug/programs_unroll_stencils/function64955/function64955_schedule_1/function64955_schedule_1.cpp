...
int main(int argc, char **argv){
    tiramisu::init("function64955_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function64955/function64955_schedule_1/function64955_schedule_1.o");
