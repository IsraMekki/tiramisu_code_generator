...
int main(int argc, char **argv){
    tiramisu::init("function70041_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70041/function70041_no_schedule/function70041_no_schedule.o");
