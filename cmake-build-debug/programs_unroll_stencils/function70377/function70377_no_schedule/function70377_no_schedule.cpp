...
int main(int argc, char **argv){
    tiramisu::init("function70377_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70377/function70377_no_schedule/function70377_no_schedule.o");
