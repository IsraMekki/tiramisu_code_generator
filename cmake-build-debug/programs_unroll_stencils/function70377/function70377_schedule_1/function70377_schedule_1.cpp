...
int main(int argc, char **argv){
    tiramisu::init("function70377_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70377/function70377_schedule_1/function70377_schedule_1.o");
