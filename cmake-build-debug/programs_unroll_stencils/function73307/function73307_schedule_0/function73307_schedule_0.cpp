...
int main(int argc, char **argv){
    tiramisu::init("function73307_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73307/function73307_schedule_0/function73307_schedule_0.o");
