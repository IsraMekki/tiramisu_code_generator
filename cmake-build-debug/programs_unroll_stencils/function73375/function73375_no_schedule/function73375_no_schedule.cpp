...
int main(int argc, char **argv){
    tiramisu::init("function73375_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73375/function73375_no_schedule/function73375_no_schedule.o");
