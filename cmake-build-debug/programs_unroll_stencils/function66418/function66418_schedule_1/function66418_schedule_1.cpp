...
int main(int argc, char **argv){
    tiramisu::init("function66418_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66418/function66418_schedule_1/function66418_schedule_1.o");
