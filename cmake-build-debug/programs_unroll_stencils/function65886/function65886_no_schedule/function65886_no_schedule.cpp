...
int main(int argc, char **argv){
    tiramisu::init("function65886_no_schedule");
    ...
    input input05("input05", {i2, i0}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) + input01(i0, i2) - input02(i1, i2) + input03(i2) + input04(i1, i2) - input05(i2, i0) - input06(i1) - input07(i0) + input08(i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65886/function65886_no_schedule/function65886_no_schedule.o");
