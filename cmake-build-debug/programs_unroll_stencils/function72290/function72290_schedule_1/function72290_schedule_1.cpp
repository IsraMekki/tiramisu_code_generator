...
int main(int argc, char **argv){
    tiramisu::init("function72290_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72290/function72290_schedule_1/function72290_schedule_1.o");
