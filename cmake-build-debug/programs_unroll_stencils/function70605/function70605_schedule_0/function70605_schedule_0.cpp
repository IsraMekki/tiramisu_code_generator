...
int main(int argc, char **argv){
    tiramisu::init("function70605_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70605/function70605_schedule_0/function70605_schedule_0.o");
