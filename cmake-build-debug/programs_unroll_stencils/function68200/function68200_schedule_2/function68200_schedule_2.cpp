...
int main(int argc, char **argv){
    tiramisu::init("function68200_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68200/function68200_schedule_2/function68200_schedule_2.o");
