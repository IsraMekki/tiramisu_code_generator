...
int main(int argc, char **argv){
    tiramisu::init("function66211_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) + input01(i1, i2) + input02(i0, i1) - input03(i0) - input04(i0, i2) - input05(i1) - input06(i0, i1) - input07(i1, i0) * input08(i1));
    ...
    buffer buf07("buf07", {4096, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function66211/function66211_no_schedule/function66211_no_schedule.o");
