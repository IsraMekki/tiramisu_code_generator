...
int main(int argc, char **argv){
    tiramisu::init("function73770_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73770/function73770_no_schedule/function73770_no_schedule.o");
