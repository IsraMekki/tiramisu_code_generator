...
int main(int argc, char **argv){
    tiramisu::init("function67608_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i2) * input02(i2, i3) * input03(i3) - input04(i1) - input05(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function67608/function67608_no_schedule/function67608_no_schedule.o");
