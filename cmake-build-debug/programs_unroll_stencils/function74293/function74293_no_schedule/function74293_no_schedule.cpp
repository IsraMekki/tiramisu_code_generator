...
int main(int argc, char **argv){
    tiramisu::init("function74293_no_schedule");
    ...
    input input01("input01", {i1, i2, i0}, p_int32);

    input input02("input02", {i1, i2, i3}, p_int32);

    input input03("input03", {i0, i1, i3}, p_int32);

    input input04("input04", {i3, i0, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) - input01(i1, i2, i0) * input02(i1, i2, i3) - input03(i0, i1, i3) * input04(i3, i0, i1) * input05(i1, i2, i3) + input06(i2) - input07(i1) - input08(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function74293/function74293_no_schedule/function74293_no_schedule.o");
