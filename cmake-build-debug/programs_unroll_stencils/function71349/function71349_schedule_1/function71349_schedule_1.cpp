...
int main(int argc, char **argv){
    tiramisu::init("function71349_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71349/function71349_schedule_1/function71349_schedule_1.o");
