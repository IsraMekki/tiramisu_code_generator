...
int main(int argc, char **argv){
    tiramisu::init("function71349_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71349/function71349_schedule_2/function71349_schedule_2.o");
