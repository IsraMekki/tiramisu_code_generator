...
int main(int argc, char **argv){
    tiramisu::init("function71842_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71842/function71842_no_schedule/function71842_no_schedule.o");
