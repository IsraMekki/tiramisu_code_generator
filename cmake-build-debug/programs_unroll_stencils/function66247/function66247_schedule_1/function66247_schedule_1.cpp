...
int main(int argc, char **argv){
    tiramisu::init("function66247_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66247/function66247_schedule_1/function66247_schedule_1.o");
