...
int main(int argc, char **argv){
    tiramisu::init("function68637_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68637/function68637_schedule_2/function68637_schedule_2.o");
