...
int main(int argc, char **argv){
    tiramisu::init("function70201_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70201/function70201_no_schedule/function70201_no_schedule.o");
