...
int main(int argc, char **argv){
    tiramisu::init("function70201_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70201/function70201_schedule_1/function70201_schedule_1.o");
