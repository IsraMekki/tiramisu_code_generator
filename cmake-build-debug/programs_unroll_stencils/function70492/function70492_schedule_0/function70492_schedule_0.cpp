...
int main(int argc, char **argv){
    tiramisu::init("function70492_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70492/function70492_schedule_0/function70492_schedule_0.o");
