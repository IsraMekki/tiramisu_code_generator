...
int main(int argc, char **argv){
    tiramisu::init("function71279_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71279/function71279_no_schedule/function71279_no_schedule.o");
