...
int main(int argc, char **argv){
    tiramisu::init("function66248_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66248/function66248_schedule_2/function66248_schedule_2.o");
