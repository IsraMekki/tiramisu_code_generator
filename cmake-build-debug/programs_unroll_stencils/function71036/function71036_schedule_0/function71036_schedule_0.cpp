...
int main(int argc, char **argv){
    tiramisu::init("function71036_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71036/function71036_schedule_0/function71036_schedule_0.o");
