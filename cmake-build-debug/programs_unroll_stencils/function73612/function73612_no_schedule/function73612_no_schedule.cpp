...
int main(int argc, char **argv){
    tiramisu::init("function73612_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73612/function73612_no_schedule/function73612_no_schedule.o");
