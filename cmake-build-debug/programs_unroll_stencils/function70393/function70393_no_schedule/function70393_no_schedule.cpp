...
int main(int argc, char **argv){
    tiramisu::init("function70393_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70393/function70393_no_schedule/function70393_no_schedule.o");
