...
int main(int argc, char **argv){
    tiramisu::init("function70393_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70393/function70393_schedule_0/function70393_schedule_0.o");
