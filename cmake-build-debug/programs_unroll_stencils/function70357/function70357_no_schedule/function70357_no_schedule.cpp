...
int main(int argc, char **argv){
    tiramisu::init("function70357_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70357/function70357_no_schedule/function70357_no_schedule.o");
