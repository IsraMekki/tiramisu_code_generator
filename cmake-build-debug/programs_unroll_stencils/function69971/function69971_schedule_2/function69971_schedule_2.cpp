...
int main(int argc, char **argv){
    tiramisu::init("function69971_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69971/function69971_schedule_2/function69971_schedule_2.o");
