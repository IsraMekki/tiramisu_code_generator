...
int main(int argc, char **argv){
    tiramisu::init("function67024_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i0) + input01(i2) + input02(i2) + input03(i0, i1) + input04(i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67024/function67024_no_schedule/function67024_no_schedule.o");
