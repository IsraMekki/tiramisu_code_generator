...
int main(int argc, char **argv){
    tiramisu::init("function71968_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71968/function71968_schedule_2/function71968_schedule_2.o");
