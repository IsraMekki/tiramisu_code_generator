...
int main(int argc, char **argv){
    tiramisu::init("function71968_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71968/function71968_schedule_0/function71968_schedule_0.o");
