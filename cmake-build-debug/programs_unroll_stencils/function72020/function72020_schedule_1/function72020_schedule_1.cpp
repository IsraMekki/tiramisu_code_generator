...
int main(int argc, char **argv){
    tiramisu::init("function72020_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72020/function72020_schedule_1/function72020_schedule_1.o");
