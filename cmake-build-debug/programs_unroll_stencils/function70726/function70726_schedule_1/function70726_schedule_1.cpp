...
int main(int argc, char **argv){
    tiramisu::init("function70726_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70726/function70726_schedule_1/function70726_schedule_1.o");
