...
int main(int argc, char **argv){
    tiramisu::init("function71546_no_schedule");
    ...
    input input06("input06", {i2, i1, i0}, p_int32);

    input input07("input07", {i1}, p_int32);

    input input08("input08", {i0, i1, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i1) - input01(i0, i1, i2) * input02(i2) * input03(i0) - input04(i0) + input05(i2) - input06(i2, i1, i0) - input07(i1) - input08(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function71546/function71546_no_schedule/function71546_no_schedule.o");
