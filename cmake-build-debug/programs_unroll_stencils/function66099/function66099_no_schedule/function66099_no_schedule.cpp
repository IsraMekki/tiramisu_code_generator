...
int main(int argc, char **argv){
    tiramisu::init("function66099_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66099/function66099_no_schedule/function66099_no_schedule.o");
