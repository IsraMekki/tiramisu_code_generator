...
int main(int argc, char **argv){
    tiramisu::init("function74529_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74529/function74529_schedule_0/function74529_schedule_0.o");
