...
int main(int argc, char **argv){
    tiramisu::init("function74529_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74529/function74529_schedule_1/function74529_schedule_1.o");
