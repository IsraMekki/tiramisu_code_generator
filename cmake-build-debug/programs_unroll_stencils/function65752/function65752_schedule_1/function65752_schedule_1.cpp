...
int main(int argc, char **argv){
    tiramisu::init("function65752_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65752/function65752_schedule_1/function65752_schedule_1.o");
