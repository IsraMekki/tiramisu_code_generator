...
int main(int argc, char **argv){
    tiramisu::init("function70390_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i0) * input02(i2) + input03(i2, i0, i3) + input04(i3) + input05(i1) - input06(i1) * input07(i0, i1) + input08(i0, i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function70390/function70390_no_schedule/function70390_no_schedule.o");
