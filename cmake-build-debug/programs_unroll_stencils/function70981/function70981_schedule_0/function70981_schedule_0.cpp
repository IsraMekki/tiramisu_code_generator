...
int main(int argc, char **argv){
    tiramisu::init("function70981_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70981/function70981_schedule_0/function70981_schedule_0.o");
