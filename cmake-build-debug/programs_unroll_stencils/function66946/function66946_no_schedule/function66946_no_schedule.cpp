...
int main(int argc, char **argv){
    tiramisu::init("function66946_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66946/function66946_no_schedule/function66946_no_schedule.o");
