...
int main(int argc, char **argv){
    tiramisu::init("function68363_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68363/function68363_no_schedule/function68363_no_schedule.o");
