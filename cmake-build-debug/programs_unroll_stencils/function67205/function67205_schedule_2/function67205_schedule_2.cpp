...
int main(int argc, char **argv){
    tiramisu::init("function67205_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67205/function67205_schedule_2/function67205_schedule_2.o");
