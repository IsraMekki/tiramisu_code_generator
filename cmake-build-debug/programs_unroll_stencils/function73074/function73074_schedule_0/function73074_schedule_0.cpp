...
int main(int argc, char **argv){
    tiramisu::init("function73074_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73074/function73074_schedule_0/function73074_schedule_0.o");
