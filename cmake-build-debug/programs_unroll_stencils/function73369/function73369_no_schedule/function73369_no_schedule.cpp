...
int main(int argc, char **argv){
    tiramisu::init("function73369_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73369/function73369_no_schedule/function73369_no_schedule.o");
