...
int main(int argc, char **argv){
    tiramisu::init("function68033_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68033/function68033_no_schedule/function68033_no_schedule.o");
