...
int main(int argc, char **argv){
    tiramisu::init("function70110_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function70110/function70110_no_schedule/function70110_no_schedule.o");
