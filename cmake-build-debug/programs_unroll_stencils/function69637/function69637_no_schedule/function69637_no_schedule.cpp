...
int main(int argc, char **argv){
    tiramisu::init("function69637_no_schedule");
    ...
    buffer buf00("buf00", {512, 262144}, p_int32, a_input);
    buffer buf0("buf0", {512, 262144}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function69637/function69637_no_schedule/function69637_no_schedule.o");
