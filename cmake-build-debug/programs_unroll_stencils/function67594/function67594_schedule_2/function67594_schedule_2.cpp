...
int main(int argc, char **argv){
    tiramisu::init("function67594_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67594/function67594_schedule_2/function67594_schedule_2.o");
