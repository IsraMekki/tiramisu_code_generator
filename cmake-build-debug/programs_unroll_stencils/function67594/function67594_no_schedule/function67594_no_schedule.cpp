...
int main(int argc, char **argv){
    tiramisu::init("function67594_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67594/function67594_no_schedule/function67594_no_schedule.o");
