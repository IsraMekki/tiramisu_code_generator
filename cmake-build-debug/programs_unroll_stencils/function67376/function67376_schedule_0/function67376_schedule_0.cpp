...
int main(int argc, char **argv){
    tiramisu::init("function67376_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67376/function67376_schedule_0/function67376_schedule_0.o");
