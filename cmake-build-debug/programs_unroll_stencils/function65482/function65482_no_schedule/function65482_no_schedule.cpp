...
int main(int argc, char **argv){
    tiramisu::init("function65482_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1) * input01(i2) + input02(i0, i1, i3) * input03(i0) + input04(i1, i2) * input05(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function65482/function65482_no_schedule/function65482_no_schedule.o");
