...
int main(int argc, char **argv){
    tiramisu::init("function68226_schedule_2");
    ...
    buffer buf00("buf00", {64, 64, 64, 256}, p_int32, a_input);
    buffer buf0("buf0", {64, 64, 64, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function68226/function68226_schedule_2/function68226_schedule_2.o");
