...
int main(int argc, char **argv){
    tiramisu::init("function68510_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68510/function68510_no_schedule/function68510_no_schedule.o");
