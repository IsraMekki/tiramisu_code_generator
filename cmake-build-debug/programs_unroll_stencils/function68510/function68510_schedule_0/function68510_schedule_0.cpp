...
int main(int argc, char **argv){
    tiramisu::init("function68510_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68510/function68510_schedule_0/function68510_schedule_0.o");
