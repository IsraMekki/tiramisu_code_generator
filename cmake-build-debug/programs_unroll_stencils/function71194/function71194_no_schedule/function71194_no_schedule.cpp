...
int main(int argc, char **argv){
    tiramisu::init("function71194_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i2, i3) * input02(i0, i3) * input03(i1, i2, i3) * input04(i0, i1, i3) * input05(i0) * input06(i1, i2, i3) + input07(i3) + input08(i1, i2, i3) + input09(i1, i2, i3));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64, 64}, p_int32, a_input);
    buffer buf01("buf01", {64, 128}, p_int32, a_input);
    buffer buf02("buf02", {64, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function71194/function71194_no_schedule/function71194_no_schedule.o");
