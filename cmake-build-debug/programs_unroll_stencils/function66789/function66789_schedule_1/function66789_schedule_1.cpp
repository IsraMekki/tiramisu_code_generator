...
int main(int argc, char **argv){
    tiramisu::init("function66789_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66789/function66789_schedule_1/function66789_schedule_1.o");
