...
int main(int argc, char **argv){
    tiramisu::init("function71185_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71185/function71185_schedule_1/function71185_schedule_1.o");
