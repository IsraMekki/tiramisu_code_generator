...
int main(int argc, char **argv){
    tiramisu::init("function69152_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69152/function69152_no_schedule/function69152_no_schedule.o");
