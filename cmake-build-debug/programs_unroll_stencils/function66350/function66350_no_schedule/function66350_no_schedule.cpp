...
int main(int argc, char **argv){
    tiramisu::init("function66350_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1) * input02(i0, i1) - input03(i2) - input04(i0, i1) + input05(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function66350/function66350_no_schedule/function66350_no_schedule.o");
