...
int main(int argc, char **argv){
    tiramisu::init("function69852_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69852/function69852_schedule_1/function69852_schedule_1.o");
