...
int main(int argc, char **argv){
    tiramisu::init("function69852_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69852/function69852_no_schedule/function69852_no_schedule.o");
