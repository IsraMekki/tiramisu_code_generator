...
int main(int argc, char **argv){
    tiramisu::init("function68453_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68453/function68453_schedule_2/function68453_schedule_2.o");
