...
int main(int argc, char **argv){
    tiramisu::init("function68328_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) + input01(i0) * input02(i1) - input03(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68328/function68328_no_schedule/function68328_no_schedule.o");
