...
int main(int argc, char **argv){
    tiramisu::init("function68328_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68328/function68328_schedule_0/function68328_schedule_0.o");
