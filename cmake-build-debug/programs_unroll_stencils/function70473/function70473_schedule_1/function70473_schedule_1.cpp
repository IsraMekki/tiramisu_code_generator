...
int main(int argc, char **argv){
    tiramisu::init("function70473_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70473/function70473_schedule_1/function70473_schedule_1.o");
