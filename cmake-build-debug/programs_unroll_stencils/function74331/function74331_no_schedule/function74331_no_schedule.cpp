...
int main(int argc, char **argv){
    tiramisu::init("function74331_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74331/function74331_no_schedule/function74331_no_schedule.o");
