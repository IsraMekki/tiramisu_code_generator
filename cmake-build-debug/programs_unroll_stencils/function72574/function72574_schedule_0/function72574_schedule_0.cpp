...
int main(int argc, char **argv){
    tiramisu::init("function72574_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72574/function72574_schedule_0/function72574_schedule_0.o");
