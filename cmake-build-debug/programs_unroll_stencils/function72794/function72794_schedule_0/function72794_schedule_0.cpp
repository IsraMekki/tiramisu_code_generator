...
int main(int argc, char **argv){
    tiramisu::init("function72794_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72794/function72794_schedule_0/function72794_schedule_0.o");
