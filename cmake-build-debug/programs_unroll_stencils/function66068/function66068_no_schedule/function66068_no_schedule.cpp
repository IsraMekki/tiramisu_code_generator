...
int main(int argc, char **argv){
    tiramisu::init("function66068_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66068/function66068_no_schedule/function66068_no_schedule.o");
