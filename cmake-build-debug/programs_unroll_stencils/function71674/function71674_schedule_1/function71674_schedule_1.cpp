...
int main(int argc, char **argv){
    tiramisu::init("function71674_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71674/function71674_schedule_1/function71674_schedule_1.o");
