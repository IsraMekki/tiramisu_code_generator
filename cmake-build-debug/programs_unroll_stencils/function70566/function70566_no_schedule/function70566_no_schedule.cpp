...
int main(int argc, char **argv){
    tiramisu::init("function70566_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70566/function70566_no_schedule/function70566_no_schedule.o");
