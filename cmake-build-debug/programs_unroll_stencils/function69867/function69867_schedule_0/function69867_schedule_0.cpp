...
int main(int argc, char **argv){
    tiramisu::init("function69867_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69867/function69867_schedule_0/function69867_schedule_0.o");
