...
int main(int argc, char **argv){
    tiramisu::init("function70985_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70985/function70985_no_schedule/function70985_no_schedule.o");
