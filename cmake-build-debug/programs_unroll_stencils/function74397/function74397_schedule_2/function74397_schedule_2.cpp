...
int main(int argc, char **argv){
    tiramisu::init("function74397_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74397/function74397_schedule_2/function74397_schedule_2.o");
