...
int main(int argc, char **argv){
    tiramisu::init("function65775_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65775/function65775_schedule_2/function65775_schedule_2.o");
