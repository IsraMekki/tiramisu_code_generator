...
int main(int argc, char **argv){
    tiramisu::init("function66373_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i0, i3) * input01(i0, i3) * input02(i0, i2, i3) - input03(i0) + input04(i1, i2, i3) + input05(i0, i2) + input06(i3) * input07(i0, i2) + input08(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function66373/function66373_no_schedule/function66373_no_schedule.o");
