...
int main(int argc, char **argv){
    tiramisu::init("function65947_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65947/function65947_schedule_1/function65947_schedule_1.o");
