...
int main(int argc, char **argv){
    tiramisu::init("function64986_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64986/function64986_schedule_0/function64986_schedule_0.o");
