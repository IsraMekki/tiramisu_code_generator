...
int main(int argc, char **argv){
    tiramisu::init("function71170_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71170/function71170_schedule_2/function71170_schedule_2.o");
