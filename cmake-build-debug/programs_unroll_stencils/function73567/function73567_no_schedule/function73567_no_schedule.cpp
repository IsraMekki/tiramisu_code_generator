...
int main(int argc, char **argv){
    tiramisu::init("function73567_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i1, i2) + input02(i1) - input03(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73567/function73567_no_schedule/function73567_no_schedule.o");
