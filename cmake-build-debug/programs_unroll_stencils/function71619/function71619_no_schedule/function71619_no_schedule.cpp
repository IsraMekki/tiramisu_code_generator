...
int main(int argc, char **argv){
    tiramisu::init("function71619_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71619/function71619_no_schedule/function71619_no_schedule.o");
