...
int main(int argc, char **argv){
    tiramisu::init("function71619_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71619/function71619_schedule_0/function71619_schedule_0.o");
