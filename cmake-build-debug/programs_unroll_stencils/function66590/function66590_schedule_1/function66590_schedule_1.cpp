...
int main(int argc, char **argv){
    tiramisu::init("function66590_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66590/function66590_schedule_1/function66590_schedule_1.o");
