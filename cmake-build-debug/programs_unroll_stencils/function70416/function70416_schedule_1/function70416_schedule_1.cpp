...
int main(int argc, char **argv){
    tiramisu::init("function70416_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70416/function70416_schedule_1/function70416_schedule_1.o");
