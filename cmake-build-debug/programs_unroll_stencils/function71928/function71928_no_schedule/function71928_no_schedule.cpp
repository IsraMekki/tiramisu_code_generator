...
int main(int argc, char **argv){
    tiramisu::init("function71928_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71928/function71928_no_schedule/function71928_no_schedule.o");
