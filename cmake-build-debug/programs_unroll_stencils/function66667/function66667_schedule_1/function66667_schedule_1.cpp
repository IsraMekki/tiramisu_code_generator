...
int main(int argc, char **argv){
    tiramisu::init("function66667_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66667/function66667_schedule_1/function66667_schedule_1.o");
