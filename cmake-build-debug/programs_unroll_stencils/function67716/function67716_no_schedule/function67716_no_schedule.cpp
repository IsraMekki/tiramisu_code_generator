...
int main(int argc, char **argv){
    tiramisu::init("function67716_no_schedule");
    ...
    input input01("input01", {i3, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) * input01(i3, i1) + input02(i2, i3) + input03(i1) * input04(i1) * input05(i1, i2) - input06(i0, i1, i2) + input07(i1, i3) + input08(i1, i2, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function67716/function67716_no_schedule/function67716_no_schedule.o");
