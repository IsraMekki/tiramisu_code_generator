...
int main(int argc, char **argv){
    tiramisu::init("function71452_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71452/function71452_schedule_0/function71452_schedule_0.o");
