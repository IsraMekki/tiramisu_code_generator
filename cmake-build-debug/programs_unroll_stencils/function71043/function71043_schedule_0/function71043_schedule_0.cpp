...
int main(int argc, char **argv){
    tiramisu::init("function71043_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71043/function71043_schedule_0/function71043_schedule_0.o");
