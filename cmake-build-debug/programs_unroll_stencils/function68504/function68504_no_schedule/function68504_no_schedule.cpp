...
int main(int argc, char **argv){
    tiramisu::init("function68504_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) + input01(i1) + input02(i3, i1) + input03(i1, i2, i3) * input04(i2) - input05(i0, i2) * input06(i3, i2) + input07(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function68504/function68504_no_schedule/function68504_no_schedule.o");
