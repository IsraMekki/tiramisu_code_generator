...
int main(int argc, char **argv){
    tiramisu::init("function72460_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72460/function72460_schedule_1/function72460_schedule_1.o");
