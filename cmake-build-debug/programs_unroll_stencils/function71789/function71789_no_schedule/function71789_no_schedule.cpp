...
int main(int argc, char **argv){
    tiramisu::init("function71789_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71789/function71789_no_schedule/function71789_no_schedule.o");
