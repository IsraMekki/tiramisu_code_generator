...
int main(int argc, char **argv){
    tiramisu::init("function68096_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68096/function68096_schedule_1/function68096_schedule_1.o");
