...
int main(int argc, char **argv){
    tiramisu::init("function70246_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70246/function70246_schedule_2/function70246_schedule_2.o");
