...
int main(int argc, char **argv){
    tiramisu::init("function70246_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70246/function70246_no_schedule/function70246_no_schedule.o");
