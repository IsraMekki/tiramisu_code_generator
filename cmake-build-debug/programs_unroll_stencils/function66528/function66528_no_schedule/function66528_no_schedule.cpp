...
int main(int argc, char **argv){
    tiramisu::init("function66528_no_schedule");
    ...
    input input02("input02", {i0, i2, i1}, p_int32);
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) - input01(i0, i2, i3) - input02(i0, i2, i1) - input03(i1) - input04(i0, i1) + input05(i2) * input06(i2) * input07(i0, i1, i3) - input08(i2, i3) * input09(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function66528/function66528_no_schedule/function66528_no_schedule.o");
