...
int main(int argc, char **argv){
    tiramisu::init("function66129_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66129/function66129_no_schedule/function66129_no_schedule.o");
