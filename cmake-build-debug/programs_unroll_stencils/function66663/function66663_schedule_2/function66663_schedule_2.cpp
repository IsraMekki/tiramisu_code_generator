...
int main(int argc, char **argv){
    tiramisu::init("function66663_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66663/function66663_schedule_2/function66663_schedule_2.o");
