...
int main(int argc, char **argv){
    tiramisu::init("function70986_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70986/function70986_schedule_0/function70986_schedule_0.o");
