...
int main(int argc, char **argv){
    tiramisu::init("function67688_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67688/function67688_schedule_1/function67688_schedule_1.o");
