...
int main(int argc, char **argv){
    tiramisu::init("function67443_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67443/function67443_no_schedule/function67443_no_schedule.o");
