...
int main(int argc, char **argv){
    tiramisu::init("function66293_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66293/function66293_schedule_0/function66293_schedule_0.o");
