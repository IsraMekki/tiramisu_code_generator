...
int main(int argc, char **argv){
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66834/function66834_no_schedule/function66834_no_schedule.o");
