...
int main(int argc, char **argv){
    tiramisu::init("function66979_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66979/function66979_schedule_0/function66979_schedule_0.o");
