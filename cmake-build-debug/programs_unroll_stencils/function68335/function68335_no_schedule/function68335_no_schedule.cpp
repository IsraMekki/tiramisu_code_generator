...
int main(int argc, char **argv){
    tiramisu::init("function68335_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i0, i1, i2) * input02(i0) * input03(i3, i1) * input04(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68335/function68335_no_schedule/function68335_no_schedule.o");
