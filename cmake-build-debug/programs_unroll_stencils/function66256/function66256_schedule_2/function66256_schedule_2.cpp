...
int main(int argc, char **argv){
    tiramisu::init("function66256_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66256/function66256_schedule_2/function66256_schedule_2.o");
