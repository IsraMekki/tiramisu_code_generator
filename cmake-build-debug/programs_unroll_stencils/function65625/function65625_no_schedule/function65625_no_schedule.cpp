...
int main(int argc, char **argv){
    tiramisu::init("function65625_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) * input01(i1) * input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65625/function65625_no_schedule/function65625_no_schedule.o");
