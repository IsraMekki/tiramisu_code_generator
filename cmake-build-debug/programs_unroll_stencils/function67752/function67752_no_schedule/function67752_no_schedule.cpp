...
int main(int argc, char **argv){
    tiramisu::init("function67752_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67752/function67752_no_schedule/function67752_no_schedule.o");
