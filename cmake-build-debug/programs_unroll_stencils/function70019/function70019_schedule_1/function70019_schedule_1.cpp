...
int main(int argc, char **argv){
    tiramisu::init("function70019_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70019/function70019_schedule_1/function70019_schedule_1.o");
