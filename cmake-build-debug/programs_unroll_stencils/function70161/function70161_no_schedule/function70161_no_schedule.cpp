...
int main(int argc, char **argv){
    tiramisu::init("function70161_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) - input01(i1, i2) - input02(i0, i2) + input03(i0, i1) * input04(i1, i2) * input05(i0, i2) * input06(i0, i2) + input07(i2) - input08(i1, i2) - input09(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70161/function70161_no_schedule/function70161_no_schedule.o");
