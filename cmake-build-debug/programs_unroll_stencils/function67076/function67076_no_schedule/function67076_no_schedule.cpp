...
int main(int argc, char **argv){
    tiramisu::init("function67076_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i0, i3) - input02(i2, i3) + input03(i0, i1, i2) * input04(i1, i2, i3) * input05(i1, i2, i3) + input06(i2, i3) - input07(i0, i2, i3) + input08(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function67076/function67076_no_schedule/function67076_no_schedule.o");
