...
int main(int argc, char **argv){
    tiramisu::init("function71553_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1) - input02(i0, i1) * input03(i0, i1) * input04(i1) - input05(i0, i1) - input06(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function71553/function71553_no_schedule/function71553_no_schedule.o");
