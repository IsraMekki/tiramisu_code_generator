...
int main(int argc, char **argv){
    tiramisu::init("function66561_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66561/function66561_schedule_1/function66561_schedule_1.o");
