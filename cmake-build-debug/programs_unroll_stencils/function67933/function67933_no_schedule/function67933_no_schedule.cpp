...
int main(int argc, char **argv){
    tiramisu::init("function67933_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i0, i1) + input02(i1) - input03(i0, i1) - input04(i0, i2) - input05(i2) + input06(i0, i2));
    ...
    buffer buf04("buf04", {64, 16384}, p_int32, a_input);
    buffer buf05("buf05", {16384}, p_int32, a_input);
    buffer buf06("buf06", {64, 16384}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function67933/function67933_no_schedule/function67933_no_schedule.o");
