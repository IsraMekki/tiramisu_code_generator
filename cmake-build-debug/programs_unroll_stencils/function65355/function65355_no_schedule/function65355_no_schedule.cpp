...
int main(int argc, char **argv){
    tiramisu::init("function65355_no_schedule");
    ...
    buffer buf00("buf00", {4096, 32768}, p_int32, a_input);
    buffer buf0("buf0", {4096, 32768}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function65355/function65355_no_schedule/function65355_no_schedule.o");
