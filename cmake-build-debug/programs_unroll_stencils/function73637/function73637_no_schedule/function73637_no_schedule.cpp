...
int main(int argc, char **argv){
    tiramisu::init("function73637_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73637/function73637_no_schedule/function73637_no_schedule.o");
