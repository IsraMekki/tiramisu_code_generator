...
int main(int argc, char **argv){
    tiramisu::init("function72623_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72623/function72623_schedule_2/function72623_schedule_2.o");
