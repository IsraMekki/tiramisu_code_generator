...
int main(int argc, char **argv){
    tiramisu::init("function68817_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68817/function68817_no_schedule/function68817_no_schedule.o");
