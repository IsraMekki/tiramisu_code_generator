...
int main(int argc, char **argv){
    tiramisu::init("function70784_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i2) - input02(i1) + input03(i1) + input04(i1, i2) * input05(i1) + input06(i0) + input07(i0, i1) - input08(i1) - input09(i1, i2));
    ...
    buffer buf09("buf09", {4096, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70784/function70784_no_schedule/function70784_no_schedule.o");
