...
int main(int argc, char **argv){
    tiramisu::init("function67062_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67062/function67062_no_schedule/function67062_no_schedule.o");
