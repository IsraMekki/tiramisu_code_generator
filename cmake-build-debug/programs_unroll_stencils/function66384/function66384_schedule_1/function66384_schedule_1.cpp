...
int main(int argc, char **argv){
    tiramisu::init("function66384_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66384/function66384_schedule_1/function66384_schedule_1.o");
