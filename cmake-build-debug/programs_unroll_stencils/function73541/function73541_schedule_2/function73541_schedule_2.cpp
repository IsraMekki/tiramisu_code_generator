...
int main(int argc, char **argv){
    tiramisu::init("function73541_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73541/function73541_schedule_2/function73541_schedule_2.o");
