...
int main(int argc, char **argv){
    tiramisu::init("function72005_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72005/function72005_schedule_1/function72005_schedule_1.o");
