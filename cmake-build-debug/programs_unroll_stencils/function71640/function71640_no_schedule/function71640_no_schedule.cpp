...
int main(int argc, char **argv){
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i1) * input01(i0) + input02(i0) - input03(i0, i2, i3) + input04(i0, i1) + input05(i0) - input06(i0) * input07(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function71640/function71640_no_schedule/function71640_no_schedule.o");
