...
int main(int argc, char **argv){
    tiramisu::init("function74281_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74281/function74281_schedule_1/function74281_schedule_1.o");
