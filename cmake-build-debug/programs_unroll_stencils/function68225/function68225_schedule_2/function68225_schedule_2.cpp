...
int main(int argc, char **argv){
    tiramisu::init("function68225_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68225/function68225_schedule_2/function68225_schedule_2.o");
