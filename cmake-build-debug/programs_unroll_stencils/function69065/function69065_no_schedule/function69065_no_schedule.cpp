...
int main(int argc, char **argv){
    tiramisu::init("function69065_no_schedule");
    ...
    input input02("input02", {i1, i3, i0}, p_int32);

    input input03("input03", {i0, i1, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) - input01(i2, i3) * input02(i1, i3, i0) + input03(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69065/function69065_no_schedule/function69065_no_schedule.o");
