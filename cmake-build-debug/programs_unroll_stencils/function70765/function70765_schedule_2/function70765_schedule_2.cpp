...
int main(int argc, char **argv){
    tiramisu::init("function70765_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70765/function70765_schedule_2/function70765_schedule_2.o");
