...
int main(int argc, char **argv){
    tiramisu::init("function72132_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72132/function72132_no_schedule/function72132_no_schedule.o");
