...
int main(int argc, char **argv){
    tiramisu::init("function69485_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69485/function69485_no_schedule/function69485_no_schedule.o");
