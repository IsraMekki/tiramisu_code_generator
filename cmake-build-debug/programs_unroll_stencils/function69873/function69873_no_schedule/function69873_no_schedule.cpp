...
int main(int argc, char **argv){
    tiramisu::init("function69873_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69873/function69873_no_schedule/function69873_no_schedule.o");
