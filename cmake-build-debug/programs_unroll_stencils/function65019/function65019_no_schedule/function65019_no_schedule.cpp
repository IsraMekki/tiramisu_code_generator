...
int main(int argc, char **argv){
    tiramisu::init("function65019_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0) + input02(i0) + input03(i1, i2) - input04(i2) * input05(i0, i1) * input06(i0, i2) * input07(i0, i1) + input08(i0, i2));
    ...
    buffer buf07("buf07", {2048, 256}, p_int32, a_input);
    buffer buf08("buf08", {2048, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function65019/function65019_no_schedule/function65019_no_schedule.o");
