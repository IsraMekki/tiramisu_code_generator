...
int main(int argc, char **argv){
    tiramisu::init("function66033_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66033/function66033_schedule_2/function66033_schedule_2.o");
