...
int main(int argc, char **argv){
    tiramisu::init("function72951_no_schedule");
    ...
    buffer buf00("buf00", {64, 4096, 256}, p_int32, a_input);
    buffer buf0("buf0", {64, 4096, 256}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function72951/function72951_no_schedule/function72951_no_schedule.o");
