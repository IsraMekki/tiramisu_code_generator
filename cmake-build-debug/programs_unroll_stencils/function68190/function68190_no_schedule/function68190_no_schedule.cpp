...
int main(int argc, char **argv){
    tiramisu::init("function68190_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) - input01(i1) + input02(i0, i2) * input03(i0, i1) + input04(i1) * input05(i0, i2) + input06(i1, i2) - input07(i0, i2) + input08(i1, i2));
    ...
    buffer buf05("buf05", {512, 1024}, p_int32, a_input);
    buffer buf06("buf06", {128, 1024}, p_int32, a_input);
    buffer buf07("buf07", {512, 1024}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function68190/function68190_no_schedule/function68190_no_schedule.o");
