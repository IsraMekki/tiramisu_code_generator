...
int main(int argc, char **argv){
    tiramisu::init("function69743_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69743/function69743_schedule_0/function69743_schedule_0.o");
