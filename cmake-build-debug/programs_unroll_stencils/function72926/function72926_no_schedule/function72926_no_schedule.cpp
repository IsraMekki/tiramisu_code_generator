...
int main(int argc, char **argv){
    tiramisu::init("function72926_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72926/function72926_no_schedule/function72926_no_schedule.o");
