...
int main(int argc, char **argv){
    tiramisu::init("function65568_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65568/function65568_schedule_2/function65568_schedule_2.o");
