...
int main(int argc, char **argv){
    tiramisu::init("function70076_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70076/function70076_no_schedule/function70076_no_schedule.o");
