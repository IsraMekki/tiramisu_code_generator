...
int main(int argc, char **argv){
    tiramisu::init("function70076_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70076/function70076_schedule_2/function70076_schedule_2.o");
