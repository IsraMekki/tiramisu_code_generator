...
int main(int argc, char **argv){
    tiramisu::init("function71498_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71498/function71498_no_schedule/function71498_no_schedule.o");
