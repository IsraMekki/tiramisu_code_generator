...
int main(int argc, char **argv){
    tiramisu::init("function72666_schedule_2");
    ...
    comp0.unroll(i103, 16);
    comp0.parallelize(i100);
    
    buffer buf00("buf00", {64, 64, 256, 64}, p_int32, a_input);
    buffer buf0("buf0", {64, 64, 256, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function72666/function72666_schedule_2/function72666_schedule_2.o");
