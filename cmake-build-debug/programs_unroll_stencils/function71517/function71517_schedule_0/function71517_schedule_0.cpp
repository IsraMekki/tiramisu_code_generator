...
int main(int argc, char **argv){
    tiramisu::init("function71517_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71517/function71517_schedule_0/function71517_schedule_0.o");
