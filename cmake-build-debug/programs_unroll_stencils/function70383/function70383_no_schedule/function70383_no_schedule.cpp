...
int main(int argc, char **argv){
    tiramisu::init("function70383_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70383/function70383_no_schedule/function70383_no_schedule.o");
