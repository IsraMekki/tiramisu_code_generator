...
int main(int argc, char **argv){
    tiramisu::init("function72235_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72235/function72235_schedule_1/function72235_schedule_1.o");
