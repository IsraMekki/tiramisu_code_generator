...
int main(int argc, char **argv){
    tiramisu::init("function65012_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65012/function65012_schedule_1/function65012_schedule_1.o");
