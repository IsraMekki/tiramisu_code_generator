...
int main(int argc, char **argv){
    tiramisu::init("function65012_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) - input01(i0, i2) * input02(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65012/function65012_no_schedule/function65012_no_schedule.o");
