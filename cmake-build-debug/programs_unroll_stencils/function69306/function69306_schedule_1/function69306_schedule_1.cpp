...
int main(int argc, char **argv){
    tiramisu::init("function69306_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69306/function69306_schedule_1/function69306_schedule_1.o");
