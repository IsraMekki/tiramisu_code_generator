...
int main(int argc, char **argv){
    tiramisu::init("function67142_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67142/function67142_no_schedule/function67142_no_schedule.o");
