...
int main(int argc, char **argv){
    tiramisu::init("function73724_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73724/function73724_schedule_1/function73724_schedule_1.o");
