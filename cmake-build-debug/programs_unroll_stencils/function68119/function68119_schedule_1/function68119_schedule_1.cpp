...
int main(int argc, char **argv){
    tiramisu::init("function68119_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68119/function68119_schedule_1/function68119_schedule_1.o");
