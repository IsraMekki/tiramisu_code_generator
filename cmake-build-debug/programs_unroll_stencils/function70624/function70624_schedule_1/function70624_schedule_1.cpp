...
int main(int argc, char **argv){
    tiramisu::init("function70624_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70624/function70624_schedule_1/function70624_schedule_1.o");
