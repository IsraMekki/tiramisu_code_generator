...
int main(int argc, char **argv){
    tiramisu::init("function69019_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69019/function69019_schedule_1/function69019_schedule_1.o");
