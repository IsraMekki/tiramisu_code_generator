...
int main(int argc, char **argv){
    tiramisu::init("function71894_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71894/function71894_schedule_2/function71894_schedule_2.o");
