...
int main(int argc, char **argv){
    tiramisu::init("function71033_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71033/function71033_no_schedule/function71033_no_schedule.o");
