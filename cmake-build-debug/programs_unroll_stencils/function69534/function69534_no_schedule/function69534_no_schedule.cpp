...
int main(int argc, char **argv){
    tiramisu::init("function69534_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69534/function69534_no_schedule/function69534_no_schedule.o");
