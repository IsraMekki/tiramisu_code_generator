...
int main(int argc, char **argv){
    tiramisu::init("function68508_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68508/function68508_schedule_2/function68508_schedule_2.o");
