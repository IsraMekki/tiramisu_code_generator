...
int main(int argc, char **argv){
    tiramisu::init("function66271_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66271/function66271_no_schedule/function66271_no_schedule.o");
