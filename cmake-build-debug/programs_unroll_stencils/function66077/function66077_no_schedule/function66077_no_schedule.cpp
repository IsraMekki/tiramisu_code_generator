...
int main(int argc, char **argv){
    tiramisu::init("function66077_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66077/function66077_no_schedule/function66077_no_schedule.o");
