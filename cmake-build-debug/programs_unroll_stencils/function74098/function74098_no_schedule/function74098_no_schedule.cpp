...
int main(int argc, char **argv){
    tiramisu::init("function74098_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i3) + input01(i1) + input02(i1, i0) + input03(i0, i1) + input04(i3, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74098/function74098_no_schedule/function74098_no_schedule.o");
