...
int main(int argc, char **argv){
    tiramisu::init("function65305_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65305/function65305_no_schedule/function65305_no_schedule.o");
