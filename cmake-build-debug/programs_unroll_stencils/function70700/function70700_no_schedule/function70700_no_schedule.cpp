...
int main(int argc, char **argv){
    tiramisu::init("function70700_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70700/function70700_no_schedule/function70700_no_schedule.o");
