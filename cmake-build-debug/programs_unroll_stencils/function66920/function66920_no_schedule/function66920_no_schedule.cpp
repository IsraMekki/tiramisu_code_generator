...
int main(int argc, char **argv){
    tiramisu::init("function66920_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66920/function66920_no_schedule/function66920_no_schedule.o");
