...
int main(int argc, char **argv){
    tiramisu::init("function73925_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2) * input01(i0, i1) - input02(i2) * input03(i2) * input04(i0) + input05(i3) - input06(i0, i1, i3) * input07(i1, i3) - input08(i1, i2, i3) + input09(i0, i3));
    ...
    buffer buf09("buf09", {128, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73925/function73925_no_schedule/function73925_no_schedule.o");
