...
int main(int argc, char **argv){
    tiramisu::init("function69397_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69397/function69397_schedule_2/function69397_schedule_2.o");
