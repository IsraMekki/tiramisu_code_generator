...
int main(int argc, char **argv){
    tiramisu::init("function74495_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74495/function74495_schedule_1/function74495_schedule_1.o");
