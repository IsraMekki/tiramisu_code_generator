...
int main(int argc, char **argv){
    tiramisu::init("function70558_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function70558/function70558_no_schedule/function70558_no_schedule.o");
