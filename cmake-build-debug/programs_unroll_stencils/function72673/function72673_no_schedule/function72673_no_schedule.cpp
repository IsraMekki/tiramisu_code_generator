...
int main(int argc, char **argv){
    tiramisu::init("function72673_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72673/function72673_no_schedule/function72673_no_schedule.o");
