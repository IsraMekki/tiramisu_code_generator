...
int main(int argc, char **argv){
    tiramisu::init("function73437_no_schedule");
    ...
    input input09("input09", {i3, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) + input01(i2) + input02(i0, i2) * input03(i2, i3) - input04(i2) - input05(i0, i1, i3) - input06(i2) * input07(i2) + input08(i0, i3) * input09(i3, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function73437/function73437_no_schedule/function73437_no_schedule.o");
