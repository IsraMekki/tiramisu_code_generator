...
int main(int argc, char **argv){
    tiramisu::init("function64894_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64894/function64894_schedule_0/function64894_schedule_0.o");
