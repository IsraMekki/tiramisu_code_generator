...
int main(int argc, char **argv){
    tiramisu::init("function64894_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64894/function64894_schedule_2/function64894_schedule_2.o");
