...
int main(int argc, char **argv){
    tiramisu::init("function71802_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71802/function71802_no_schedule/function71802_no_schedule.o");
