...
int main(int argc, char **argv){
    tiramisu::init("function70314_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70314/function70314_schedule_2/function70314_schedule_2.o");
