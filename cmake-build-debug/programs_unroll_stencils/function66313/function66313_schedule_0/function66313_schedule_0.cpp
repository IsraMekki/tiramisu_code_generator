...
int main(int argc, char **argv){
    tiramisu::init("function66313_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66313/function66313_schedule_0/function66313_schedule_0.o");
