...
int main(int argc, char **argv){
    tiramisu::init("function72124_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72124/function72124_schedule_2/function72124_schedule_2.o");
