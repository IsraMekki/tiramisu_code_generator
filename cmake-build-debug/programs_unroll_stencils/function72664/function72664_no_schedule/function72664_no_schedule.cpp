...
int main(int argc, char **argv){
    tiramisu::init("function72664_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72664/function72664_no_schedule/function72664_no_schedule.o");
