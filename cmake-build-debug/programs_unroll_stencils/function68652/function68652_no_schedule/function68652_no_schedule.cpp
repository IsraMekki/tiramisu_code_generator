...
int main(int argc, char **argv){
    tiramisu::init("function68652_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68652/function68652_no_schedule/function68652_no_schedule.o");
