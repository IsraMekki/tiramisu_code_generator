...
int main(int argc, char **argv){
    tiramisu::init("function74456_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74456/function74456_schedule_1/function74456_schedule_1.o");
