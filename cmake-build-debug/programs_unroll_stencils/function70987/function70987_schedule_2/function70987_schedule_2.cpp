...
int main(int argc, char **argv){
    tiramisu::init("function70987_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70987/function70987_schedule_2/function70987_schedule_2.o");
