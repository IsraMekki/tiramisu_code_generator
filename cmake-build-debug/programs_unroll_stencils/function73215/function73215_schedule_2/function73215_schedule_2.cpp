...
int main(int argc, char **argv){
    tiramisu::init("function73215_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73215/function73215_schedule_2/function73215_schedule_2.o");
