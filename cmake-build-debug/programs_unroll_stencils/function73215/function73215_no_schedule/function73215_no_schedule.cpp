...
int main(int argc, char **argv){
    tiramisu::init("function73215_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73215/function73215_no_schedule/function73215_no_schedule.o");
