...
int main(int argc, char **argv){
    tiramisu::init("function67673_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67673/function67673_no_schedule/function67673_no_schedule.o");
