...
int main(int argc, char **argv){
    tiramisu::init("function68828_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68828/function68828_no_schedule/function68828_no_schedule.o");
