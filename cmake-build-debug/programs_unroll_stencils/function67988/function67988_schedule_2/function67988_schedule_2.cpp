...
int main(int argc, char **argv){
    tiramisu::init("function67988_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67988/function67988_schedule_2/function67988_schedule_2.o");
