...
int main(int argc, char **argv){
    tiramisu::init("function68069_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68069/function68069_no_schedule/function68069_no_schedule.o");
