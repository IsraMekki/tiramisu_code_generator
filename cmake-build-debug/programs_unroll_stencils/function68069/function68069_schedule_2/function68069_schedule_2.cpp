...
int main(int argc, char **argv){
    tiramisu::init("function68069_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68069/function68069_schedule_2/function68069_schedule_2.o");
