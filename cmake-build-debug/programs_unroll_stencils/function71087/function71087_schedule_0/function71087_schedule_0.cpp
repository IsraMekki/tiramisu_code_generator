...
int main(int argc, char **argv){
    tiramisu::init("function71087_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71087/function71087_schedule_0/function71087_schedule_0.o");
