...
int main(int argc, char **argv){
    tiramisu::init("function66149_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66149/function66149_no_schedule/function66149_no_schedule.o");
