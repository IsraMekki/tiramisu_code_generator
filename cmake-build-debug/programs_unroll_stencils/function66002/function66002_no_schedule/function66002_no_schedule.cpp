...
int main(int argc, char **argv){
    tiramisu::init("function66002_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66002/function66002_no_schedule/function66002_no_schedule.o");
