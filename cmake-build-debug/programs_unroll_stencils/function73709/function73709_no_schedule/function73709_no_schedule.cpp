...
int main(int argc, char **argv){
    tiramisu::init("function73709_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) - input01(i0, i2) * input02(i2, i0) - input03(i1, i2) * input04(i2) + input05(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function73709/function73709_no_schedule/function73709_no_schedule.o");
