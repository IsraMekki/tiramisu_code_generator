...
int main(int argc, char **argv){
    tiramisu::init("function71306_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71306/function71306_schedule_1/function71306_schedule_1.o");
