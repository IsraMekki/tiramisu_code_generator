...
int main(int argc, char **argv){
    tiramisu::init("function67499_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67499/function67499_no_schedule/function67499_no_schedule.o");
