...
int main(int argc, char **argv){
    tiramisu::init("function70144_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i3) + input01(i0) + input02(i0, i1, i3) + input03(i0) * input04(i3, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function70144/function70144_no_schedule/function70144_no_schedule.o");
