...
int main(int argc, char **argv){
    tiramisu::init("function69860_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69860/function69860_schedule_0/function69860_schedule_0.o");
