...
int main(int argc, char **argv){
    tiramisu::init("function66440_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66440/function66440_schedule_0/function66440_schedule_0.o");
