...
int main(int argc, char **argv){
    tiramisu::init("function66805_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66805/function66805_schedule_0/function66805_schedule_0.o");
