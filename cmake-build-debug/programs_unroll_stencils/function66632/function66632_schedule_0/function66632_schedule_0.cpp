...
int main(int argc, char **argv){
    tiramisu::init("function66632_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66632/function66632_schedule_0/function66632_schedule_0.o");
