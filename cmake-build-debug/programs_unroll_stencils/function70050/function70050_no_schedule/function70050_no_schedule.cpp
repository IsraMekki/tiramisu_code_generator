...
int main(int argc, char **argv){
    tiramisu::init("function70050_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70050/function70050_no_schedule/function70050_no_schedule.o");
