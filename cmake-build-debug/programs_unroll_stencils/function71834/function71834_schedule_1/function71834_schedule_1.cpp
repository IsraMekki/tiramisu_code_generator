...
int main(int argc, char **argv){
    tiramisu::init("function71834_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71834/function71834_schedule_1/function71834_schedule_1.o");
