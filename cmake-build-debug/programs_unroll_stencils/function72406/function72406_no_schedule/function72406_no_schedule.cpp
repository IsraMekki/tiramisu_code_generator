...
int main(int argc, char **argv){
    tiramisu::init("function72406_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) + input01(i0, i1) - input02(i1) + input03(i1, i2) * input04(i0, i1) + input05(i0, i2) * input06(i2) * input07(i1, i2) - input08(i1) * input09(i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {512, 64}, p_int32, a_input);
    ...
    buffer buf04("buf04", {512, 1024}, p_int32, a_input);
    buffer buf05("buf05", {512, 64}, p_int32, a_input);
    buffer buf06("buf06", {64}, p_int32, a_input);
    buffer buf07("buf07", {1024, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function72406/function72406_no_schedule/function72406_no_schedule.o");
