...
int main(int argc, char **argv){
    tiramisu::init("function66855_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66855/function66855_schedule_0/function66855_schedule_0.o");
