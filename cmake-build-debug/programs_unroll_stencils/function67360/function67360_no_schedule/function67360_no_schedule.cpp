...
int main(int argc, char **argv){
    tiramisu::init("function67360_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i1) * input01(i2) + input02(i1, i2) * input03(i2) + input04(i0, i2) - input05(i0, i1) + input06(i1, i2) - input07(i2) - input08(i0, i2) - input09(i1));
    ...
    buffer buf06("buf06", {256, 1024}, p_int32, a_input);
    buffer buf07("buf07", {1024}, p_int32, a_input);
    buffer buf08("buf08", {128, 1024}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67360/function67360_no_schedule/function67360_no_schedule.o");
