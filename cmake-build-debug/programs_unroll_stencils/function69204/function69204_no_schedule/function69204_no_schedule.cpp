...
int main(int argc, char **argv){
    tiramisu::init("function69204_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69204/function69204_no_schedule/function69204_no_schedule.o");
