...
int main(int argc, char **argv){
    tiramisu::init("function68804_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68804/function68804_schedule_0/function68804_schedule_0.o");
