...
int main(int argc, char **argv){
    tiramisu::init("function73547_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73547/function73547_schedule_0/function73547_schedule_0.o");
