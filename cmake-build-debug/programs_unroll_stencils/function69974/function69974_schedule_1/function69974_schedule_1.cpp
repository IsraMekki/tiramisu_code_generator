...
int main(int argc, char **argv){
    tiramisu::init("function69974_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69974/function69974_schedule_1/function69974_schedule_1.o");
