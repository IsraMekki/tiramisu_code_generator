...
int main(int argc, char **argv){
    tiramisu::init("function74434_no_schedule");
    ...
    input input05("input05", {i3, i1, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) + input01(i1, i2, i3) + input02(i1, i2, i3) + input03(i0, i3) + input04(i0, i2, i3) * input05(i3, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function74434/function74434_no_schedule/function74434_no_schedule.o");
