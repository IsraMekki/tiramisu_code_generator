...
int main(int argc, char **argv){
    tiramisu::init("function67358_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67358/function67358_no_schedule/function67358_no_schedule.o");
