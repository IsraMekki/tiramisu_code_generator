...
int main(int argc, char **argv){
    tiramisu::init("function67358_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67358/function67358_schedule_1/function67358_schedule_1.o");
