...
int main(int argc, char **argv){
    tiramisu::init("function67964_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67964/function67964_schedule_1/function67964_schedule_1.o");
