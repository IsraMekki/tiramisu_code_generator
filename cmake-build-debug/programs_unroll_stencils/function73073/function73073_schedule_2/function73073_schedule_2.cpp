...
int main(int argc, char **argv){
    tiramisu::init("function73073_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73073/function73073_schedule_2/function73073_schedule_2.o");
