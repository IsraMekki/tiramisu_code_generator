...
int main(int argc, char **argv){
    tiramisu::init("function67628_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67628/function67628_no_schedule/function67628_no_schedule.o");
