...
int main(int argc, char **argv){
    tiramisu::init("function73114_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73114/function73114_schedule_0/function73114_schedule_0.o");
