...
int main(int argc, char **argv){
    tiramisu::init("function74311_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74311/function74311_schedule_0/function74311_schedule_0.o");
