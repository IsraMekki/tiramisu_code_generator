...
int main(int argc, char **argv){
    tiramisu::init("function74311_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74311/function74311_schedule_1/function74311_schedule_1.o");
