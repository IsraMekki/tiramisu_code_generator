...
int main(int argc, char **argv){
    tiramisu::init("function73187_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73187/function73187_schedule_0/function73187_schedule_0.o");
