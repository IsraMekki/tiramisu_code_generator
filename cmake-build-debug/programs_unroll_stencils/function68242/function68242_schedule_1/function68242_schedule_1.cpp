...
int main(int argc, char **argv){
    tiramisu::init("function68242_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68242/function68242_schedule_1/function68242_schedule_1.o");
