...
int main(int argc, char **argv){
    tiramisu::init("function67395_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67395/function67395_schedule_1/function67395_schedule_1.o");
