...
int main(int argc, char **argv){
    tiramisu::init("function72665_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72665/function72665_schedule_1/function72665_schedule_1.o");
