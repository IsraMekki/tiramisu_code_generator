...
int main(int argc, char **argv){
    tiramisu::init("function71379_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71379/function71379_schedule_2/function71379_schedule_2.o");
