...
int main(int argc, char **argv){
    tiramisu::init("function69427_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69427/function69427_schedule_0/function69427_schedule_0.o");
