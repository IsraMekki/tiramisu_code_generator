...
int main(int argc, char **argv){
    tiramisu::init("function74522_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74522/function74522_schedule_1/function74522_schedule_1.o");
