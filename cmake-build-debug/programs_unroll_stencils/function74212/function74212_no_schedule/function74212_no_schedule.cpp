...
int main(int argc, char **argv){
    tiramisu::init("function74212_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74212/function74212_no_schedule/function74212_no_schedule.o");
