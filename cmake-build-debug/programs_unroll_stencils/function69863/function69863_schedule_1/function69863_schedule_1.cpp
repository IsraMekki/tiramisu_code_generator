...
int main(int argc, char **argv){
    tiramisu::init("function69863_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69863/function69863_schedule_1/function69863_schedule_1.o");
