...
int main(int argc, char **argv){
    tiramisu::init("function69361_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69361/function69361_no_schedule/function69361_no_schedule.o");
