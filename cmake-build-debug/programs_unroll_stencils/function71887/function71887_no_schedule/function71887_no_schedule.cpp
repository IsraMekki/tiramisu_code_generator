...
int main(int argc, char **argv){
    tiramisu::init("function71887_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i0) - input02(i1) - input03(i1, i2) - input04(i1, i2) * input05(i1) * input06(i1) - input07(i0, i1) - input08(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function71887/function71887_no_schedule/function71887_no_schedule.o");
