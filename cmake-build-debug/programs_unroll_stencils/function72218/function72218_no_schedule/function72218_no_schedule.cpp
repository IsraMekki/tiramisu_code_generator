...
int main(int argc, char **argv){
    tiramisu::init("function72218_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72218/function72218_no_schedule/function72218_no_schedule.o");
