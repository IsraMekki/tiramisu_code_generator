...
int main(int argc, char **argv){
    tiramisu::init("function66294_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66294/function66294_no_schedule/function66294_no_schedule.o");
