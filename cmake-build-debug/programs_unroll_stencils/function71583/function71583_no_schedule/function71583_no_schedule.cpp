...
int main(int argc, char **argv){
    tiramisu::init("function71583_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71583/function71583_no_schedule/function71583_no_schedule.o");
