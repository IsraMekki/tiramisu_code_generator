...
int main(int argc, char **argv){
    tiramisu::init("function71583_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71583/function71583_schedule_2/function71583_schedule_2.o");
