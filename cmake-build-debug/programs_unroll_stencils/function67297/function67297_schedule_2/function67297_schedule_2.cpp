...
int main(int argc, char **argv){
    tiramisu::init("function67297_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67297/function67297_schedule_2/function67297_schedule_2.o");
