...
int main(int argc, char **argv){
    tiramisu::init("function68010_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68010/function68010_no_schedule/function68010_no_schedule.o");
