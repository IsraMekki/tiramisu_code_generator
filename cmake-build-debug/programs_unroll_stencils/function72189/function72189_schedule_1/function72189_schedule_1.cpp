...
int main(int argc, char **argv){
    tiramisu::init("function72189_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72189/function72189_schedule_1/function72189_schedule_1.o");
