...
int main(int argc, char **argv){
    tiramisu::init("function71793_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71793/function71793_schedule_2/function71793_schedule_2.o");
