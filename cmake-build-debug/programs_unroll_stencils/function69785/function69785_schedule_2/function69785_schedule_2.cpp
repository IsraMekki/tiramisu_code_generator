...
int main(int argc, char **argv){
    tiramisu::init("function69785_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69785/function69785_schedule_2/function69785_schedule_2.o");
