...
int main(int argc, char **argv){
    tiramisu::init("function70103_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70103/function70103_schedule_0/function70103_schedule_0.o");
