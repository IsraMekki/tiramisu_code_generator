...
int main(int argc, char **argv){
    tiramisu::init("function68721_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68721/function68721_schedule_0/function68721_schedule_0.o");
