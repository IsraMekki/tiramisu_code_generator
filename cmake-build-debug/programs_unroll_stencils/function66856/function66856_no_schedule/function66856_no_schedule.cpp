...
int main(int argc, char **argv){
    tiramisu::init("function66856_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66856/function66856_no_schedule/function66856_no_schedule.o");
