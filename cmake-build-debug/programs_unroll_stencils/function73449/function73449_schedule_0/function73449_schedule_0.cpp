...
int main(int argc, char **argv){
    tiramisu::init("function73449_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73449/function73449_schedule_0/function73449_schedule_0.o");
