...
int main(int argc, char **argv){
    tiramisu::init("function72837_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) + input01(i0) - input02(i1, i0) * input03(i1, i2) * input04(i0, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72837/function72837_no_schedule/function72837_no_schedule.o");
