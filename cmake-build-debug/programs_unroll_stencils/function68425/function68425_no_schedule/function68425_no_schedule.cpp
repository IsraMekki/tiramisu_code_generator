...
int main(int argc, char **argv){
    tiramisu::init("function68425_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68425/function68425_no_schedule/function68425_no_schedule.o");
