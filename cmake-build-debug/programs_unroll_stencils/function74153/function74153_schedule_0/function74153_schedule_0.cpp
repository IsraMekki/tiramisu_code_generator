...
int main(int argc, char **argv){
    tiramisu::init("function74153_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74153/function74153_schedule_0/function74153_schedule_0.o");
