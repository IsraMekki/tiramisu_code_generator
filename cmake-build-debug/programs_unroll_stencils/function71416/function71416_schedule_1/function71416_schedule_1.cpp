...
int main(int argc, char **argv){
    tiramisu::init("function71416_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71416/function71416_schedule_1/function71416_schedule_1.o");
