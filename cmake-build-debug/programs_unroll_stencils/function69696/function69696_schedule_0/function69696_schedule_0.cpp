...
int main(int argc, char **argv){
    tiramisu::init("function69696_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69696/function69696_schedule_0/function69696_schedule_0.o");
