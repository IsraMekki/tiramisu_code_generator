...
int main(int argc, char **argv){
    tiramisu::init("function66388_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) + input01(i0) * input02(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66388/function66388_no_schedule/function66388_no_schedule.o");
