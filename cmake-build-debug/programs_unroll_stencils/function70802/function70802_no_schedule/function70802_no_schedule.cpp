...
int main(int argc, char **argv){
    tiramisu::init("function70802_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70802/function70802_no_schedule/function70802_no_schedule.o");
