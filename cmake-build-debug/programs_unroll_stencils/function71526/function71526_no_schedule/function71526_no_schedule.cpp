...
int main(int argc, char **argv){
    tiramisu::init("function71526_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71526/function71526_no_schedule/function71526_no_schedule.o");
