...
int main(int argc, char **argv){
    tiramisu::init("function66864_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66864/function66864_schedule_1/function66864_schedule_1.o");
