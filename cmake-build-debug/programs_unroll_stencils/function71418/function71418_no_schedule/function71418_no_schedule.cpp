...
int main(int argc, char **argv){
    tiramisu::init("function71418_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71418/function71418_no_schedule/function71418_no_schedule.o");
