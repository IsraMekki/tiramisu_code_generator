...
int main(int argc, char **argv){
    tiramisu::init("function71221_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71221/function71221_schedule_2/function71221_schedule_2.o");
