...
int main(int argc, char **argv){
    tiramisu::init("function73657_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73657/function73657_schedule_0/function73657_schedule_0.o");
