...
int main(int argc, char **argv){
    tiramisu::init("function67146_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) + input01(i1) - input02(i1) - input03(i1) * input04(i1) * input05(i0) - input06(i1) * input07(i1) - input08(i1) - input09(i1));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64}, p_int32, a_input);
    buffer buf01("buf01", {1048576}, p_int32, a_input);
    buffer buf02("buf02", {1048576}, p_int32, a_input);
    buffer buf03("buf03", {1048576}, p_int32, a_input);
    buffer buf04("buf04", {1048576}, p_int32, a_input);
    buffer buf05("buf05", {64}, p_int32, a_input);
    buffer buf06("buf06", {1048576}, p_int32, a_input);
    buffer buf07("buf07", {1048576}, p_int32, a_input);
    buffer buf08("buf08", {1048576}, p_int32, a_input);
    buffer buf09("buf09", {1048576}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function67146/function67146_no_schedule/function67146_no_schedule.o");
