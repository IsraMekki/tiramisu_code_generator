...
int main(int argc, char **argv){
    tiramisu::init("function70373_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70373/function70373_schedule_1/function70373_schedule_1.o");
