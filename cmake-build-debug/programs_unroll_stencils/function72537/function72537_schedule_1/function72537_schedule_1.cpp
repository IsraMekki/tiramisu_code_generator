...
int main(int argc, char **argv){
    tiramisu::init("function72537_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72537/function72537_schedule_1/function72537_schedule_1.o");
