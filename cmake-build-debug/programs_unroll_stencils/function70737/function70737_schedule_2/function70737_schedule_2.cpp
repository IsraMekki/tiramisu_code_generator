...
int main(int argc, char **argv){
    tiramisu::init("function70737_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70737/function70737_schedule_2/function70737_schedule_2.o");
