...
int main(int argc, char **argv){
    tiramisu::init("function72468_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2) - input01(i0, i2) * input02(i1, i2, i3) - input03(i0, i3) - input04(i2) + input05(i1) - input06(i1, i2, i3) - input07(i2) - input08(i3) + input09(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function72468/function72468_no_schedule/function72468_no_schedule.o");
