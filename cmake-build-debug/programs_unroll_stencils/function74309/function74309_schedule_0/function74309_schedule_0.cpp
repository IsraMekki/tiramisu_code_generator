...
int main(int argc, char **argv){
    tiramisu::init("function74309_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74309/function74309_schedule_0/function74309_schedule_0.o");
