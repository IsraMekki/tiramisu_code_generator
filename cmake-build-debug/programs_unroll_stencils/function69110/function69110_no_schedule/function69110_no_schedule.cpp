...
int main(int argc, char **argv){
    tiramisu::init("function69110_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69110/function69110_no_schedule/function69110_no_schedule.o");
