...
int main(int argc, char **argv){
    tiramisu::init("function69110_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69110/function69110_schedule_1/function69110_schedule_1.o");
