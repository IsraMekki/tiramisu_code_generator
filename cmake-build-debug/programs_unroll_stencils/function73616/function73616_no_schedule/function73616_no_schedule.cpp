...
int main(int argc, char **argv){
    tiramisu::init("function73616_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73616/function73616_no_schedule/function73616_no_schedule.o");
