...
int main(int argc, char **argv){
    tiramisu::init("function65492_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65492/function65492_schedule_1/function65492_schedule_1.o");
