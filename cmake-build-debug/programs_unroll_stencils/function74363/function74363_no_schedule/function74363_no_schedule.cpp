...
int main(int argc, char **argv){
    tiramisu::init("function74363_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74363/function74363_no_schedule/function74363_no_schedule.o");
