...
int main(int argc, char **argv){
    tiramisu::init("function68085_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68085/function68085_schedule_2/function68085_schedule_2.o");
