...
int main(int argc, char **argv){
    tiramisu::init("function65160_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65160/function65160_schedule_0/function65160_schedule_0.o");
