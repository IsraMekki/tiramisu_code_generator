...
int main(int argc, char **argv){
    tiramisu::init("function71102_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71102/function71102_no_schedule/function71102_no_schedule.o");
