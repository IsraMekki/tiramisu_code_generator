...
int main(int argc, char **argv){
    tiramisu::init("function65365_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65365/function65365_no_schedule/function65365_no_schedule.o");
