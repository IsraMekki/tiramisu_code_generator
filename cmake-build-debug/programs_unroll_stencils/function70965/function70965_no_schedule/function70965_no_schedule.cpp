...
int main(int argc, char **argv){
    tiramisu::init("function70965_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70965/function70965_no_schedule/function70965_no_schedule.o");
