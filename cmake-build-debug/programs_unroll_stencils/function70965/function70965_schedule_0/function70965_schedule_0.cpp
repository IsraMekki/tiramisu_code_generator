...
int main(int argc, char **argv){
    tiramisu::init("function70965_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70965/function70965_schedule_0/function70965_schedule_0.o");
