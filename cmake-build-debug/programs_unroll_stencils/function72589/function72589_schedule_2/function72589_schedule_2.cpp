...
int main(int argc, char **argv){
    tiramisu::init("function72589_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72589/function72589_schedule_2/function72589_schedule_2.o");
