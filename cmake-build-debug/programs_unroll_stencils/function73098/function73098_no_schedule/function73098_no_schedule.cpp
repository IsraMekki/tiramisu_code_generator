...
int main(int argc, char **argv){
    tiramisu::init("function73098_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i3) - input02(i2) + input03(i1, i0, i3) - input04(i2) * input05(i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf0}, "../data/programs/function73098/function73098_no_schedule/function73098_no_schedule.o");
