...
int main(int argc, char **argv){
    tiramisu::init("function70424_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70424/function70424_no_schedule/function70424_no_schedule.o");
