...
int main(int argc, char **argv){
    tiramisu::init("function73952_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73952/function73952_no_schedule/function73952_no_schedule.o");
