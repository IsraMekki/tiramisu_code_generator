...
int main(int argc, char **argv){
    tiramisu::init("function65614_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65614/function65614_schedule_1/function65614_schedule_1.o");
