...
int main(int argc, char **argv){
    tiramisu::init("function73753_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73753/function73753_no_schedule/function73753_no_schedule.o");
