...
int main(int argc, char **argv){
    tiramisu::init("function71268_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71268/function71268_schedule_1/function71268_schedule_1.o");
