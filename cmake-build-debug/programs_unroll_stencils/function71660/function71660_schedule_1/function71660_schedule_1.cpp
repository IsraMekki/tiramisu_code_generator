...
int main(int argc, char **argv){
    tiramisu::init("function71660_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71660/function71660_schedule_1/function71660_schedule_1.o");
