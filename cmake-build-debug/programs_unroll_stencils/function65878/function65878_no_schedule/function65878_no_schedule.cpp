...
int main(int argc, char **argv){
    tiramisu::init("function65878_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65878/function65878_no_schedule/function65878_no_schedule.o");
