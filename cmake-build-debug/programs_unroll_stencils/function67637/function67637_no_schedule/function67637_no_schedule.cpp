...
int main(int argc, char **argv){
    tiramisu::init("function67637_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67637/function67637_no_schedule/function67637_no_schedule.o");
