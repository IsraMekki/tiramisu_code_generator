...
int main(int argc, char **argv){
    tiramisu::init("function73625_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73625/function73625_schedule_2/function73625_schedule_2.o");
