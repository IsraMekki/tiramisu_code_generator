...
int main(int argc, char **argv){
    tiramisu::init("function65227_no_schedule");
    ...
    input input06("input06", {i1, i3, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i3) - input01(i0) + input02(i3) * input03(i0, i1, i3) + input04(i3) - input05(i1) - input06(i1, i3, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf0}, "../data/programs/function65227/function65227_no_schedule/function65227_no_schedule.o");
