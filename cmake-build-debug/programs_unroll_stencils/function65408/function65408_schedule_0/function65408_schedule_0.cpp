...
int main(int argc, char **argv){
    tiramisu::init("function65408_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65408/function65408_schedule_0/function65408_schedule_0.o");
