...
int main(int argc, char **argv){
    tiramisu::init("function72402_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72402/function72402_no_schedule/function72402_no_schedule.o");
