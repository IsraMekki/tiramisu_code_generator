...
int main(int argc, char **argv){
    tiramisu::init("function67488_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67488/function67488_no_schedule/function67488_no_schedule.o");
