...
int main(int argc, char **argv){
    tiramisu::init("function67488_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67488/function67488_schedule_0/function67488_schedule_0.o");
