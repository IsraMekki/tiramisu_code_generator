...
int main(int argc, char **argv){
    tiramisu::init("function70778_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70778/function70778_schedule_0/function70778_schedule_0.o");
