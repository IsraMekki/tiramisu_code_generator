...
int main(int argc, char **argv){
    tiramisu::init("function74042_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74042/function74042_schedule_2/function74042_schedule_2.o");
