...
int main(int argc, char **argv){
    tiramisu::init("function72696_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72696/function72696_schedule_2/function72696_schedule_2.o");
