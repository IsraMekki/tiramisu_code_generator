...
int main(int argc, char **argv){
    tiramisu::init("function71270_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71270/function71270_schedule_0/function71270_schedule_0.o");
