...
int main(int argc, char **argv){
    tiramisu::init("function70319_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70319/function70319_schedule_0/function70319_schedule_0.o");
