...
int main(int argc, char **argv){
    tiramisu::init("function67002_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67002/function67002_schedule_2/function67002_schedule_2.o");
