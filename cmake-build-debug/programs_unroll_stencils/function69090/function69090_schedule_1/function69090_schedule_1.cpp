...
int main(int argc, char **argv){
    tiramisu::init("function69090_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69090/function69090_schedule_1/function69090_schedule_1.o");
