...
int main(int argc, char **argv){
    tiramisu::init("function71630_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2, i3) * input01(i3, i0) + input02(i0, i2, i3) + input03(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71630/function71630_no_schedule/function71630_no_schedule.o");
