...
int main(int argc, char **argv){
    tiramisu::init("function71355_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function71355/function71355_no_schedule/function71355_no_schedule.o");
