...
int main(int argc, char **argv){
    tiramisu::init("function70919_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70919/function70919_schedule_0/function70919_schedule_0.o");
