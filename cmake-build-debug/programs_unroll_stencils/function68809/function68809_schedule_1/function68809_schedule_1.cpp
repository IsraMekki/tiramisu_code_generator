...
int main(int argc, char **argv){
    tiramisu::init("function68809_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68809/function68809_schedule_1/function68809_schedule_1.o");
