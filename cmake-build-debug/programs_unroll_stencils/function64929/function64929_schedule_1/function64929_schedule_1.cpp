...
int main(int argc, char **argv){
    tiramisu::init("function64929_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64929/function64929_schedule_1/function64929_schedule_1.o");
