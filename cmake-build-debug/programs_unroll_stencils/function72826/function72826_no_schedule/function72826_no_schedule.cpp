...
int main(int argc, char **argv){
    tiramisu::init("function72826_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72826/function72826_no_schedule/function72826_no_schedule.o");
