...
int main(int argc, char **argv){
    tiramisu::init("function74137_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74137/function74137_schedule_2/function74137_schedule_2.o");
