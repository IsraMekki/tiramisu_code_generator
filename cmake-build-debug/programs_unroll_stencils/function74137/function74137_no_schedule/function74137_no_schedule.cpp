...
int main(int argc, char **argv){
    tiramisu::init("function74137_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74137/function74137_no_schedule/function74137_no_schedule.o");
