...
int main(int argc, char **argv){
    tiramisu::init("function73430_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i2, i3) + input01(i0) * input02(i3) * input03(i2, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73430/function73430_no_schedule/function73430_no_schedule.o");
