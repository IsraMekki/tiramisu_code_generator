...
int main(int argc, char **argv){
    tiramisu::init("function74651_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74651/function74651_schedule_2/function74651_schedule_2.o");
