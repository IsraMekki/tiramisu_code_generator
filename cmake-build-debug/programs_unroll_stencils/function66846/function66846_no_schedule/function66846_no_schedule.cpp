...
int main(int argc, char **argv){
    tiramisu::init("function66846_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66846/function66846_no_schedule/function66846_no_schedule.o");
