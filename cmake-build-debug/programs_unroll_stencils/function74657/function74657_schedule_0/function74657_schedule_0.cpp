...
int main(int argc, char **argv){
    tiramisu::init("function74657_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74657/function74657_schedule_0/function74657_schedule_0.o");
