...
int main(int argc, char **argv){
    tiramisu::init("function70741_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70741/function70741_schedule_2/function70741_schedule_2.o");
