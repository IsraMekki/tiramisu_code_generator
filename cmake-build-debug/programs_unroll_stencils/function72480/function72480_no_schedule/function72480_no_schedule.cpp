...
int main(int argc, char **argv){
    tiramisu::init("function72480_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) + input01(i3) + input02(i3) * input03(i2) * input04(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72480/function72480_no_schedule/function72480_no_schedule.o");
