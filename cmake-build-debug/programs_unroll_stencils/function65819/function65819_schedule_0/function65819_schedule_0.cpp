...
int main(int argc, char **argv){
    tiramisu::init("function65819_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65819/function65819_schedule_0/function65819_schedule_0.o");
