...
int main(int argc, char **argv){
    tiramisu::init("function74070_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74070/function74070_schedule_0/function74070_schedule_0.o");
