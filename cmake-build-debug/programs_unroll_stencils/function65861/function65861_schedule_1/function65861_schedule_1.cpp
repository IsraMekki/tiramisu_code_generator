...
int main(int argc, char **argv){
    tiramisu::init("function65861_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65861/function65861_schedule_1/function65861_schedule_1.o");
