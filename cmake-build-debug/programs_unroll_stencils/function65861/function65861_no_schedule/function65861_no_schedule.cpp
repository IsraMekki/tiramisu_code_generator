...
int main(int argc, char **argv){
    tiramisu::init("function65861_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65861/function65861_no_schedule/function65861_no_schedule.o");
