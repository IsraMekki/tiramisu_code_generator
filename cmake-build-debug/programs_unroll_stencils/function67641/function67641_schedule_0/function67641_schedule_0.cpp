...
int main(int argc, char **argv){
    tiramisu::init("function67641_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67641/function67641_schedule_0/function67641_schedule_0.o");
