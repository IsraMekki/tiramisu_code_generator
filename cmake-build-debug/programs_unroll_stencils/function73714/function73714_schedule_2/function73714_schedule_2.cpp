...
int main(int argc, char **argv){
    tiramisu::init("function73714_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73714/function73714_schedule_2/function73714_schedule_2.o");
