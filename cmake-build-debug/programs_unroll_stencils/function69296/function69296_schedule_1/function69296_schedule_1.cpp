...
int main(int argc, char **argv){
    tiramisu::init("function69296_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69296/function69296_schedule_1/function69296_schedule_1.o");
