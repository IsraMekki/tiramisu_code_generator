...
int main(int argc, char **argv){
    tiramisu::init("function69296_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69296/function69296_no_schedule/function69296_no_schedule.o");
