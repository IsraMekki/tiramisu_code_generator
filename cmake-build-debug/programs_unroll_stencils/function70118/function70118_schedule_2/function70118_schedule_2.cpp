...
int main(int argc, char **argv){
    tiramisu::init("function70118_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70118/function70118_schedule_2/function70118_schedule_2.o");
