...
int main(int argc, char **argv){
    tiramisu::init("function71424_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71424/function71424_schedule_2/function71424_schedule_2.o");
