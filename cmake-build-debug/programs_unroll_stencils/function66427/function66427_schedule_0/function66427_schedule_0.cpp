...
int main(int argc, char **argv){
    tiramisu::init("function66427_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66427/function66427_schedule_0/function66427_schedule_0.o");
