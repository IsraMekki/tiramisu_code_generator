...
int main(int argc, char **argv){
    tiramisu::init("function66427_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) - input01(i3) + input02(i2) + input03(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66427/function66427_no_schedule/function66427_no_schedule.o");
