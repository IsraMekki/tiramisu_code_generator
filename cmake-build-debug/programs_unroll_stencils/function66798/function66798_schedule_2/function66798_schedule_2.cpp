...
int main(int argc, char **argv){
    tiramisu::init("function66798_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66798/function66798_schedule_2/function66798_schedule_2.o");
