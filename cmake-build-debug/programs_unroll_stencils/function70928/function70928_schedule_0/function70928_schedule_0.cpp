...
int main(int argc, char **argv){
    tiramisu::init("function70928_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70928/function70928_schedule_0/function70928_schedule_0.o");
