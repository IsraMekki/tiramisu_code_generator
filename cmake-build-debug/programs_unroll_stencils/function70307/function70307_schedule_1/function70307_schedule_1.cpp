...
int main(int argc, char **argv){
    tiramisu::init("function70307_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70307/function70307_schedule_1/function70307_schedule_1.o");
