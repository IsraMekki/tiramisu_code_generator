...
int main(int argc, char **argv){
    tiramisu::init("function67755_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67755/function67755_no_schedule/function67755_no_schedule.o");
