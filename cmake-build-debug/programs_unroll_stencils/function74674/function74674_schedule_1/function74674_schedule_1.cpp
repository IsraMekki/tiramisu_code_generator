...
int main(int argc, char **argv){
    tiramisu::init("function74674_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74674/function74674_schedule_1/function74674_schedule_1.o");
