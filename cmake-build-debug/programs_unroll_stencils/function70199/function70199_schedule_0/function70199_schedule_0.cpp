...
int main(int argc, char **argv){
    tiramisu::init("function70199_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70199/function70199_schedule_0/function70199_schedule_0.o");
