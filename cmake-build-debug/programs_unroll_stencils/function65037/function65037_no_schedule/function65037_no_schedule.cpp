...
int main(int argc, char **argv){
    tiramisu::init("function65037_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65037/function65037_no_schedule/function65037_no_schedule.o");
