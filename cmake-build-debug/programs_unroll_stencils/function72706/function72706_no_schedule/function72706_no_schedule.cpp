...
int main(int argc, char **argv){
    tiramisu::init("function72706_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72706/function72706_no_schedule/function72706_no_schedule.o");
