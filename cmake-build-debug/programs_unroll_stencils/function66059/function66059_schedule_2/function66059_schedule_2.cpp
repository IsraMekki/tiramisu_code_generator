...
int main(int argc, char **argv){
    tiramisu::init("function66059_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66059/function66059_schedule_2/function66059_schedule_2.o");
