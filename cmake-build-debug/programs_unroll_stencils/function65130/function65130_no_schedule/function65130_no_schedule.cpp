...
int main(int argc, char **argv){
    tiramisu::init("function65130_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65130/function65130_no_schedule/function65130_no_schedule.o");
