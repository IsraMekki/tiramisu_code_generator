...
int main(int argc, char **argv){
    tiramisu::init("function74134_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74134/function74134_no_schedule/function74134_no_schedule.o");
