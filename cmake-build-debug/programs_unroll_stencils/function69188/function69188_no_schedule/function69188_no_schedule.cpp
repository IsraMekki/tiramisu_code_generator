...
int main(int argc, char **argv){
    tiramisu::init("function69188_no_schedule");
    ...
    buffer buf00("buf00", {256, 128, 1024}, p_int32, a_input);
    buffer buf0("buf0", {256, 128, 1024}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function69188/function69188_no_schedule/function69188_no_schedule.o");
