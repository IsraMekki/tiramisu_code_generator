...
int main(int argc, char **argv){
    tiramisu::init("function66207_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66207/function66207_no_schedule/function66207_no_schedule.o");
