...
int main(int argc, char **argv){
    tiramisu::init("function72689_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72689/function72689_schedule_2/function72689_schedule_2.o");
