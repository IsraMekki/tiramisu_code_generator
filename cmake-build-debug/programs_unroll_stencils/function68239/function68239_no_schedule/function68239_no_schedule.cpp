...
int main(int argc, char **argv){
    tiramisu::init("function68239_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68239/function68239_no_schedule/function68239_no_schedule.o");
