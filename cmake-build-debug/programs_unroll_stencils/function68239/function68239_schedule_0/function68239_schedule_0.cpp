...
int main(int argc, char **argv){
    tiramisu::init("function68239_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68239/function68239_schedule_0/function68239_schedule_0.o");
