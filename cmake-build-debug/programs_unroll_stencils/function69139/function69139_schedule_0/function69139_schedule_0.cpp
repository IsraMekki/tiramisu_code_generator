...
int main(int argc, char **argv){
    tiramisu::init("function69139_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69139/function69139_schedule_0/function69139_schedule_0.o");
