...
int main(int argc, char **argv){
    tiramisu::init("function68527_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68527/function68527_no_schedule/function68527_no_schedule.o");
