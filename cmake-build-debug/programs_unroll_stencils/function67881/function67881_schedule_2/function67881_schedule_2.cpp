...
int main(int argc, char **argv){
    tiramisu::init("function67881_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67881/function67881_schedule_2/function67881_schedule_2.o");
