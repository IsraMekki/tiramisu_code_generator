...
int main(int argc, char **argv){
    tiramisu::init("function74314_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74314/function74314_schedule_2/function74314_schedule_2.o");
