...
int main(int argc, char **argv){
    tiramisu::init("function66952_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66952/function66952_schedule_0/function66952_schedule_0.o");
