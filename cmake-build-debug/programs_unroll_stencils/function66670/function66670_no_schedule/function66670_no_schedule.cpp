...
int main(int argc, char **argv){
    tiramisu::init("function66670_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66670/function66670_no_schedule/function66670_no_schedule.o");
