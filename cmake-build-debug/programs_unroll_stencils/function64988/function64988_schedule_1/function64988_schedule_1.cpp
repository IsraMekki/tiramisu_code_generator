...
int main(int argc, char **argv){
    tiramisu::init("function64988_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64988/function64988_schedule_1/function64988_schedule_1.o");
