...
int main(int argc, char **argv){
    tiramisu::init("function70576_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70576/function70576_no_schedule/function70576_no_schedule.o");
