...
int main(int argc, char **argv){
    tiramisu::init("function67175_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67175/function67175_no_schedule/function67175_no_schedule.o");
