...
int main(int argc, char **argv){
    tiramisu::init("function70685_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70685/function70685_no_schedule/function70685_no_schedule.o");
