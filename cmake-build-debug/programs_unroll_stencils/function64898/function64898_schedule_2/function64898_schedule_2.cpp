...
int main(int argc, char **argv){
    tiramisu::init("function64898_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64898/function64898_schedule_2/function64898_schedule_2.o");
