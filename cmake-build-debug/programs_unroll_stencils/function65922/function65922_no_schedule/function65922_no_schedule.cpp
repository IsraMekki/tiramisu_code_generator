...
int main(int argc, char **argv){
    tiramisu::init("function65922_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0) + input01(i0) - input02(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65922/function65922_no_schedule/function65922_no_schedule.o");
