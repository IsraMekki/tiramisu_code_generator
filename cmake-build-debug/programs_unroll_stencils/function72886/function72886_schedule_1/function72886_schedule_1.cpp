...
int main(int argc, char **argv){
    tiramisu::init("function72886_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72886/function72886_schedule_1/function72886_schedule_1.o");
