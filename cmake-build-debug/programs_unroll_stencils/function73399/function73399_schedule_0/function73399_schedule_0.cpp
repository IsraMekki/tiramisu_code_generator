...
int main(int argc, char **argv){
    tiramisu::init("function73399_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73399/function73399_schedule_0/function73399_schedule_0.o");
