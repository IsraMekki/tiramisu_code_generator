...
int main(int argc, char **argv){
    tiramisu::init("function71307_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71307/function71307_schedule_1/function71307_schedule_1.o");
