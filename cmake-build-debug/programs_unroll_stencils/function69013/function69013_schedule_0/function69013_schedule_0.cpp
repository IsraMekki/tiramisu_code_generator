...
int main(int argc, char **argv){
    tiramisu::init("function69013_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69013/function69013_schedule_0/function69013_schedule_0.o");
