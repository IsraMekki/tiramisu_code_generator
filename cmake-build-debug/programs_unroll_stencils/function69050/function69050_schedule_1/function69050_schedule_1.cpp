...
int main(int argc, char **argv){
    tiramisu::init("function69050_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69050/function69050_schedule_1/function69050_schedule_1.o");
