...
int main(int argc, char **argv){
    tiramisu::init("function68711_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68711/function68711_no_schedule/function68711_no_schedule.o");
