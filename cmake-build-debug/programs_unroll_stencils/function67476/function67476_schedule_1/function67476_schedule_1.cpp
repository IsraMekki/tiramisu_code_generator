...
int main(int argc, char **argv){
    tiramisu::init("function67476_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67476/function67476_schedule_1/function67476_schedule_1.o");
