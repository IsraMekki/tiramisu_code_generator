...
int main(int argc, char **argv){
    tiramisu::init("function69451_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69451/function69451_schedule_2/function69451_schedule_2.o");
