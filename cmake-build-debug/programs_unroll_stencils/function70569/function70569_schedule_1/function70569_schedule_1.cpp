...
int main(int argc, char **argv){
    tiramisu::init("function70569_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70569/function70569_schedule_1/function70569_schedule_1.o");
