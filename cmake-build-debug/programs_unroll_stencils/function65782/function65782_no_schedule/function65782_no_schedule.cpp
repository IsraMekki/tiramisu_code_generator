...
int main(int argc, char **argv){
    tiramisu::init("function65782_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65782/function65782_no_schedule/function65782_no_schedule.o");
