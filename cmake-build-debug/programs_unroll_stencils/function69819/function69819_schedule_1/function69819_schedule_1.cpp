...
int main(int argc, char **argv){
    tiramisu::init("function69819_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69819/function69819_schedule_1/function69819_schedule_1.o");
