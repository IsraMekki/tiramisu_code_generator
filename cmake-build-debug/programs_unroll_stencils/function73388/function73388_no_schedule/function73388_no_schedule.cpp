...
int main(int argc, char **argv){
    tiramisu::init("function73388_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) - input01(i1) * input02(i2) * input03(i2) - input04(i1) - input05(i0) - input06(i0, i1) - input07(i2) + input08(i1, i2));
    ...
    buffer buf08("buf08", {512, 2048}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function73388/function73388_no_schedule/function73388_no_schedule.o");
