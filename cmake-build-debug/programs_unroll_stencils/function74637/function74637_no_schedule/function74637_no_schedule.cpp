...
int main(int argc, char **argv){
    tiramisu::init("function74637_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74637/function74637_no_schedule/function74637_no_schedule.o");
