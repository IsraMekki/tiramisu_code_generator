...
int main(int argc, char **argv){
    tiramisu::init("function69865_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69865/function69865_schedule_2/function69865_schedule_2.o");
