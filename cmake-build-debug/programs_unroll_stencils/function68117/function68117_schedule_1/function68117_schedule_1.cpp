...
int main(int argc, char **argv){
    tiramisu::init("function68117_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68117/function68117_schedule_1/function68117_schedule_1.o");
