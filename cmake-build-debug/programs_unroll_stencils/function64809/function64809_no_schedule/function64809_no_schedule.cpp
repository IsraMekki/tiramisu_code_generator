...
int main(int argc, char **argv){
    tiramisu::init("function64809_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function64809/function64809_no_schedule/function64809_no_schedule.o");
