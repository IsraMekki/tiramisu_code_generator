...
int main(int argc, char **argv){
    tiramisu::init("function71337_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71337/function71337_no_schedule/function71337_no_schedule.o");
