...
int main(int argc, char **argv){
    tiramisu::init("function69881_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69881/function69881_schedule_0/function69881_schedule_0.o");
