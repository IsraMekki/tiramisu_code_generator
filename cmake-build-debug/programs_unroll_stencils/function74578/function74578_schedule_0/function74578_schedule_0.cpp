...
int main(int argc, char **argv){
    tiramisu::init("function74578_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74578/function74578_schedule_0/function74578_schedule_0.o");
