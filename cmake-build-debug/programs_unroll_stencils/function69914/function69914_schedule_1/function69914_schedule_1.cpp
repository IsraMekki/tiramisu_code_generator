...
int main(int argc, char **argv){
    tiramisu::init("function69914_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69914/function69914_schedule_1/function69914_schedule_1.o");
