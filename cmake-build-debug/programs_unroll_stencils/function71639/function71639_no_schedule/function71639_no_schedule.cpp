...
int main(int argc, char **argv){
    tiramisu::init("function71639_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71639/function71639_no_schedule/function71639_no_schedule.o");
