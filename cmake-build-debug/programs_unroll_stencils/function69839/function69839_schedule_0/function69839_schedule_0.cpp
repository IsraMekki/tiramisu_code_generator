...
int main(int argc, char **argv){
    tiramisu::init("function69839_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69839/function69839_schedule_0/function69839_schedule_0.o");
