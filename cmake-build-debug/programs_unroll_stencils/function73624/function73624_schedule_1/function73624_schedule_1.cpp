...
int main(int argc, char **argv){
    tiramisu::init("function73624_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73624/function73624_schedule_1/function73624_schedule_1.o");
