...
int main(int argc, char **argv){
    tiramisu::init("function67410_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i1, i2, i0) * input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67410/function67410_no_schedule/function67410_no_schedule.o");
