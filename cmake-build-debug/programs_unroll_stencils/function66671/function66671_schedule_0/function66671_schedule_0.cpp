...
int main(int argc, char **argv){
    tiramisu::init("function66671_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66671/function66671_schedule_0/function66671_schedule_0.o");
