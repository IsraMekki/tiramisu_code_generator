...
int main(int argc, char **argv){
    tiramisu::init("function68357_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68357/function68357_no_schedule/function68357_no_schedule.o");
