...
int main(int argc, char **argv){
    tiramisu::init("function70368_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70368/function70368_schedule_0/function70368_schedule_0.o");
