...
int main(int argc, char **argv){
    tiramisu::init("function73189_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73189/function73189_no_schedule/function73189_no_schedule.o");
