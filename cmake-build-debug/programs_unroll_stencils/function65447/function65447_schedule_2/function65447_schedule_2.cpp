...
int main(int argc, char **argv){
    tiramisu::init("function65447_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65447/function65447_schedule_2/function65447_schedule_2.o");
