...
int main(int argc, char **argv){
    tiramisu::init("function67991_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function67991/function67991_schedule_1/function67991_schedule_1.o");
