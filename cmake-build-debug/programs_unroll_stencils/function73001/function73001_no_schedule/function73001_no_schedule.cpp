...
int main(int argc, char **argv){
    tiramisu::init("function73001_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73001/function73001_no_schedule/function73001_no_schedule.o");
