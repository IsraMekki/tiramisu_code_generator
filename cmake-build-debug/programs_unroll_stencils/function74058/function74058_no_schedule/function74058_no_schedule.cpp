...
int main(int argc, char **argv){
    tiramisu::init("function74058_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74058/function74058_no_schedule/function74058_no_schedule.o");
