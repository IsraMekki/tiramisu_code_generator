...
int main(int argc, char **argv){
    tiramisu::init("function71645_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71645/function71645_schedule_2/function71645_schedule_2.o");
