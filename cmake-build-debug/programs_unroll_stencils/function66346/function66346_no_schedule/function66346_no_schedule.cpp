...
int main(int argc, char **argv){
    tiramisu::init("function66346_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66346/function66346_no_schedule/function66346_no_schedule.o");
