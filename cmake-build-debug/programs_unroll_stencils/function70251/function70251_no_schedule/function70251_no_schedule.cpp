...
int main(int argc, char **argv){
    tiramisu::init("function70251_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) * input01(i0, i1, i2) + input02(i1, i3) - input03(i0, i2, i3) * input04(i0) + input05(i0) + input06(i0, i1, i2) * input07(i0, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function70251/function70251_no_schedule/function70251_no_schedule.o");
