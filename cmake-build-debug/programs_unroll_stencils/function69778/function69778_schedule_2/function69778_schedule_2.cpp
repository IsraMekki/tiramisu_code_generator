...
int main(int argc, char **argv){
    tiramisu::init("function69778_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69778/function69778_schedule_2/function69778_schedule_2.o");
