...
int main(int argc, char **argv){
    tiramisu::init("function69778_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) + input01(i0, i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69778/function69778_no_schedule/function69778_no_schedule.o");
