...
int main(int argc, char **argv){
    tiramisu::init("function74430_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74430/function74430_schedule_1/function74430_schedule_1.o");
