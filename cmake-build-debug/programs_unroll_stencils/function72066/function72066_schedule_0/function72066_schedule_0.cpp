...
int main(int argc, char **argv){
    tiramisu::init("function72066_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72066/function72066_schedule_0/function72066_schedule_0.o");
