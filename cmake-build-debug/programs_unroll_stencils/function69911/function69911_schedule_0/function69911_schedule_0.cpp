...
int main(int argc, char **argv){
    tiramisu::init("function69911_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69911/function69911_schedule_0/function69911_schedule_0.o");
