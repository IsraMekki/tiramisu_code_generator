...
int main(int argc, char **argv){
    tiramisu::init("function73757_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73757/function73757_schedule_2/function73757_schedule_2.o");
