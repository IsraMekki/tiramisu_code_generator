...
int main(int argc, char **argv){
    tiramisu::init("function73172_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73172/function73172_no_schedule/function73172_no_schedule.o");
