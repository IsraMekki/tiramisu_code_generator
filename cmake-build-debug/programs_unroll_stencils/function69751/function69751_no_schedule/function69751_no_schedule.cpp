...
int main(int argc, char **argv){
    tiramisu::init("function69751_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1, i2) * input01(i1, i2) - input02(i0, i1) + input03(i1, i2) * input04(i2) * input05(i2) + input06(i1, i2) + input07(i0, i1) - input08(i0, i1) + input09(i0, i1));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {256, 512}, p_int32, a_input);
    buffer buf01("buf01", {256, 512}, p_int32, a_input);
    buffer buf02("buf02", {512, 256}, p_int32, a_input);
    buffer buf03("buf03", {256, 512}, p_int32, a_input);
    buffer buf04("buf04", {512}, p_int32, a_input);
    buffer buf05("buf05", {512}, p_int32, a_input);
    buffer buf06("buf06", {256, 512}, p_int32, a_input);
    buffer buf07("buf07", {512, 256}, p_int32, a_input);
    buffer buf08("buf08", {512, 256}, p_int32, a_input);
    buffer buf09("buf09", {512, 256}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69751/function69751_no_schedule/function69751_no_schedule.o");
