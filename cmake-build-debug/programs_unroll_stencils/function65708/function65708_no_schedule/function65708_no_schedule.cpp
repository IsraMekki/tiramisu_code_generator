...
int main(int argc, char **argv){
    tiramisu::init("function65708_no_schedule");
    ...
    buffer buf00("buf00", {4096, 256, 64}, p_int32, a_input);
    buffer buf0("buf0", {4096, 256, 64}, p_int32, a_output);
    
    input0.store_in(&buf00);
    comp0.store_in(&buf0);

    tiramisu::codegen({&buf00, &buf0}, "../data/programs/function65708/function65708_no_schedule/function65708_no_schedule.o");
