...
int main(int argc, char **argv){
    tiramisu::init("function66610_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66610/function66610_no_schedule/function66610_no_schedule.o");
