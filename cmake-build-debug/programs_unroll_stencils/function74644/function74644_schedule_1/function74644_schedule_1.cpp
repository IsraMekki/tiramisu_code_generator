...
int main(int argc, char **argv){
    tiramisu::init("function74644_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74644/function74644_schedule_1/function74644_schedule_1.o");
