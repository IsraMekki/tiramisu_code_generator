...
int main(int argc, char **argv){
    tiramisu::init("function74644_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74644/function74644_schedule_0/function74644_schedule_0.o");
