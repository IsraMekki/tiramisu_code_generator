...
int main(int argc, char **argv){
    tiramisu::init("function66322_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i1, i2, i3) * input01(i0) + input02(i1) - input03(i0, i3) * input04(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66322/function66322_no_schedule/function66322_no_schedule.o");
