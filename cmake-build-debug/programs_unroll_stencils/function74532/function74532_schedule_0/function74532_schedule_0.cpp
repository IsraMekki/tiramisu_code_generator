...
int main(int argc, char **argv){
    tiramisu::init("function74532_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74532/function74532_schedule_0/function74532_schedule_0.o");
