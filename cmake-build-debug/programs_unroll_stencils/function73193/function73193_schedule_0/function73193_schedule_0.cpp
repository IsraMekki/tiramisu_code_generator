...
int main(int argc, char **argv){
    tiramisu::init("function73193_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73193/function73193_schedule_0/function73193_schedule_0.o");
