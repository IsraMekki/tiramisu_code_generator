...
int main(int argc, char **argv){
    tiramisu::init("function74660_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74660/function74660_no_schedule/function74660_no_schedule.o");
