...
int main(int argc, char **argv){
    tiramisu::init("function69588_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69588/function69588_schedule_2/function69588_schedule_2.o");
