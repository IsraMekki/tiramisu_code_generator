...
int main(int argc, char **argv){
    tiramisu::init("function71825_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71825/function71825_schedule_2/function71825_schedule_2.o");
