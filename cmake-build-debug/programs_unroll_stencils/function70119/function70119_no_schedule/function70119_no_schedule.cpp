...
int main(int argc, char **argv){
    tiramisu::init("function70119_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70119/function70119_no_schedule/function70119_no_schedule.o");
