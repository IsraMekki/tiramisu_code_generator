...
int main(int argc, char **argv){
    tiramisu::init("function70119_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70119/function70119_schedule_1/function70119_schedule_1.o");
