...
int main(int argc, char **argv){
    tiramisu::init("function68980_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68980/function68980_schedule_1/function68980_schedule_1.o");
