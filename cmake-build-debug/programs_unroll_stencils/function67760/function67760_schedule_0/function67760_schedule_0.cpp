...
int main(int argc, char **argv){
    tiramisu::init("function67760_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67760/function67760_schedule_0/function67760_schedule_0.o");
