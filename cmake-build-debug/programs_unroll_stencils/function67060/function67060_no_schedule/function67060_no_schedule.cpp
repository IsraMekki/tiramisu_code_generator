...
int main(int argc, char **argv){
    tiramisu::init("function67060_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67060/function67060_no_schedule/function67060_no_schedule.o");
