...
int main(int argc, char **argv){
    tiramisu::init("function69235_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69235/function69235_schedule_0/function69235_schedule_0.o");
