...
int main(int argc, char **argv){
    tiramisu::init("function72339_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72339/function72339_schedule_0/function72339_schedule_0.o");
