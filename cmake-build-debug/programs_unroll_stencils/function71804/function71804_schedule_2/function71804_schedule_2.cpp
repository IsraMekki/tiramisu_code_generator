...
int main(int argc, char **argv){
    tiramisu::init("function71804_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71804/function71804_schedule_2/function71804_schedule_2.o");
