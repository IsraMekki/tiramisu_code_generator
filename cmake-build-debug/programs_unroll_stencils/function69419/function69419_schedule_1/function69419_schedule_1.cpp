...
int main(int argc, char **argv){
    tiramisu::init("function69419_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69419/function69419_schedule_1/function69419_schedule_1.o");
