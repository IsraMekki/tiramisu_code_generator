...
int main(int argc, char **argv){
    tiramisu::init("function68430_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68430/function68430_schedule_2/function68430_schedule_2.o");
