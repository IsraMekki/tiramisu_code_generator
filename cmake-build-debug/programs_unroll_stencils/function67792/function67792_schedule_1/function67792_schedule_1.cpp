...
int main(int argc, char **argv){
    tiramisu::init("function67792_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67792/function67792_schedule_1/function67792_schedule_1.o");
