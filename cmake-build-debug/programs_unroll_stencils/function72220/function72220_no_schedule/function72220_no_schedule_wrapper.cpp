#include "Halide.h"
#include "function72220_no_schedule_wrapper.h"
...
int main(int, char **){
    ...
    function72220_no_schedule(buf00.raw_buffer(), buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer(), buf04.raw_buffer(), buf05.raw_buffer(), buf06.raw_buffer(), buf07.raw_buffer(), buf08.raw_buffer(), buf09.raw_buffer(), buf0.raw_buffer());
    ...
    exec_times_file.open("../data/programs/function72220/function72220_no_schedule/exec_times.txt", std::ios_base::app);
