...
int main(int argc, char **argv){
    tiramisu::init("function66175_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66175/function66175_schedule_2/function66175_schedule_2.o");
