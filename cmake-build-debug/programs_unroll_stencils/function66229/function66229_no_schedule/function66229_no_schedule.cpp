...
int main(int argc, char **argv){
    tiramisu::init("function66229_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66229/function66229_no_schedule/function66229_no_schedule.o");
