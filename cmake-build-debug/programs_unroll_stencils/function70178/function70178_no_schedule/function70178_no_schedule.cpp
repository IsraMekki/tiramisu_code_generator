...
int main(int argc, char **argv){
    tiramisu::init("function70178_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70178/function70178_no_schedule/function70178_no_schedule.o");
