...
int main(int argc, char **argv){
    tiramisu::init("function66924_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66924/function66924_schedule_0/function66924_schedule_0.o");
