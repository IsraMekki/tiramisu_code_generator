...
int main(int argc, char **argv){
    tiramisu::init("function68595_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68595/function68595_no_schedule/function68595_no_schedule.o");
