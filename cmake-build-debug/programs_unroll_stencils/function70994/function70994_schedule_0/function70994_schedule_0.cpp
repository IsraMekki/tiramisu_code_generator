...
int main(int argc, char **argv){
    tiramisu::init("function70994_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70994/function70994_schedule_0/function70994_schedule_0.o");
