...
int main(int argc, char **argv){
    tiramisu::init("function69709_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function69709/function69709_no_schedule/function69709_no_schedule.o");
