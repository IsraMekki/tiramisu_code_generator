...
int main(int argc, char **argv){
    tiramisu::init("function64940_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function64940/function64940_schedule_2/function64940_schedule_2.o");
