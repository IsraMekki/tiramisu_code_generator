...
int main(int argc, char **argv){
    tiramisu::init("function73395_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i2) * input01(i0) - input02(i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function73395/function73395_no_schedule/function73395_no_schedule.o");
