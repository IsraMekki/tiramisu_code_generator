...
int main(int argc, char **argv){
    tiramisu::init("function69436_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69436/function69436_schedule_1/function69436_schedule_1.o");
