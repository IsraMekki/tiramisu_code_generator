...
int main(int argc, char **argv){
    tiramisu::init("function72827_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72827/function72827_schedule_0/function72827_schedule_0.o");
