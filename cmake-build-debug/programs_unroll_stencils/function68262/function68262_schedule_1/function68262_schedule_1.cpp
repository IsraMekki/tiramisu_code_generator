...
int main(int argc, char **argv){
    tiramisu::init("function68262_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68262/function68262_schedule_1/function68262_schedule_1.o");
