...
int main(int argc, char **argv){
    tiramisu::init("function69174_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69174/function69174_no_schedule/function69174_no_schedule.o");
