...
int main(int argc, char **argv){
    tiramisu::init("function68870_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68870/function68870_no_schedule/function68870_no_schedule.o");
