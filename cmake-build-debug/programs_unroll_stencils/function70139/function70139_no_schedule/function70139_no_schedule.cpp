...
int main(int argc, char **argv){
    tiramisu::init("function70139_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70139/function70139_no_schedule/function70139_no_schedule.o");
