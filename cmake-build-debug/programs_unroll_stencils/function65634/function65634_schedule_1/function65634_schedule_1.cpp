...
int main(int argc, char **argv){
    tiramisu::init("function65634_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function65634/function65634_schedule_1/function65634_schedule_1.o");
