...
int main(int argc, char **argv){
    tiramisu::init("function64835_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64835/function64835_schedule_1/function64835_schedule_1.o");
