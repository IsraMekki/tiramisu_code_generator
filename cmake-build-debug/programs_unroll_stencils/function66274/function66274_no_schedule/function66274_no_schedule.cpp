...
int main(int argc, char **argv){
    tiramisu::init("function66274_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66274/function66274_no_schedule/function66274_no_schedule.o");
