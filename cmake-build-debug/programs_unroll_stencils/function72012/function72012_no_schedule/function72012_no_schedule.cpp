...
int main(int argc, char **argv){
    tiramisu::init("function72012_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72012/function72012_no_schedule/function72012_no_schedule.o");
