...
int main(int argc, char **argv){
    tiramisu::init("function71246_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71246/function71246_schedule_0/function71246_schedule_0.o");
