...
int main(int argc, char **argv){
    tiramisu::init("function66700_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66700/function66700_schedule_0/function66700_schedule_0.o");
