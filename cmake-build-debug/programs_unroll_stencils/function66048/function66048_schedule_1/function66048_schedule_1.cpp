...
int main(int argc, char **argv){
    tiramisu::init("function66048_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66048/function66048_schedule_1/function66048_schedule_1.o");
