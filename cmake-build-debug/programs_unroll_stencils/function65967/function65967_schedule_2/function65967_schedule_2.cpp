...
int main(int argc, char **argv){
    tiramisu::init("function65967_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65967/function65967_schedule_2/function65967_schedule_2.o");
