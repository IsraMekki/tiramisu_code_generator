...
int main(int argc, char **argv){
    tiramisu::init("function68981_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68981/function68981_no_schedule/function68981_no_schedule.o");
