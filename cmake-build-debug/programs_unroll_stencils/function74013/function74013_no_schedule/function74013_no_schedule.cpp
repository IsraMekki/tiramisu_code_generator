...
int main(int argc, char **argv){
    tiramisu::init("function74013_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i1) - input01(i0, i2) + input02(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74013/function74013_no_schedule/function74013_no_schedule.o");
