...
int main(int argc, char **argv){
    tiramisu::init("function73563_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i0, i2, i3) * input02(i0, i1, i3) + input03(i1, i2) * input04(i2, i1, i3) - input05(i3) - input06(i0, i1, i3) + input07(i2));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {64}, p_int32, a_input);
    buffer buf01("buf01", {256, 64, 64}, p_int32, a_input);
    buffer buf02("buf02", {256, 64, 64}, p_int32, a_input);
    buffer buf03("buf03", {64, 64}, p_int32, a_input);
    buffer buf04("buf04", {64, 64, 64}, p_int32, a_input);
    buffer buf05("buf05", {64}, p_int32, a_input);
    buffer buf06("buf06", {256, 64, 64}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf0}, "../data/programs/function73563/function73563_no_schedule/function73563_no_schedule.o");
