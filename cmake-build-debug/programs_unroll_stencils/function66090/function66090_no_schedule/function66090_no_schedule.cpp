...
int main(int argc, char **argv){
    tiramisu::init("function66090_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66090/function66090_no_schedule/function66090_no_schedule.o");
