...
int main(int argc, char **argv){
    tiramisu::init("function68566_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68566/function68566_schedule_2/function68566_schedule_2.o");
