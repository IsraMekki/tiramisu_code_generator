...
int main(int argc, char **argv){
    tiramisu::init("function74581_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function74581/function74581_no_schedule/function74581_no_schedule.o");
