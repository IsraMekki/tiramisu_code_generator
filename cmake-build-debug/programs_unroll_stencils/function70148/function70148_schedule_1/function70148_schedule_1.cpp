...
int main(int argc, char **argv){
    tiramisu::init("function70148_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70148/function70148_schedule_1/function70148_schedule_1.o");
