...
int main(int argc, char **argv){
    tiramisu::init("function70148_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function70148/function70148_schedule_2/function70148_schedule_2.o");
