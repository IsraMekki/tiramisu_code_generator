...
int main(int argc, char **argv){
    tiramisu::init("function67609_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67609/function67609_schedule_1/function67609_schedule_1.o");
