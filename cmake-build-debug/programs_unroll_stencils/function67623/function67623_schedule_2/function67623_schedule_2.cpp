...
int main(int argc, char **argv){
    tiramisu::init("function67623_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67623/function67623_schedule_2/function67623_schedule_2.o");
