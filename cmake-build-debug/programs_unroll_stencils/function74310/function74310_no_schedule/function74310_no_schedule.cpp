...
int main(int argc, char **argv){
    tiramisu::init("function74310_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) + input01(i1) - input02(i1) + input03(i0) + input04(i0) + input05(i1) + input06(i0) - input07(i0) - input08(i1));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf0}, "../data/programs/function74310/function74310_no_schedule/function74310_no_schedule.o");
