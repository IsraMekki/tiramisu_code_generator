...
int main(int argc, char **argv){
    tiramisu::init("function69437_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69437/function69437_no_schedule/function69437_no_schedule.o");
