...
int main(int argc, char **argv){
    tiramisu::init("function70663_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function70663/function70663_schedule_1/function70663_schedule_1.o");
