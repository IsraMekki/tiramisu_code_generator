...
int main(int argc, char **argv){
    tiramisu::init("function66505_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66505/function66505_no_schedule/function66505_no_schedule.o");
