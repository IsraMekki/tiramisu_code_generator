...
int main(int argc, char **argv){
    tiramisu::init("function73457_no_schedule");
    ...
    input input03("input03", {i2, i3, i1}, p_int32);

    input input04("input04", {i0, i1, i2}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i0) + input02(i0, i2) + input03(i2, i3, i1) * input04(i0, i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73457/function73457_no_schedule/function73457_no_schedule.o");
