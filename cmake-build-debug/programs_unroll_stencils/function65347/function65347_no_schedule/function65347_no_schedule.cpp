...
int main(int argc, char **argv){
    tiramisu::init("function65347_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65347/function65347_no_schedule/function65347_no_schedule.o");
