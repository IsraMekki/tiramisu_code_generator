...
int main(int argc, char **argv){
    tiramisu::init("function71459_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71459/function71459_no_schedule/function71459_no_schedule.o");
