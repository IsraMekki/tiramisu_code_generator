...
int main(int argc, char **argv){
    tiramisu::init("function71459_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71459/function71459_schedule_2/function71459_schedule_2.o");
