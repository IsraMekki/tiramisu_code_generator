...
int main(int argc, char **argv){
    tiramisu::init("function67831_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67831/function67831_schedule_2/function67831_schedule_2.o");
