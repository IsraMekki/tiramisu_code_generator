...
int main(int argc, char **argv){
    tiramisu::init("function69671_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function69671/function69671_schedule_0/function69671_schedule_0.o");
