...
int main(int argc, char **argv){
    tiramisu::init("function72423_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72423/function72423_schedule_0/function72423_schedule_0.o");
