...
int main(int argc, char **argv){
    tiramisu::init("function67738_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67738/function67738_schedule_0/function67738_schedule_0.o");
