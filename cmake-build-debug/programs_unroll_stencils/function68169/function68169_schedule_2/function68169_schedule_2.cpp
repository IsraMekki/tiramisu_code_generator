...
int main(int argc, char **argv){
    tiramisu::init("function68169_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function68169/function68169_schedule_2/function68169_schedule_2.o");
