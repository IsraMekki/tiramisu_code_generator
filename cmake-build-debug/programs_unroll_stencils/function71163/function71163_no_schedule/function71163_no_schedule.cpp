...
int main(int argc, char **argv){
    tiramisu::init("function71163_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71163/function71163_no_schedule/function71163_no_schedule.o");
