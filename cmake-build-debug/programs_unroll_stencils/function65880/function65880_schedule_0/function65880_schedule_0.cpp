...
int main(int argc, char **argv){
    tiramisu::init("function65880_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function65880/function65880_schedule_0/function65880_schedule_0.o");
