...
int main(int argc, char **argv){
    tiramisu::init("function65868_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65868/function65868_schedule_0/function65868_schedule_0.o");
