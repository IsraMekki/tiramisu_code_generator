...
int main(int argc, char **argv){
    tiramisu::init("function68601_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68601/function68601_no_schedule/function68601_no_schedule.o");
