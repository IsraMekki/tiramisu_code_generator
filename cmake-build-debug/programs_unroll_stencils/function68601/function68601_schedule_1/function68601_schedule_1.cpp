...
int main(int argc, char **argv){
    tiramisu::init("function68601_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68601/function68601_schedule_1/function68601_schedule_1.o");
