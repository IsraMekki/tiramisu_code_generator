...
int main(int argc, char **argv){
    tiramisu::init("function66692_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function66692/function66692_schedule_0/function66692_schedule_0.o");
