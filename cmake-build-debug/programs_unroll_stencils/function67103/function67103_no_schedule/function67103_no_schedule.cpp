...
int main(int argc, char **argv){
    tiramisu::init("function67103_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67103/function67103_no_schedule/function67103_no_schedule.o");
