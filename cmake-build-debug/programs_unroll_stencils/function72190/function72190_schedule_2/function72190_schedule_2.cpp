...
int main(int argc, char **argv){
    tiramisu::init("function72190_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72190/function72190_schedule_2/function72190_schedule_2.o");
