...
int main(int argc, char **argv){
    tiramisu::init("function67958_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67958/function67958_no_schedule/function67958_no_schedule.o");
