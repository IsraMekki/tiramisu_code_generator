...
int main(int argc, char **argv){
    tiramisu::init("function69191_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1) - input01(i2) - input02(i3) + input03(i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69191/function69191_no_schedule/function69191_no_schedule.o");
