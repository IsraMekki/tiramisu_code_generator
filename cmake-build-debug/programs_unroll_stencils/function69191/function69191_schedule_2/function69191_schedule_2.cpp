...
int main(int argc, char **argv){
    tiramisu::init("function69191_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69191/function69191_schedule_2/function69191_schedule_2.o");
