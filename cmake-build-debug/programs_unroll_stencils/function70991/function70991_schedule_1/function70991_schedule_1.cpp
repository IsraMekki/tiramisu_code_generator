...
int main(int argc, char **argv){
    tiramisu::init("function70991_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70991/function70991_schedule_1/function70991_schedule_1.o");
