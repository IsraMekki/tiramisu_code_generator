...
int main(int argc, char **argv){
    tiramisu::init("function72028_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72028/function72028_no_schedule/function72028_no_schedule.o");
