...
int main(int argc, char **argv){
    tiramisu::init("function68688_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68688/function68688_schedule_0/function68688_schedule_0.o");
