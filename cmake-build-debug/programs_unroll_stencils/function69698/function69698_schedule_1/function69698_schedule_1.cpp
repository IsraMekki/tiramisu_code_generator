...
int main(int argc, char **argv){
    tiramisu::init("function69698_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69698/function69698_schedule_1/function69698_schedule_1.o");
