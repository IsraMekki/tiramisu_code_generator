...
int main(int argc, char **argv){
    tiramisu::init("function70254_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i2) - input02(i1, i2) + input03(i0, i2) * input04(i0) + input05(i1) - input06(i0) + input07(i2) * input08(i1) - input09(i1));
    ...
    buffer buf03("buf03", {256, 4096}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70254/function70254_no_schedule/function70254_no_schedule.o");
