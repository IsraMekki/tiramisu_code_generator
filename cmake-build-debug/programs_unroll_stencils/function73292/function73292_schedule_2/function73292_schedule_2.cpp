...
int main(int argc, char **argv){
    tiramisu::init("function73292_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73292/function73292_schedule_2/function73292_schedule_2.o");
