...
int main(int argc, char **argv){
    tiramisu::init("function73651_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function73651/function73651_no_schedule/function73651_no_schedule.o");
