...
int main(int argc, char **argv){
    tiramisu::init("function72606_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72606/function72606_no_schedule/function72606_no_schedule.o");
