...
int main(int argc, char **argv){
    tiramisu::init("function64841_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64841/function64841_no_schedule/function64841_no_schedule.o");
