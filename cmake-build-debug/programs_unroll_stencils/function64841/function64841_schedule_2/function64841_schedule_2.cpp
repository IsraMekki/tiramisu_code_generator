...
int main(int argc, char **argv){
    tiramisu::init("function64841_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function64841/function64841_schedule_2/function64841_schedule_2.o");
