...
int main(int argc, char **argv){
    tiramisu::init("function66830_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66830/function66830_schedule_1/function66830_schedule_1.o");
