...
int main(int argc, char **argv){
    tiramisu::init("function66482_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66482/function66482_schedule_1/function66482_schedule_1.o");
