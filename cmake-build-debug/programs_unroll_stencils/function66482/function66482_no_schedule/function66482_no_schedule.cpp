...
int main(int argc, char **argv){
    tiramisu::init("function66482_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function66482/function66482_no_schedule/function66482_no_schedule.o");
