...
int main(int argc, char **argv){
    tiramisu::init("function73016_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function73016/function73016_schedule_0/function73016_schedule_0.o");
