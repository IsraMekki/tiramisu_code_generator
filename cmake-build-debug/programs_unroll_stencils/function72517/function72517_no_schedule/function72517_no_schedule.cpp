...
int main(int argc, char **argv){
    tiramisu::init("function72517_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i3) * input01(i1, i2));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72517/function72517_no_schedule/function72517_no_schedule.o");
