...
int main(int argc, char **argv){
    tiramisu::init("function65732_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function65732/function65732_no_schedule/function65732_no_schedule.o");
