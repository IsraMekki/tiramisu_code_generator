...
int main(int argc, char **argv){
    tiramisu::init("function72475_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function72475/function72475_no_schedule/function72475_no_schedule.o");
