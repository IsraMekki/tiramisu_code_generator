...
int main(int argc, char **argv){
    tiramisu::init("function65131_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function65131/function65131_schedule_2/function65131_schedule_2.o");
