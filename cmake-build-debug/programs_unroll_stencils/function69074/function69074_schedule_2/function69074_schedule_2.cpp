...
int main(int argc, char **argv){
    tiramisu::init("function69074_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69074/function69074_schedule_2/function69074_schedule_2.o");
