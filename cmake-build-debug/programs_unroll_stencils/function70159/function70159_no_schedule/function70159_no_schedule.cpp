...
int main(int argc, char **argv){
    tiramisu::init("function70159_no_schedule");
    ...
    computation comp0("comp0", {i0, i1}, input00(i0) - input01(i1) * input02(i1) + input03(i0) + input04(i0) * input05(i1) * input06(i1) + input07(i1) - input08(i1) - input09(i0));
    
    comp0.parallelize(i0);
    
    buffer buf00("buf00", {512}, p_int32, a_input);
    buffer buf01("buf01", {131072}, p_int32, a_input);
    buffer buf02("buf02", {131072}, p_int32, a_input);
    buffer buf03("buf03", {512}, p_int32, a_input);
    buffer buf04("buf04", {512}, p_int32, a_input);
    buffer buf05("buf05", {131072}, p_int32, a_input);
    buffer buf06("buf06", {131072}, p_int32, a_input);
    buffer buf07("buf07", {131072}, p_int32, a_input);
    buffer buf08("buf08", {131072}, p_int32, a_input);
    buffer buf09("buf09", {512}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function70159/function70159_no_schedule/function70159_no_schedule.o");
