...
int main(int argc, char **argv){
    tiramisu::init("function72435_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72435/function72435_schedule_0/function72435_schedule_0.o");
