...
int main(int argc, char **argv){
    tiramisu::init("function74145_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function74145/function74145_no_schedule/function74145_no_schedule.o");
