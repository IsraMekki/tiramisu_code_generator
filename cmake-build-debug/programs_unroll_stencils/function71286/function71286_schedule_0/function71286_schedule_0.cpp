...
int main(int argc, char **argv){
    tiramisu::init("function71286_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71286/function71286_schedule_0/function71286_schedule_0.o");
