...
int main(int argc, char **argv){
    tiramisu::init("function70604_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70604/function70604_no_schedule/function70604_no_schedule.o");
