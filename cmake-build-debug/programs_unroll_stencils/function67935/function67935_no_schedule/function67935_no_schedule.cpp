...
int main(int argc, char **argv){
    tiramisu::init("function67935_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67935/function67935_no_schedule/function67935_no_schedule.o");
