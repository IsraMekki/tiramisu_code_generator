...
int main(int argc, char **argv){
    tiramisu::init("function72612_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72612/function72612_no_schedule/function72612_no_schedule.o");
