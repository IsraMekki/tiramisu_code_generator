...
int main(int argc, char **argv){
    tiramisu::init("function69001_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function69001/function69001_schedule_1/function69001_schedule_1.o");
