...
int main(int argc, char **argv){
    tiramisu::init("function68368_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68368/function68368_schedule_0/function68368_schedule_0.o");
