...
int main(int argc, char **argv){
    tiramisu::init("function73564_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73564/function73564_schedule_1/function73564_schedule_1.o");
