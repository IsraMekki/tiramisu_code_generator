...
int main(int argc, char **argv){
    tiramisu::init("function73883_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function73883/function73883_no_schedule/function73883_no_schedule.o");
