...
int main(int argc, char **argv){
    tiramisu::init("function72692_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72692/function72692_schedule_0/function72692_schedule_0.o");
