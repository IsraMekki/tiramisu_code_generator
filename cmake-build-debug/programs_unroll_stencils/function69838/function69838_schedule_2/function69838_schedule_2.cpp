...
int main(int argc, char **argv){
    tiramisu::init("function69838_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function69838/function69838_schedule_2/function69838_schedule_2.o");
