...
int main(int argc, char **argv){
    tiramisu::init("function70526_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70526/function70526_no_schedule/function70526_no_schedule.o");
