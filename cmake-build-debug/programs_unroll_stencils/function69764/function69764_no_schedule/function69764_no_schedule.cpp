...
int main(int argc, char **argv){
    tiramisu::init("function69764_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) * input01(i0, i1, i3) + input02(i0) + input03(i0) - input04(i2) - input05(i1, i2, i3) - input06(i2, i3) * input07(i0, i1, i2) - input08(i1, i3) - input09(i0, i3));
    ...
    buffer buf06("buf06", {128, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69764/function69764_no_schedule/function69764_no_schedule.o");
