...
int main(int argc, char **argv){
    tiramisu::init("function72482_no_schedule");
    ...
    input input04("input04", {i3, i1, i0}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i0, i1, i2) + input01(i2, i3) + input02(i2) + input03(i2) - input04(i3, i1, i0));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function72482/function72482_no_schedule/function72482_no_schedule.o");
