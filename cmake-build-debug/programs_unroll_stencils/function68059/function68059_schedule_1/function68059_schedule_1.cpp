...
int main(int argc, char **argv){
    tiramisu::init("function68059_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68059/function68059_schedule_1/function68059_schedule_1.o");
