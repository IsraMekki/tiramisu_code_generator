...
int main(int argc, char **argv){
    tiramisu::init("function68659_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function68659/function68659_schedule_1/function68659_schedule_1.o");
