...
int main(int argc, char **argv){
    tiramisu::init("function71788_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function71788/function71788_schedule_2/function71788_schedule_2.o");
