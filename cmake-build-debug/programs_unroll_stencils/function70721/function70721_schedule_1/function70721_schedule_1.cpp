...
int main(int argc, char **argv){
    tiramisu::init("function70721_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function70721/function70721_schedule_1/function70721_schedule_1.o");
