...
int main(int argc, char **argv){
    tiramisu::init("function67328_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function67328/function67328_schedule_2/function67328_schedule_2.o");
