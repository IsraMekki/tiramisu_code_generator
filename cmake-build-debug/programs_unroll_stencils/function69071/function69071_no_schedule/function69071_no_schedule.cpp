...
int main(int argc, char **argv){
    tiramisu::init("function69071_no_schedule");
    ...
    computation comp0("comp0", {i0, i1, i2}, input00(i0, i2) * input01(i0, i1) + input02(i1) + input03(i0, i2) + input04(i0) - input05(i0) * input06(i0, i1) - input07(i0) - input08(i0) * input09(i1, i2));
    ...
    buffer buf06("buf06", {2048, 256}, p_int32, a_input);
    buffer buf07("buf07", {2048}, p_int32, a_input);
    buffer buf08("buf08", {2048}, p_int32, a_input);
    buffer buf09("buf09", {256, 128}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69071/function69071_no_schedule/function69071_no_schedule.o");
