#include "Halide.h"
#include "function65035_schedule_1_wrapper.h"
...
int main(int, char **){
    ...
    function65035_schedule_1(buf00.raw_buffer(), buf01.raw_buffer(), buf02.raw_buffer(), buf03.raw_buffer(), buf04.raw_buffer(), buf05.raw_buffer(), buf06.raw_buffer(), buf07.raw_buffer(), buf08.raw_buffer(), buf0.raw_buffer());
    ...
    exec_times_file.open("../data/programs/function65035/function65035_schedule_1/exec_times.txt", std::ios_base::app);
