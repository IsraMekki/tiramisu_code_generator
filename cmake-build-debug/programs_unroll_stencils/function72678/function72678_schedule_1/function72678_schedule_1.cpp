...
int main(int argc, char **argv){
    tiramisu::init("function72678_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function72678/function72678_schedule_1/function72678_schedule_1.o");
