...
int main(int argc, char **argv){
    tiramisu::init("function67338_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67338/function67338_schedule_2/function67338_schedule_2.o");
