...
int main(int argc, char **argv){
    tiramisu::init("function72411_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function72411/function72411_no_schedule/function72411_no_schedule.o");
