...
int main(int argc, char **argv){
    tiramisu::init("function74764_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74764/function74764_schedule_1/function74764_schedule_1.o");
