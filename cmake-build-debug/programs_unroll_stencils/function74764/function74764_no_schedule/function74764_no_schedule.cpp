...
int main(int argc, char **argv){
    tiramisu::init("function74764_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function74764/function74764_no_schedule/function74764_no_schedule.o");
