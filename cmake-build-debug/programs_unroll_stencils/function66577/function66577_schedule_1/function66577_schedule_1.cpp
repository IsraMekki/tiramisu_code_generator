...
int main(int argc, char **argv){
    tiramisu::init("function66577_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf0}, "../data/programs/function66577/function66577_schedule_1/function66577_schedule_1.o");
