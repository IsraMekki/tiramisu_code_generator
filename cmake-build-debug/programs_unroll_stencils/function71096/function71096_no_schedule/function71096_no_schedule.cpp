...
int main(int argc, char **argv){
    tiramisu::init("function71096_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function71096/function71096_no_schedule/function71096_no_schedule.o");
