...
int main(int argc, char **argv){
    tiramisu::init("function68888_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function68888/function68888_no_schedule/function68888_no_schedule.o");
