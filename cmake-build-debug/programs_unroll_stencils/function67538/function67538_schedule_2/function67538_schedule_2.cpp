...
int main(int argc, char **argv){
    tiramisu::init("function67538_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67538/function67538_schedule_2/function67538_schedule_2.o");
