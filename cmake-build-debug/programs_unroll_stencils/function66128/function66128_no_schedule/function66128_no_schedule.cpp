...
int main(int argc, char **argv){
    tiramisu::init("function66128_no_schedule");
    ...
    input input01("input01", {i3, i1, i0}, p_int32);

    input input02("input02", {i0, i3}, p_int32);

    input input03("input03", {i1, i3}, p_int32);

    computation comp0("comp0", {i0, i1, i2, i3}, input00(i2) - input01(i3, i1, i0) * input02(i0, i3) + input03(i1, i3));
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function66128/function66128_no_schedule/function66128_no_schedule.o");
