...
int main(int argc, char **argv){
    tiramisu::init("function69020_no_schedule");

    constant c0("c0", 262144), c1("c1", 512);
    ...
    computation comp0("comp0", {i0, i1}, input00(i1) + input01(i1) - input02(i0) * input03(i1) * input04(i1) - input05(i1) - input06(i0) - input07(i1) * input08(i0) - input09(i0));
    ...
    buffer buf06("buf06", {262144}, p_int32, a_input);
    buffer buf07("buf07", {512}, p_int32, a_input);
    buffer buf08("buf08", {262144}, p_int32, a_input);
    buffer buf09("buf09", {262144}, p_int32, a_input);
    buffer buf0("buf0", {262144, 512}, p_int32, a_output);
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf04, &buf05, &buf06, &buf07, &buf08, &buf09, &buf0}, "../data/programs/function69020/function69020_no_schedule/function69020_no_schedule.o");
