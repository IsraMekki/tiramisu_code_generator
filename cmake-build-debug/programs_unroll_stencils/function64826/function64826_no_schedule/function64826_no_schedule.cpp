...
int main(int argc, char **argv){
    tiramisu::init("function64826_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function64826/function64826_no_schedule/function64826_no_schedule.o");
