...
int main(int argc, char **argv){
    tiramisu::init("function68356_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68356/function68356_no_schedule/function68356_no_schedule.o");
