...
int main(int argc, char **argv){
    tiramisu::init("function68356_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68356/function68356_schedule_1/function68356_schedule_1.o");
