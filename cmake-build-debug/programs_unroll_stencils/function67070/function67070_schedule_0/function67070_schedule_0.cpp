...
int main(int argc, char **argv){
    tiramisu::init("function67070_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67070/function67070_schedule_0/function67070_schedule_0.o");
