...
int main(int argc, char **argv){
    tiramisu::init("function68647_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68647/function68647_no_schedule/function68647_no_schedule.o");
