...
int main(int argc, char **argv){
    tiramisu::init("function68647_schedule_0");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function68647/function68647_schedule_0/function68647_schedule_0.o");
