...
int main(int argc, char **argv){
    tiramisu::init("function70622_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70622/function70622_no_schedule/function70622_no_schedule.o");
