...
int main(int argc, char **argv){
    tiramisu::init("function71644_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71644/function71644_schedule_1/function71644_schedule_1.o");
