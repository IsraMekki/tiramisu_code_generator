...
int main(int argc, char **argv){
    tiramisu::init("function74451_schedule_1");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function74451/function74451_schedule_1/function74451_schedule_1.o");
