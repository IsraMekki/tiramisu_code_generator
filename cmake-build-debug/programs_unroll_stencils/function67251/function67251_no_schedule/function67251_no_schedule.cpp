...
int main(int argc, char **argv){
    tiramisu::init("function67251_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67251/function67251_no_schedule/function67251_no_schedule.o");
