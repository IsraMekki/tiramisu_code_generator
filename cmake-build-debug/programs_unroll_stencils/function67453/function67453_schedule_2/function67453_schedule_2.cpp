...
int main(int argc, char **argv){
    tiramisu::init("function67453_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67453/function67453_schedule_2/function67453_schedule_2.o");
