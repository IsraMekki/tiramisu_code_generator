...
int main(int argc, char **argv){
    tiramisu::init("function67453_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf0}, "../data/programs/function67453/function67453_no_schedule/function67453_no_schedule.o");
