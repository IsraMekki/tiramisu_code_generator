...
int main(int argc, char **argv){
    tiramisu::init("function67643_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function67643/function67643_schedule_2/function67643_schedule_2.o");
