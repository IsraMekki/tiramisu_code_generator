...
int main(int argc, char **argv){
    tiramisu::init("function70482_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70482/function70482_schedule_2/function70482_schedule_2.o");
