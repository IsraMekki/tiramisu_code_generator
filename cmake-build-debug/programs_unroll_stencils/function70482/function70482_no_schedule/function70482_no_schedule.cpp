...
int main(int argc, char **argv){
    tiramisu::init("function70482_no_schedule");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf0}, "../data/programs/function70482/function70482_no_schedule/function70482_no_schedule.o");
