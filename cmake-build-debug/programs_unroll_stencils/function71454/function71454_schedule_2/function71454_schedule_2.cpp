...
int main(int argc, char **argv){
    tiramisu::init("function71454_schedule_2");
    ...
    tiramisu::codegen({&buf00, &buf01, &buf02, &buf03, &buf0}, "../data/programs/function71454/function71454_schedule_2/function71454_schedule_2.o");
